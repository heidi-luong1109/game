...
}"id="bonuss">BONUS:<?php echo e(number_format(Auth::user()->count_return, 2,".","")); ?> <?php if( auth()->user()->present()->shop ): ?><?php echo e(auth()->user()->present()->shop->currenc); ?><?php endif; ?></em>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
<script>
					setInterval(function(){$("#bonuss").load("./index.php #bonuss")},2000)
					</script></span>

<?php /**PATH C:\OSPanelCH\domains\vlt.mycasinoch.com\resources\views/frontend/games/list/AdmiralNelsonAM.blade.php ENDPATH**/ ?>