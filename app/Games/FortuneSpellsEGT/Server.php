        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('FortuneSpellsEGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'bet':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                        {
                            for( $r = 1; $r <= 5; $r++ ) 
                            {
                                ...
                                {
                                    if( $_obf_0D3D05062631163936351A352E0A073E0401223F110832['reel' . $r][$_obf_0D31403C0837332A1A1711312A3415151610280F122122] == $slotSettings->GetGameData('FortuneSpellsEGTExpandSymbol') ) 
                                    {
                                        $_obf_0D3D05062631163936351A352E0A073E0401223F110832['reel' . $r][0] = $slotSettings->GetGameData('FortuneSpellsEGTExpandSymbol');
                                        $_obf_0D3D05062631163936351A352E0A073E0401223F110832['reel' . $r][1] = $slotSettings->GetGameData('FortuneSpellsEGTExpandSymbol');
                                        $_obf_0D3D05062631163936351A352E0A073E0401223F110832['reel' . $r][2] = $slotSettings->GetGameData('FortuneSpellsEGTExpandSymbol');
                                        break;
                                    }
                                }
                            }
                        ...
                        for( $k = 0; $k < $lines; $k++ ) 
                        {
                            ...
                            for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                            {
                                ...
                                else
                                {
                                    ...
                                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' && $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 == $slotSettings->GetGameData('FortuneSpellsEGTExpandSymbol') ) 
                                    {
                    ...
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = $slotSettings->GetGameData('FortuneSpellsEGTFreeBalance');
                    }
                    else
                    {
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('FortuneSpellsEGTCards');
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('FortuneSpellsEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('FortuneSpellsEGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('FortuneSpellsEGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('FortuneSpellsEGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('FortuneSpellsEGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
