...
/*            if( config('LicenseDK.APL_INCLUDE_KEY_CONFIG') != 'wi9qydosuimsnls5zoe5q298evkhim0ughx1w16qybs2fhlcpn' ) 
            ...
            {
                $_obf_0D05270F1B1A0F141C39381718325B2F1C191021320D22 = [
                    '1' => 3, 
                    '10' => 0, 
                    '100' => 1, 
                    '105' => 1, 
                ...
                $slotSettings->SetGameData('PumpkinFairyIGSpArr', $_obf_0D05270F1B1A0F141C39381718325B2F1C191021320D22);
            }
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['action'] == 'risk' && $slotSettings->GetGameData('PumpkinFairyIGWin') <= 0 ) 
            {
            ...
            switch( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['action'] ) 
            {
                case 'init':
                    ...
                    $allbet = $bet * $lines;
                    $_obf_0D05270F1B1A0F141C39381718325B2F1C191021320D22 = $slotSettings->GetGameData('PumpkinFairyIGSpArr');
                    $_obf_0D1F05363932012B03251E113503262B15300B2F323322 = [];
                    foreach( $_obf_0D05270F1B1A0F141C39381718325B2F1C191021320D22 as $key => $vl ) 
                    {
                        $_obf_0D1F05363932012B03251E113503262B15300B2F323322[] = '"' . $key . '":' . $vl;
                    }
                    $sp = 0;
                    if( isset($_obf_0D05270F1B1A0F141C39381718325B2F1C191021320D22[$allbet]) ) 
                    {
                        $sp = $_obf_0D05270F1B1A0F141C39381718325B2F1C191021320D22[$allbet];
                    }
                    $slotSettings->SetGameData('PumpkinFairyIGSprinkler', $sp);
                    $response = '{"Amount":"' . sprintf('%01.2f', $balance * $slotSettings->CurrentDenom) . '","slotViewState":"' . $slotSettings->slotViewState . '","slotKeyConfig":' . $slotSettings->slotKeyConfig . ',"BetArray":[' . implode(',', $slotSettings->Bet) . '],"Credit":' . floor($balance) . ',"Currency":"' . $slotSettings->slotCurrency . '","Denomination":"' . sprintf('%01.2f', $slotSettings->CurrentDenom) . '","Denominations":{"100":"1.00"},"HelpCoef":[[0,0,0],[200,1000,5000],[100,500,2000],[30,100,500],[20,50,200],[10,30,100],[5,10,50],[3,5,20],[2,3,10]],"LastBet":' . $bet . ',"LastLines":' . $lines . ',"MaxWin":675000,"RawCredit":1000,"Reels":[' . $_obf_0D282A3E130518100418230D042B0A2B400930193F3232 . '],"Sprinkler":' . $slotSettings->GetGameData('PumpkinFairyIGSprinkler') . ',"Sprinklers":{' . implode(',', $_obf_0D1F05363932012B03251E113503262B15300B2F323322) . '},"Win":0,"args":{},"cmd":"init","time":"20190327T143954"}';
                    break;
                case 'status':
                ...
                case 'start':
                    ...
                    for( $i = 0; $i <= 1500; $i++ ) 
                    {
                        ...
                        {
                            $_obf_0D5B0D190F07273911051D090F2C1C12103018242A5C32 = $slotSettings->Bonus($bet * $lines, $fuseBet, $slotSettings->GetGameData('PumpkinFairyIGSprinkler'));
                        ...
                        $bonusSym = 0;
                        $_obf_0D3D0E3335392C0C21070B25255C40402207111C145C01 = 0;
                        for( $_obf_0D182E3D04083B031231152D232B1935261A062D0A0F01 = 0; $_obf_0D182E3D04083B031231152D232B1935261A062D0A0F01 <= 4; $_obf_0D182E3D04083B031231152D232B1935261A062D0A0F01++ ) 
                        {
                            ...
                            if( $reels['reel' . ($_obf_0D182E3D04083B031231152D232B1935261A062D0A0F01 + 1)][0] == 5 ) 
                            {
                                $_obf_0D3D0E3335392C0C21070B25255C40402207111C145C01++;
                            }
                            if( $reels['reel' . ($_obf_0D182E3D04083B031231152D232B1935261A062D0A0F01 + 1)][1] == 5 ) 
                            {
                                $_obf_0D3D0E3335392C0C21070B25255C40402207111C145C01++;
                            }
                            if( $reels['reel' . ($_obf_0D182E3D04083B031231152D232B1935261A062D0A0F01 + 1)][2] == 5 ) 
                            {
                                $_obf_0D3D0E3335392C0C21070B25255C40402207111C145C01++;
                            }
                        }
                    ...
                    if( $_obf_0D3D0E3335392C0C21070B25255C40402207111C145C01 >= 3 && $slotSettings->GetGameData('PumpkinFairyIGSprinkler') < 27 ) 
                    {
                    ...
                    $slotSettings->SetGameData('PumpkinFairyIGReels', $_obf_0D282A3E130518100418230D042B0A2B400930193F3232);
                    ...
                    $slotSettings->SetGameData('PumpkinFairyIGDealerCard', $_obf_0D152F2B13101C1F2D320B1C302214192A26071A401E32);
                    if( isset($_obf_0D5B0D190F07273911051D090F2C1C12103018242A5C32['Sprinkler']) && $_obf_0D5C39151E192A0D0C273E041A211E31150B2201231D01 ) 
                    {
                        $slotSettings->SetGameData('PumpkinFairyIGSprinkler', $_obf_0D5B0D190F07273911051D090F2C1C12103018242A5C32['Sprinkler']);
                    }
                    if( isset($_obf_0D05270F1B1A0F141C39381718325B2F1C191021320D22[$lines * $bet]) ) 
                    {
                        $_obf_0D05270F1B1A0F141C39381718325B2F1C191021320D22[$lines * $bet] = $slotSettings->GetGameData('PumpkinFairyIGSprinkler');
                    }
                    $slotSettings->SetGameData('PumpkinFairyIGSpArr', $_obf_0D05270F1B1A0F141C39381718325B2F1C191021320D22);
