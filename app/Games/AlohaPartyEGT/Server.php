        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('AlohaPartyEGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                    ...
                    if( $lastEvent != 'NULL' ) 
                    {
                        ...
                        $_obf_0D3E331C040E390B031B03100422040311293E023E0322 = '' . rand(0, 6) . ',' . $reels->reel1[0] . ',' . $reels->reel1[1] . ',' . $reels->reel1[2] . ',' . $reels->reel1[3] . ',' . rand(0, 6);
                        $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(0, 6) . ',' . $reels->reel2[0] . ',' . $reels->reel2[1] . ',' . $reels->reel2[2] . ',' . $reels->reel2[3] . ',' . rand(0, 6));
                        $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(0, 6) . ',' . $reels->reel3[0] . ',' . $reels->reel3[1] . ',' . $reels->reel3[2] . ',' . $reels->reel3[3] . ',' . rand(0, 6));
                        $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(0, 6) . ',' . $reels->reel4[0] . ',' . $reels->reel4[1] . ',' . $reels->reel4[2] . ',' . $reels->reel4[3] . ',' . rand(0, 6));
                        $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(0, 6) . ',' . $reels->reel5[0] . ',' . $reels->reel5[1] . ',' . $reels->reel5[2] . ',' . $reels->reel5[3] . ',' . rand(0, 6));
                    ...
                    {
                        $_obf_0D33051C1539292C322D230A2B230A1F321305011D0D11 = 1;
                        $_obf_0D3E331C040E390B031B03100422040311293E023E0322 = '' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . '';
                        $lines = 10;
                ...
                case 'bet':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                        {
                            ...
                            $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222 = [
                                0, 
                                0, 
                                0, 
                                0, 
                            ...
                            $_obf_0D16182D2B31120E1C1B29351805140216313036102C01 = [
                                0, 
                                0, 
                                0, 
                                0, 
                            ...
                            $_obf_0D2F1E3814082E1328220F5B24335C0E0C080331120A22 = [
                                0, 
                                0, 
                                0, 
                                0, 
                            ...
                            $_obf_0D1C22330730162F271D22262B090A1937323736093F01 = 0;
                            $_obf_0D0D2B0330121904261537292A32120D2E372A24263032 = 1;
                            $_obf_0D37111B3335140203262E17350902171D182F5B312522 = 0;
                            $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 = 1;
                            $_obf_0D2E1F25273605073D37382D151B041925011E31392132 = 1;
                            $_obf_0D16361002191D12250B370F351724173E02193C2D0E11 = 1;
                            ...
                            {
                                $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '';
                                $_obf_0D1F0B292F242B2516303F2D3C2C5C2205250F2C320F11 = [];
                                $_obf_0D1F3B1A370D2E2B2701040A2902350D39070D181A3211 = 0;
                                $_obf_0D1A2F0B1A180C1D0D010A0333013D073C1035105C5C01 = false;
                                $_obf_0D1B0B122F293202403E040D155C32031F0A2E195C0D01 = [];
                                $_obf_0D1B0B122F293202403E040D155C32031F0A2E195C0D01['lines1'] = [
                                    [
                                        0, 
                                        1, 
                                        2, 
                                ...
                                $_obf_0D1B0B122F293202403E040D155C32031F0A2E195C0D01['lines5'] = [
                                    [
                                        0, 
                                        1, 
                                        2, 
                                ...
                                $_obf_0D1B0B122F293202403E040D155C32031F0A2E195C0D01['lines10'] = [
                                    [
                                        0, 
                                        1, 
                                        2, 
                                ...
                                $_obf_0D1B0B122F293202403E040D155C32031F0A2E195C0D01['lines20'] = [
                                    [
                                        0, 
                                        1, 
                                        2, 
                                ...
                                $_obf_0D1B0B122F293202403E040D155C32031F0A2E195C0D01['lines40'] = [
                                    [
                                        0, 
                                        1, 
                                        2, 
                                ...
                                for( $r = 1; $r <= 5; $r++ ) 
                                {
                                    if( $_obf_0D1A2F0B1A180C1D0D010A0333013D073C1035105C5C01 ) 
                                    {
                                        break;
                                    }
                                    $_obf_0D1A2F0B1A180C1D0D010A0333013D073C1035105C5C01 = true;
                                    for( $s = 0; $s <= 3; $s++ ) 
                                    {
                                        if( !in_array($s, $_obf_0D1B0B122F293202403E040D155C32031F0A2E195C0D01['lines' . $lines][$r - 1]) ) 
                                        {
                                        }
                                        else
                                        {
                                            if( $reels['reel' . $r][$s] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $reels['reel' . $r][$s] == $wild ) 
                                            {
                                                $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[$r - 1] = 1;
                                                $_obf_0D2F1E3814082E1328220F5B24335C0E0C080331120A22[$r - 1]++;
                                                $_obf_0D1F0B292F242B2516303F2D3C2C5C2205250F2C320F11[] = ($r - 1) . ',' . $s;
                                                $_obf_0D1F3B1A370D2E2B2701040A2902350D39070D181A3211++;
                                                $_obf_0D1A2F0B1A180C1D0D010A0333013D073C1035105C5C01 = false;
                                            }
                                            if( $reels['reel' . $r][$s] == $wild ) 
                                            {
                                                $_obf_0D1C22330730162F271D22262B090A1937323736093F01++;
                                                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                                                {
                                                    if( $_obf_0D1C22330730162F271D22262B090A1937323736093F01 == 1 && $r == 2 ) 
                                                    {
                                                        $_obf_0D0D2B0330121904261537292A32120D2E372A24263032 = 3;
                                                    }
                                                    if( $_obf_0D1C22330730162F271D22262B090A1937323736093F01 == 1 && $r == 4 ) 
                                                    {
                                                        $_obf_0D0D2B0330121904261537292A32120D2E372A24263032 = 5;
                                                    }
                                                    if( $_obf_0D1C22330730162F271D22262B090A1937323736093F01 == 2 ) 
                                                    {
                                                        $_obf_0D0D2B0330121904261537292A32120D2E372A24263032 = 15;
                                                    }
                                                }
                                            }
                                        }
                                ...
                                if( $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[0] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[1] > 0 ) 
                                {
                                    $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 = 1;
                                    $_obf_0D2E1F25273605073D37382D151B041925011E31392132 = 1;
                                    $_obf_0D16361002191D12250B370F351724173E02193C2D0E11 = 1;
                                    for( $r = 1; $r <= 2; $r++ ) 
                                    {
                                        if( $_obf_0D2F1E3814082E1328220F5B24335C0E0C080331120A22[$r - 1] > 0 ) 
                                        {
                                            $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 = $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 * $_obf_0D2F1E3814082E1328220F5B24335C0E0C080331120A22[$r - 1];
                                        }
                                    }
                                    $_obf_0D1A08361C315C0F302C102A0D011D1F041B0637020C11 = $slotSettings->Paytable['SYM_' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][2] * $betline * $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 * $_obf_0D0D2B0330121904261537292A32120D2E372A24263032;
                                    $_obf_0D2312103E1E3F2B0A2724252D2916031F2E18100A2222 = $slotSettings->Paytable['SYM_' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][2] * $betline;
                                    if( $_obf_0D37111B3335140203262E17350902171D182F5B312522 < $_obf_0D1A08361C315C0F302C102A0D011D1F041B0637020C11 ) 
                                    {
                                        $_obf_0D37111B3335140203262E17350902171D182F5B312522 = $_obf_0D1A08361C315C0F302C102A0D011D1F041B0637020C11;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . ',"len":2,"count":' . $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 . ',"winPerCount":' . ($_obf_0D2312103E1E3F2B0A2724252D2916031F2E18100A2222 * 100) . ',"multiplier":' . $_obf_0D0D2B0330121904261537292A32120D2E372A24263032 . ',"winAmount":' . round($_obf_0D37111B3335140203262E17350902171D182F5B312522 / ($_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 * $_obf_0D0D2B0330121904261537292A32120D2E372A24263032) * 100) . ',"cells":[' . implode(',', $_obf_0D1F0B292F242B2516303F2D3C2C5C2205250F2C320F11) . ']}';
                                    }
                                }
                                if( $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[0] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[1] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[2] > 0 ) 
                                {
                                    $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 = 1;
                                    $_obf_0D2E1F25273605073D37382D151B041925011E31392132 = 1;
                                    $_obf_0D16361002191D12250B370F351724173E02193C2D0E11 = 1;
                                    ...
                                    $_obf_0D1A08361C315C0F302C102A0D011D1F041B0637020C11 = $slotSettings->Paytable['SYM_' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][3] * $betline * $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 * $_obf_0D0D2B0330121904261537292A32120D2E372A24263032;
                                    $_obf_0D2312103E1E3F2B0A2724252D2916031F2E18100A2222 = $slotSettings->Paytable['SYM_' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][3] * $betline;
                                    if( $_obf_0D37111B3335140203262E17350902171D182F5B312522 < $_obf_0D1A08361C315C0F302C102A0D011D1F041B0637020C11 ) 
                                    {
                                        $_obf_0D37111B3335140203262E17350902171D182F5B312522 = $_obf_0D1A08361C315C0F302C102A0D011D1F041B0637020C11;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . ',"len":3,"count":' . $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 . ',"winPerCount":' . ($_obf_0D2312103E1E3F2B0A2724252D2916031F2E18100A2222 * 100) . ',"multiplier":' . $_obf_0D0D2B0330121904261537292A32120D2E372A24263032 . ',"winAmount":' . round($_obf_0D37111B3335140203262E17350902171D182F5B312522 / ($_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 * $_obf_0D0D2B0330121904261537292A32120D2E372A24263032) * 100) . ',"cells":[' . implode(',', $_obf_0D1F0B292F242B2516303F2D3C2C5C2205250F2C320F11) . ']}';
                                    }
                                }
                                if( $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[0] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[1] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[2] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[3] > 0 ) 
                                {
                                    $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 = 1;
                                    $_obf_0D2E1F25273605073D37382D151B041925011E31392132 = 1;
                                    $_obf_0D16361002191D12250B370F351724173E02193C2D0E11 = 1;
                                    ...
                                    $_obf_0D1A08361C315C0F302C102A0D011D1F041B0637020C11 = $slotSettings->Paytable['SYM_' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][4] * $betline * $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 * $_obf_0D0D2B0330121904261537292A32120D2E372A24263032;
                                    $_obf_0D2312103E1E3F2B0A2724252D2916031F2E18100A2222 = $slotSettings->Paytable['SYM_' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][4] * $betline;
                                    if( $_obf_0D37111B3335140203262E17350902171D182F5B312522 < $_obf_0D1A08361C315C0F302C102A0D011D1F041B0637020C11 ) 
                                    {
                                        $_obf_0D37111B3335140203262E17350902171D182F5B312522 = $_obf_0D1A08361C315C0F302C102A0D011D1F041B0637020C11;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . ',"len":4,"count":' . $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 . ',"winPerCount":' . ($_obf_0D2312103E1E3F2B0A2724252D2916031F2E18100A2222 * 100) . ',"multiplier":' . $_obf_0D0D2B0330121904261537292A32120D2E372A24263032 . ',"winAmount":' . round($_obf_0D37111B3335140203262E17350902171D182F5B312522 / ($_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 * $_obf_0D0D2B0330121904261537292A32120D2E372A24263032) * 100) . ',"cells":[' . implode(',', $_obf_0D1F0B292F242B2516303F2D3C2C5C2205250F2C320F11) . ']}';
                                    }
                                }
                                if( $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[0] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[1] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[2] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[3] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[4] > 0 ) 
                                {
                                    $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 = 1;
                                    $_obf_0D2E1F25273605073D37382D151B041925011E31392132 = 1;
                                    $_obf_0D16361002191D12250B370F351724173E02193C2D0E11 = 1;
                                    ...
                                    $_obf_0D1A08361C315C0F302C102A0D011D1F041B0637020C11 = $slotSettings->Paytable['SYM_' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][5] * $betline * $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 * $_obf_0D0D2B0330121904261537292A32120D2E372A24263032;
                                    $_obf_0D2312103E1E3F2B0A2724252D2916031F2E18100A2222 = $slotSettings->Paytable['SYM_' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][5] * $betline;
                                    if( $_obf_0D37111B3335140203262E17350902171D182F5B312522 < $_obf_0D1A08361C315C0F302C102A0D011D1F041B0637020C11 ) 
                                    {
                                        $_obf_0D37111B3335140203262E17350902171D182F5B312522 = $_obf_0D1A08361C315C0F302C102A0D011D1F041B0637020C11;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . ',"len":5,"count":' . $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 . ',"winPerCount":' . ($_obf_0D2312103E1E3F2B0A2724252D2916031F2E18100A2222 * 100) . ',"multiplier":' . $_obf_0D0D2B0330121904261537292A32120D2E372A24263032 . ',"winAmount":' . round($_obf_0D37111B3335140203262E17350902171D182F5B312522 / ($_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 * $_obf_0D0D2B0330121904261537292A32120D2E372A24263032) * 100) . ',"cells":[' . implode(',', $_obf_0D1F0B292F242B2516303F2D3C2C5C2205250F2C320F11) . ']}';
                                    }
                                }
                                $totalWin += $_obf_0D37111B3335140203262E17350902171D182F5B312522;
                                $cWins[$j] = $_obf_0D37111B3335140203262E17350902171D182F5B312522;
                    ...
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = $slotSettings->GetGameData('AlohaPartyEGTFreeBalance');
                    }
                    else
                    {
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . '' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('AlohaPartyEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AlohaPartyEGTCurrentFreeGame') . ',"Balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"afterBalance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"bonusWin":' . $slotSettings->GetGameData('AlohaPartyEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"Jackpots":' . $_obf_0D28393910101E062539311B3F371C121912162B061E32 . ',"reelsSymbols":' . $_obf_0D273522403840350F0A36072E150A0524143F382C3B32 . '}}';
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('AlohaPartyEGTCards');
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gambles":5,"reels":[' . $_obf_0D3E331C040E390B031B03100422040311293E023E0322 . '],"combos":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"expand":[],"additional": [],"choices": 0,"specialExpand":[],"gambles":5,"freespins":' . $fs . ',"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('AlohaPartyEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('AlohaPartyEGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('AlohaPartyEGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('AlohaPartyEGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('AlohaPartyEGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
