        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                case 'choice':
                    ...
                    $_obf_0D3E2A21032136092235272A2C3D1C0340223B163F0C11 = $slotSettings->GetGameData('TheExplorersEGTChoiceArr');
                    $fs = $slotSettings->GetGameData('TheExplorersEGTFreeGames');
                    $_obf_0D352C3B2F030A2414021C3C255C37211A3E31241E3922 = $slotSettings->GetGameData('TheExplorersEGTMultiplier');
                    ...
                    if( count($_obf_0D3E2A21032136092235272A2C3D1C0340223B163F0C11) >= 3 && $slotSettings->GetGameData('TheExplorersEGTFreeGames') > 0 ) 
                    {
                    ...
                    $slotSettings->SetGameData('TheExplorersEGTChoiceArr', $_obf_0D3E2A21032136092235272A2C3D1C0340223B163F0C11);
                    $slotSettings->SetGameData('TheExplorersEGTFreeGames', $fs + $_obf_0D5B30195C320C5B21191E1C0226261E052D3C29120422);
                    $slotSettings->SetGameData('TheExplorersEGTMultiplier', $_obf_0D352C3B2F030A2414021C3C255C37211A3E31241E3922 + $_obf_0D1F2E39342F0F2D371835031F0A3B2C350E251D3C1732);
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"pos":' . $choice . ',"multiplier":' . $slotSettings->GetGameData('TheExplorersEGTMultiplier') . ',"freespins":' . $slotSettings->GetGameData('TheExplorersEGTFreeGames') . ',"mult":' . $_obf_0D1F2E39342F0F2D371835031F0A3B2C350E251D3C1732 . ',"fs":' . $_obf_0D5B30195C320C5B21191E1C0226261E052D3C29120422 . ',"play":' . $_obf_0D105C2811322F073E163E1B1F390D1E3D1A03323D3F22 . ',"closed":[' . $_obf_0D22363F0F3C1234262F032D2D1A3F2B0C1F1F2A3D3801 . '],"freespins":' . $slotSettings->GetGameData('TheExplorersEGTFreeGames') . ',"choices":1,"gameCommand":"choice"},"state":"' . $state . '","winAmount":' . ($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":1787203010852,"sessionKey":"5af6a26c031aa4ec491159428c5a7742","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":1566584969191}';
                    break;
                case 'login':
                ...
                case 'settings':
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"paytableCoef":{"0":{"coef":[5,20,100],"multiplier":2},"1":{"coef":[5,20,100],"multiplier":2},"2":{"coef":[5,20,150],"multiplier":2},"3":{"coef":[5,20,150],"multiplier":2},"4":{"coef":[10,50,200],"multiplier":2},"5":{"coef":[10,50,200],"multiplier":2},"6":{"coef":[10,50,250],"multiplier":2},"7":{"coef":[20,100,500],"multiplier":2},"8":{"coef":[20,150,750],"multiplier":2},"9":{"coef":[10,100,1000,5000],"multiplier":1},"10":{"coef":[5],"multiplier":1}},"bets":[' . implode(',', $_obf_0D131333153E3B3F113536290D1D1A025B0D3F16341932) . '],"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[8,1,4,0,5,2,6,1,9,7,3,8,1,4,2,3,5,6,0,2],[2,8,0,6,1,5,9,2,4,3,5,1,2,3,5,7,0,8,3,6],[4,0,2,1,9,3,7,4,8,1,10,3,2,0,1,3,6,1,6,2],[3,6,1,5,3,9,1,7,0,5,2,1,7,1,4,1,2,3,4,10],[6,1,7,3,5,0,1,4,8,1,5,10,2,4,9,7,5,0,3,4]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $_obf_0D0C2105130819393F29112D311A15170F3C2913160B01) . ']},"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                    break;
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('TheExplorersEGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'bet':
                    ...
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = $slotSettings->GetGameData('TheExplorersEGTFreeBalance');
                    }
                    else
                    {
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('TheExplorersEGTCards');
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('TheExplorersEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('TheExplorersEGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('TheExplorersEGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('TheExplorersEGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('TheExplorersEGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
