        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'settings':
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"paytableCoef":{"0":{"coef":[10,30,150],"multiplier":1},"1":{"coef":[10,30,150],"multiplier":1},"2":{"coef":[10,30,150],"multiplier":1},"3":{"coef":[10,30,150],"multiplier":1},"4":{"coef":[20,40,200],"multiplier":1},"5":{"coef":[40,120,700],"multiplier":1},"6":{"coef":[40,120,700],"multiplier":1},"7":{"coef":[10,50,250,5000],"multiplier":1},"8":{"coef":[],"multiplier":1},"9":{"coef":[20],"multiplier":1},"10":{"coef":[5,20,100],"multiplier":1}},"bets":[' . implode(',', $_obf_0D131333153E3B3F113536290D1D1A025B0D3F16341932) . '],"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[6,2,2,2,0,0,0,5,4,1,5,10,1,1,3,4,7,4,9,4],[7,2,2,2,5,3,0,0,10,6,3,3,1,1,4,1,4,8,4,2],[6,1,1,8,7,1,5,3,3,9,1,4,0,4,2,2,2,10,0,0],[1,1,1,7,1,3,3,8,6,4,3,4,2,2,10,2,0,0,5,1],[7,3,3,2,2,1,6,10,1,1,3,3,3,2,7,0,0,4,9,4]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $_obf_0D0C2105130819393F29112D311A15170F3C2913160B01) . ']},"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                    break;
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('BurningDice5EGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'bet':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            for( $_obf_0D31403C0837332A1A1711312A3415151610280F122122 = 0; $_obf_0D31403C0837332A1A1711312A3415151610280F122122 <= 2; $_obf_0D31403C0837332A1A1711312A3415151610280F122122++ ) 
                            {
                                ...
                                {
                                    for( $_obf_0D35250B12082127321B0D2E052D39231612220B2E3F32 = 0; $_obf_0D35250B12082127321B0D2E052D39231612220B2E3F32 <= 2; $_obf_0D35250B12082127321B0D2E052D39231612220B2E3F32++ ) 
                                    {
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('BurningDice5EGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BurningDice5EGTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('BurningDice5EGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"Jackpots":' . $_obf_0D28393910101E062539311B3F371C121912162B061E32 . ',"reelsSymbols":' . $_obf_0D273522403840350F0A36072E150A0524143F382C3B32 . '}}';
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('BurningDice5EGTCards');
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 = '' . rand(1, 8) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(1, 8);
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(1, 8) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(1, 8));
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(1, 8) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(1, 8));
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(1, 8) . ',' . $reels['reel4'][0] . ',' . $reels['reel4'][1] . ',' . $reels['reel4'][2] . ',' . rand(1, 8));
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('BurningDice5EGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('BurningDice5EGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('BurningDice5EGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('BurningDice5EGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('BurningDice5EGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
