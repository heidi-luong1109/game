        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 ) 
            {
                ...
                case 'SELGAME':
                    ...
                    $slotSettings->SetGameData('WormVSCards', $_obf_0D21152412095C03222D3808130C3C012907290C181E22);
                ...
                case 'GA_SPIN':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22 = ['2'];
                        ...
                        else
                        {
                            ...
                            if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && ($_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel3'][0] == '12' || $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel3'][1] == '12' || $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel3'][2] == '12') && $totalWin > 0 ) 
                            {
                                $totalWin = $slotSettings->GetGameData('WormVSBonusWin') + $totalWin;
                                $_obf_0D072B122F3D340D1505113B262C1D092A21323C401811 = ',"aftertake":{"addon_type":1,"addon_sym":12,"addon_snd1":"wormanim_inscatter","addon_inscatwinto":' . (($slotSettings->GetGameData('WormVSBonusWin') + $totalWin) * 2 * 100) . ',"addon_snd2":"wpay_end","addon_ms2":2000}';
                            }
                            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && ($_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel3'][0] == '12' || $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel3'][1] == '12' || $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel3'][2] == '12') && $totalWin == 0 ) 
                            {
                            }
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $_obf_0D1F292430132C1009140F17162121100D240917270211 . ',"totalFreeGames":' . $slotSettings->GetGameData('WormVSFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('WormVSCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('WormVSBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                    ...
                    $_obf_0D21152412095C03222D3808130C3C012907290C181E22 = $slotSettings->GetGameData('WormVSCards');
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                    {
                        if( $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel3'][0] == '12' || $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel3'][1] == '12' || $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel3'][2] == '12' ) 
                        {
                        }
                        $_obf_0D5C30050315032D3D1E3914110A241812070A19102122 = 2;
                ...
                case 'GA_TAKE':
                    ...
                    $slotSettings->SetGameData('WormVSTotalWin', 0);
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '{"status":"OK","authtoken":"1/90317550919705477001","for":"GA_TAKE","totsg":' . $slotSettings->GetGameData('WormVSFreeGames') . ',"plsg":' . $slotSettings->GetGameData('WormVSCurrentFreeGame') . ',"inscatwin":' . ($slotSettings->GetGameData('WormVSBonusWin') * 100) . ',"gtype":' . $_obf_0D3B3428360D152B3D312F043B1F083E2317380A020511 . ',"credit":{"tot":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . '}}';
                    break;
                case 'QUITGAME':
                    $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
