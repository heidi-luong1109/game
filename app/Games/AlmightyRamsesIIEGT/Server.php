        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('AlmightyRamsesIIEGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'bet':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $_obf_0D293D36331F1422393610140D3F1415405B1C22383732 = [];
                        if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' && $reels['reel1'][0] == $reels['reel1'][1] && $reels['reel1'][1] == $reels['reel1'][2] ) 
                        {
                            $_obf_0D0B1E231E352D1F042C260A39361C1D033B382E2C1A11 = $reels['reel1'][0];
                            for( $ms = 0; $ms < 3; $ms++ ) 
                            {
                                $_obf_0D0C330F1D38240B5B31110614140F34014040212A0A11 = '';
                                if( $reels['reel3'][$ms] == $_obf_0D0B1E231E352D1F042C260A39361C1D033B382E2C1A11 ) 
                                {
                                    $_obf_0D0C330F1D38240B5B31110614140F34014040212A0A11 = '1,' . $ms . ',2,' . $ms . '';
                                    $reels['reel2'][$ms] = $_obf_0D0B1E231E352D1F042C260A39361C1D033B382E2C1A11;
                                    $reels['reel3'][$ms] = $_obf_0D0B1E231E352D1F042C260A39361C1D033B382E2C1A11;
                                }
                                if( $reels['reel4'][$ms] == $_obf_0D0B1E231E352D1F042C260A39361C1D033B382E2C1A11 ) 
                                {
                                    $_obf_0D0C330F1D38240B5B31110614140F34014040212A0A11 = '1,' . $ms . ',2,' . $ms . ',3,' . $ms . '';
                                    $reels['reel2'][$ms] = $_obf_0D0B1E231E352D1F042C260A39361C1D033B382E2C1A11;
                                    $reels['reel3'][$ms] = $_obf_0D0B1E231E352D1F042C260A39361C1D033B382E2C1A11;
                                    $reels['reel4'][$ms] = $_obf_0D0B1E231E352D1F042C260A39361C1D033B382E2C1A11;
                                }
                                if( $reels['reel5'][$ms] == $_obf_0D0B1E231E352D1F042C260A39361C1D033B382E2C1A11 ) 
                                {
                                    $_obf_0D0C330F1D38240B5B31110614140F34014040212A0A11 = '1,' . $ms . ',2,' . $ms . ',3,' . $ms . ',4,' . $ms . '';
                                    $reels['reel2'][$ms] = $_obf_0D0B1E231E352D1F042C260A39361C1D033B382E2C1A11;
                                    $reels['reel3'][$ms] = $_obf_0D0B1E231E352D1F042C260A39361C1D033B382E2C1A11;
                                    $reels['reel4'][$ms] = $_obf_0D0B1E231E352D1F042C260A39361C1D033B382E2C1A11;
                                }
                                if( $_obf_0D0C330F1D38240B5B31110614140F34014040212A0A11 != '' ) 
                                {
                                    $_obf_0D293D36331F1422393610140D3F1415405B1C22383732[] = $_obf_0D0C330F1D38240B5B31110614140F34014040212A0A11;
                                }
                            }
                        }
                        for( $k = 0; $k < $lines; $k++ ) 
                    ...
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = $slotSettings->GetGameData('AlmightyRamsesIIEGTFreeBalance');
                    }
                    else
                    {
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('AlmightyRamsesIIEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AlmightyRamsesIIEGTCurrentFreeGame') . ',"Balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"afterBalance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"bonusWin":' . $slotSettings->GetGameData('AlmightyRamsesIIEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"Jackpots":' . $_obf_0D28393910101E062539311B3F371C121912162B061E32 . ',"reelsSymbols":' . $_obf_0D273522403840350F0A36072E150A0524143F382C3B32 . '}}';
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('AlmightyRamsesIIEGTCards');
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('AlmightyRamsesIIEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('AlmightyRamsesIIEGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('AlmightyRamsesIIEGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('AlmightyRamsesIIEGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('AlmightyRamsesIIEGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
