        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'settings':
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"paytableCoef":{"0":{"coef":[5,20,100],"multiplier":1},"1":{"coef":[5,20,100],"multiplier":1},"2":{"coef":[5,20,100],"multiplier":1},"3":{"coef":[10,20,125],"multiplier":1},"4":{"coef":[15,50,200],"multiplier":1},"5":{"coef":[20,50,400],"multiplier":1},"6":{"coef":[20,100,500],"multiplier":1},"7":{"coef":[50,500,2000],"multiplier":1},"9":{"coef":[5,50,200],"multiplier":1}},"bets":[' . implode(',', $_obf_0D131333153E3B3F113536290D1D1A025B0D3F16341932) . '],"jackpotMinBet":1,"jackpot":true,"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[5,2,4,0,0,9,1,1,7,2,3,0,4,1,2,4,0,5,3,2,0,6,9,4,0,2,2,4,0,3],[4,2,3,4,9,4,0,6,3,1,1,1,1,3,5,8,1,3,5,2,1,6,8,2,1,6,4,2,5,3],[1,6,9,5,1,1,5,7,3,2,8,7,3,2,5,0,0,4,6,8,0,4,6,1,6,0,0,0,5,2],[4,5,2,7,1,1,3,3,8,6,5,0,0,3,4,1,6,2,7,3,0,0,9,5,4,1,6,6,3,5],[5,2,6,4,1,3,1,7,1,7,2,0,4,2,4,0,6,3,3,2,1,6,2,4,0,0,9,2,4,1]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $_obf_0D0C2105130819393F29112D311A15170F3C2913160B01) . ']},"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                    break;
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('EgyptSkyEGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                    ...
                    {
                        $_obf_0D33051C1539292C322D230A2B230A1F321305011D0D11 = 1;
                        $_obf_0D3E331C040E390B031B03100422040311293E023E0322 = '' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . '';
                        $lines = 100;
                ...
                case 'bet':
                    ...
                    if( $winType == 'bonus' ) 
                    {
                        ...
                        {
                            if( $_obf_0D3105083F300417011E24321D131C14325C260C400511[$_obf_0D3D11063F0B3C1E1D365C1E122104310B3219022B3D11] * $betline <= $slotSettings->GetBank((isset($_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent']) ? $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] : '')) ) 
                            {
                        ...
                        {
                            $_obf_0D2D3F3D0A2F0E1A2C3C265C261C312107270D2D061C22 = json_decode(trim(file_get_contents(dirname(__FILE__) . '/presets/p_' . $_obf_0D0D142D29330A012D0B2E232729130B1F2B14222F1522 . '/preset_' . $lines . '.json')), true);
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $_obf_0D2C2C24180C0B0606390B1206253F3E3106111E211832 = [];
                        $_obf_0D140B1B0A3D3509061B0D38030E132E08071D0D1D1E01 = $holds;
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            for( $_obf_0D31403C0837332A1A1711312A3415151610280F122122 = 0; $_obf_0D31403C0837332A1A1711312A3415151610280F122122 <= 3; $_obf_0D31403C0837332A1A1711312A3415151610280F122122++ ) 
                            {
                                ...
                                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                                {
                                    if( $reels['reel' . $r][$_obf_0D31403C0837332A1A1711312A3415151610280F122122] == '8' && !in_array($r - 1, $_obf_0D140B1B0A3D3509061B0D38030E132E08071D0D1D1E01) ) 
                                    {
                                        $_obf_0D2C2C24180C0B0606390B1206253F3E3106111E211832[] = '' . ($r - 1) . ',0';
                                        $_obf_0D140B1B0A3D3509061B0D38030E132E08071D0D1D1E01[] = $r - 1;
                                    }
                                }
                                else if( $reels['reel' . $r][$_obf_0D31403C0837332A1A1711312A3415151610280F122122] == '8' ) 
                                {
                        ...
                        if( $scattersWin > 0 ) 
                        {
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                $_obf_0D341E1906402E012D2302041A0B29343137123F023201 = $slotSettings->slotFreeCount[$scattersCount];
                            }
                    ...
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = $slotSettings->GetGameData('EgyptSkyEGTFreeBalance');
                        $slotSettings->SetGameData($slotSettings->slotId . 'Holds', $_obf_0D140B1B0A3D3509061B0D38030E132E08071D0D1D1E01);
                    }
                    else
                    {
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"holdReels": ' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Holds')) . ',"totalFreeGames":' . $slotSettings->GetGameData('EgyptSkyEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('EgyptSkyEGTCurrentFreeGame') . ',"Balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"afterBalance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"bonusWin":' . $slotSettings->GetGameData('EgyptSkyEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"Jackpots":' . $_obf_0D28393910101E062539311B3F371C121912162B061E32 . ',"reelsSymbols":' . $_obf_0D273522403840350F0A36072E150A0524143F382C3B32 . '}}';
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('EgyptSkyEGTCards');
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('EgyptSkyEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('EgyptSkyEGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('EgyptSkyEGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('EgyptSkyEGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('EgyptSkyEGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
