        ...
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType']) ) 
            {
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType'] == 'regular' ) 
                {
                    ...
                    $slotSettings->SetGameData('SantaSurprisePTMChosenTree', $_obf_0D332D0D1D1835283D2F2A3E350C0D3B3806132F092532);
                    $slotSettings->SetGameData('SantaSurprisePTMstartStick', $_obf_0D5B04291F2E1B3312272C03162513041836345B260611);
                    $slotSettings->SetGameData('SantaSurprisePTMtreeStep', $_obf_0D09345C0F041B195C25080E373113305C263C3D040B32);
                    $slotSettings->SetGameData('SantaSurprisePTMlastWins', $_obf_0D02300F1F24102B1F3F253C5B3F132323180A01232F11);
                }
                ...
                $slotSettings->SetGameData('SantaSurprisePTMAllBet', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['bet']);
                ...
                if( $_obf_0D2F2D132713113D2310013B1A1E0D315C1A3B38213601 ) 
                {
                    ...
                    $slotSettings->SetGameData('SantaSurprisePTMWinValues', $_obf_0D1A0A3E13292D2D182C023B2B27315B190F1507391601['curValues']);
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{' . $_obf_0D34133B2D401823121A3E3C0C3B3440063B2832150332 . '"allbet":' . $slotSettings->GetGameData('SantaSurprisePTMAllBet') . ',"betLine":' . $slotSettings->GetGameData('SantaSurprisePTMBetLine') . ',"linesArr":[' . implode(',', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('SantaSurprisePTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('SantaSurprisePTMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('SantaSurprisePTMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('SantaSurprisePTMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
            ...
            {
                case '40145':
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['pickIndex'] >= 0 && $slotSettings->GetGameData('SantaSurprisePTMPickedCount') < $slotSettings->GetGameData('SantaSurprisePTMprizeBonusNum') ) 
                    {
                        $_obf_0D262D0136400C3F0525143D36383F363C3514155B0711 = json_decode($slotSettings->GetGameData('SantaSurprisePTMLastResponse'));
                        $values = $slotSettings->GetGameData('SantaSurprisePTMWinValues');
                        $pick = $slotSettings->GetGameData('SantaSurprisePTMPickedCount');
                        $_obf_0D5C210631273818332424032C281E0D38310B1F0A1201 = $slotSettings->GetGameData('SantaSurprisePTMPickedCountArr');
                        $_obf_0D23292E1910310B2D0F382A090D063F2A132521111C32 = $values[$pick] * $slotSettings->GetGameData('SantaSurprisePTMBetLine');
                        ...
                        $slotSettings->SetGameData('SantaSurprisePTMPickedCountArr', $_obf_0D5C210631273818332424032C281E0D38310B1F0A1201);
                        ...
                        $slotSettings->SetGameData('SantaSurprisePTMLastResponse', json_encode($_obf_0D262D0136400C3F0525143D36383F363C3514155B0711));
                    }
