        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('WonderHeartEGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'bet':
                        ...
                        for( $k = 0; $k < $lines; $k++ ) 
                        {
                            ...
                            for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        $mpl = 1;
                                        $_obf_0D01303529230C370803235C135B3E0B2D3F3E13163232 = 3;
                                        if( $s[0] == '11' ) 
                                        {
                                            $_obf_0D01303529230C370803235C135B3E0B2D3F3E13163232 += 1;
                                        }
                                        if( $s[1] == '11' ) 
                                        {
                                            $_obf_0D01303529230C370803235C135B3E0B2D3F3E13163232 += 1;
                                        ...
                                        $_obf_0D365B172533170712222423300A1B092C161521071B32 = $slotSettings->Paytable['SYM_' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][$_obf_0D01303529230C370803235C135B3E0B2D3F3E13163232] * $betline * $mpl * $bonusMpl;
                                        if( $cWins[$k] < $_obf_0D365B172533170712222423300A1B092C161521071B32 ) 
                                        {
                                            ...
                                            $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"line":' . $k . ',"sequence":' . $_obf_0D01303529230C370803235C135B3E0B2D3F3E13163232 . ',"winAmount":' . ($cWins[$k] * 100) . ',"cells":[0,' . ($linesId[$k][0] - 1) . ',1,' . ($linesId[$k][1] - 1) . ',2,' . ($linesId[$k][2] - 1) . '],"freespins":0,"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . '}';
                                        }
                                    }
                                    ...
                                    {
                                        $mpl = 1;
                                        $_obf_0D01303529230C370803235C135B3E0B2D3F3E13163232 = 4;
                                        if( $s[0] == '11' ) 
                                        {
                                            $_obf_0D01303529230C370803235C135B3E0B2D3F3E13163232 += 1;
                                        }
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                            $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"line":' . $k . ',"sequence":' . $_obf_0D01303529230C370803235C135B3E0B2D3F3E13163232 . ',"winAmount":' . ($cWins[$k] * 100) . ',"cells":[0,' . ($linesId[$k][0] - 1) . ',1,' . ($linesId[$k][1] - 1) . ',2,' . ($linesId[$k][2] - 1) . ',3,' . ($linesId[$k][3] - 1) . '],"freespins":0,"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . '}';
                                        }
                                    }
                                    ...
                                    {
                                        $mpl = 1;
                                        $_obf_0D01303529230C370803235C135B3E0B2D3F3E13163232 = 5;
                                        if( $s[0] == '11' ) 
                                        {
                                            $_obf_0D01303529230C370803235C135B3E0B2D3F3E13163232 += 1;
                                        }
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                            $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"line":' . $k . ',"sequence":' . $_obf_0D01303529230C370803235C135B3E0B2D3F3E13163232 . ',"winAmount":' . ($cWins[$k] * 100) . ',"cells":[0,' . ($linesId[$k][0] - 1) . ',1,' . ($linesId[$k][1] - 1) . ',2,' . ($linesId[$k][2] - 1) . ',3,' . ($linesId[$k][3] - 1) . ',4,' . ($linesId[$k][4] - 1) . '],"freespins":0,"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . '}';
                                        }
                                    }
                                }
                            }
                    ...
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = $slotSettings->GetGameData('WonderHeartEGTFreeBalance');
                    }
                    else
                    {
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('WonderHeartEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('WonderHeartEGTCurrentFreeGame') . ',"Balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"afterBalance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"bonusWin":' . $slotSettings->GetGameData('WonderHeartEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"Jackpots":' . $_obf_0D28393910101E062539311B3F371C121912162B061E32 . ',"reelsSymbols":' . $_obf_0D273522403840350F0A36072E150A0524143F382C3B32 . '}}';
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('WonderHeartEGTCards');
                    ...
                    $_obf_0D1E1530380E012C0C2E06183B132B233F1B27371D3F32 = '';
                    if( $scattersCount >= 3 ) 
                    {
                        $state = 'freespin';
                        $_obf_0D1E1530380E012C0C2E06183B132B233F1B27371D3F32 = ',"freespinScatters":[10]';
                    }
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gambles":5,"reels":[' . $_obf_0D3E331C040E390B031B03100422040311293E023E0322 . ']' . $_obf_0D1E1530380E012C0C2E06183B132B233F1B27371D3F32 . ',"lines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"expand":[],"gambles":0,"freespins":' . $fs . ',"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":523,"gameNumber":1789199147124,"balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"a18f5e82acec5ee5a8e631ee77a7e1c1","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('WonderHeartEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('WonderHeartEGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('WonderHeartEGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('WonderHeartEGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('WonderHeartEGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
