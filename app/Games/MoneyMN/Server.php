...
namespace VanguardLTE\Games\MoneyMN
{
    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = floor(sprintf('%01.2f', $slotSettings->GetBalance() * ($slotSettings->CurrentDenom * 100)));
                ...
                case 'Act18':
                    if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['reqDat']) ) 
                    {
                        ...
                        if( $scattersCount >= 3 ) 
                        {
                            ...
                            {
                                $_obf_0D292D0A090D1508062B052B1101321D29243405020D11 = floor(sprintf('%01.2f', $slotSettings->GetBalance() * ($slotSettings->CurrentDenom * 100)));
