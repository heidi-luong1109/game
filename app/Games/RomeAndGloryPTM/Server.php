                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    for( $k = 0; $k < $lines; $k++ ) 
                    {
                        ...
                        for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                        {
                            ...
                            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && $slotSettings->GetGameData('RomeAndGloryPTMFreeSym') == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 ) 
                            {
                            }
                            else
                            {
                    ...
                    for( $r = 1; $r <= 5; $r++ ) 
                    {
                        for( $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 = 0; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 <= 3; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32++ ) 
                        {
                            ...
                            if( $reels['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] == $slotSettings->GetGameData('RomeAndGloryPTMFreeSym') ) 
                            {
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                    {
                        $_obf_0D0606060F3828293224071C222E321608251839343C11 = $slotSettings->Paytable['SYM_' . $slotSettings->GetGameData('RomeAndGloryPTMFreeSym')][$_obf_0D020D22251B191B3519055C091E0B2A062F1238190611] * $betLine * $lines * $bonusMpl;
                    }
