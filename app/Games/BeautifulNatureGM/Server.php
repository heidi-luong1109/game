            ...
            switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 ) 
            {
                ...
                case 'spin':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        for( $k = 0; $k < $lines; $k++ ) 
                        {
                            ...
                            for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                            {
                                ...
                                else
                                {
                                    ...
                                    if( $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == '9' && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) ) 
                                    {
                                        $mpl = 1;
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = 'i:' . $_obf_0D3003383B0233010601281016311C09043C0C3F362811 . ';a:6:{i:0;i:' . ($k + 1) . ';i:1;b:0;i:2;b:0;i:3;i:' . $s[2] . ';i:4;i:' . $s[3] . ';i:5;i:' . $s[4] . ';}';
                                            $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel3'][$linesId[$k][2] - 1] = -1;
                                    ...
                                    if( $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == '9' && $s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) ) 
                                    {
                                        $mpl = 1;
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = 'i:' . $_obf_0D3003383B0233010601281016311C09043C0C3F362811 . ';a:6:{i:0;i:' . ($k + 1) . ';i:1;b:0;i:2;i:' . $s[1] . ';i:3;i:' . $s[2] . ';i:4;i:' . $s[3] . ';i:5;i:' . $s[4] . ';}';
                                            $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel2'][$linesId[$k][1] - 1] = -1;
                                            $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel3'][$linesId[$k][2] - 1] = -1;
                                            $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel4'][$linesId[$k][3] - 1] = -1;
                                            $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel5'][$linesId[$k][4] - 1] = -1;
                        ...
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            $_obf_0D231D3C1A112B01271C2F3027043E040F0E2A1F0F0832 = 0;
                            $_obf_0D26240F12380B163D1C033E2E2509371C3D3F06143E11 = '1';
                            if( $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel' . $r][0] == -1 && $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel' . $r][1] == -1 && $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel' . $r][2] == -1 && $reels['reel' . $r][0] == 9 && $reels['reel' . $r][1] == 9 && $reels['reel' . $r][2] == 9 ) 
                            {
                                $_obf_0D26240F12380B163D1C033E2E2509371C3D3F06143E11 = '3';
                            }
                            else if( $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel' . $r][1] == -1 && $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel' . $r][2] == -1 && $reels['reel' . $r][1] == 9 && $reels['reel' . $r][2] == 9 ) 
                            {
                                $_obf_0D26240F12380B163D1C033E2E2509371C3D3F06143E11 = '2';
                            }
                            else if( $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel' . $r][0] == -1 && $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel' . $r][1] == -1 && $reels['reel' . $r][0] == 9 && $reels['reel' . $r][1] == 9 ) 
                            {
                                $_obf_0D26240F12380B163D1C033E2E2509371C3D3F06143E11 = '2';
                            }
                            for( $p = 0; $p <= 2; $p++ ) 
                            {
                                if( $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel' . $r][$p] == -1 ) 
                                {
                                    ...
                                    {
                                        $_obf_0D0410092A1F39153D171B22300F190E22312603020C01[] = 's:4:"' . ($r - 1) . '§' . $p . '";a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:' . $p . ';s:9:"animation";s:4:"wild";}';
                                    }
                                    else if( $reels['reel' . $r][$p] == 9 ) 
                                    {
                                        $_obf_0D2E0719043D213F282C39091A0F1C3B0B311A35242B32 = [
                                            't', 
                                            'm', 
                                            'b'
                                        ];
                                        $_obf_0D0410092A1F39153D171B22300F190E22312603020C01[] = 's:4:"' . ($r - 1) . '§' . $p . '";a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:' . $p . ';s:9:"animation";s:5:"top' . $_obf_0D26240F12380B163D1C033E2E2509371C3D3F06143E11 . $_obf_0D2E0719043D213F282C39091A0F1C3B0B311A35242B32[$_obf_0D231D3C1A112B01271C2F3027043E040F0E2A1F0F0832] . '";}';
                                        $_obf_0D231D3C1A112B01271C2F3027043E040F0E2A1F0F0832++;
                                    }
                                    else
                                    {
                                        $_obf_0D231D3C1A112B01271C2F3027043E040F0E2A1F0F0832 = 0;
