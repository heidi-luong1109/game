            ...
            switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 ) 
            {
                ...
                case 'spin':
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] != 'freespin' ) 
                    {
                        ...
                        $slotSettings->SetGameData('LightsNETDenom', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['bet_denomination']);
                        $slotSettings->SetGameData('LightsNETFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                        $bonusMpl = 1;
                        $_obf_0D40190A015B312F113323220C1736325B1D1F3B282422 = 'basic';
                    }
                    else
                    {
                        $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['bet_denomination'] = $slotSettings->GetGameData('LightsNETDenom');
                        $slotSettings->CurrentDenom = $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['bet_denomination'];
                        $slotSettings->CurrentDenomination = $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['bet_denomination'];
                        ...
                        $_obf_0D40190A015B312F113323220C1736325B1D1F3B282422 = 'freespin';
                    }
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $_obf_0D340D3F241D28110A1D18371F19360E3C3E07230B2422 = [];
                        if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                        {
                            $_obf_0D213B5C05065C03050F1A1F0B0322221B263027343D01 = rand(3, 6);
                        }
                        else
                        {
                            $_obf_0D213B5C05065C03050F1A1F0B0322221B263027343D01 = rand(2, 4);
                        }
                        $_obf_0D01373C192C15080B363D173B2B3B373715020B360432 = 0;
                        for( $r = 0; $r < 200; $r++ ) 
                        {
                            $_obf_0D06332C33251E172A1B3E1F341C0E2F0528315B261011 = rand(1, 5);
                            $_obf_0D1C0A273328404018110B0B170221180A35120E090722 = rand(0, 2);
                            if( $reels['reel' . $_obf_0D06332C33251E172A1B3E1F341C0E2F0528315B261011][$_obf_0D1C0A273328404018110B0B170221180A35120E090722] == '1' || $reels['reel' . $_obf_0D06332C33251E172A1B3E1F341C0E2F0528315B261011][$_obf_0D1C0A273328404018110B0B170221180A35120E090722] == '0' ) 
                            {
                            }
                            else
                            {
                                $_obf_0D01373C192C15080B363D173B2B3B373715020B360432++;
                                $reels['reel' . $_obf_0D06332C33251E172A1B3E1F341C0E2F0528315B261011][$_obf_0D1C0A273328404018110B0B170221180A35120E090722] = '1';
                            }
                            if( $_obf_0D213B5C05065C03050F1A1F0B0322221B263027343D01 <= $_obf_0D01373C192C15080B363D173B2B3B373715020B360432 ) 
                            {
                                break;
                            }
                        }
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            $_obf_0D31082E0C2F0A08240511052E073B340A1016222C1511 = 0;
                            for( $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 = 0; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 <= 2; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32++ ) 
                            {
                                ...
                                {
                                    $_obf_0D340D3F241D28110A1D18371F19360E3C3E07230B2422[] = '&rs.i0.r.i' . ($r - 1) . '.overlay.i' . $_obf_0D31082E0C2F0A08240511052E073B340A1016222C1511 . '.pos=321&rs.i0.r.i' . ($r - 1) . '.overlay.i' . $_obf_0D31082E0C2F0A08240511052E073B340A1016222C1511 . '.with=SYM1&rs.i0.r.i' . ($r - 1) . '.overlay.i' . $_obf_0D31082E0C2F0A08240511052E073B340A1016222C1511 . '.row=' . $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32;
                                    $_obf_0D31082E0C2F0A08240511052E073B340A1016222C1511++;
                                }
                            }
                        }
                    ...
                    $_obf_0D152237351A11402238012F3B2F0F3022363E15083E11 = implode('', $_obf_0D340D3F241D28110A1D18371F19360E3C3E07230B2422);
                    $_obf_0D0C2D02303D05261238144030211A030D5C28401C0F32 = '&rs.i0.r.i0.syms=SYM' . $reels['reel1'][0] . '%2CSYM' . $reels['reel1'][1] . '%2CSYM' . $reels['reel1'][2] . '';
                    $_obf_0D0C2D02303D05261238144030211A030D5C28401C0F32 .= ('&rs.i0.r.i1.syms=SYM' . $reels['reel2'][0] . '%2CSYM' . $reels['reel2'][1] . '%2CSYM' . $reels['reel2'][2] . '');
                    $_obf_0D0C2D02303D05261238144030211A030D5C28401C0F32 .= ('&rs.i0.r.i2.syms=SYM' . $reels['reel3'][0] . '%2CSYM' . $reels['reel3'][1] . '%2CSYM' . $reels['reel3'][2] . '');
                    $_obf_0D0C2D02303D05261238144030211A030D5C28401C0F32 .= ('&rs.i0.r.i3.syms=SYM' . $reels['reel4'][0] . '%2CSYM' . $reels['reel4'][1] . '%2CSYM' . $reels['reel4'][2] . '');
                    ...
                    if( $scattersCount >= 3 ) 
                    {
                        ...
                        $freeState = '&freespins.betlines=0%2C1%2C2%2C3%2C4%2C5%2C6%2C7%2C8%2C9%2C10%2C11%2C12%2C13%2C14%2C15%2C16%2C17%2C18%2C19&freespins.totalwin.cents=0&nextaction=freespin&freespins.left=' . $fs . '&freespins.wavecount=1&freespins.multiplier=1&gamestate.stack=basic%2Cfreespin&freespins.totalwin.coins=0&freespins.total=' . $fs . '&freespins.win.cents=0&gamestate.current=freespin&freespins.initial=' . $fs . '&freespins.win.coins=0&freespins.betlevel=' . $slotSettings->GetGameData('LightsNETBet') . '&totalwin.coins=' . $totalWin . '&credit=' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . '&totalwin.cents=' . ($totalWin * $slotSettings->CurrentDenomination * 100) . '&game.win.amount=' . ($totalWin / $slotSettings->CurrentDenomination) . '';
                    ...
                    $_obf_0D21152412095C03222D3808130C3C012907290C181E22 = $slotSettings->GetGameData('LightsNETCards');
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $fs = $slotSettings->GetGameData('LightsNETFreeGames');
                        $_obf_0D5B2132391B38031D040A1B1C132D1228043912362232 = $slotSettings->GetGameData('LightsNETFreeGames') - $slotSettings->GetGameData('LightsNETCurrentFreeGame');
                        ...
                        $_obf_0D0C2D02303D05261238144030211A030D5C28401C0F32 = $freeState . $_obf_0D0C2D02303D05261238144030211A030D5C28401C0F32 . '&freespins.totalwin.cents=0&nextaction=' . $_obf_0D0A1C392F2C170F1D1901172B0C02090B122A0D220E01 . '&freespins.left=' . $_obf_0D5B2132391B38031D040A1B1C132D1228043912362232 . '&freespins.wavecount=1&next.rs=freespin&current.rs.i0=freespin&freespins.multiplier=1&gamestate.stack=' . $_obf_0D3B2A29270D28011A1D15282A3331381F28191C374001 . '&freespins.totalwin.coins=' . $totalWin . '&freespins.total=' . $fs . '&freespins.win.cents=' . ($totalWin / $slotSettings->CurrentDenomination * 100) . '&gamestate.current=' . $_obf_0D0B3C1C1F5C16371D102B372440183D25213D1E1C0122 . '&freespins.initial=' . $fs . '&freespins.win.coins=' . $totalWin . '&freespins.betlevel=' . $slotSettings->GetGameData('LightsNETBet') . '&totalwin.coins=' . $totalWin . '&credit=' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . '&totalwin.cents=' . ($totalWin * $slotSettings->CurrentDenomination * 100) . '&game.win.amount=' . ($totalWin / $slotSettings->CurrentDenomination);
                        $freeState = '&freespins.totalwin.cents=0&nextaction=' . $_obf_0D0A1C392F2C170F1D1901172B0C02090B122A0D220E01 . '&freespins.left=' . $_obf_0D5B2132391B38031D040A1B1C132D1228043912362232 . '&freespins.wavecount=1&next.rs=freespin&current.rs.i0=freespin&freespins.multiplier=1&gamestate.stack=' . $_obf_0D3B2A29270D28011A1D15282A3331381F28191C374001 . '&freespins.totalwin.coins=' . $totalWin . '&freespins.total=' . $fs . '&freespins.win.cents=' . ($totalWin / $slotSettings->CurrentDenomination * 100) . '&gamestate.current=' . $_obf_0D0B3C1C1F5C16371D102B372440183D25213D1E1C0122 . '&freespins.initial=' . $fs . '&freespins.win.coins=' . $totalWin . '&freespins.betlevel=' . $slotSettings->GetGameData('LightsNETBet') . '&totalwin.coins=' . $totalWin . '&credit=' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . '&totalwin.cents=' . ($totalWin * $slotSettings->CurrentDenomination * 100) . '&game.win.amount=' . ($totalWin / $slotSettings->CurrentDenomination);
                    }
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"freeState":"' . $freeState . '","slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('LightsNETFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('LightsNETCurrentFreeGame') . ',"Balance":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"afterBalance":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"bonusWin":' . $slotSettings->GetGameData('LightsNETBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
