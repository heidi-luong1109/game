        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'settings':
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"paytableCoef":{"0":{"coef":[5,25,100],"multiplier":1},"1":{"coef":[5,25,100],"multiplier":1},"2":{"coef":[5,25,100],"multiplier":1},"3":{"coef":[5,40,150],"multiplier":1},"4":{"coef":[5,40,150],"multiplier":1},"5":{"coef":[5,30,100,750],"multiplier":1},"6":{"coef":[5,30,100,750],"multiplier":1},"7":{"coef":[5,40,400,2000],"multiplier":1},"8":{"coef":[10,100,1000,5000],"multiplier":1},"9":{"coef":[2,25,250],"multiplier":1},"-1":{"coef":[],"multiplier":1}},"bets":[' . implode(',', $_obf_0D131333153E3B3F113536290D1D1A025B0D3F16341932) . '],"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[8,1,4,0,5,2,6,1,5,7,3,3,1,4,2,9,5,6,8,2],[2,8,0,6,1,5,8,2,4,3,5,9,2,4,1,7,2,8,3,6],[4,0,5,1,8,3,6,4,8,1,9,3,2,5,1,7,0,3,6,2],[2,6,2,5,3,8,1,7,0,5,2,5,7,1,4,8,6,3,4,9],[6,1,7,3,5,0,5,4,8,1,5,9,2,4,8,7,5,0,3,4]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $_obf_0D0C2105130819393F29112D311A15170F3C2913160B01) . ']},"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                    break;
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('MajesticForestEGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'bet':
                    ...
                    {
                        $totalWin = 0;
                        $_obf_0D110919322F1A121D1902170A3325192D3F0E391C0922 = 0;
                        $lineWins = [];
                        $_obf_0D390917381818292C1730182540043D393D2B30161E01 = [];
                        $cWins = [
                            0, 
                            0, 
                            0, 
                        ...
                        $_obf_0D0D2F2C2E1013045B0517140A272B1D091D280A0E2732 = [
                            0, 
                            0, 
                            0, 
                            0, 
                        ...
                        $_obf_0D3D05062631163936351A352E0A073E0401223F110832 = $reels;
                        if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                        {
                            for( $r = 1; $r <= 5; $r++ ) 
                            {
                                ...
                                {
                                    if( $_obf_0D3D05062631163936351A352E0A073E0401223F110832['reel' . $r][$_obf_0D31403C0837332A1A1711312A3415151610280F122122] == $slotSettings->GetGameData('MajesticForestEGTExpandSymbol') ) 
                                    {
                                        $_obf_0D3D05062631163936351A352E0A073E0401223F110832['reel' . $r][0] = $slotSettings->GetGameData('MajesticForestEGTExpandSymbol');
                                        $_obf_0D3D05062631163936351A352E0A073E0401223F110832['reel' . $r][1] = $slotSettings->GetGameData('MajesticForestEGTExpandSymbol');
                                        $_obf_0D3D05062631163936351A352E0A073E0401223F110832['reel' . $r][2] = $slotSettings->GetGameData('MajesticForestEGTExpandSymbol');
                                        break;
                                    }
                                }
                            }
                        ...
                        for( $k = 0; $k < $lines; $k++ ) 
                        {
                            ...
                            $_obf_0D020A30142A013B10221D322D302F0416362111030D22 = '';
                            for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                            {
                                ...
                                else
                                {
                                    ...
                                    $_obf_0D0C0C261A1D3E04060E3B322B2811042F10332D192D11[0] = $_obf_0D3D05062631163936351A352E0A073E0401223F110832['reel1'][$linesId[$k][0] - 1];
                                    $_obf_0D0C0C261A1D3E04060E3B322B2811042F10332D192D11[1] = $_obf_0D3D05062631163936351A352E0A073E0401223F110832['reel2'][$linesId[$k][1] - 1];
                                    $_obf_0D0C0C261A1D3E04060E3B322B2811042F10332D192D11[2] = $_obf_0D3D05062631163936351A352E0A073E0401223F110832['reel3'][$linesId[$k][2] - 1];
                                    $_obf_0D0C0C261A1D3E04060E3B322B2811042F10332D192D11[3] = $_obf_0D3D05062631163936351A352E0A073E0401223F110832['reel4'][$linesId[$k][3] - 1];
                                    $_obf_0D0C0C261A1D3E04060E3B322B2811042F10332D192D11[4] = $_obf_0D3D05062631163936351A352E0A073E0401223F110832['reel5'][$linesId[$k][4] - 1];
                                    if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) ) 
                                    {
                                        ...
                                        if( $cWins[$k] < $_obf_0D365B172533170712222423300A1B092C161521071B32 ) 
                                        {
                                            ...
                                            $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"line":' . $k . ',"winAmount":' . ($cWins[$k] * 100) . ',"cells":[0,' . ($linesId[$k][0] - 1) . ',1,' . ($linesId[$k][1] - 1) . '],"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . '}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[2], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                            $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"line":' . $k . ',"winAmount":' . ($cWins[$k] * 100) . ',"cells":[0,' . ($linesId[$k][0] - 1) . ',1,' . ($linesId[$k][1] - 1) . ',2,' . ($linesId[$k][2] - 1) . '],"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . '}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[3], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                            $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"line":' . $k . ',"winAmount":' . ($cWins[$k] * 100) . ',"cells":[0,' . ($linesId[$k][0] - 1) . ',1,' . ($linesId[$k][1] - 1) . ',2,' . ($linesId[$k][2] - 1) . ',3,' . ($linesId[$k][3] - 1) . '],"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . '}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[4], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                            $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"line":' . $k . ',"winAmount":' . ($cWins[$k] * 100) . ',"cells":[0,' . ($linesId[$k][0] - 1) . ',1,' . ($linesId[$k][1] - 1) . ',2,' . ($linesId[$k][2] - 1) . ',3,' . ($linesId[$k][3] - 1) . ',4,' . ($linesId[$k][4] - 1) . '],"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . '}';
                                        }
                                    }
                                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' && $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 == $slotSettings->GetGameData('MajesticForestEGTExpandSymbol') ) 
                                    {
                                        $_obf_0D195B102E172A26161B22102D3723390C11300B3F1C01 = [];
                                        $_obf_0D031414213406085B35190F38060C250A0D2C2C271D32 = 0;
                                        for( $ex = 0; $ex < 5; $ex++ ) 
                                        {
                                            if( $_obf_0D0C0C261A1D3E04060E3B322B2811042F10332D192D11[$ex] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 ) 
                                            {
                                                $_obf_0D031414213406085B35190F38060C250A0D2C2C271D32++;
                                                $_obf_0D195B102E172A26161B22102D3723390C11300B3F1C01[] = $ex . ',' . ($linesId[$k][$ex] - 1);
                                            }
                                        }
                                        $_obf_0D3E0E233C0B2A37160E0E0A073C1823245B1C36243822 = $slotSettings->Paytable['SYM_' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][$_obf_0D031414213406085B35190F38060C250A0D2C2C271D32] * $betline * $bonusMpl;
                                        if( $_obf_0D0D2F2C2E1013045B0517140A272B1D091D280A0E2732[$k] < $_obf_0D3E0E233C0B2A37160E0E0A073C1823245B1C36243822 ) 
                                        {
                                            $_obf_0D0D2F2C2E1013045B0517140A272B1D091D280A0E2732[$k] = $_obf_0D3E0E233C0B2A37160E0E0A073C1823245B1C36243822;
                                            $_obf_0D020A30142A013B10221D322D302F0416362111030D22 = '{"line":' . $k . ',"winAmount":' . ($_obf_0D0D2F2C2E1013045B0517140A272B1D091D280A0E2732[$k] * 100) . ',"cells":[' . implode(',', $_obf_0D195B102E172A26161B22102D3723390C11300B3F1C01) . '],"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . '}';
                                        }
                                    }
                                }
                            }
                            ...
                            if( $_obf_0D0D2F2C2E1013045B0517140A272B1D091D280A0E2732[$k] > 0 && $_obf_0D020A30142A013B10221D322D302F0416362111030D22 != '' ) 
                            {
                                array_push($_obf_0D390917381818292C1730182540043D393D2B30161E01, $_obf_0D020A30142A013B10221D322D302F0416362111030D22);
                                $_obf_0D110919322F1A121D1902170A3325192D3F0E391C0922 += $_obf_0D0D2F2C2E1013045B0517140A272B1D091D280A0E2732[$k];
                                $totalWin += $_obf_0D0D2F2C2E1013045B0517140A272B1D091D280A0E2732[$k];
                            }
                        }
                        $scattersWin = 0;
                        $scattersStr = '';
                    ...
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = $slotSettings->GetGameData('MajesticForestEGTFreeBalance');
                    }
                    else
                    {
                    ...
                    $fs = 0;
                    $_obf_0D362C3E0E1A30390F33402D10063535065C2639323B01 = '';
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(0, 6));
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(0, 6));
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(0, 6) . ',' . $reels['reel4'][0] . ',' . $reels['reel4'][1] . ',' . $reels['reel4'][2] . ',' . rand(0, 6));
                    ...
                    if( $scattersCount >= 3 ) 
                    {
                        ...
                        else
                        {
                            ...
                            $slotSettings->SetGameData($slotSettings->slotId . 'FirstSpin', ',"firstSpin":{"expand":[],"reels":[' . $_obf_0D3E331C040E390B031B03100422040311293E023E0322 . '],"lines":[],"expand":[],"scatters":[' . $scattersStr . ']}');
                        }
                    ...
                    $_obf_0D2E15282C2E16291216341D1F1C38092C2427380F1C22 = implode(',', $_obf_0D390917381818292C1730182540043D393D2B30161E01);
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('MajesticForestEGTFreeGames') . ',"freeSpinsExpandLines": [' . $_obf_0D2E15282C2E16291216341D1F1C38092C2427380F1C22 . '],"freeSpinsExpandSymbol":' . $slotSettings->GetGameData('MajesticForestEGTExpandSymbol') . ',"freeSpinsExpandWinAmount": ' . $_obf_0D110919322F1A121D1902170A3325192D3F0E391C0922 . ',"currentFreeGames":' . $slotSettings->GetGameData('MajesticForestEGTCurrentFreeGame') . ',"Balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"afterBalance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"bonusWin":' . $slotSettings->GetGameData('MajesticForestEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"Jackpots":' . $_obf_0D28393910101E062539311B3F371C121912162B061E32 . ',"reelsSymbols":' . $_obf_0D273522403840350F0A36072E150A0524143F382C3B32 . '}}';
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('MajesticForestEGTCards');
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gambles":5,"reels":[' . $_obf_0D3E331C040E390B031B03100422040311293E023E0322 . '],"lines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"expand":[],"freespinScatters":[' . $scatter . '],"freespins":' . $fs . ',"jackpot":' . $isJack . ',"freespinScatters":[9],"freeSpinsExpandSymbol":' . $slotSettings->GetGameData('MajesticForestEGTExpandSymbol') . ',"freeSpinsExpandLines":[' . $_obf_0D2E15282C2E16291216341D1F1C38092C2427380F1C22 . '],"freeSpinsExpandWinAmount":' . $_obf_0D110919322F1A121D1902170A3325192D3F0E391C0922 . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":1786348900601,"balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"894b17d797618b2d99d0c94df1d88e72","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('MajesticForestEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('MajesticForestEGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('MajesticForestEGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('MajesticForestEGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('MajesticForestEGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
