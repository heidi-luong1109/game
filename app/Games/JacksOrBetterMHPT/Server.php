    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            if( $umid == '40186' ) 
            {
                ...
                $_obf_0D0E141F34210C271834013D060623402816092A400E11 = $slotSettings->GetGameData('JacksOrBetterMHPTTotalWin');
                ...
                {
                    $_obf_0D373202210A393C1A2E39210B383D283D05051C3E1001 = rand($slotSettings->GetGameData('JacksOrBetterMHPTDCard'), 12);
                }
                else
                {
                    $_obf_0D373202210A393C1A2E39210B383D283D05051C3E1001 = rand(0, $slotSettings->GetGameData('JacksOrBetterMHPTDCard'));
                }
                $_obf_0D3933282D2F3207131E01322E3D2A243306341C300F01 = [
                    $cardsArr[0], 
                    $cardsArr[1], 
                ...
                if( $slotSettings->GetGameData('JacksOrBetterMHPTDCard') == $_obf_0D373202210A393C1A2E39210B383D283D05051C3E1001 ) 
                {
                    $totalWin = $_obf_0D0E141F34210C271834013D060623402816092A400E11;
                }
                else if( $slotSettings->GetGameData('JacksOrBetterMHPTDCard') < $_obf_0D373202210A393C1A2E39210B383D283D05051C3E1001 ) 
                {
                ...
                $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"amount":' . $slotSettings->GetGameData('JacksOrBetterMHPTDAmount') . ',"cWin":' . $_obf_0D0E141F34210C271834013D060623402816092A400E11 . ',"pcard":' . $slotSettings->GetGameData('JacksOrBetterMHPTDCard') . ',"totalWin":' . $totalWin . ',"data":{"cards":' . json_encode($_obf_0D3933282D2F3207131E01322E3D2A243306341C300F01) . ',"windowId":"VRqbhm"},"ID":40187,"umid":46}';
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"deltaBalanceInCents":1},"ID":40085}';
                if( $totalWin <= 0 ) 
                {
            ...
            if( $umid == '40182' ) 
            {
                ...
                $slotSettings->SetGameData('JacksOrBetterMHPTDAmount', (double)$_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['amount']);
                $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"am":' . $slotSettings->GetGameData('JacksOrBetterMHPTDAmount') . ',"card":{"suit":"' . $cardsArr[0]->suit . '","value":"' . $cardsArr[0]->value . '"},"windowId":"VRqbhm"},"ID":40183,"umid":46}';
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"deltaBalanceInCents":1},"ID":40085}';
            }
            if( $umid == '40179' ) 
            {
                $_obf_0D3933282D2F3207131E01322E3D2A243306341C300F01 = $slotSettings->GetGameData('JacksOrBetterMHPTCurrentCards');
                $cardsArr = $slotSettings->GetGameData('JacksOrBetterMHPTCards');
                $_obf_0D250C12110C045B341A300E173F143F2A281425015C11 = $slotSettings->GetGameData('JacksOrBetterMHPTBankReserved');
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    for( $_obf_0D3E291C370537291F350C5C0E070E3403290801034001 = 0; $_obf_0D3E291C370537291F350C5C0E070E3403290801034001 < $_obf_0D3D0937381D0C17242E212C1106111804183109400D11; $_obf_0D3E291C370537291F350C5C0E070E3403290801034001++ ) 
                    {
                        ...
                        $totalWin += (($_obf_0D3930021E065C30212C110F1D2D150E03113925171401 * $slotSettings->GetGameData('JacksOrBetterMHPTBet')) / $_obf_0D3D0937381D0C17242E212C1106111804183109400D11);
                        $_obf_0D33100817143735213E131F0E1221033F330D07123B01[] = ($_obf_0D3930021E065C30212C110F1D2D150E03113925171401 * $slotSettings->GetGameData('JacksOrBetterMHPTBet')) / $_obf_0D3D0937381D0C17242E212C1106111804183109400D11;
                    }
                    if( $totalWin <= $bank ) 
                    {
                        break;
            ...
            if( $umid == '40175' ) 
            {
                ...
                $slotSettings->SetGameData('JacksOrBetterMHPTCurrentCards', $_obf_0D3933282D2F3207131E01322E3D2A243306341C300F01);
