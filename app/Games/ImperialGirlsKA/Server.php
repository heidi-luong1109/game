        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 ) 
            {
                case 'startGame':
                    ...
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[0] = '{"sgr":{"gn":"ImperialGirls","lsd":{"sid":' . rand(0, 9999999) . ',"tid":"1fdbe371480a4b4a8971101c2a170721","sel":5,"cps":1,"dn":0.01,"nd":0.01,"ncps":0,"atb":0,"v":true,"fs":' . $fs . ',"twg":' . (100 * $bet) . ',"swm":0,"sw":0,"swu":0,"tw":0,"fsw":0,"fsr":' . $_obf_0D3E242D3C395C18220C29333636375C152728333D0332 . ',"tfw":' . $_obf_0D2207030C311933271F08142B19010D35391119151D22 . ',"st":[' . $_obf_0D0C2D02303D05261238144030211A030D5C28401C0F32 . '],"swi":[],"snm":[],"ssm":[],"sm":[0,0,0,0,0],"acb":0,"rf":0,"as":[{"asi":392042761,"st":[' . $_obf_0D0C2D02303D05261238144030211A030D5C28401C0F32 . '],"swm":0,"sw":0,"swu":0,"fsw":0,"tw":0}],"sp":0,"cr":"USD","rd":0,"pbb":0,"obb":0,"mb":false,"pwa":0},"drs":[[' . implode(',', $slotSettings->reelStrip1) . '],[' . implode(',', $slotSettings->reelStrip2) . '],[' . implode(',', $slotSettings->reelStrip3) . '],[' . implode(',', $slotSettings->reelStrip4) . '],[' . implode(',', $slotSettings->reelStrip5) . ']],"pt":[[0,0,0,0,0],[0,0,10,20,60],[0,0,10,20,60],[0,0,10,20,60],[0,0,10,20,60],[0,0,20,40,100],[0,0,20,40,100],[0,0,5,10,15],[0,5,40,150,220],[0,5,35,120,200],[0,5,30,100,180],[0,0,5,15,30],[0,0,2,10,100]],"cps":[1,2,3,4,5,7,8,10,15,20,25,30,50,75,100],"e":false,"ec":0,"cc":""},"un":"accessKey|USD|887553269","bl":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"gn":"ImperialGirls","lgn":"Imperial Girls","gv":0,"fs":false,"si":"71564036dec148e68115c0df1498f606","dn":[0.01,0.05,0.1,0.25,0.5,1.0,2.0],"cs":"$","cd":2,"cp":false,"gs":",","ds":".","ase":[5],"gm":0,"mi":-1,"cud":0.01,"cup":[' . implode(',', $_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11) . '],"mm":0,"e":false,"ec":0,"cc":"RU"}';
                    break;
                case 'ping':
                ...
                case 'spin':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $_obf_0D342732242E25192A372310300D06111139032A0C2932 = false;
                        $_obf_0D130823163F0833381538032F221B3138352C3F102822 = false;
                        for( $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622 = 1; $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622 <= 5; $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622++ ) 
                        {
                            ...
                            for( $rs = 0; $rs <= 3; $rs++ ) 
                            {
                                ...
                                {
                                    $reels['reel' . $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622][0] = '0';
                                    $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel' . $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622][0] = '0';
                                    $reels['reel' . $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622][1] = '0';
                                    $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel' . $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622][1] = '0';
                                    $reels['reel' . $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622][2] = '0';
                                    $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel' . $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622][2] = '0';
                                    if( $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622 == 3 ) 
                                    {
                                        $_obf_0D342732242E25192A372310300D06111139032A0C2932 = true;
                                    }
                                    if( $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622 == 5 ) 
                                    {
                                        $_obf_0D130823163F0833381538032F221B3138352C3F102822 = true;
                                    }
                                    break;
                                }
                            }
                        }
                        if( $_obf_0D342732242E25192A372310300D06111139032A0C2932 ) 
                        {
                            $_obf_0D1A31365C2828323432011C290C0C32091F3709230511 = 4;
                        }
                        if( $_obf_0D130823163F0833381538032F221B3138352C3F102822 ) 
                        {
                            $_obf_0D1A31365C2828323432011C290C0C32091F3709230511 = 16;
                        }
                        if( $_obf_0D342732242E25192A372310300D06111139032A0C2932 && $_obf_0D130823163F0833381538032F221B3138352C3F102822 ) 
                        {
                        ...
                        for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                        {
                            ...
                            else
                            {
                                ...
                                if( $_obf_0D093E0C04250E390E2E2B032D223307091B251B5C0E22[1] > 0 && $_obf_0D093E0C04250E390E2E2B032D223307091B251B5C0E22[2] > 0 && $_obf_0D093E0C04250E390E2E2B032D223307091B251B5C0E22[3] > 0 ) 
                                {
                                    ...
                                    $_obf_0D243D303F2535360506093008312D1A1A5B022D070232[$k] = $slotSettings->GetSymPositions($_obf_0D2F271A3F332D2B5C013404340B27173C252824250E22);
                                    $_obf_0D112E082E2B040D3331180A1E193C36362B362B2F3201 = 1;
                                    if( $_obf_0D342732242E25192A372310300D06111139032A0C2932 && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                                    {
                                        $_obf_0D112E082E2B040D3331180A1E193C36362B362B2F3201 = 2;
                                    }
                                }
                                ...
                                if( $_obf_0D093E0C04250E390E2E2B032D223307091B251B5C0E22[1] > 0 && $_obf_0D093E0C04250E390E2E2B032D223307091B251B5C0E22[2] > 0 && $_obf_0D093E0C04250E390E2E2B032D223307091B251B5C0E22[3] > 0 && $_obf_0D093E0C04250E390E2E2B032D223307091B251B5C0E22[4] > 0 && $_obf_0D093E0C04250E390E2E2B032D223307091B251B5C0E22[5] > 0 ) 
                                {
                                    ...
                                    $_obf_0D243D303F2535360506093008312D1A1A5B022D070232[$k] = $slotSettings->GetSymPositions($_obf_0D2F271A3F332D2B5C013404340B27173C252824250E22);
                                    $_obf_0D112E082E2B040D3331180A1E193C36362B362B2F3201 = 1;
                                    if( ($_obf_0D342732242E25192A372310300D06111139032A0C2932 || $_obf_0D130823163F0833381538032F221B3138352C3F102822) && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                                    {
                                        $_obf_0D112E082E2B040D3331180A1E193C36362B362B2F3201 = 2;
                                    }
                                }
                                if( $_obf_0D0E141F34210C271834013D060623402816092A400E11 > 0 ) 
                                {
                                    ...
                                    $cWins[$k] = $_obf_0D0E141F34210C271834013D060623402816092A400E11 / ($bonusMpl * $_obf_0D112E082E2B040D3331180A1E193C36362B362B2F3201);
                    ...
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[0] = '{"sid":' . rand(0, 9999999) . ',"mp":' . json_encode($_obf_0D093E0C04250E390E2E2B032D223307091B251B5C0E22) . ',"md":{"sid":' . rand(0, 9999999) . ',"tid":"d7e96786853e422c8aa0448364b01fed","sel":5,"cps":1,"dn":0.01,"nd":0.01,"ncps":0,"atb":0,"v":true,"fs":' . $_obf_0D380B2515180F1C2C170B075B0A392209351C07312C32 . ',"twg":' . (100 * $betline * 100) . ',"swm":' . $_obf_0D2722011B2C34273F323035330D123F2706282E131932 . ',"sw":' . ($scattersWin * 100) . ',"swu":' . $_obf_0D271526050C14371508061C1D40060F233C35263B3B01 . ',"tw":' . ($totalWin * 100) . ',"fsw":' . $fs . ',"fsr":' . ($slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') - $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame')) . ',"tfw":' . ($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') * 100) . ',"st":[' . $_obf_0D0C2D02303D05261238144030211A030D5C28401C0F32 . '],"swi":[' . implode(',', $_obf_0D1432010D2B5B25344012133611322511253B0D401D22) . '],"snm":[' . implode(',', $_obf_0D11393B38130D38112E2A01373F0A5C34211932123911) . '],"ssm":[' . implode(',', $_obf_0D243D303F2535360506093008312D1A1A5B022D070232) . '],"sm":[' . $_obf_0D1A31365C2828323432011C290C0C32091F3709230511 . ',0,0,0,0],"acb":0,"rf":0,"as":[{"asi":396043528,"st":[' . $_obf_0D1B5B1F362C3D1B1C14161B2D27035B360A3214381911 . '],"swm":' . $_obf_0D2722011B2C34273F323035330D123F2706282E131932 . ',"sw":' . ($scattersWin * 100) . ',"swu":' . $_obf_0D271526050C14371508061C1D40060F233C35263B3B01 . ',"fsw":' . $fs . ',"tw":' . ($totalWin * 100) . '}],"sp":11,"cr":"USD","sessionId":"106d8e988322418bb092694276bf5573","rd":0,"pbb":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"obb":' . $_obf_0D06130C3D353902081217172123151E250923172E1932 . ',"mb":false,"pwa":0,"pac":{}},"pcr":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"cr":' . $_obf_0D06130C3D353902081217172123151E250923172E1932 . ',"xp":0,"lvl":{"lvl":1,"xp":0,"bc":0,"cps":5,"sc":200,"wb":0},"dl":0,"cps":[1,2,3,4,5,7,8,10,15,20,25,30,50,75,100],"e":false,"ec":0,"cc":"RU"}';
                    break;
