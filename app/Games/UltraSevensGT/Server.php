...
*/            $response = '';
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'gamble5GetUserCards' ) 
            {
                ...
                $_obf_0D040B162710402D331E2209370C14231F2C252B172601 = $slotSettings->GetGameData('UltraSevensGTDealerCard');
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'gamble5GetDealerCard' ) 
            {
                ...
                $slotSettings->SetGameData('UltraSevensGTDealerCard', $_obf_0D5B5C0F232838114030190505402A241E131019332901);
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'bet' || $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
            {
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] != 'freespin' ) 
                {
                    ...
                    $_obf_0D3F08152E011C2E053E0C34233B231F3D212F3C1B2A22 = $slotSettings->UpdateJackpots($_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotBet'] * $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotLines']);
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    $_obf_0D03051730353328315B3B2613072A1C1A0D0E1B102132 = 0;
                    $lineWins = [];
                    $cWins = [
                        0, 
                        0, 
                    ...
                    if( isset($_obf_0D3F08152E011C2E053E0C34233B231F3D212F3C1B2A22) && $_obf_0D3F08152E011C2E053E0C34233B231F3D212F3C1B2A22['isJackPay'] ) 
                    {
                        ...
                        if( $_obf_0D3F08152E011C2E053E0C34233B231F3D212F3C1B2A22['isJackId'] == 1 ) 
                        {
                            $_obf_0D1B381B033E11010B0A01021A2316302A35141B082332 = [
                                'P_2', 
                                'P_3'
                            ];
                            shuffle($_obf_0D1B381B033E11010B0A01021A2316302A35141B082332);
                        }
                        if( $_obf_0D3F08152E011C2E053E0C34233B231F3D212F3C1B2A22['isJackId'] == 2 ) 
                        {
                            $_obf_0D1B381B033E11010B0A01021A2316302A35141B082332 = [
                                'P_4', 
                                'P_5', 
                        ...
                        for( $_obf_0D0E361C162906193F350C2711233B34010C2F0E232632 = 1; $_obf_0D0E361C162906193F350C2711233B34010C2F0E232632 <= 5; $_obf_0D0E361C162906193F350C2711233B34010C2F0E232632++ ) 
                        {
                            ...
                            if( $_obf_0D3F08152E011C2E053E0C34233B231F3D212F3C1B2A22['isJackId'] == 1 ) 
                            {
                                $_obf_0D0D21221110082E2F1140152E3C1C370E100601132101 = $slotSettings->PutBonusToLine($_obf_0D0E361C162906193F350C2711233B34010C2F0E232632, $linesId[$_obf_0D07151D39191237311B250631072E2502142E0B2A0B22][$_obf_0D0E361C162906193F350C2711233B34010C2F0E232632 - 1], $_obf_0D1B381B033E11010B0A01021A2316302A35141B082332[0]);
                                $reels['reel' . $_obf_0D0E361C162906193F350C2711233B34010C2F0E232632] = [
                                    $_obf_0D1B381B033E11010B0A01021A2316302A35141B082332[0], 
                                    $_obf_0D1B381B033E11010B0A01021A2316302A35141B082332[0], 
                                    $_obf_0D1B381B033E11010B0A01021A2316302A35141B082332[0], 
                                    $_obf_0D1B381B033E11010B0A01021A2316302A35141B082332[0], 
                                    ''
                    ...
                    $_obf_0D182D3C2D0F17160D3938275C280F2201220A3B3B1201 = 0;
                        ...
                        for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                        {
                            ...
                            else
                            {
                                ...
                                for( $r = 1; $r <= 5; $r++ ) 
                                {
                                    ...
                                    {
                                        if( $reels['reel' . $r][$_obf_0D31403C0837332A1A1711312A3415151610280F122122] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 ) 
                                        {
                                            $_obf_0D1603170E181E05093E17132423360A391A210B285B11++;
                                        }
                                    }
                                }
                                if( $_obf_0D1603170E181E05093E17132423360A391A210B285B11 >= 20 ) 
                                {
                                    $_obf_0D182D3C2D0F17160D3938275C280F2201220A3B3B1201 = $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11;
                                ...
                                if( $s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild) ) 
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D365B172533170712222423300A1B092C161521071B32 ) 
                                    {
                                        ...
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('UltraSevensGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('UltraSevensGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                ...
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[2], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('UltraSevensGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                ...
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[3], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('UltraSevensGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k + 1][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                    }
                                }
                                $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                ...
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[4], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('UltraSevensGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k + 1][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k + 1][4] - 1) . ',"' . $s[4] . '"]}';
                                    }
                                }
                            }
                        }
                    ...
                    else
                    {
                        if( $i > 1500 ) 
                        {
                            $response = $winType . '|' . $_obf_0D3030072F273706293C133F2F072B113B383322291201 . '|' . $totalWin . '{"responseEvent":"error","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":"Bad Reel Strip"}';
                            exit( $response );
                        }
                        if( $_obf_0D1603170E181E05093E17132423360A391A210B285B11 >= 20 ) 
                        {
                            if( $_obf_0D182D3C2D0F17160D3938275C280F2201220A3B3B1201 == 'P_7' || $_obf_0D182D3C2D0F17160D3938275C280F2201220A3B3B1201 == 'P_6' || $_obf_0D182D3C2D0F17160D3938275C280F2201220A3B3B1201 == 'P_5' || $_obf_0D182D3C2D0F17160D3938275C280F2201220A3B3B1201 == 'P_4' ) 
                            {
                                $_obf_0D03051730353328315B3B2613072A1C1A0D0E1B102132 = 2;
                            }
                            else if( $_obf_0D182D3C2D0F17160D3938275C280F2201220A3B3B1201 == 'P_3' || $_obf_0D182D3C2D0F17160D3938275C280F2201220A3B3B1201 == 'P_2' ) 
                            {
                                $_obf_0D03051730353328315B3B2613072A1C1A0D0E1B102132 = 1;
                            }
                            else if( $_obf_0D182D3C2D0F17160D3938275C280F2201220A3B3B1201 == 'P_1' ) 
                            {
                                $_obf_0D03051730353328315B3B2613072A1C1A0D0E1B102132 = 0;
                            }
                            break;
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' && $slotSettings->GetGameData('UltraSevensGTFreeGames') <= $slotSettings->GetGameData('UltraSevensGTCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('UltraSevensGTTotalWin') + $totalWin > 0 ) 
                {
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"$jackState":' . json_encode($_obf_0D3F08152E011C2E053E0C34233B231F3D212F3C1B2A22) . ',"slotLines":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotLines'] . ',"slotBet":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotBet'] . ',"slotJackpot":[' . implode(',', $slotSettings->slotJackpot) . '],"totalFreeGames":' . $slotSettings->GetGameData('UltraSevensGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('UltraSevensGTCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D28393910101E062539311B3F371C121912162B061E32 . ',"reelsSymbols":' . $_obf_0D273522403840350F0A36072E150A0524143F382C3B32 . '}}';
