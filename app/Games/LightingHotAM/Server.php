            ...
            switch( $gameData['slotEvent'] ) 
            {
                ...
                case 'A/u25':
                    ...
                    if( $lastEvent != 'NULL' ) 
                    {
                        ...
                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeBalance', 0);
                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeStartWin', 0);
                        $_obf_0D2F1816033E36143D160A39333D122840370C160B1D32 = dechex($slotSettings->GetGameData($slotSettings->slotId . 'FreeGames'));
                        $_obf_0D243812041C191E1B1A3F113E330236293F3D3D105C11 = dechex($slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') - $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame'));
                        ...
                        $_obf_0D1F02220D0F2D281D26051502182F0E0C1C3D18350732 = $slotSettings->HexFormat($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01);
                    ...
                    {
                        $slotSettings->SetGameData($slotSettings->slotId . 'Lines', $_obf_0D01361D0A3E2D311F08242223290C1B173C3E1D332432);
                        $slotState = '4';
                    ...
                    break;
                case 'A/u250':
                    $_obf_0D01361D0A3E2D311F08242223290C1B173C3E1D332432 = $slotSettings->GetGameData($slotSettings->slotId . 'Lines');
                    $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01));
                    $lastEvent = $slotSettings->GetHistory();
                    if( $lastEvent != 'NULL' ) 
                    {
                    ...
                    break;
                case 'A/u2531':
                    $_obf_0D0F3D2C310C360F2638082C24383B1D0A2A163F243532 = $slotSettings->GetGameData($slotSettings->slotId . 'TotalWin');
                    $_obf_0D231D3F2A0C22272C0406123C250817373523141E0911 = $slotSettings->GetGameData($slotSettings->slotId . 'TotalWin');
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        $_obf_0D0B340B12383130240E392A110B0A3B113E2A5C0A2822 = $slotSettings->GetGameData($slotSettings->slotId . 'Reels');
                        $_obf_0D1A341D3F24273E2B35250C271217290D3D3B2D183B22 = $slotSettings->GetReelStrips('', 'bet');
                        $mpl = 0;
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            for( $p = 0; $p <= 2; $p++ ) 
                            {
                                if( $_obf_0D0B340B12383130240E392A110B0A3B113E2A5C0A2822['reel' . $r][$p] == $_obf_0D1A341D3F24273E2B35250C271217290D3D3B2D183B22['reel' . $r][$p] ) 
                                {
                                    $mpl++;
                                }
                            }
                        }
                        $_obf_0D5B0D3F3C3B01223D100A2D383F301229052313141601 = $_obf_0D0F3D2C310C360F2638082C24383B1D0A2A163F243532 * $mpl;
                        $_obf_0D0C2A183E0A0E3937331C0E151B1F22133C3F313D1B11 = $_obf_0D5B0D3F3C3B01223D100A2D383F301229052313141601 - $_obf_0D0F3D2C310C360F2638082C24383B1D0A2A163F243532;
                        if( $_obf_0D0C2A183E0A0E3937331C0E151B1F22133C3F313D1B11 <= $bank ) 
                        {
                            break;
                        }
                    }
                    ...
                    $reelSate = $slotSettings->HexFormat($_obf_0D1A341D3F24273E2B35250C271217290D3D3B2D183B22['rp'][0]) . $slotSettings->HexFormat($_obf_0D1A341D3F24273E2B35250C271217290D3D3B2D183B22['rp'][1]) . $slotSettings->HexFormat($_obf_0D1A341D3F24273E2B35250C271217290D3D3B2D183B22['rp'][2]) . $slotSettings->HexFormat($_obf_0D1A341D3F24273E2B35250C271217290D3D3B2D183B22['rp'][3]) . $slotSettings->HexFormat($_obf_0D1A341D3F24273E2B35250C271217290D3D3B2D183B22['rp'][4]);
                    $_obf_0D5B0D3F3C3B01223D100A2D383F301229052313141601 = $_obf_0D0F3D2C310C360F2638082C24383B1D0A2A163F243532 * $mpl;
                    $_obf_0D0C2A183E0A0E3937331C0E151B1F22133C3F313D1B11 = $_obf_0D5B0D3F3C3B01223D100A2D383F301229052313141601 - $_obf_0D0F3D2C310C360F2638082C24383B1D0A2A163F243532;
                    if( $mpl > 1 ) 
                    {
                        $slotSettings->SetBank((isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent']) ? $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] : ''), -1 * $_obf_0D0C2A183E0A0E3937331C0E151B1F22133C3F313D1B11);
                        $slotSettings->SetBalance($_obf_0D0C2A183E0A0E3937331C0E151B1F22133C3F313D1B11);
                        $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', $_obf_0D5B0D3F3C3B01223D100A2D383F301229052313141601);
                        $_obf_0D0F3D2C310C360F2638082C24383B1D0A2A163F243532 = $_obf_0D5B0D3F3C3B01223D100A2D383F301229052313141601;
                    }
                    $response = '120010' . $balanceFormated . $slotSettings->HexFormat($_obf_0D5B0D3F3C3B01223D100A2D383F301229052313141601 * 100) . $reelSate . $slotSettings->GetGameData($slotSettings->slotId . 'BetStr') . '1010101' . dechex($mpl) . '101010101010100b' . $slotSettings->GetGameData($slotSettings->slotId . 'winLinesFormated') . '0000000000000000' . $slotSettings->GetGameData($slotSettings->slotId . 'reelSate') . $slotSettings->GetGameData($slotSettings->slotId . 'LockedReels');
                    $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01));
                    $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22 = '104010' . $balanceFormated . $slotSettings->HexFormat($_obf_0D5B0D3F3C3B01223D100A2D383F301229052313141601 * 100) . $reelSate . $slotSettings->GetGameData($slotSettings->slotId . 'BetStr') . '10101010101010101010100b' . $slotSettings->GetGameData($slotSettings->slotId . 'winLinesFormated') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards')) . '#101010';
                    $slotSettings->SetGameData($slotSettings->slotId . 'Collect', $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22);
                    $_obf_0D2D350C1338352E3F0236115C1407341C0926053F2211 = '{"responseEvent":"gambleResult","serverResponse":{"totalWin":' . $_obf_0D0C2A183E0A0E3937331C0E151B1F22133C3F313D1B11 . '}}';
                    $slotSettings->SaveLogReport($_obf_0D2D350C1338352E3F0236115C1407341C0926053F2211, 0, 0, $_obf_0D0C2A183E0A0E3937331C0E151B1F22133C3F313D1B11, 'MPL');
                    break;
                case 'A/u251':
                                ...
                                else
                                {
                                    ...
                                    if( $s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild) ) 
                                    {
                                        ...
                                        if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                        {
                                            ...
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData($slotSettings->slotId . 'BonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData($slotSettings->slotId . 'BonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData($slotSettings->slotId . 'BonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData($slotSettings->slotId . 'BonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData($slotSettings->slotId . 'BonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                        }
                                    }
                                }
                            }
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') + $totalWin > 0 ) 
                    {
                    ...
                    if( $totalWin > 0 ) 
                    {
                        $response = '11e010' . $balanceFormated . $slotSettings->HexFormat(round($totalWin * 100)) . $reelSate . $_obf_0D3F05382A29123605040E3D10291E2F12391926360401 . $_obf_0D2E320D352628142310141D2F010A085C321810131022 . '10101011101010101010100b' . $winLinesFormated . '0000000000000000' . $reelSate . '13' . implode('', $reels['reel1']) . '13' . implode('', $reels['reel2']) . '13' . implode('', $reels['reel3']) . '13' . implode('', $reels['reel4']) . '13' . implode('', $reels['reel5']) . '';
                        $slotSettings->SetGameData($slotSettings->slotId . 'reelSate', $reelSate);
                        $slotSettings->SetGameData($slotSettings->slotId . 'Reels', $reels);
                        $slotSettings->SetGameData($slotSettings->slotId . 'BetStr', $_obf_0D3F05382A29123605040E3D10291E2F12391926360401 . $_obf_0D2E320D352628142310141D2F010A085C321810131022);
                    ...
                    $slotSettings->SetGameData($slotSettings->slotId . 'DoubleAnswer', $reelSate . $_obf_0D3F05382A29123605040E3D10291E2F12391926360401 . $_obf_0D2E320D352628142310141D2F010A085C321810131022 . '1010101010101010101010' . $_obf_0D0F172D1118050C402A0F213C1D233038275B3E103101 . $winLinesFormated);
                    ...
                    $slotSettings->SetGameData($slotSettings->slotId . 'CollectP0', $_obf_0D121F0821192F3304332C1D225C362A0F2C5C23312322);
                ...
                case 'A/u257':
                    $doubleWin = rand(1, 2);
                    $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032 = $slotSettings->GetGameData($slotSettings->slotId . 'DoubleWin');
                    ...
                    $response = '107010' . $slotSettings->GetGameData($slotSettings->slotId . 'DoubleBalance') . strlen($_obf_0D143B0B042F091727280D3E182D1D0115352113380F01) . $_obf_0D143B0B042F091727280D3E182D1D0115352113380F01 . $slotSettings->GetGameData($slotSettings->slotId . 'DoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                    $slotSettings->SetGameData($slotSettings->slotId . 'DoubleWin', $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032);
                    $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032);
                    $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01));
                    $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22 = '104010' . $balanceFormated . strlen($_obf_0D143B0B042F091727280D3E182D1D0115352113380F01) . $_obf_0D143B0B042F091727280D3E182D1D0115352113380F01 . $slotSettings->GetGameData($slotSettings->slotId . 'CollectP0');
                    $slotSettings->SetGameData($slotSettings->slotId . 'Collect', $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22);
                ...
                case 'A/u258':
                    ...
                    $slotSettings->SetGameData($slotSettings->slotId . 'DoubleBalance', $_obf_0D373B302A1614233D3F2D03055B0B142A33240F1D0511);
                    $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032 = sprintf('%01.2f', $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032) * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01;
                    $_obf_0D055B13312136223405401F250A14140A220F080A0211 = str_replace('.', '', $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032 . '');
                    $_obf_0D143B0B042F091727280D3E182D1D0115352113380F01 = dechex($_obf_0D055B13312136223405401F250A14140A220F080A0211);
                    $_obf_0D0B231C5C1F3C2202340D2D242505232E371E352F2532 = '26280b2714161d0c';
                    $response = '108010' . $slotSettings->GetGameData($slotSettings->slotId . 'DoubleBalance') . strlen($_obf_0D143B0B042F091727280D3E182D1D0115352113380F01) . $_obf_0D143B0B042F091727280D3E182D1D0115352113380F01 . $slotSettings->GetGameData($slotSettings->slotId . 'DoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                    break;
            }
