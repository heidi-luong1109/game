...
namespace VanguardLTE\Games\SuperHotWD
{
    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            {
                $_obf_0D320C272C01163710281538400712181A0704263D1F01 = '';
            }
            else
            {
                $_obf_0D320C272C01163710281538400712181A0704263D1F01 = $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['cid'];
            }
            if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['act'] == '464529TBNS' && $slotSettings->GetGameData('SuperHotWDTotalWin') <= 0 ) 
            {
            ...
            switch( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['act'] ) 
            {
                ...
                case 'GNNNVGVTKP':
                    ...
                    break;
                case 'QE8J5MIKCA':
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '{"a": "DRUXHWsV", "cid": "' . $_obf_0D320C272C01163710281538400712181A0704263D1F01 . '", "id": ' . $_obf_0D103E5B092B2E1E0D5C0A15011F221F321932311C1622 . ', "res": {"manual! lines": "9", "manual! lines! enabled": "0", "max.! stake": "10000", "min.! stake": "1", "min.! treasure": "100", "stake! per! line": "1"}, "s": "ok"}';
                    break;
                case 'DVVRWT9K7D':
                    ...
                    {
                        $_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11[$i] = $_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11[$i] * 5 * 100;
                    }
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '{"a": "sxYumxhx", "cid": "' . $_obf_0D320C272C01163710281538400712181A0704263D1F01 . '", "id": ' . $_obf_0D103E5B092B2E1E0D5C0A15011F221F321932311C1622 . ', "res": {"bank": "0", "coins": "1", "credit": "10000", "difficulty_level_mode": "0", "energy": "1", "flags": "0", "free_rounds": "0", "iv": "3", "lines": "5", "maxstake": "' . ($_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11[count($_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11) - 1] * 5) . '", "minstake": "1", "notes": "0", "prize": "' . ($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') * 100) . '", "protocol_version": "1", "risk": "1", "skill_games": "0", "skill_record": "0", "stake": "' . $_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11[0] . '", "stake_list": "' . implode(',', $_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11) . '", "stake_per_line": "1", "time": "0"}, "s": "ok"}';
                    break;
                case '1KI735SFY5':
                ...
                case 'D3425KPHW1':
                    ...
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '{"a": "XtlT6LoA", "cid": "' . $_obf_0D320C272C01163710281538400712181A0704263D1F01 . '", "id": ' . $_obf_0D103E5B092B2E1E0D5C0A15011F221F321932311C1622 . ', "res": {"symb": "' . $_obf_0D0E28151E1B1A1A2F130B1D37332436301F2822370311 . '"}, "s": "ok"}';
                    break;
                case 'PTUDQQMKZB':
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '{"a": "CRc5ya6I", "cid": "Gm4VyA0w", "id": ' . $_obf_0D103E5B092B2E1E0D5C0A15011F221F321932311C1622 . ', "res": {"limit_count": "0"}, "s": "ok"}';
                    break;
                case 'ping':
                ...
                case 'pause':
                    ...
                    break;
                case 'resume':
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '{"a": "o8W9ap6u", "cid": "gC55xpDm", "id": ' . $_obf_0D103E5B092B2E1E0D5C0A15011F221F321932311C1622 . ', "s": "ok"}';
                    break;
                case 'resume':
                ...
                case 'WXMNPP7H8F':
                    ...
                    $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['bet'] = $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['arg']['stake'] / 100;
                    $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['lines'] = 5;
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $_obf_0D0137091E13053E273C250F3E3E251D162D2A0C0B2F32 += $_obf_0D10342528350D243D16293C2835061F263C1C39042811;
                        if( $i > 1000 ) 
                        {
                            $winType = 'none';
                        }
                        ...
                        else
                        {
                            ...
                            if( $_obf_0D0137091E13053E273C250F3E3E251D162D2A0C0B2F32 > 0 && $_obf_0D0137091E13053E273C250F3E3E251D162D2A0C0B2F32 <= $_obf_0D3B3C113639391705311B0F12323C3B3B250C1A142401 && $winType == 'win' ) 
                            {
                    ...
                    $slotSettings->SetGameData('SuperHotWDTotalWin', $_obf_0D0137091E13053E273C250F3E3E251D162D2A0C0B2F32);
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $_obf_0D3B5B082B1F0F0235292F01260B303B0F2E32313B0832 . ',"totalFreeGames":' . $slotSettings->GetGameData('SuperHotWDFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('SuperHotWDCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('SuperHotWDBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('SuperHotWDFreeStartWin') . ',"totalWin":' . $_obf_0D0137091E13053E273C250F3E3E251D162D2A0C0B2F32 . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $_obf_0D033835123E051D331E010A3C300C332C34021F052801 . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                    $_obf_0D2A01173F373E120F303B3F3E0505371B3424131B1701 = $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel1'][0] . ',' . $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel2'][0] . ',' . $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel3'][0] . ',' . $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel1'][1] . ',' . $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel2'][1] . ',' . $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel3'][1] . ',' . $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel1'][2] . ',' . $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel2'][2] . ',' . $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel3'][2];
                    ...
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '{"a": "l0TVF5xh", "cid": "Gm4VyA0w", "id": ' . $_obf_0D103E5B092B2E1E0D5C0A15011F221F321932311C1622 . ', "res": {"bank": "0", "cprize": "0", "credit": "' . round($balance * 100) . '", "flags": "6", "jprize": "0", "prize": "' . round($_obf_0D23292E1910310B2D0F382A090D063F2A132521111C32 * 100) . '", "symb": "' . $_obf_0D2A01173F373E120F303B3F3E0505371B3424131B1701 . '"}, "s": "ok"}';
                    break;
                case '9MHKS5E2Z2':
                ...
                case '464529TBNS':
                    ...
                    $_obf_0D0137091E13053E273C250F3E3E251D162D2A0C0B2F32 = $slotSettings->GetGameData('SuperHotWDTotalWin');
