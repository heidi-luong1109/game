...
namespace VanguardLTE\Games\HighwayToHellDeluxeWD
{
    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            {
                $_obf_0D320C272C01163710281538400712181A0704263D1F01 = 'BKYzNZNh';
            }
            else
            {
                $_obf_0D320C272C01163710281538400712181A0704263D1F01 = $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['cid'];
            }
            if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['act'] == '464529TBNS' && $slotSettings->GetGameData('HighwayToHellDeluxeWDTotalWin') <= 0 ) 
            {
            ...
            switch( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['act'] ) 
            {
                ...
                case 'D3425KPHW1':
                    ...
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '{"a": "XtlT6LoA", "cid": "' . $_obf_0D320C272C01163710281538400712181A0704263D1F01 . '", "id": ' . $_obf_0D103E5B092B2E1E0D5C0A15011F221F321932311C1622 . ', "res": {"symb": "7,0,8,6,1,9,0,0,7,1,1,0,8,5,4"}, "s": "ok"}';
                    break;
                case 'PTUDQQMKZB':
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '{"a": "CRc5ya6I", "cid": "Gm4VyA0w", "id": 11, "res": {"limit_count": "0"}, "s": "ok"}';
                    break;
                case 'ping':
                ...
                case 'WXMNPP7H8F':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22 = ['11'];
                        ...
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            ...
                            {
                                if( $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] == '11' ) 
                                {
                                    $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel' . $r][0] = '11';
                                    $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel' . $r][1] = '11';
                                    $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel' . $r][2] = '11';
                                    break;
                                }
                            }
                        }
                    ...
                    $slotSettings->SetGameData('HighwayToHellDeluxeWDTotalWin', $_obf_0D0137091E13053E273C250F3E3E251D162D2A0C0B2F32);
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $_obf_0D3B5B082B1F0F0235292F01260B303B0F2E32313B0832 . ',"totalFreeGames":' . $slotSettings->GetGameData('HighwayToHellDeluxeWDFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('HighwayToHellDeluxeWDCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('HighwayToHellDeluxeWDBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('HighwayToHellDeluxeWDFreeStartWin') . ',"totalWin":' . $_obf_0D0137091E13053E273C250F3E3E251D162D2A0C0B2F32 . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $_obf_0D033835123E051D331E010A3C300C332C34021F052801 . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                ...
                case '464529TBNS':
                    ...
                    $_obf_0D0137091E13053E273C250F3E3E251D162D2A0C0B2F32 = $slotSettings->GetGameData('HighwayToHellDeluxeWDTotalWin');
