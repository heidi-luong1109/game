...
namespace VanguardLTE\Games\DemonJack27WD
{
    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['act'] == '464529TBNS' && $slotSettings->GetGameData('DemonJack27WDTotalWin') <= 0 ) 
            {
            ...
            switch( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['act'] ) 
            {
                ...
                case 'DVVRWT9K7D':
                    ...
                    {
                        $_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11[$i] = $_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11[$i] * 1 * 100;
                    }
                ...
                case 'WXMNPP7H8F':
                    ...
                    $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['lines'] = 1;
                    ...
                    $slotSettings->SetGameData('DemonJack27WDTotalWin', $_obf_0D0137091E13053E273C250F3E3E251D162D2A0C0B2F32);
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $_obf_0D3B5B082B1F0F0235292F01260B303B0F2E32313B0832 . ',"totalFreeGames":' . $slotSettings->GetGameData('DemonJack27WDFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('DemonJack27WDCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('DemonJack27WDBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('DemonJack27WDFreeStartWin') . ',"totalWin":' . $_obf_0D0137091E13053E273C250F3E3E251D162D2A0C0B2F32 . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $_obf_0D033835123E051D331E010A3C300C332C34021F052801 . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                ...
                case '464529TBNS':
                    ...
                    $_obf_0D0137091E13053E273C250F3E3E251D162D2A0C0B2F32 = $slotSettings->GetGameData('DemonJack27WDTotalWin');
