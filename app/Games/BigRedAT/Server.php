            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'bet' || $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    for( $r = 1; $r <= 5; $r++ ) 
                    {
                        ...
                        {
                            if( $reels['reel' . $r][$_obf_0D31403C0837332A1A1711312A3415151610280F122122] == 'symbol_11' ) 
                            {
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                {
                    ...
                    $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('BigRedATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('BigRedATMpl') . ',"add":0,"total":' . $slotSettings->GetGameData('BigRedATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('BigRedATBonusWin') * 100) . '';
                }
                else
                {
                    $slotSettings->SetGameData('BigRedATTotalWin', $totalWin);
                ...
                if( $scattersCount >= 3 ) 
                {
                    if( $slotSettings->GetGameData('BigRedATFreeGames') > 0 ) 
                    {
                        ...
                        $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('BigRedATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('BigRedATMpl') . ',"add":' . $slotSettings->slotFreeCount . ',"total":' . $slotSettings->GetGameData('BigRedATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('BigRedATBonusWin') * 100) . '';
                    }
                    else
                    {
