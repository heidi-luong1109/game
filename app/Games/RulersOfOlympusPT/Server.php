        ...
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType']) ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    $_obf_0D3F04271B051D32160C2A2413012B090110320A331E11 = $slotSettings->GetGameData('RulersOfOlympusPTShiftingWilds');
                    $wild = [
                        '22', 
                        '23', 
                        '19'
                    ...
                    $scatter = '26';
                    $reels = $slotSettings->GetReelStrips($winType, $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'], $slotSettings->GetGameData('RulersOfOlympusPTBonusType'));
                    $_obf_0D0C353C231930293E1C32222A282208283E03311D0C01 = $reels;
                    $isBonusStart = false;
                    $_obf_0D35071815173013080A0C282D07323C1C110D02143911 = 0;
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && $slotSettings->GetGameData('RulersOfOlympusPTBonusType') == 'olympus' ) 
                    {
                        $_obf_0D35071815173013080A0C282D07323C1C110D02143911 = 12;
                        $_obf_0D241B2516103E01062C1C130C3B3B1215352E15192C22 = $slotSettings->GetGameData('RulersOfOlympusPTOlympusFreeWilds');
                ...
                if( $scattersCount >= 1 ) 
                {
                    ...
                    $slotSettings->SetGameData('RulersOfOlympusPTOlympusFreeWilds', $_obf_0D0C0213291D021D051D381B195B0D2B1B34080B212822);
                }
                $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                ...
                $slotSettings->SetGameData('RulersOfOlympusPTShiftingWilds', $_obf_0D3F04271B051D32160C2A2413012B090110320A331E11);
                $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 = '' . json_encode($reels) . '';
                $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 = '' . json_encode($slotSettings->Jackpots) . '';
                $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 = implode(',', $lineWins);
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"OlympusFreeWilds":' . json_encode($slotSettings->GetGameData('RulersOfOlympusPTOlympusFreeWilds')) . ',"BonusType":"' . $slotSettings->GetGameData('RulersOfOlympusPTBonusType') . '","linesArr":[' . implode(',', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('RulersOfOlympusPTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('RulersOfOlympusPTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('RulersOfOlympusPTBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('RulersOfOlympusPTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                ...
                $slotSettings->SetGameData('RulersOfOlympusPTreelSetIndex', $_obf_0D35071815173013080A0C282D07323C1C110D02143911);
            ...
            switch( $umid ) 
            {
                ...
                case '40036':
                    ...
                    break;
                case '49149':
                    $_obf_0D35071815173013080A0C282D07323C1C110D02143911 = $slotSettings->GetGameData('RulersOfOlympusPTreelSetIndex');
