...
*/            $response = '';
            ...
            if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'gameInit' ) 
            {
                ...
                $response = '{"status":"success","microtime":0.23813390731812,"dateTime":"2020-02-18 10:17:41","error":"","content":{"cmd":"gameInit","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"session":"55492646_b3d33c4034356bc47136d98eae43f081","betInfo":{"denomination":0.01,"bet":' . $_obf_0D131333153E3B3F113536290D1D1A025B0D3F16341932[0] . ',"lines":25},"betSettings":{"denomination":[0.01],"bets":[' . implode(',', $_obf_0D131333153E3B3F113536290D1D1A025B0D3F16341932) . '],"lines":[1,5,10,15,20,25]},"symbols":' . $_obf_0D26400E0A283529372A365B352A06032B3E1106081D32 . ',"reels":{"base":{"1":["' . implode('","', $slotSettings->reelStrip1) . '"],"2":["' . implode('","', $slotSettings->reelStrip2) . '"],"3":["' . implode('","', $slotSettings->reelStrip3) . '"],"4":["' . implode('","', $slotSettings->reelStrip4) . '"],"5":["' . implode('","', $slotSettings->reelStrip5) . '"]},"feature":{"1":["' . implode('","', $slotSettings->reelStripBonus1) . '"],"2":["' . implode('","', $slotSettings->reelStripBonus2) . '"],"3":["' . implode('","', $slotSettings->reelStripBonus3) . '"],"4":["' . implode('","', $slotSettings->reelStripBonus4) . '"],"5":["' . implode('","', $slotSettings->reelStripBonus5) . '"]}},"exitUrl":"\/","pingInterval":60000,"restore":' . $restore . ',"freeSpin":{' . $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 . '},"hash":"af0bc9acbee8a5a9b559dfe95e6527c4"}}';
            }
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'bet' || $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
            {
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                {
                    ...
                    $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('LuckyCountATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('LuckyCountATMpl') . ',"add":0,"total":' . $slotSettings->GetGameData('LuckyCountATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('LuckyCountATBonusWin') * 100) . '';
                }
                else
                {
                    $slotSettings->SetGameData('LuckyCountATTotalWin', $totalWin);
