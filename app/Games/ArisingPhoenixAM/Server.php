            ...
            switch( $gameData['slotEvent'] ) 
            {
                ...
                case 'A/u25':
                    ...
                    if( $lastEvent != 'NULL' ) 
                    {
                        ...
                        $slotSettings->SetGameData('ArisingPhoenixAMLines', $_obf_0D0D3D19173E372D15391D0C1E1F01030F1E163B5B3222);
                        ...
                        $_obf_0D2F1816033E36143D160A39333D122840370C160B1D32 = dechex($slotSettings->GetGameData('ArisingPhoenixAMFreeGames'));
                        $_obf_0D243812041C191E1B1A3F113E330236293F3D3D105C11 = dechex($slotSettings->GetGameData('ArisingPhoenixAMFreeGames') - $slotSettings->GetGameData('ArisingPhoenixAMCurrentFreeGame'));
                        ...
                        $_obf_0D1F02220D0F2D281D26051502182F0E0C1C3D18350732 = $slotSettings->HexFormat($slotSettings->GetGameData('ArisingPhoenixAMBonusWin') * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01);
                    }
                    else
                    {
                        $slotSettings->SetGameData('ArisingPhoenixAMLines', $_obf_0D01361D0A3E2D311F08242223290C1B173C3E1D332432);
                        $slotState = '4';
                    ...
                    break;
                case 'A/u250':
                    $_obf_0D01361D0A3E2D311F08242223290C1B173C3E1D332432 = $slotSettings->GetGameData('ArisingPhoenixAMLines');
                    $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01));
                    $lastEvent = $slotSettings->GetHistory();
                    if( $lastEvent != 'NULL' ) 
                    {
                ...
                case 'A/u251':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $_obf_0D262F5C231C19353703111206230F1E2B3B312A362E01 = $slotSettings->GetGameData('ArisingPhoenixAMRespinState');
                        $_obf_0D0324131F1B140F38253514380610043E2F1504140732 = false;
                        if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                        {
                            for( $r = 1; $r <= 5; $r++ ) 
                            {
                                for( $p = 0; $p <= 3; $p++ ) 
                                {
                                    if( $_obf_0D262F5C231C19353703111206230F1E2B3B312A362E01[$p][$r - 1] != 'f' ) 
                                    {
                                        $reels['reel' . $r][$p] = $_obf_0D262F5C231C19353703111206230F1E2B3B312A362E01[$p][$r - 1];
                                    }
                                }
                            }
                            for( $r = 1; $r <= 5; $r++ ) 
                            {
                                for( $p = 0; $p <= 3; $p++ ) 
                                {
                                    ...
                                    {
                                        if( $_obf_0D262F5C231C19353703111206230F1E2B3B312A362E01[$p][$r - 1] != $slotSettings->GetGameData('ArisingPhoenixAMRSym') && $_obf_0D262F5C231C19353703111206230F1E2B3B312A362E01[$p][$r - 1] != '9' ) 
                                        {
                                            $_obf_0D0324131F1B140F38253514380610043E2F1504140732 = true;
                                        }
                                        $_obf_0D262F5C231C19353703111206230F1E2B3B312A362E01[$p][$r - 1] = $reels['reel' . $r][$p];
                                    }
                                }
                            }
                        }
                                ...
                                else
                                {
                                    ...
                                    if( $s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild) ) 
                                    {
                                        ...
                                        if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                        {
                                            ...
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ArisingPhoenixAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ArisingPhoenixAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ArisingPhoenixAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ArisingPhoenixAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ArisingPhoenixAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                        }
                                    }
                                }
                            }
                        ...
                        else
                        {
                            ...
                            $_obf_0D261501173B3E2715043D363316012B5B1A1F0A2D2932 = false;
                            $_obf_0D312901272C0F292D0F1A391F212B231402093D253001 = false;
                            for( $r = 1; $r <= 5; $r++ ) 
                            {
                                if( $reels['reel' . $r][0] == $reels['reel' . $r][1] && $reels['reel' . $r][1] == $reels['reel' . $r][2] && $reels['reel' . $r][2] == $reels['reel' . $r][3] && $r == 1 ) 
                                {
                                    $_obf_0D261501173B3E2715043D363316012B5B1A1F0A2D2932 = true;
                                }
                                if( ($reels['reel' . $r][0] == 9 || $reels['reel' . $r][1] == 9 || $reels['reel' . $r][2] == 9 || $reels['reel' . $r][3] == 9) && $r > 1 ) 
                                {
                                    $_obf_0D312901272C0F292D0F1A391F212B231402093D253001 = true;
                                }
                            }
                            if( $_obf_0D261501173B3E2715043D363316012B5B1A1F0A2D2932 && $_obf_0D312901272C0F292D0F1A391F212B231402093D253001 && $winType == 'bonus' && $reels['reel1'][0] != $reels['rsym'] ) 
                            {
                            }
                            else if( $_obf_0D261501173B3E2715043D363316012B5B1A1F0A2D2932 && $_obf_0D312901272C0F292D0F1A391F212B231402093D253001 && $winType != 'bonus' && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] != 'freespin' ) 
                            {
                            }
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && $_obf_0D0324131F1B140F38253514380610043E2F1504140732 ) 
                    {
                        $totalWin = 0;
                        $slotSettings->SetGameData('ArisingPhoenixAMFreeGames', $slotSettings->slotFreeCount);
                        $slotSettings->SetGameData('ArisingPhoenixAMCurrentFreeGame', 0);
                    }
                    else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && !$_obf_0D0324131F1B140F38253514380610043E2F1504140732 ) 
                    {
                        $slotSettings->SetGameData('ArisingPhoenixAMFreeGames', 0);
                        $slotSettings->SetGameData('ArisingPhoenixAMCurrentFreeGame', 0);
                    }
                    ...
                    $_obf_0D2D350C1338352E3F0236115C1407341C0926053F2211 = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $_obf_0D5C0D3128242C1E2D2A0A0C38391632153F3C3B171F11 . ',"totalFreeGames":' . $slotSettings->GetGameData('ArisingPhoenixAMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('ArisingPhoenixAMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('ArisingPhoenixAMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('ArisingPhoenixAMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $bonusMpl = $slotSettings->slotFreeMpl;
                        if( $_obf_0D0324131F1B140F38253514380610043E2F1504140732 ) 
                        {
                            $_obf_0D2E3437162622183F300B5C220C15055C2D38031B3511 = '1f';
                        }
                        else
                        {
                            $_obf_0D2E3437162622183F300B5C220C15055C2D38031B3511 = '20';
                        }
                    }
                    else
                    {
                    ...
                    $slotSettings->SetGameData('ArisingPhoenixAMRespinState', $_obf_0D262F5C231C19353703111206230F1E2B3B312A362E01);
                    $_obf_0D2C280226393D1D16260439281D29230735370E5C3432 = '0' . $slotSettings->GetGameData('ArisingPhoenixAMRSym') . '15' . implode('', $_obf_0D262F5C231C19353703111206230F1E2B3B312A362E01[0]) . '15' . implode('', $_obf_0D262F5C231C19353703111206230F1E2B3B312A362E01[1]) . '15' . implode('', $_obf_0D262F5C231C19353703111206230F1E2B3B312A362E01[2]) . '15' . implode('', $_obf_0D262F5C231C19353703111206230F1E2B3B312A362E01[3]);
                    $response = '1' . $_obf_0D2E3437162622183F300B5C220C15055C2D38031B3511 . '010' . $balanceFormated . $slotSettings->HexFormat(round($totalWin * 100)) . $reelSate . $_obf_0D3F05382A29123605040E3D10291E2F12391926360401 . $_obf_0D2E320D352628142310141D2F010A085C321810131022 . $_obf_0D143D1E1E380F351E1138192B253404170B06113D2922 . $_obf_0D2A110E32023D090C020D1E24321C2F19081A26092D32 . $slotSettings->HexFormat($bonusMpl) . '1010' . $reelSate . $_obf_0D0F172D1118050C402A0F213C1D233038275B3E103101 . $winLinesFormated . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards')) . '' . $_obf_0D2C280226393D1D16260439281D29230735370E5C3432 . '#';
                    $response .= ('_' . json_encode($reels));
                    $slotSettings->SetGameData('ArisingPhoenixAMDoubleAnswer', $reelSate . $_obf_0D3F05382A29123605040E3D10291E2F12391926360401 . $_obf_0D2E320D352628142310141D2F010A085C321810131022 . '1010101010101010101010' . $_obf_0D0F172D1118050C402A0F213C1D233038275B3E103101 . $winLinesFormated);
                    ...
                    $slotSettings->SetGameData('ArisingPhoenixAMCollectP0', $_obf_0D121F0821192F3304332C1D225C362A0F2C5C23312322);
                    ...
                    $slotSettings->SetGameData('ArisingPhoenixAMCollect', $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22);
                    break;
                case 'A/u254':
                    $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                ...
                case 'A/u257':
                    $doubleWin = rand(1, 2);
                    $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032 = $slotSettings->GetGameData('ArisingPhoenixAMDoubleWin');
                    ...
                    $response = '107010' . $slotSettings->GetGameData('ArisingPhoenixAMDoubleBalance') . strlen($_obf_0D143B0B042F091727280D3E182D1D0115352113380F01) . $_obf_0D143B0B042F091727280D3E182D1D0115352113380F01 . $slotSettings->GetGameData('ArisingPhoenixAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                    $slotSettings->SetGameData('ArisingPhoenixAMDoubleWin', $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032);
                    $slotSettings->SetGameData('ArisingPhoenixAMTotalWin', $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032);
                    $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01));
                    $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22 = '104010' . $balanceFormated . strlen($_obf_0D143B0B042F091727280D3E182D1D0115352113380F01) . $_obf_0D143B0B042F091727280D3E182D1D0115352113380F01 . $slotSettings->GetGameData('ArisingPhoenixAMCollectP0');
                    $slotSettings->SetGameData('ArisingPhoenixAMCollect', $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22);
                ...
                case 'A/u258':
                    ...
                    $slotSettings->SetGameData('ArisingPhoenixAMDoubleBalance', $_obf_0D373B302A1614233D3F2D03055B0B142A33240F1D0511);
                    $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032 = sprintf('%01.2f', $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032) * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01;
                    $_obf_0D055B13312136223405401F250A14140A220F080A0211 = str_replace('.', '', $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032 . '');
                    $_obf_0D143B0B042F091727280D3E182D1D0115352113380F01 = dechex($_obf_0D055B13312136223405401F250A14140A220F080A0211);
                    $_obf_0D0B231C5C1F3C2202340D2D242505232E371E352F2532 = '26280b2714161d0c';
                    $response = '108010' . $slotSettings->GetGameData('ArisingPhoenixAMDoubleBalance') . strlen($_obf_0D143B0B042F091727280D3E182D1D0115352113380F01) . $_obf_0D143B0B042F091727280D3E182D1D0115352113380F01 . $slotSettings->GetGameData('ArisingPhoenixAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                    break;
            }
