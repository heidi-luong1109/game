        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('CatsRoyalEGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'bet':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $_obf_0D1B160E1F102D3131091316010C381429043219241611 = [];
                        $bonusMpl = 1;
                        if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] != 'freespin' && ($reels['reel5'][0] == '10' || $reels['reel5'][1] == '10' || $reels['reel5'][2] == '10') ) 
                        {
                            if( $reels['reel5'][0] == '10' ) 
                            {
                                $_obf_0D1B160E1F102D3131091316010C381429043219241611[0] = 4;
                                $_obf_0D1B160E1F102D3131091316010C381429043219241611[1] = 0;
                            }
                            if( $reels['reel5'][1] == '10' ) 
                            {
                                $_obf_0D1B160E1F102D3131091316010C381429043219241611[0] = 4;
                                $_obf_0D1B160E1F102D3131091316010C381429043219241611[1] = 1;
                            }
                            if( $reels['reel5'][2] == '10' ) 
                            {
                                $_obf_0D1B160E1F102D3131091316010C381429043219241611[0] = 4;
                                $_obf_0D1B160E1F102D3131091316010C381429043219241611[1] = 2;
                            }
                            $_obf_0D29022337141835032E1A2D1C2D183C020B1F30061722 = rand(1, 20);
                            $bonusMpl = $_obf_0D29022337141835032E1A2D1C2D183C020B1F30061722;
                        }
                        for( $k = 0; $k < $lines; $k++ ) 
                        {
                                ...
                                else
                                {
                                    ...
                                    if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) ) 
                                    {
                                        ...
                                        if( $cWins[$k] < $_obf_0D365B172533170712222423300A1B092C161521071B32 ) 
                                        {
                                            ...
                                            $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"line":' . $k . ',"multiplier":' . $bonusMpl . ',"winAmount":' . ($cWins[$k] * 100) . ',"cells":[0,' . ($linesId[$k][0] - 1) . ',1,' . ($linesId[$k][1] - 1) . '],"freespins":0,"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . '}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[2], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                            $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"line":' . $k . ',"multiplier":' . $bonusMpl . ',"winAmount":' . ($cWins[$k] * 100) . ',"cells":[0,' . ($linesId[$k][0] - 1) . ',1,' . ($linesId[$k][1] - 1) . ',2,' . ($linesId[$k][2] - 1) . '],"freespins":0,"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . '}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[3], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                            $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"line":' . $k . ',"multiplier":' . $bonusMpl . ',"winAmount":' . ($cWins[$k] * 100) . ',"cells":[0,' . ($linesId[$k][0] - 1) . ',1,' . ($linesId[$k][1] - 1) . ',2,' . ($linesId[$k][2] - 1) . ',3,' . ($linesId[$k][3] - 1) . '],"freespins":0,"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . '}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[4], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                            $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"line":' . $k . ',"multiplier":' . $bonusMpl . ',"winAmount":' . ($cWins[$k] * 100) . ',"cells":[0,' . ($linesId[$k][0] - 1) . ',1,' . ($linesId[$k][1] - 1) . ',2,' . ($linesId[$k][2] - 1) . ',3,' . ($linesId[$k][3] - 1) . ',4,' . ($linesId[$k][4] - 1) . '],"freespins":0,"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . '}';
                                        }
                                    }
                                }
                            }
                    ...
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = $slotSettings->GetGameData('CatsRoyalEGTFreeBalance');
                    }
                    else
                    {
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"FreeMultiplier":' . $slotSettings->GetGameData('CatsRoyalEGTFreeMultiplier') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('CatsRoyalEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('CatsRoyalEGTCurrentFreeGame') . ',"Balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"afterBalance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"bonusWin":' . $slotSettings->GetGameData('CatsRoyalEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"Jackpots":' . $_obf_0D28393910101E062539311B3F371C121912162B061E32 . ',"reelsSymbols":' . $_obf_0D273522403840350F0A36072E150A0524143F382C3B32 . '}}';
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('CatsRoyalEGTCards');
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(0, 6));
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(0, 6));
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(0, 6) . ',' . $reels['reel4'][0] . ',' . $reels['reel4'][1] . ',' . $reels['reel4'][2] . ',' . rand(0, 6));
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('CatsRoyalEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('CatsRoyalEGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('CatsRoyalEGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('CatsRoyalEGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('CatsRoyalEGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
