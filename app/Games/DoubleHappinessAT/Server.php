...
*/            $response = '';
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'bet' || $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
            {
                ...
                $_obf_0D360F0140113330275B14311E3516150112390A0F1B22 = $slotSettings->GetSpinSettings($_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'], $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotBet'] * 30, $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotLines']);
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] != 'freespin' ) 
                {
                    ...
                    $_obf_0D2A0526273612293511363C26193E1C130B2719192611 = ($_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotBet'] * 30) / 100 * $slotSettings->GetPercent();
                    ...
                    $slotSettings->UpdateJackpots($_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotBet'] * 30);
                    $slotSettings->SetBalance(-1 * ($_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotBet'] * 30), $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent']);
                    $bonusMpl = 1;
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    $scattersWin = $slotSettings->Paytable[$scatter][$scattersCount] * $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotBet'] * 30;
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                {
                    ...
                    $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('DoubleHappinessATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('DoubleHappinessATMpl') . ',"add":0,"total":' . $slotSettings->GetGameData('DoubleHappinessATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('DoubleHappinessATBonusWin') * 100) . '';
                }
                else
                {
                    $slotSettings->SetGameData('DoubleHappinessATTotalWin', $totalWin);
                ...
                if( $scattersCount >= 3 ) 
                {
                    if( $slotSettings->GetGameData('DoubleHappinessATFreeGames') > 0 ) 
                    {
                        ...
                        $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('DoubleHappinessATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('DoubleHappinessATMpl') . ',"add":' . $slotSettings->slotFreeCount[$scattersCount] . ',"total":' . $slotSettings->GetGameData('DoubleHappinessATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('DoubleHappinessATBonusWin') * 100) . '';
                    }
                    else
                    {
                ...
                $slotSettings->SaveLogReport($_obf_0D332B280C0C3223043E3831210D233725331D30261301, $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotBet'], 30, $_obf_0D0C361D2E35362209025C2317232809271D34270D3232, $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent']);
            }
