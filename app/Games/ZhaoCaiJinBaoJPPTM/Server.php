...
namespace VanguardLTE\Games\ZhaoCaiJinBaoJPPTM
{
    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['ID']) && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['ID'] == 41020 && $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMBonusStart') ) 
            {
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01 = [];
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['type'] == 'spin' ) 
                {
                    ...
                    if( $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTM_JP' . $_obf_0D0A320610031E11100C0A2E07131F273D12211D0F3501 . 'Cnt') == 2 ) 
                    {
                    ...
                    $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTM_JP' . $_obf_0D0A320610031E11100C0A2E07131F273D12211D0F3501 . 'Cnt', $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTM_JP' . $_obf_0D0A320610031E11100C0A2E07131F273D12211D0F3501 . 'Cnt') + 1);
                    $_obf_0D2F362210232735111D2E28162E08075B05221C071011 = 0;
                    if( $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTM_JP' . $_obf_0D0A320610031E11100C0A2E07131F273D12211D0F3501 . 'Cnt') >= 3 ) 
                    {
                    ...
                    $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMJackReport', $_obf_0D1A27130D24113E132109342438182A38141A213E2332);
                    if( $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTM_JP' . $_obf_0D0A320610031E11100C0A2E07131F273D12211D0F3501 . 'Cnt') >= 3 ) 
                    {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['index']) ) 
            {
                ...
                if( $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMBonusStep') == 0 ) 
                {
                    ...
                    $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMBonusOpt', $_obf_0D1D03322B341A3E1C5B123F3E3F320821050D251C1611);
                    ...
                    {
                        $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMFreeGames', $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMFreeGames') + $_obf_0D142C241F1B181D2723252601234035375B141A063811);
                    }
                    else
                    {
                        $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMFreeMpl', $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMFreeMpl') + ($_obf_0D142C241F1B181D2723252601234035375B141A063811 * -1));
                    }
                ...
                {
                    $_obf_0D1D03322B341A3E1C5B123F3E3F320821050D251C1611 = $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMBonusOpt');
                    $_obf_0D142C241F1B181D2723252601234035375B141A063811 = $_obf_0D1D03322B341A3E1C5B123F3E3F320821050D251C1611[$_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['index']];
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType']) ) 
            {
                ...
                else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType'] == 'free' ) 
                {
                    ...
                    $_obf_0D3E1E10392C18192A17311514325C2E132A29390E2E22 = $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMFreeMpl');
                }
                            ...
                            else
                            {
                                ...
                                if( $s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22) ) 
                                {
                                    ...
                                    if( $_obf_0D1F171A1F35063716213837072F111B1E0D042E1B1A11[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                    {
                                        ...
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":1,"Line":' . $k . ',"Win":' . $_obf_0D1F171A1F35063716213837072F111B1E0D042E1B1A11[$k] . ',"stepWin":' . ($_obf_0D1F171A1F35063716213837072F111B1E0D042E1B1A11[$k] + $totalWin + $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMBonusWin')) . ',"winReel1":[' . ($_obf_0D1F0E07322B28015B3101401931191F0119352A1D0901[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
            ...
            switch( $umid ) 
            {
                ...
                case '40030':
                    ...
                    if( $slotSettings->GetGameData($slotSettings->slotId . 'brokenGames') != '' ) 
                    {
                        ...
                        $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMMBonusStart', true);
