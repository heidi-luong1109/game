        ...
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType']) ) 
            {
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                {
                    ...
                    shuffle($_obf_0D27332F352B311B190D045B333538180E3C1B3F333B32);
                    $slotSettings->slotWildMpl = $_obf_0D27332F352B311B190D045B333538180E3C1B3F333B32[0];
                    if( $winType == 'bonus' ) 
                    {
                        $winType = 'win';
                    }
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322 = ['13'];
                    $scatter = '12';
                        ...
                        for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                        {
                            ...
                            else
                            {
                                ...
                                if( $s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild) ) 
                                {
                                    ...
                                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == '0' ) 
                                    {
                                        $wild = ['0'];
                                    }
                                    else
                                ...
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) ) 
                                {
                                    ...
                                    if( in_array($s[0], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) || in_array($s[1], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) ) 
                                    {
                                ...
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) ) 
                                {
                                    ...
                                    if( in_array($s[0], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) || in_array($s[1], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) || in_array($s[2], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) ) 
                                    {
                                        $_obf_0D1016073B15193E060D2D0C262328020129171D232A32 = $slotSettings->slotWildMpl;
                                    }
                                    if( in_array($s[0], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) && in_array($s[1], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) && in_array($s[2], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) ) 
                                ...
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) ) 
                                {
                                    ...
                                    if( in_array($s[0], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) || in_array($s[1], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) || in_array($s[2], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) || in_array($s[3], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) ) 
                                    {
                                        $_obf_0D1016073B15193E060D2D0C262328020129171D232A32 = $slotSettings->slotWildMpl;
                                    }
                                    if( in_array($s[0], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) && in_array($s[1], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) && in_array($s[2], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) && in_array($s[3], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) ) 
                                ...
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $wild)) ) 
                                {
                                    ...
                                    if( in_array($s[0], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) || in_array($s[1], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) || in_array($s[2], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) || in_array($s[3], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) || in_array($s[4], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) ) 
                                    {
                                        $_obf_0D1016073B15193E060D2D0C262328020129171D232A32 = $slotSettings->slotWildMpl;
                                    }
                                    if( in_array($s[0], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) && in_array($s[1], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) && in_array($s[2], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) && in_array($s[3], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) && in_array($s[4], $_obf_0D242D052E233F5B3B1B07183E033C3912362C120A3322) ) 
                    ...
                    $_obf_0D0417180F5B1B091717100B0B5B252A121414343F3611 = 0;
                    for( $r = 1; $r <= 5; $r++ ) 
                    {
                    ...
                    for( $r = 1; $r <= 4; $r++ ) 
                    {
                        for( $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 = 0; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 <= 3; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32++ ) 
                        {
                            if( $reels['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] == 1 && $reels['reel' . ($r + 1)][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] == 2 ) 
                            {
                                $_obf_0D0417180F5B1B091717100B0B5B252A121414343F3611 = $betLine * $lines * 3;
                            }
                        }
                    }
                    ...
                    $totalWin += ($scattersWin + $_obf_0D0417180F5B1B091717100B0B5B252A121414343F3611);
                    if( $i > 1000 ) 
                    {
                        $winType = 'none';
                    }
                    ...
                    else
                    {
                        ...
                        if( $_obf_0D28301D333F2827165C2511011438180336175B1E2A01 >= 3 ) 
                        {
                            ...
                            $_obf_0D3C380D1A3107320A1A2D2A274040131B2C2C2A272A32 = 0;
                            $_obf_0D0A04361940345B1A0732041A3D3026313B103C153B22 = [];
                            for( $_obf_0D01241F5C020C062614013F12120B22011F13100D3411 = 0; $_obf_0D01241F5C020C062614013F12120B22011F13100D3411 < 5; $_obf_0D01241F5C020C062614013F12120B22011F13100D3411++ ) 
                            {
                                $_obf_0D342A0C36271E1B1A1240140D2111220D171E1D170A11 = $_obf_0D0A171D1E131B3B352E0E37172D40181B133D210C2722[$_obf_0D01241F5C020C062614013F12120B22011F13100D3411] * $betLine * $lines;
                                $_obf_0D3C380D1A3107320A1A2D2A274040131B2C2C2A272A32 += $_obf_0D342A0C36271E1B1A1240140D2111220D171E1D170A11;
                                $_obf_0D0A04361940345B1A0732041A3D3026313B103C153B22[] = $_obf_0D0A171D1E131B3B352E0E37172D40181B133D210C2722[$_obf_0D01241F5C020C062614013F12120B22011F13100D3411];
                            }
                            $slotSettings->SetGameData('SherlockMysteryPTMBonusWinArr', $_obf_0D0A04361940345B1A0732041A3D3026313B103C153B22);
                            $totalWin += $_obf_0D3C380D1A3107320A1A2D2A274040131B2C2C2A272A32;
                        }
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                {
                    ...
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"multiplier":' . $slotSettings->slotWildMpl . ',"windowId":"fdyxbZ"},"ID":40595,"umid":67}';
                }
                else
                {
                    $slotSettings->SetGameData('SherlockMysteryPTMTotalWin', $totalWin);
                ...
                if( $_obf_0D28301D333F2827165C2511011438180336175B1E2A01 >= 3 ) 
                {
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"picksCount":5,"windowId":"2FV71o"},"ID":40595,"umid":275}';
                }
                $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"linesArr":[' . implode(',', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('SherlockMysteryPTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('SherlockMysteryPTMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('SherlockMysteryPTMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('SherlockMysteryPTMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
            ...
            {
                case '40591':
                    $_obf_0D05362C2B0E0B1A11092A1E281A222F5C071A0D263701 = $slotSettings->GetGameData('SherlockMysteryPTMBonusWinArr');
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"prize":' . array_shift($_obf_0D05362C2B0E0B1A11092A1E281A222F5C071A0D263701) . ',"windowId":"2FV71o"},"ID":40595,"umid":287}';
                    $slotSettings->SetGameData('SherlockMysteryPTMBonusWinArr', $_obf_0D05362C2B0E0B1A11092A1E281A222F5C071A0D263701);
                    break;
                case '31031':
                ...
                case '40066':
                    ...
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"funNoticeGames":0,"funNoticePayouts":0,"gameGroup":"shmst","minBet":0,"maxBet":0,"minPosBet":0,"maxPosBet":50000,"coinSizes":[' . implode(',', $_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11) . ']},"ID":40025,"umid":21}';
                    break;
                case '40036':
