            ...
            switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 ) 
            {
                case 'init':
                    ...
                    else
                    {
                        ...
                        $_obf_0D0D3D19173E372D15391D0C1E1F01030F1E163B5B3222 = 30;
                        $_obf_0D303824321032022116072C3F3F1A2225350B2B261611 = 0;
                ...
                case 'spin':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $_obf_0D310A012F071F133C183C183640133206032A08142332 = false;
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            for( $p = 0; $p <= 2; $p++ ) 
                            {
                                ...
                                {
                                    $_obf_0D1A04030A3C0D0E0B05221D232504161C2E19122D0C01 = 'a:1:{i:2;i:' . $p . ';}';
                                    $_obf_0D310A012F071F133C183C183640133206032A08142332 = true;
                                    break;
                                }
                            }
                        }
                        $_obf_0D1D130E11023C1B271009171133291B3E01150E152332 = [
                            0, 
                            0
                        ];
                        if( $_obf_0D310A012F071F133C183C183640133206032A08142332 ) 
                        {
                            $_obf_0D2C21040C193E10050A2833052F272B1B3D3C141F0E32 = [];
                            $_obf_0D1D130E11023C1B271009171133291B3E01150E152332 = [
                                rand(1, 8), 
                                rand(1, 8)
                            ];
                            $wild = [
                                '11', 
                                '12', 
                                $_obf_0D1D130E11023C1B271009171133291B3E01150E152332[0], 
                                $_obf_0D1D130E11023C1B271009171133291B3E01150E152332[1]
                            ];
                            ...
                            for( $r = 1; $r <= 5; $r++ ) 
                            {
                                for( $p = 0; $p <= 2; $p++ ) 
                                {
                                    if( $reels['reel' . $r][$p] == $_obf_0D1D130E11023C1B271009171133291B3E01150E152332[0] || $reels['reel' . $r][$p] == $_obf_0D1D130E11023C1B271009171133291B3E01150E152332[1] ) 
                                    {
                                        $_obf_0D2C21040C193E10050A2833052F272B1B3D3C141F0E32[] = 'i:' . $_obf_0D01373C192C15080B363D173B2B3B373715020B360432 . ';a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:' . $p . ';s:6:"symbol";i:' . $reels['reel' . $r][$p] . ';}';
                                        $_obf_0D01373C192C15080B363D173B2B3B373715020B360432++;
                                    }
                                }
                            }
                            $_obf_0D02273710032306403E240D122E343C13283228380701 = 'a:' . count($_obf_0D2C21040C193E10050A2833052F272B1B3D3C141F0E32) . ':{' . implode('', $_obf_0D2C21040C193E10050A2833052F272B1B3D3C141F0E32) . '}';
                        }
                            ...
                            for( $p = 0; $p <= 2; $p++ ) 
                            {
                                if( $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel' . $r][$p] == -1 ) 
                                {
                                    if( $reels['reel' . $r][$p] == 11 ) 
                                    {
                                        ...
                                        $_obf_0D0410092A1F39153D171B22300F190E22312603020C01[] = 'i:' . $_obf_0D37325B0B3F020C26403910323E16341F311E110F1232 . ';a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:' . $p . ';s:9:"animation";s:7:"topWild";}';
                                    }
                                    else if( $reels['reel' . $r][$p] == $_obf_0D1D130E11023C1B271009171133291B3E01150E152332[0] || $reels['reel' . $r][$p] == $_obf_0D1D130E11023C1B271009171133291B3E01150E152332[1] ) 
                                    {
                                    ...
                                    {
                                        $_obf_0D0410092A1F39153D171B22300F190E22312603020C01[] = 'i:' . $_obf_0D37325B0B3F020C26403910323E16341F311E110F1232 . ';a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:' . $p . ';s:9:"animation";s:9:"stoneWild";}';
                                    }
                    ...
                    if( $_obf_0D310A012F071F133C183C183640133206032A08142332 ) 
                    {
                        $_obf_0D3C26080C282C210D0716102802330E40315C0D372A11 = 'a:2:{i:0;i:' . $_obf_0D1D130E11023C1B271009171133291B3E01150E152332[0] . ';i:1;i:' . $_obf_0D1D130E11023C1B271009171133291B3E01150E152332[1] . ';}';
                    }
                    else
                    {
                        $_obf_0D3C26080C282C210D0716102802330E40315C0D372A11 = 'b:0;';
                        $_obf_0D1A04030A3C0D0E0B05221D232504161C2E19122D0C01 = 'b:0;';
                        $_obf_0D02273710032306403E240D122E343C13283228380701 = 'a:0:{}';
                    }
