        ...
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['index']) ) 
            {
                ...
                if( $slotSettings->GetGameData('IrishLuckPTMBonusStep') == 0 ) 
                {
                    ...
                    $slotSettings->SetGameData('IrishLuckPTMBonusOpt', $_obf_0D1D03322B341A3E1C5B123F3E3F320821050D251C1611);
                    ...
                    {
                        $slotSettings->SetGameData('IrishLuckPTMFreeGames', $slotSettings->GetGameData('IrishLuckPTMFreeGames') + ($_obf_0D142C241F1B181D2723252601234035375B141A063811 / 100));
                    }
                    else
                    {
                        $slotSettings->SetGameData('IrishLuckPTMFreeMpl', $slotSettings->GetGameData('IrishLuckPTMFreeMpl') + $_obf_0D142C241F1B181D2723252601234035375B141A063811);
                    }
                ...
                {
                    $_obf_0D1D03322B341A3E1C5B123F3E3F320821050D251C1611 = $slotSettings->GetGameData('IrishLuckPTMBonusOpt');
                    $_obf_0D142C241F1B181D2723252601234035375B141A063811 = $_obf_0D1D03322B341A3E1C5B123F3E3F320821050D251C1611[$_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['index']];
                    if( $_obf_0D142C241F1B181D2723252601234035375B141A063811 > 10 ) 
                    {
                        $slotSettings->SetGameData('IrishLuckPTMFreeGames', $slotSettings->GetGameData('IrishLuckPTMFreeGames') + ($_obf_0D142C241F1B181D2723252601234035375B141A063811 / 100));
