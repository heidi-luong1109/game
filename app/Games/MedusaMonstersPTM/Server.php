        ...
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType']) ) 
            {
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType'] == 'regular' ) 
                {
                    ...
                    $slotSettings->SetGameData('MedusaMonstersPTMstickySymbolArr', $_obf_0D2B21073B383F352F4033273225302208161E23042322);
                ...
                else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType'] == 'free' ) 
                {
                    ...
                    $_obf_0D2B21073B383F352F4033273225302208161E23042322 = $slotSettings->GetGameData('MedusaMonstersPTMstickySymbolArr');
                    $bonusMpl = 1;
                }
                $linesId = [];
                $linesId[0] = [
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && $slotSettings->GetGameData('MedusaMonstersPTMwildRow') >= 1 ) 
                    {
                ...
                if( $scattersCount >= 3 ) 
                {
                    ...
                    $slotSettings->SetGameData('MedusaMonstersPTMwildReels', $_obf_0D373B33361D1F2D401F0B2234112E362E0B2238062C01);
                    $slotSettings->SetGameData('MedusaMonstersPTMIncreaseMpl', 0);
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"stickySymbolArr":[' . implode(',', $_obf_0D2B21073B383F352F4033273225302208161E23042322) . '],"wildRow":' . $slotSettings->GetGameData('MedusaMonstersPTMwildRow') . ',"stickySymbol":' . $stickySymbol . ',"IncreaseMpl":1,"linesArr":[' . implode(',', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('MedusaMonstersPTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('MedusaMonstersPTMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('MedusaMonstersPTMBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('MedusaMonstersPTMFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('MedusaMonstersPTMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
