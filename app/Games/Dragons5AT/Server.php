...
*/            $response = '';
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'bet' || $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                    {
                        ...
                        else
                        {
                            ...
                            $_obf_0D0F393B153C2A2F1B3619282622292F170124133D0D22[10] = [
                                [
                                    0, 
                                    1, 
                                    2, 
                            ...
                            $_obf_0D0F393B153C2A2F1B3619282622292F170124133D0D22[20] = [
                                [
                                    0, 
                                    1, 
                                    2, 
                            ...
                            $_obf_0D0F393B153C2A2F1B3619282622292F170124133D0D22[30] = [
                                [
                                    0, 
                                    1, 
                                    2
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                {
                    ...
                    $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('Dragons5ATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('Dragons5ATMpl') . ',"xWin":[' . implode(',', $_obf_0D322E3B232F25403F0406272B0513332A2E082B113B11) . '],"add":0,"total":' . $slotSettings->GetGameData('Dragons5ATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('Dragons5ATBonusWin') * 100) . '';
                }
                else
                {
                    $slotSettings->SetGameData('Dragons5ATTotalWin', $totalWin);
                ...
                if( $scattersCount >= 3 ) 
                {
                    if( $slotSettings->GetGameData('Dragons5ATFreeGames') > 0 ) 
                    {
                        ...
                        $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('Dragons5ATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('Dragons5ATMpl') . ',"add":' . $slotSettings->slotFreeCount[$scattersCount] . ',"total":' . $slotSettings->GetGameData('Dragons5ATFreeGames') . ',"xWin":[' . implode(',', $_obf_0D322E3B232F25403F0406272B0513332A2E082B113B11) . '],"totalWin":' . ($slotSettings->GetGameData('Dragons5ATBonusWin') * 100) . '';
                    }
                    else
                    {
