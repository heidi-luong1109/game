        ...
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType']) ) 
            {
                ...
                if( $_obf_0D0B230B342E0C0727115B043F283E2137182D312A3D11 >= 2 ) 
                {
                    ...
                    {
                        $slotSettings->SetGameData('WaysOfPhoenixPTMFreeGames', $slotSettings->GetGameData('WaysOfPhoenixPTMFreeGames') + $slotSettings->slotFreeCountAdd[$_obf_0D0B230B342E0C0727115B043F283E2137182D312A3D11]);
                    }
                    else if( $_obf_0D0B230B342E0C0727115B043F283E2137182D312A3D11 >= 3 ) 
                    {
                        ...
                        $slotSettings->SetGameData('WaysOfPhoenixPTMBonusWin', 0);
                        $slotSettings->SetGameData('WaysOfPhoenixPTMFreeGames', $slotSettings->slotFreeCount[$_obf_0D0B230B342E0C0727115B043F283E2137182D312A3D11]);
                    }
                }
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"gridState":' . json_encode($gridState) . ',"linesArr":[4096],"slotLines":' . $lines . ',"slotBet":' . $_obf_0D3B5B082B1F0F0235292F01260B303B0F2E32313B0832 . ',"totalFreeGames":' . $slotSettings->GetGameData('WaysOfPhoenixPTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('WaysOfPhoenixPTMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('WaysOfPhoenixPTMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('WaysOfPhoenixPTMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $_obf_0D033835123E051D331E010A3C300C332C34021F052801 . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
            ...
            switch( $umid ) 
            {
                case '31031':
                    ...
                    break;
                case '40029':
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"numFgWon":' . $slotSettings->GetGameData('WaysOfPhoenixPTMFreeGames') . ',"windowId":"JB2We4"},"ID":49373,"umid":63}';
                    break;
                case '10001':
                ...
                case '40030':
                    ...
                    if( $slotSettings->GetGameData($slotSettings->slotId . 'brokenGames') != '' ) 
                    {
                        ...
                        $_obf_0D0E13050525251E113F1717012D402223035B2F352C01 = $slotSettings->GetGameData('WaysOfPhoenixPTMGridState');
