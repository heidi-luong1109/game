        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                case 'choice':
                    ...
                    $_obf_0D3E2A21032136092235272A2C3D1C0340223B163F0C11 = $slotSettings->GetGameData('GeniusOfLeonardoEGTChoiceArr');
                    $fs = $slotSettings->GetGameData('GeniusOfLeonardoEGTFreeGames');
                    $_obf_0D352C3B2F030A2414021C3C255C37211A3E31241E3922 = $slotSettings->GetGameData('GeniusOfLeonardoEGTMultiplier');
                    $_obf_0D045C2A0C141828030C1310160C172C162808313F1501 = $slotSettings->GetGameData('GeniusOfLeonardoEGTBonusCredits');
                    ...
                    for( $i = 0; $i <= 1000; $i++ ) 
                    {
                        $_obf_0D5B30195C320C5B21191E1C0226261E052D3C29120422 = rand(1, 10);
                        $_obf_0D2A011415400237290F232D0C0D3C1C0238370F231401 = $_obf_0D5B30195C320C5B21191E1C0226261E052D3C29120422 * $bet;
                    ...
                    $_obf_0D1F2E39342F0F2D371835031F0A3B2C350E251D3C1732 = rand(1, 3);
                    $_obf_0D105C2811322F073E163E1B1F390D1E3D1A03323D3F22 = 'false';
                    if( rand(3, 9) <= count($_obf_0D3E2A21032136092235272A2C3D1C0340223B163F0C11) && $slotSettings->GetGameData('GeniusOfLeonardoEGTFreeGames') > 0 ) 
                    {
                    ...
                    if( $_obf_0D262B143F2B3E140B0F050D371F08351338221C5B2922 ) 
                    {
                        ...
                        for( $i = 0; $i < 18; $i++ ) 
                        {
                            ...
                            {
                                $opt[$i] = '{"pos":' . $i . ',"credits":0,"currentCredits":' . $_obf_0D35163328030A1F0C0D0E072532190F1209130A1E1A22 . ',"stopKey":' . $_obf_0D22025B1B2E1E073C1127230D28322334173B30161F11[rand(0, 1)] . '}';
                            }
                        }
                        $_obf_0D22363F0F3C1234262F032D2D1A3F2B0C1F1F2A3D3801 = implode(',', $opt);
                    }
                    $_obf_0D045C2A0C141828030C1310160C172C162808313F1501 += $_obf_0D5B30195C320C5B21191E1C0226261E052D3C29120422;
                    $_obf_0D10020A152E15360C312C1F0E142E403C32011D181122 = 5;
                    if( $_obf_0D045C2A0C141828030C1310160C172C162808313F1501 >= 7 ) 
                    {
                        $_obf_0D10020A152E15360C312C1F0E142E403C32011D181122 = 7;
                    }
                    if( $_obf_0D045C2A0C141828030C1310160C172C162808313F1501 >= 13 ) 
                    {
                        $_obf_0D10020A152E15360C312C1F0E142E403C32011D181122 = 10;
                    }
                    if( $_obf_0D045C2A0C141828030C1310160C172C162808313F1501 >= 31 ) 
                    {
                        $_obf_0D10020A152E15360C312C1F0E142E403C32011D181122 = 15;
                    }
                    if( $_obf_0D045C2A0C141828030C1310160C172C162808313F1501 >= 46 ) 
                    {
                        $_obf_0D10020A152E15360C312C1F0E142E403C32011D181122 = 20;
                    }
                    if( $_obf_0D045C2A0C141828030C1310160C172C162808313F1501 >= 56 ) 
                    {
                        $_obf_0D10020A152E15360C312C1F0E142E403C32011D181122 = 30;
                    }
                    if( $_obf_0D045C2A0C141828030C1310160C172C162808313F1501 >= 63 ) 
                    {
                        $_obf_0D10020A152E15360C312C1F0E142E403C32011D181122 = 50;
                    }
                    if( $_obf_0D262B143F2B3E140B0F050D371F08351338221C5B2922 ) 
                    {
                        $_obf_0D0C361D2E35362209025C2317232809271D34270D3232 = $_obf_0D045C2A0C141828030C1310160C172C162808313F1501 * $bet;
                        $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"slotLines":30' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . ($bet / 30) . ',"totalFreeGames":' . $slotSettings->GetGameData('GeniusOfLeonardoEGTFreeGames') . ',"Multiplier":' . $slotSettings->GetGameData('GeniusOfLeonardoEGTMultiplier') . ',"currentFreeGames":' . $slotSettings->GetGameData('GeniusOfLeonardoEGTCurrentFreeGame') . ',"Balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"afterBalance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"bonusWin":' . $slotSettings->GetGameData('GeniusOfLeonardoEGTBonusWin') . ',"totalWin":' . $_obf_0D0C361D2E35362209025C2317232809271D34270D3232 . ',"winLines":[]}}';
                        $slotSettings->SaveLogReport($response, $bet, 30, $_obf_0D0C361D2E35362209025C2317232809271D34270D3232, 'freespin');
                    }
                    $slotSettings->SetGameData('GeniusOfLeonardoEGTChoiceArr', $_obf_0D3E2A21032136092235272A2C3D1C0340223B163F0C11);
                    $slotSettings->SetGameData('GeniusOfLeonardoEGTFreeGames', $_obf_0D10020A152E15360C312C1F0E142E403C32011D181122);
                    $slotSettings->SetGameData('GeniusOfLeonardoEGTBonusCredits', $_obf_0D045C2A0C141828030C1310160C172C162808313F1501);
                    $slotSettings->SetGameData($slotSettings->slotId . 'BonusWin', $slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') + $_obf_0D2A011415400237290F232D0C0D3C1C0238370F231401);
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"pos":' . $choice . ',"credits":' . $_obf_0D045C2A0C141828030C1310160C172C162808313F1501 . ',"currentCredits":' . $_obf_0D5B30195C320C5B21191E1C0226261E052D3C29120422 . ',"freespins":' . $slotSettings->GetGameData('GeniusOfLeonardoEGTFreeGames') . ',"totalBet":' . ($bet * 100) . ',"play":' . $_obf_0D105C2811322F073E163E1B1F390D1E3D1A03323D3F22 . ',"closed":[' . $_obf_0D22363F0F3C1234262F032D2D1A3F2B0C1F1F2A3D3801 . '],"gameCommand":"choice"},"state":"' . $state . '","winAmount":' . ($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":1787203010852,"sessionKey":"5af6a26c031aa4ec491159428c5a7742","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":1566584969191}';
                    break;
                case 'login':
                ...
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('GeniusOfLeonardoEGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'bet':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $_obf_0D1D190732303117182A032A083236110B03405B101A01 = $reels;
                        $_obf_0D1F17191A01213B0E181701280B2A0F13075B17271E11 = [];
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            $_obf_0D39082621071F3D0B0516042F16120E0C395C3B310332 = false;
                            if( $reels['reel' . $r][0] == '10' ) 
                            {
                                $_obf_0D1F17191A01213B0E181701280B2A0F13075B17271E11[] = '' . ($r - 1) . ',1';
                                $_obf_0D1F17191A01213B0E181701280B2A0F13075B17271E11[] = '' . ($r - 1) . ',2';
                                $_obf_0D39082621071F3D0B0516042F16120E0C395C3B310332 = true;
                            }
                            if( $reels['reel' . $r][1] == '10' ) 
                            {
                                $_obf_0D1F17191A01213B0E181701280B2A0F13075B17271E11[] = '' . ($r - 1) . ',0';
                                $_obf_0D1F17191A01213B0E181701280B2A0F13075B17271E11[] = '' . ($r - 1) . ',2';
                                $_obf_0D39082621071F3D0B0516042F16120E0C395C3B310332 = true;
                            }
                            ...
                            if( $_obf_0D39082621071F3D0B0516042F16120E0C395C3B310332 ) 
                            {
                                $reels['reel' . $r][0] = '10';
                                $reels['reel' . $r][1] = '10';
                                $reels['reel' . $r][2] = '10';
                    ...
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = $slotSettings->GetGameData('GeniusOfLeonardoEGTFreeBalance');
                    }
                    else
                    {
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('GeniusOfLeonardoEGTCards');
                    ...
                    {
                        $state = 'freespin';
                        $_obf_0D341E1906402E012D2302041A0B29343137123F023201 = $slotSettings->GetGameData('GeniusOfLeonardoEGTFreeGames');
                        $fs = $_obf_0D341E1906402E012D2302041A0B29343137123F023201;
                    }
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gambles":5,"reels":[' . $_obf_0D3E331C040E390B031B03100422040311293E023E0322 . '],"lines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . ']' . $_obf_0D1224210F3F5B0819110834131432040D0E062B260211 . ',"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"expand":[' . implode(',', $_obf_0D1F17191A01213B0E181701280B2A0F13075B17271E11) . '],"specialExpand":[],"gambles":5,"freespins":' . $fs . ',"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('GeniusOfLeonardoEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('GeniusOfLeonardoEGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('GeniusOfLeonardoEGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('GeniusOfLeonardoEGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('GeniusOfLeonardoEGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
