...
namespace VanguardLTE\Games\JiXiang8PTM
{
    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['ID']) && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['ID'] == '46123' ) 
            {
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01 = [];
                $umid = '0';
                ...
                $_obf_0D280E2F2B1F1F2809310C09101E072907012417070511 = 'false';
                if( $totalWin > 0 ) 
                {
                    $slotSettings->SetBank((isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent']) ? $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] : ''), -1 * $totalWin);
                    $slotSettings->SetBalance($totalWin);
                    $_obf_0D280E2F2B1F1F2809310C09101E072907012417070511 = 'true';
                }
                ...
                $_obf_0D2C363925251F150B17322D25102321152C020F033611 = $reels['reel1'][0] . ',' . $reels['reel2'][0] . ',' . $reels['reel3'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel2'][1] . ',' . $reels['reel3'][1] . ',' . $reels['reel1'][2] . ',' . $reels['reel2'][2] . ',' . $reels['reel3'][2];
                $_obf_0D3E321337050712341D3919362326131A245C3B5C2311 = $reels['rp'][0] . ',' . $reels['rp'][3] . ',' . $reels['rp'][6] . ',' . $reels['rp'][1] . ',' . $reels['rp'][4] . ',' . $reels['rp'][7] . ',' . $reels['rp'][2] . ',' . $reels['rp'][5] . ',' . $reels['rp'][8];
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"placeBetsResponse":{"gameId":2476842377,"newBalance":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . '},"loadResultsResponse":{"gameId":2476842377,"drawState":{"drawId":0,"state":"settling","wCapMaxWin":1000000.0,"winLines":{"display":"' . $_obf_0D2C363925251F150B17322D25102321152C020F033611 . '","reelset":0,"runningTotal":0.0,"stops":"' . $_obf_0D3E321337050712341D3919362326131A245C3B5C2311 . '"},"replayInfo":{"foItems":"' . $_obf_0D3E321337050712341D3919362326131A245C3B5C2311 . '"},"bet":{"pick":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['numLines'] . '","seq":0,"stake":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['bet'] . ',"type":"line","won":"' . $_obf_0D280E2F2B1F1F2809310C09101E072907012417070511 . '"}}}},"ID":47382,"umid":37}';
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . ($_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 * 100) . ',"deltaBalanceInCents":1},"ID":40085}';
            ...
            switch( $umid ) 
            {
                ...
                case '40066':
                    ...
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"funNoticeGames":0,"funNoticePayouts":0,"gameGroup":"gtsjxb","minBet":0,"maxBet":0,"minPosBet":0,"maxPosBet":50000,"coinSizes":[' . implode(',', $_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11) . ']},"ID":40025,"umid":21}';
                    break;
                case '40036':
                ...
                case '40030':
                    ...
                    break;
                case '46090':
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"gameId":2476582349,"drawState":{"drawId":0}},"ID":47380,"umid":30}';
                    break;
                case '46124':
                    $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance());
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"settleBetsResponse":{"gameId":2476842377,"newBalance":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . '},"closeGameResponse":{},"openGameResponse":{"gameId":2476843970,"drawState":{"drawId":0}}},"ID":47383,"umid":39}';
                    break;
                case '48300':
