...
namespace VanguardLTE\Games\SunWukongPT
{
    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['ID']) && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['ID'] == '46108' ) 
            {
                ...
                for( $s = 1; $s <= $_obf_0D220B060A21130E0C011A09151D32403F5B025C070411; $s++ ) 
                {
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $_obf_0D31103E3B3D1E1A27051D1540063B0528291C5C1A0D22 = $slotSettings->GetSpinSettings($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'], $slotSettings->GetGameData('SunWukongPTBet'));
                        ...
                        $_obf_0D2E2603172E2216072F1A0936232A2E17313917190211 = $slotSettings->GetSpinWin($reels, $lines, $betLine, $linesId, $wild, $scatter, $bonusMpl);
                    ...
                    $_obf_0D390225301D2E21373038281039131A192C011A3F0632[] = '{"drawId":' . ($s + 1) . ',"winLines":{"currentWin":' . $totalWin . ',"currentSpins":' . $_obf_0D220B060A21130E0C011A09151D32403F5B025C070411 . ',"display":"Q,SA,M,K,M;PE,M,J,A,N;A,PE,K,Q,A","reelset":0,"runningTotal":' . ($slotSettings->GetGameData('SunWukongPTFreeStartWin') + $slotSettings->GetGameData('SunWukongPTBonusWin')) . ',"spins":' . $_obf_0D220B060A21130E0C011A09151D32403F5B025C070411 . ',"stops":"' . implode(',', $reels['rp']) . '"},"replayInfo":{"foItems":"' . implode(',', $reels['rp']) . '"}}';
                    $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 = '' . json_encode($reels) . '';
                    $_obf_0D1116233529011F0C293C2D011C113C061E381B341411[] = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"bonusMpl":' . $bonusMpl . ',"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $_obf_0D220B060A21130E0C011A09151D32403F5B025C070411 . ',"currentFreeGames":' . $s . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('SunWukongPTBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('SunWukongPTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"bonusInfo":"","Jackpots":"","reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                }
                $slotSettings->SetGameData('SunWukongPTFreeSpins', $_obf_0D390225301D2E21373038281039131A192C011A3F0632);
                $slotSettings->SetGameData('SunWukongPTFreeLogs', $_obf_0D1116233529011F0C293C2D011C113C061E381B341411);
                $slotSettings->SetGameData('SunWukongPTFreeGames', $_obf_0D220B060A21130E0C011A09151D32403F5B025C070411);
            ...
            {
                $_obf_0D2813390912262B102326025B34051621182F31041832 = $slotSettings->GetGameData('SunWukongPTCurrentFreeGame');
                $_obf_0D131D5C261C392D093F121D1F2E13191812150D231232 = $slotSettings->GetGameData('SunWukongPTFreeSpins');
                $_obf_0D222C3C342D2C31305B091C0A1C10250A19140B2B2811 = $slotSettings->GetGameData('SunWukongPTFreeLogs');
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['ID']) && ($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['ID'] == '46123' || $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['ID'] == '46302') ) 
            {
                ...
                {
                    $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['bet'] = $slotSettings->GetGameData('SunWukongPTBet');
                    $lines = $slotSettings->GetGameData('SunWukongPTLines');
                }
                else
                {
                    ...
                    $slotSettings->SetGameData('SunWukongPTBet', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['bet']);
            ...
            switch( $umid ) 
            {
                ...
                case '46090':
                    ...
                    {
                        $_obf_0D2410310726250E1A3F025B0F2101383038135B043C01 = $slotSettings->GetGameData('SunWukongPTFreeSpins');
