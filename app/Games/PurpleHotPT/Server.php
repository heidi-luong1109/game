    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType']) ) 
            {
                ...
                $_obf_0D22023D3D393C1734302612130F2B311D020D332E2801 = [];
                for( $i = count($_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11) - 4; $i < count($_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11); $i++ ) 
                {
                    $_obf_0D22023D3D393C1734302612130F2B311D020D332E2801[] = $_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11[$i];
                }
                for( $i = 0; $i < 4; $i++ ) 
                {
                    if( $_obf_0D22023D3D393C1734302612130F2B311D020D332E2801[$i] == $betLine && $lines >= 5 ) 
                    {
                        $_obf_0D251C035C12110B0F5B28213D2A222F2E1D280F131B32 = $i;
                    }
                }
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                        ...
                        for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                        {
                            ...
                            else
                            {
                                ...
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $wild)) ) 
                                {
                                    ...
                                    if( $_obf_0D251C035C12110B0F5B28213D2A222F2E1D280F131B32 >= 0 && $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == '0' && !$jackPay ) 
                                    {
                                        $jackPay = true;
                    ...
                    else
                    {
                        ...
                        if( $_obf_0D251C035C12110B0F5B28213D2A222F2E1D280F131B32 >= 0 && $jackPay && !$_obf_0D262A401E2428360E103910312E0E2A2D04280B345B11['isJackPay'] ) 
                        {
                        }
                ...
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"credit":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"results":[' . implode(',', $reels['rp']) . '],"windowId":"Adbmao"},"jackPay":"' . $jackPay . '","jackID":' . $_obf_0D251C035C12110B0F5B28213D2A222F2E1D280F131B32 . ',"ID":40022,"umid":35}';
            ...
            switch( $umid ) 
            {
                ...
                case '40066':
                    ...
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"funNoticeGames":0,"funNoticePayouts":0,"gameGroup":"phot","minBet":0,"maxBet":0,"minPosBet":0,"maxPosBet":50000,"coinSizes":[' . implode(',', $_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11) . ']},"ID":40025,"umid":21}';
                    break;
                case '40036':
