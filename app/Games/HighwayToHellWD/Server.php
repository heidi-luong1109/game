...
namespace VanguardLTE\Games\HighwayToHellWD
{
    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['act'] == '464529TBNS' && $slotSettings->GetGameData('HighwayToHellWDTotalWin') <= 0 ) 
            {
            ...
            switch( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['act'] ) 
            {
                ...
                case 'WXMNPP7H8F':
                    ...
                    $slotSettings->SetGameData('HighwayToHellWDTotalWin', $_obf_0D0137091E13053E273C250F3E3E251D162D2A0C0B2F32);
                ...
                case '464529TBNS':
                    ...
                    $_obf_0D0137091E13053E273C250F3E3E251D162D2A0C0B2F32 = $slotSettings->GetGameData('HighwayToHellWDTotalWin');
