        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'settings':
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"paytableCoef":{"0":{"coef":[10,20],"multiplier":1},"1":{"coef":[10,40],"multiplier":1},"2":{"coef":[10,40],"multiplier":1},"3":{"coef":[10,40],"multiplier":1},"4":{"coef":[10,40],"multiplier":1},"5":{"coef":[40,400],"multiplier":1},"6":{"coef":[60,600],"multiplier":1},"7":{"coef":[160,1600],"multiplier":1},"8":{"coef":[],"multiplier":1}},"bets":[' . implode(',', $_obf_0D131333153E3B3F113536290D1D1A025B0D3F16341932) . '],"jackpotMinBet":1,"lines":[5],"jackpot":true,"mainFakeReels":[[6,1,1,1,4,0,0,0,4,5,8,2,2,2,3,3,3,5,2,2,2,5,8,2,2,2,7,1,1,1],[7,0,0,0,8,2,2,2,3,3,3,7,5,1,1,1,0,0,0,2,2,2,4,8,6,5,2,2,2,5],[0,0,0,2,2,2,1,1,1,6,4,0,0,0,6,7,3,3,3,5,1,1,1,5,7,2,2,2,5,8],[0,0,0,2,2,2,1,1,1,6,4,0,0,0,6,7,3,3,3,5,1,1,1,5,7,2,2,2,5,8]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $_obf_0D0C2105130819393F29112D311A15170F3C2913160B01) . ']},"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                    break;
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('Dice81EGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                    ...
                    if( $lastEvent != 'NULL' ) 
                    {
                        ...
                        $_obf_0D3E331C040E390B031B03100422040311293E023E0322 = '' . rand(1, 8) . ',' . $reels->reel1[0] . ',' . $reels->reel1[1] . ',' . $reels->reel1[2] . ',' . rand(1, 8);
                        $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(1, 8) . ',' . $reels->reel2[0] . ',' . $reels->reel2[1] . ',' . $reels->reel2[2] . ',' . rand(1, 8));
                        $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(1, 8) . ',' . $reels->reel3[0] . ',' . $reels->reel3[1] . ',' . $reels->reel3[2] . ',' . rand(1, 8));
                        $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(1, 8) . ',' . $reels->reel4[0] . ',' . $reels->reel4[1] . ',' . $reels->reel4[2] . ',' . rand(1, 8));
                ...
                case 'bet':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                            ...
                            else
                            {
                                ...
                                for( $r = 1; $r <= 4; $r++ ) 
                                {
                                    for( $s = 0; $s <= 2; $s++ ) 
                                    {
                                        ...
                                        if( $reels['reel' . $r][$s] == $wild ) 
                                        {
                                            ...
                                            if( $_obf_0D1C22330730162F271D22262B090A1937323736093F01 == 1 ) 
                                            {
                                                $_obf_0D0D2B0330121904261537292A32120D2E372A24263032 = 2;
                                            }
                                            if( $_obf_0D1C22330730162F271D22262B090A1937323736093F01 == 2 ) 
                                            {
                                                $_obf_0D0D2B0330121904261537292A32120D2E372A24263032 = 4;
                                            }
                                            if( $_obf_0D1C22330730162F271D22262B090A1937323736093F01 >= 3 ) 
                                            {
                                                $_obf_0D0D2B0330121904261537292A32120D2E372A24263032 = 8;
                                            }
                                        }
                                    }
                                }
                                if( $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[0] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[1] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[2] > 0 ) 
                                {
                                    ...
                                    if( $_obf_0D37111B3335140203262E17350902171D182F5B312522 < $_obf_0D1A08361C315C0F302C102A0D011D1F041B0637020C11 ) 
                                    {
                                        ...
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . ',"len":3,"multipliersWinInfo":[{"count":' . $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 . ',"winPerCount":' . ($slotSettings->Paytable['SYM_' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][3] * $betline * 100) . ',"multiplier":' . $_obf_0D0D2B0330121904261537292A32120D2E372A24263032 . '}],"count":' . $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 . ',"winPerCount":' . ($_obf_0D2312103E1E3F2B0A2724252D2916031F2E18100A2222 * 100) . ',"multiplier":1,"winAmount":' . ($_obf_0D37111B3335140203262E17350902171D182F5B312522 * 100) . ',"cells":[' . implode(',', $_obf_0D1F0B292F242B2516303F2D3C2C5C2205250F2C320F11) . ']}';
                                    }
                                }
                                if( $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[0] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[1] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[2] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[3] > 0 ) 
                                {
                                    ...
                                    {
                                        $_obf_0D37111B3335140203262E17350902171D182F5B312522 = $_obf_0D1A08361C315C0F302C102A0D011D1F041B0637020C11;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . ',"len":4,"multipliersWinInfo":[{"count":' . $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 . ',"winPerCount":' . ($slotSettings->Paytable['SYM_' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][4] * $betline * 100) . ',"multiplier":' . $_obf_0D0D2B0330121904261537292A32120D2E372A24263032 . '}],"count":' . $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 . ',"winPerCount":' . ($_obf_0D2312103E1E3F2B0A2724252D2916031F2E18100A2222 * 100) . ',"multiplier":1,"winAmount":' . ($_obf_0D37111B3335140203262E17350902171D182F5B312522 * 100) . ',"cells":[' . implode(',', $_obf_0D1F0B292F242B2516303F2D3C2C5C2205250F2C320F11) . ']}';
                                    }
                                }
                        ...
                        for( $r = 1; $r <= 4; $r++ ) 
                        {
                            ...
                            {
                                if( $reels['reel' . $r][$_obf_0D31403C0837332A1A1711312A3415151610280F122122] == '9' ) 
                                {
                                    $scattersCount++;
                        ...
                        if( $scattersWin > 0 ) 
                        {
                            ...
                            $scattersStr = '{"scatterName":9,"cells":[' . implode(',', $_obf_0D2A350433382703193E3D095B5C3B160A253E01191622) . '],"winAmount":' . ($scattersWin * 100) . ',"freespins":0}';
                        }
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('Dice81EGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('Dice81EGTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('Dice81EGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"Jackpots":' . $_obf_0D28393910101E062539311B3F371C121912162B061E32 . ',"reelsSymbols":' . $_obf_0D273522403840350F0A36072E150A0524143F382C3B32 . '}}';
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('Dice81EGTCards');
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 = '' . rand(1, 8) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(1, 8);
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(1, 8) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(1, 8));
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(1, 8) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(1, 8));
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(1, 8) . ',' . $reels['reel4'][0] . ',' . $reels['reel4'][1] . ',' . $reels['reel4'][2] . ',' . rand(1, 8));
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('Dice81EGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('Dice81EGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('Dice81EGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('Dice81EGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[$_obf_0D11320C0D2404193303071F0D1F011915251140013D22] == 3 ) 
                    {
                        ...
                        $slotSettings->SetBank((isset($_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent']) ? $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] : ''), -1 * $slotSettings->slotJackpot[$_obf_0D11320C0D2404193303071F0D1F011915251140013D22]);
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"levelI":' . ($slotSettings->slotJackpot[0] * 100) . ',"levelII":' . ($slotSettings->slotJackpot[1] * 100) . ',"levelIII":' . ($slotSettings->slotJackpot[2] * 100) . ',"levelIV":' . ($slotSettings->slotJackpot[3] * 100) . ',"screenName":"","winLevel":' . $_obf_0D11320C0D2404193303071F0D1F011915251140013D22 . ',"winAmount":' . $_obf_0D2B3E3E3639015B183306132215193F083C0B30020F01 . ',"winsLevelI":0,"largestWinLevelI":0,"largestWinDateLevelI":"","largestWinUserLevelI":"","lastWinLevelI":0,"lastWinDateLevelI":"","lastWinUserLevelI":"","winsLevelII":0,"largestWinLevelII":0,"largestWinDateLevelII":"","largestWinUserLevelII":"","lastWinLevelII":0,"lastWinDateLevelII":"","lastWinUserLevelII":"","winsLevelIII":0,"largestWinLevelIII":0,"largestWinDateLevelIII":"","largestWinUserLevelIII":"","lastWinLevelIII":0,"lastWinDateLevelIII":"","lastWinUserLevelIII":"","winsLevelIV":0,"largestWinLevelIV":0,"largestWinDateLevelIV":"","largestWinUserLevelIV":"","lastWinLevelIV":0,"lastWinDateLevelIV":"","lastWinUserLevelIV":""},"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"event","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('Dice81EGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
