        ...
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType']) ) 
            {
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType'] == 'regular' ) 
                {
                    ...
                    $slotSettings->SetGameData('EasterSurprisePTMChosenTree', $_obf_0D332D0D1D1835283D2F2A3E350C0D3B3806132F092532);
                    $slotSettings->SetGameData('EasterSurprisePTMstartStick', $_obf_0D5B04291F2E1B3312272C03162513041836345B260611);
                    $slotSettings->SetGameData('EasterSurprisePTMtreeStep', $_obf_0D09345C0F041B195C25080E373113305C263C3D040B32);
                    $slotSettings->SetGameData('EasterSurprisePTMlastWins', $_obf_0D02300F1F24102B1F3F253C5B3F132323180A01232F11);
                }
                ...
                $slotSettings->SetGameData('EasterSurprisePTMAllBet', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['bet']);
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    $wild = ['0'];
                    $_obf_0D2B2C361A1519230B37081F290E3430171007181F1522 = '9';
                    $scatter = '10';
                            ...
                            else
                            {
                                ...
                                if( $s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild) ) 
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                    {
                                        ...
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('EasterSurprisePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('EasterSurprisePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('EasterSurprisePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('EasterSurprisePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('EasterSurprisePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                    }
                                }
                                if( $_obf_0D011C142C3C37263F351C4012170A074027083F321132 == '9' ) 
                                {
                                    if( $s[0] == $s[1] && $s[1] == $s[2] ) 
                                    {
                ...
                $_obf_0D34133B2D401823121A3E3C0C3B3440063B2832150332 = '"winValues":[0,0,0,0,0],"eggBonusNum":' . $eggBonusNum . ',"PickedCount":0,"PickedCountArr":[],';
                $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                ...
                if( $_obf_0D35273F2D06292431231D3C36395B12392B013B080522 ) 
                {
                    ...
                    $_obf_0D34133B2D401823121A3E3C0C3B3440063B2832150332 = '"winValues":[' . implode(',', $_obf_0D321C1F1D222C240E191D5C32245B062105292C2E0822['curValues']) . '],"eggBonusNum":' . $eggBonusNum . ',"PickedCount":0,"PickedCountArr":[],';
                    ...
                    $slotSettings->SetGameData('EasterSurprisePTMWinValues', $_obf_0D321C1F1D222C240E191D5C32245B062105292C2E0822['curValues']);
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{' . $_obf_0D34133B2D401823121A3E3C0C3B3440063B2832150332 . '"allbet":' . $slotSettings->GetGameData('EasterSurprisePTMAllBet') . ',"betLine":' . $slotSettings->GetGameData('EasterSurprisePTMBetLine') . ',"linesArr":[' . implode(',', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('EasterSurprisePTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('EasterSurprisePTMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('EasterSurprisePTMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('EasterSurprisePTMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
            ...
            {
                case '40971':
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['pickIndex'] >= 0 && $slotSettings->GetGameData('EasterSurprisePTMPickedCount') < $slotSettings->GetGameData('EasterSurprisePTMeggBonusNum') ) 
                    {
                        $_obf_0D262D0136400C3F0525143D36383F363C3514155B0711 = json_decode($slotSettings->GetGameData('EasterSurprisePTMLastResponse'));
                        $values = $slotSettings->GetGameData('EasterSurprisePTMWinValues');
                        $pick = $slotSettings->GetGameData('EasterSurprisePTMPickedCount');
                        $_obf_0D5C210631273818332424032C281E0D38310B1F0A1201 = $slotSettings->GetGameData('EasterSurprisePTMPickedCountArr');
                        $_obf_0D23292E1910310B2D0F382A090D063F2A132521111C32 = $values[$pick] * $slotSettings->GetGameData('EasterSurprisePTMBetLine');
                        ...
                        $slotSettings->SetGameData('EasterSurprisePTMPickedCountArr', $_obf_0D5C210631273818332424032C281E0D38310B1F0A1201);
                        ...
                        $slotSettings->SetGameData('EasterSurprisePTMLastResponse', json_encode($_obf_0D262D0136400C3F0525143D36383F363C3514155B0711));
                    }
                    break;
                case '31031':
                ...
                case '40066':
                    ...
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"funNoticeGames":0,"funNoticePayouts":0,"gameGroup":"eas","minBet":0,"maxBet":0,"minPosBet":0,"maxPosBet":50000,"coinSizes":[' . implode(',', $_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11) . ']},"ID":40025,"umid":21}';
                    break;
                case '40036':
