        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 ) 
            {
                ...
                case 'poll':
                    ...
                    {
                        $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('AmericanGigoloCTTotalWin')) * 100;
                    }
                ...
                case 'game_finished':
                    $slotSettings->SetGameData('AmericanGigoloCTBonusWin', 0);
                    $slotSettings->SetGameData('AmericanGigoloCTTotalWin', 0);
                    $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('AmericanGigoloCTCurrentFreeGame0');
                ...
                case 'subgame_finished':
                    if( $slotSettings->GetGameData('AmericanGigoloCTCurrentFreeGame0') < $slotSettings->GetGameData('AmericanGigoloCTFreeGames') && $slotSettings->GetGameData('AmericanGigoloCTFreeGames') > 0 ) 
                    {
                        ...
                        $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('AmericanGigoloCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AmericanGigoloCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('AmericanGigoloCTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('AmericanGigoloCTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('AmericanGigoloCTBonusWin') . ',"totalWin":' . $_obf_0D23292E1910310B2D0F382A090D063F2A132521111C32 . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                        ...
                        $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = $slotSettings->GetGameData('AmericanGigoloCTFreeBalance');
                        ...
                        $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('AmericanGigoloCTCurrentFreeGame0');
                        $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('AmericanGigoloCTCurrentFreeGame0');
                ...
                case 'play':
                    ...
                    for( $_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32 = 0; $_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32 < $_obf_0D3B2A04131D2F18191C37340F3E1F161B362122233C01; $_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32++ ) 
                    {
                        ...
                        $_obf_0D21152412095C03222D3808130C3C012907290C181E22 = $slotSettings->GetGameData('AmericanGigoloCTCards');
                        if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                        {
                            $state = 'freespin';
                        ...
                        $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['play'][0]['result'][$_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32]['total_win'] = $slotSettings->GetGameData('AmericanGigoloCTTotalWin') / $denom;
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"result":' . json_encode($_obf_0D34321010172C292A1A09211E38143C3D083803231B01['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('AmericanGigoloCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AmericanGigoloCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('AmericanGigoloCTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                ...
                case 'gamble':
                    ...
                    $slotSettings->SetGameData('AmericanGigoloCTCards', $_obf_0D21152412095C03222D3808130C3C012907290C181E22);
