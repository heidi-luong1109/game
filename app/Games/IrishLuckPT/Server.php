        ...
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['index']) ) 
            {
                ...
                if( $slotSettings->GetGameData('IrishLuckPTBonusStep') == 0 ) 
                {
                    ...
                    $slotSettings->SetGameData('IrishLuckPTBonusOpt', $_obf_0D1D03322B341A3E1C5B123F3E3F320821050D251C1611);
                    ...
                    {
                        $slotSettings->SetGameData('IrishLuckPTFreeGames', $slotSettings->GetGameData('IrishLuckPTFreeGames') + ($_obf_0D142C241F1B181D2723252601234035375B141A063811 / 100));
                    }
                    else
                    {
                        $slotSettings->SetGameData('IrishLuckPTFreeMpl', $slotSettings->GetGameData('IrishLuckPTFreeMpl') + $_obf_0D142C241F1B181D2723252601234035375B141A063811);
                    }
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"prizes":[' . $_obf_0D142C241F1B181D2723252601234035375B141A063811 . '],"windowId":"2Hjr3k"},"ID":40251,"umid":474}';
                    $slotSettings->SetGameData('IrishLuckPTBonusStep', 1);
                }
                else if( $slotSettings->GetGameData('IrishLuckPTBonusStep') == 1 ) 
                {
                    $_obf_0D1D03322B341A3E1C5B123F3E3F320821050D251C1611 = $slotSettings->GetGameData('IrishLuckPTBonusOpt');
                    $_obf_0D142C241F1B181D2723252601234035375B141A063811 = $_obf_0D1D03322B341A3E1C5B123F3E3F320821050D251C1611[$_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['index']];
                    if( $_obf_0D142C241F1B181D2723252601234035375B141A063811 > 10 ) 
                    {
                        $slotSettings->SetGameData('IrishLuckPTFreeGames', $slotSettings->GetGameData('IrishLuckPTFreeGames') + ($_obf_0D142C241F1B181D2723252601234035375B141A063811 / 100));
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType']) ) 
            {
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"linesArr":[' . implode(',', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('IrishLuckPTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('IrishLuckPTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('IrishLuckPTBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('IrishLuckPTFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('IrishLuckPTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
