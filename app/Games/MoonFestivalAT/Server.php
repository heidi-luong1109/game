...
*/            $response = '';
            ...
            if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'gameInit' ) 
            {
                ...
                if( $lastEvent != 'NULL' ) 
                {
                    ...
                    $_obf_0D312C0D14273F0410351D402740232540165B060B2332 = $slotSettings->GetGameData('MoonFestivalATholdWildsStr');
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'bet' || $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        $_obf_0D312C0D14273F0410351D402740232540165B060B2332 = $slotSettings->GetGameData('MoonFestivalATholdWildsArr');
                        if( !is_array($_obf_0D312C0D14273F0410351D402740232540165B060B2332) ) 
                        {
                            $_obf_0D312C0D14273F0410351D402740232540165B060B2332 = [];
                        }
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                {
                    $slotSettings->SetGameData('MoonFestivalATholdWildsArr', $_obf_0D1F3632381B1B130E3F38121B400F2E16251C250D2501);
                    $slotSettings->SetGameData('MoonFestivalATholdWildsStr', $_obf_0D1F311D150B1108362F05193E350A0C1B061516160D11);
                    ...
                    $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('MoonFestivalATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('MoonFestivalATMpl') . ',"add":0,"total":' . $slotSettings->GetGameData('MoonFestivalATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('MoonFestivalATBonusWin') * 100) . ',"wilds":[' . implode(',', $_obf_0D1F311D150B1108362F05193E350A0C1B061516160D11) . ']';
                }
                else
                {
                    $slotSettings->SetGameData('MoonFestivalATTotalWin', $totalWin);
                ...
                if( $scattersCount >= 3 ) 
                {
                    if( $slotSettings->GetGameData('MoonFestivalATFreeGames') > 0 ) 
                    {
                        ...
                        $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('MoonFestivalATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('MoonFestivalATMpl') . ',"add":' . $slotSettings->slotFreeCount . ',"total":' . $slotSettings->GetGameData('MoonFestivalATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('MoonFestivalATBonusWin') * 100) . ',"wilds":[' . implode(',', $_obf_0D1F311D150B1108362F05193E350A0C1B061516160D11) . ']';
                    }
                    else
                    {
