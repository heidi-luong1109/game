    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'gamble5GetUserCards' ) 
            {
                ...
                $_obf_0D25035C31183316381216122811401A1F2A17243E2B22 = $slotSettings->GetGameData('QueenOfHeartsDealerCard');
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'gamble5GetDealerCard' ) 
            {
                ...
                $slotSettings->SetGameData('QueenOfHeartsDealerCard', $_obf_0D1A28330223330201021115084008123B0F213C102922);
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'bet' || $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    $_obf_0D272C08072B051D3C270A3D27390E22361009110F2711 = [];
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                    {
                        for( $row = 0; $row < 5; $row++ ) 
                        {
                            $_obf_0D1329291509050821340D1D13373C011E5C0102142822 = rand(1, 5);
                            if( $_obf_0D1329291509050821340D1D13373C011E5C0102142822 == 1 ) 
                            {
                                $_obf_0D345B111230192C392A171C0C01403825031629271501 = [
                                    0, 
                                    1, 
                                    2, 
                                    -1, 
                                ...
                                $_obf_0D3B40102D1A053619392F332E3C10302C3B1E13151E01 = [
                                    0, 
                                    1, 
                                    2
                                ];
                                shuffle($_obf_0D3B40102D1A053619392F332E3C10302C3B1E13151E01);
                                shuffle($_obf_0D345B111230192C392A171C0C01403825031629271501);
                                for( $_obf_0D285B1D2625251E16232D190140011B0E2F130F082132 = 0; $_obf_0D285B1D2625251E16232D190140011B0E2F130F082132 <= $_obf_0D345B111230192C392A171C0C01403825031629271501[0]; $_obf_0D285B1D2625251E16232D190140011B0E2F130F082132++ ) 
                                {
                                    $_obf_0D0C353C231930293E1C32222A282208283E03311D0C01['reel' . ($row + 1)][$_obf_0D3B40102D1A053619392F332E3C10302C3B1E13151E01[$_obf_0D285B1D2625251E16232D190140011B0E2F130F082132]] = $wild;
                                    $_obf_0D272C08072B051D3C270A3D27390E22361009110F2711[] = [
                                        $row, 
                                        $_obf_0D3B40102D1A053619392F332E3C10302C3B1E13151E01[$_obf_0D285B1D2625251E16232D190140011B0E2F130F082132]
                                    ];
                                }
                            }
                        }
                    ...
                    for( $k = 0; $k < $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines']; $k++ ) 
                    {
                        ...
                        for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                        {
                            ...
                            {
                                $s = [];
                                $s[0] = $_obf_0D0C353C231930293E1C32222A282208283E03311D0C01['reel1'][$linesId[$k][0] - 1];
                                $s[1] = $_obf_0D0C353C231930293E1C32222A282208283E03311D0C01['reel2'][$linesId[$k][1] - 1];
                                $s[2] = $_obf_0D0C353C231930293E1C32222A282208283E03311D0C01['reel3'][$linesId[$k][2] - 1];
                                $s[3] = $_obf_0D0C353C231930293E1C32222A282208283E03311D0C01['reel4'][$linesId[$k][3] - 1];
                                $s[4] = $_obf_0D0C353C231930293E1C32222A282208283E03311D0C01['reel5'][$linesId[$k][4] - 1];
                                if( $s[0] == $wild ) 
                                {
                                    $mpl = 1;
                                    $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 = $slotSettings->Paytable[$wild][1] * $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet'] * $mpl * $bonusMpl;
                                    if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                    {
                                        ...
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('QueenOfHeartsBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[0] == $wild) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[1] == $wild) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('QueenOfHeartsBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[0] == $wild) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[1] == $wild) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[2] == $wild) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('QueenOfHeartsBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[0] == $wild) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[1] == $wild) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[2] == $wild) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[3] == $wild) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('QueenOfHeartsBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[0] == $wild) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[1] == $wild) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[2] == $wild) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[3] == $wild) && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || $s[4] == $wild) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('QueenOfHeartsBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                    }
                                }
                            }
                        }
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && $slotSettings->GetGameData('QueenOfHeartsFreeGames') <= $slotSettings->GetGameData('QueenOfHeartsCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('QueenOfHeartsTotalWin') + $totalWin > 0 ) 
                {
                ...
                if( count($_obf_0D272C08072B051D3C270A3D27390E22361009110F2711) ) 
                {
                    $_obf_0D181A1C2529162927373D243F17391636040508281211 = '"flyObj":' . json_encode($_obf_0D272C08072B051D3C270A3D27390E22361009110F2711) . ',';
                }
                else
                {
                    $_obf_0D181A1C2529162927373D243F17391636040508281211 = '';
                }
                $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 = implode(',', $lineWins);
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"slotLines":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines'] . ',"slotBet":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet'] . ',' . $_obf_0D181A1C2529162927373D243F17391636040508281211 . '"totalFreeGames":' . $slotSettings->GetGameData('QueenOfHeartsFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('QueenOfHeartsCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
