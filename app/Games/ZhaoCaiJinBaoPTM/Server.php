            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType']) ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    for( $k = 0; $k < $lines; $k++ ) 
                    {
                            ...
                            else
                            {
                                ...
                                if( $s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22) ) 
                                {
                                    ...
                                    if( $_obf_0D1F171A1F35063716213837072F111B1E0D042E1B1A11[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                    {
                                        ...
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":1,"Line":' . $k . ',"Win":' . $_obf_0D1F171A1F35063716213837072F111B1E0D042E1B1A11[$k] . ',"stepWin":' . ($_obf_0D1F171A1F35063716213837072F111B1E0D042E1B1A11[$k] + $totalWin + $slotSettings->GetGameData('ZhaoCaiJinBaoPTMMBonusWin')) . ',"winReel1":[' . ($_obf_0D1F0E07322B28015B3101401931191F0119352A1D0901[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                ...
                                {
                                    $_obf_0D1016073B15193E060D2D0C262328020129171D232A32 = 1;
                                    $_obf_0D1A321903103534161A3E082D09312C212C19262C2822 = $slotSettings->Paytable['SYM_' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132][1] * $_obf_0D3B5B082B1F0F0235292F01260B303B0F2E32313B0832 * $_obf_0D1016073B15193E060D2D0C262328020129171D232A32 * $_obf_0D3E1E10392C18192A17311514325C2E132A29390E2E22;
                                ...
                                if( ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22)) && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22)) ) 
                                {
                                    $_obf_0D1016073B15193E060D2D0C262328020129171D232A32 = 1;
                                    ...
                                    else if( in_array($s[3], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22) || in_array($s[4], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22) ) 
                                    {
                                        $_obf_0D1016073B15193E060D2D0C262328020129171D232A32 = $slotSettings->slotWildMpl;
                                    }
                                    $_obf_0D1A321903103534161A3E082D09312C212C19262C2822 = $slotSettings->Paytable['SYM_' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132][2] * $_obf_0D3B5B082B1F0F0235292F01260B303B0F2E32313B0832 * $_obf_0D1016073B15193E060D2D0C262328020129171D232A32 * $_obf_0D3E1E10392C18192A17311514325C2E132A29390E2E22;
                                    if( $_obf_0D1F3921401608132D25080B0D0B32143213093B3E3011[$k] < $_obf_0D1A321903103534161A3E082D09312C212C19262C2822 ) 
                                    {
                                        $_obf_0D1F3921401608132D25080B0D0B32143213093B3E3011[$k] = $_obf_0D1A321903103534161A3E082D09312C212C19262C2822;
                                        $_obf_0D11160A241933040412293F080D15240E1B3D03353B32 = '{"Count":2,"Line":' . $k . ',"Win":' . $_obf_0D1F171A1F35063716213837072F111B1E0D042E1B1A11[$k] . ',"stepWin":' . ($_obf_0D1F171A1F35063716213837072F111B1E0D042E1B1A11[$k] + $totalWin + $slotSettings->GetGameData('ZhaoCaiJinBaoPTMMBonusWin')) . ',"winReel1":[' . ($_obf_0D1F0E07322B28015B3101401931191F0119352A1D0901[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($_obf_0D1F0E07322B28015B3101401931191F0119352A1D0901[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                ...
                                if( ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22)) && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22)) ) 
                                {
                                    $_obf_0D1016073B15193E060D2D0C262328020129171D232A32 = 1;
                                    if( in_array($s[2], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22) && in_array($s[3], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22) && in_array($s[4], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22) ) 
                                    {
                                        $_obf_0D1016073B15193E060D2D0C262328020129171D232A32 = 1;
                                    }
                                    else if( in_array($s[2], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22) || in_array($s[3], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22) || in_array($s[4], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22) ) 
                                    {
                                        $_obf_0D1016073B15193E060D2D0C262328020129171D232A32 = $slotSettings->slotWildMpl;
                                    }
                                    $_obf_0D1A321903103534161A3E082D09312C212C19262C2822 = $slotSettings->Paytable['SYM_' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132][3] * $_obf_0D3B5B082B1F0F0235292F01260B303B0F2E32313B0832 * $_obf_0D1016073B15193E060D2D0C262328020129171D232A32 * $_obf_0D3E1E10392C18192A17311514325C2E132A29390E2E22;
                                    if( $_obf_0D1F3921401608132D25080B0D0B32143213093B3E3011[$k] < $_obf_0D1A321903103534161A3E082D09312C212C19262C2822 ) 
                                    {
                                        $_obf_0D1F3921401608132D25080B0D0B32143213093B3E3011[$k] = $_obf_0D1A321903103534161A3E082D09312C212C19262C2822;
                                        $_obf_0D11160A241933040412293F080D15240E1B3D03353B32 = '{"Count":3,"Line":' . $k . ',"Win":' . $_obf_0D1F171A1F35063716213837072F111B1E0D042E1B1A11[$k] . ',"stepWin":' . ($_obf_0D1F171A1F35063716213837072F111B1E0D042E1B1A11[$k] + $totalWin + $slotSettings->GetGameData('ZhaoCaiJinBaoPTMMBonusWin')) . ',"winReel1":[' . ($_obf_0D1F0E07322B28015B3101401931191F0119352A1D0901[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($_obf_0D1F0E07322B28015B3101401931191F0119352A1D0901[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($_obf_0D1F0E07322B28015B3101401931191F0119352A1D0901[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                ...
                                {
                                    $_obf_0D1016073B15193E060D2D0C262328020129171D232A32 = 1;
                                    if( in_array($s[1], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22) && in_array($s[2], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22) && in_array($s[3], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22) && in_array($s[4], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22) ) 
                                    {
                                        $_obf_0D1016073B15193E060D2D0C262328020129171D232A32 = 1;
                                    }
                                    else if( in_array($s[1], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22) || in_array($s[2], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22) || in_array($s[3], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22) || in_array($s[4], $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22) ) 
                                    {
                                        $_obf_0D1016073B15193E060D2D0C262328020129171D232A32 = $slotSettings->slotWildMpl;
                                    }
                                    $_obf_0D1A321903103534161A3E082D09312C212C19262C2822 = $slotSettings->Paytable['SYM_' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132][4] * $_obf_0D3B5B082B1F0F0235292F01260B303B0F2E32313B0832 * $_obf_0D1016073B15193E060D2D0C262328020129171D232A32 * $_obf_0D3E1E10392C18192A17311514325C2E132A29390E2E22;
                                    if( $_obf_0D1F3921401608132D25080B0D0B32143213093B3E3011[$k] < $_obf_0D1A321903103534161A3E082D09312C212C19262C2822 ) 
                                    {
                                        $_obf_0D1F3921401608132D25080B0D0B32143213093B3E3011[$k] = $_obf_0D1A321903103534161A3E082D09312C212C19262C2822;
                                        $_obf_0D11160A241933040412293F080D15240E1B3D03353B32 = '{"Count":4,"Line":' . $k . ',"Win":' . $_obf_0D1F171A1F35063716213837072F111B1E0D042E1B1A11[$k] . ',"stepWin":' . ($_obf_0D1F171A1F35063716213837072F111B1E0D042E1B1A11[$k] + $totalWin + $slotSettings->GetGameData('ZhaoCaiJinBaoPTMMBonusWin')) . ',"winReel1":[' . ($_obf_0D1F0E07322B28015B3101401931191F0119352A1D0901[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($_obf_0D1F0E07322B28015B3101401931191F0119352A1D0901[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($_obf_0D1F0E07322B28015B3101401931191F0119352A1D0901[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($_obf_0D1F0E07322B28015B3101401931191F0119352A1D0901[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                        ...
                        {
                            array_push($_obf_0D181C103526150D021B2C0E1A1F211F3F3E2A15363632, $_obf_0D11160A241933040412293F080D15240E1B3D03353B32);
                    ...
                    for( $r = 1; $r <= 5; $r++ ) 
                    {
                        ...
                        for( $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 = 0; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 <= 3; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32++ ) 
                        {
                            ...
                            if( $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] == '0' ) 
                            {
                    ...
                    $_obf_0D10342528350D243D16293C2835061F263C1C39042811 = $slotSettings->Paytable['SYM_' . $_obf_0D2B2F2802280E223138132C0B310F3C0A2D3328275C22][$_obf_0D0B230B342E0C0727115B043F283E2137182D312A3D11] * $_obf_0D3B5B082B1F0F0235292F01260B303B0F2E32313B0832 * $lines * $_obf_0D311C121D140F1B04183622382830052F121413213611;
                ...
                $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"credit":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"results":[' . implode(',', $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['rp']) . '],"windowId":"Adbmao"},"ID":40022,"umid":35}';
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"deltaBalanceInCents":1},"ID":40085}';
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"linesArr":[' . implode(',', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $_obf_0D3B5B082B1F0F0235292F01260B303B0F2E32313B0832 . ',"totalFreeGames":' . $slotSettings->GetGameData('ZhaoCaiJinBaoPTMMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('ZhaoCaiJinBaoPTMMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('ZhaoCaiJinBaoPTMMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('ZhaoCaiJinBaoPTMMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $_obf_0D033835123E051D331E010A3C300C332C34021F052801 . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
