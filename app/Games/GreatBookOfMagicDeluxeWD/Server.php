            ...
            switch( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['act'] ) 
            {
                ...
                case 'WXMNPP7H8F':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $_obf_0D2B2F2802280E223138132C0B310F3C0A2D3328275C22 = '10';
                        ...
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            ...
                            for( $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 = 0; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 <= 2; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32++ ) 
                            {
                                if( $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] == $_obf_0D2E030A3D363C3609223E2A38340211061A0C3C1F2511 ) 
                                {
                                    $_obf_0D2A1335372C0233305B350D0434101F2A2B170D072522++;
                                    break;
                                }
                            }
                        }
                        ...
                        if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                        {
                            $_obf_0D2B28260915392535401B1E0E0F131108072321262C11 = $slotSettings->Paytable['SYM_' . $_obf_0D2E030A3D363C3609223E2A38340211061A0C3C1F2511][$_obf_0D2A1335372C0233305B350D0434101F2A2B170D072522] * $_obf_0D3B5B082B1F0F0235292F01260B303B0F2E32313B0832 * $lines;
                        }
