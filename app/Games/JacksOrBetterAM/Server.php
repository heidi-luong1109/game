            ...
            switch( $gameData['slotEvent'] ) 
            {
                ...
                case 'A/u253':
                    ...
                    if( $lastEvent != 'NULL' ) 
                    {
                        ...
                        $_obf_0D061C162B391B0A23183D303C3C3F251F341D021D1022 = $slotSettings->GetGameData('JacksOrBetterAMCurrentCards');
                    }
                    else
                    {
                        $_obf_0D403B31280D2A01051A033840271D0236293E2E091601 = $slotSettings->GetGameData('JacksOrBetterAMCurrentCards');
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $totalWin = $_obf_0D3E291C370537291F350C5C0E070E3403290801034001[0] * $slotSettings->GetGameData('JacksOrBetterAMBet');
                        if( $totalWin <= $bank ) 
                        {
                            break;
                        }
                    ...
                    $slotSettings->SetGameData('JacksOrBetterAMCollect', $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22);
                ...
                case 'A/u257':
                    $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                    $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22 = $slotSettings->GetGameData('JacksOrBetterAMCollect');
                    $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01));
                ...
                case 'A/u251':
                    ...
                    $slotSettings->SetGameData('JacksOrBetterAMCurrentCards', $_obf_0D3933282D2F3207131E01322E3D2A243306341C300F01);
                ...
                case 'A/u2514':
                    ...
                    $slotSettings->SetGameData('JacksOrBetterAMDealerCard', $_obf_0D100B2E300B08312605022B1D192108061414050A4022);
                    $slotSettings->SetGameData('JacksOrBetterAMDealerCardS', $_obf_0D25035C31183316381216122811401A1F2A17243E2B22);
                    break;
                case 'A/u2515':
                    $balanceFormated = $slotSettings->GetGameData('JacksOrBetterAMbalanceFormated');
                    $cardsID = [];
                ...
                case 'A/u2513':
                    ...
                    $_obf_0D0E141F34210C271834013D060623402816092A400E11 = $slotSettings->GetGameData('JacksOrBetterAMTotalWin');
                    ...
                    {
                        $_obf_0D373202210A393C1A2E39210B383D283D05051C3E1001 = rand($slotSettings->GetGameData('JacksOrBetterAMDealerCard'), 14);
                    }
                    else
                    {
                        $_obf_0D373202210A393C1A2E39210B383D283D05051C3E1001 = rand(2, $slotSettings->GetGameData('JacksOrBetterAMDealerCard'));
                    }
                    if( $slotSettings->GetGameData('JacksOrBetterAMDealerCard') == $_obf_0D373202210A393C1A2E39210B383D283D05051C3E1001 ) 
                    {
                        $totalWin = $_obf_0D0E141F34210C271834013D060623402816092A400E11;
                    }
                    else if( $slotSettings->GetGameData('JacksOrBetterAMDealerCard') < $_obf_0D373202210A393C1A2E39210B383D283D05051C3E1001 ) 
                    {
                    ...
                    $response = '10d010' . $balanceFormated . $slotSettings->HexFormat(round($totalWin * 100)) . '10001a33e810' . $slotSettings->GetGameData('JacksOrBetterAMDealerCardS') . $_obf_0D2B31081230130F113539313C272632073F153E0C0432 . '0000001723c1d23b21b10101023b21b020100000' . $_obf_0D132F5B3B05282630012921082440063E1F1B22351A11 . $slotSettings->GetGameData('JacksOrBetterAMDealerCardS') . '#' . $_obf_0D373202210A393C1A2E39210B383D283D05051C3E1001 . '|' . $slotSettings->GetGameData('JacksOrBetterAMDealerCardS');
                    if( $totalWin <= 0 ) 
                    {
                    ...
                    $slotSettings->SaveLogReport($_obf_0D2D350C1338352E3F0236115C1407341C0926053F2211, $slotSettings->GetGameData('JacksOrBetterAMBet'), 1, $totalWin, 'double');
                    break;
            }
