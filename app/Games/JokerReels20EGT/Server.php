        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'settings':
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"paytableCoef":{"0":{"coef":[8,35,100],"multiplier":1},"1":{"coef":[8,35,100],"multiplier":1},"2":{"coef":[8,35,100],"multiplier":1},"3":{"coef":[8,35,100],"multiplier":1},"4":{"coef":[10,60,200],"multiplier":1},"5":{"coef":[10,60,200],"multiplier":1},"6":{"coef":[30,100,300],"multiplier":1},"7":{"coef":[4,40,100,1000],"multiplier":1},"8":{"coef":[],"multiplier":1},"9":{"coef":[3,20,500],"multiplier":1}},"bets":[' . implode(',', $_obf_0D131333153E3B3F113536290D1D1A025B0D3F16341932) . '],"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[6,6,6,1,1,0,0,0,3,3,4,4,4,2,2,2,7,5,5,5],[6,6,0,0,2,3,7,3,3,9,1,7,4,4,2,2,2,5,5,5],[6,6,2,2,9,7,6,3,3,4,4,4,7,9,0,0,5,5,1,1],[6,6,8,8,7,3,3,5,5,9,4,4,7,1,1,2,2,0,0,0],[6,6,6,5,5,5,0,0,3,3,9,4,4,2,2,2,7,1,1,1]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $_obf_0D0C2105130819393F29112D311A15170F3C2913160B01) . ']},"gameIdentificationNumber":554,"gameNumber":"","sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                    break;
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('JokerReels20EGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'bet':
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('JokerReels20EGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('JokerReels20EGTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('JokerReels20EGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"Jackpots":' . $_obf_0D28393910101E062539311B3F371C121912162B061E32 . ',"reelsSymbols":' . $_obf_0D273522403840350F0A36072E150A0524143F382C3B32 . '}}';
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('JokerReels20EGTCards');
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 = '' . rand(1, 8) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(1, 8);
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(1, 8) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(1, 8));
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(1, 8) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(1, 8));
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(1, 8) . ',' . $reels['reel4'][0] . ',' . $reels['reel4'][1] . ',' . $reels['reel4'][2] . ',' . rand(1, 8));
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('JokerReels20EGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('JokerReels20EGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('JokerReels20EGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('JokerReels20EGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('JokerReels20EGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('JokerReels20EGTGambleStep') . ',"card":' . $_obf_0D040B162710402D331E2209370C14231F2C252B172601 . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $_obf_0D1C0D102A3D1F22280124351A230D33190A15123B2522 . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":554,"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    break;
            }
