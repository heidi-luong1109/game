...
namespace VanguardLTE\Games\OceanRushEGT
{
    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['command'] == 'bet' && $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['bet']['gameCommand'] == 'choice' ) 
            {
                $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['command'] = 'choice';
            }
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                case 'bonuschoice':
                    ...
                    $_obf_0D2A011415400237290F232D0C0D3C1C0238370F231401 = $slotSettings->GetGameData('OceanRushEGTChoiceWinAmount');
                    $_obf_0D071B212611040A1736371C140F1C5B1A31143B3F1A32 = $slotSettings->GetGameData('OceanRushEGTChoiceCount');
                    $_obf_0D3C020D05193B1C40132714172E061D08263D36263522 = $_obf_0D2A011415400237290F232D0C0D3C1C0238370F231401[2];
                    shuffle($_obf_0D3C020D05193B1C40132714172E061D08263D36263522);
                    $_obf_0D06053C171007163C2B110C17381E1C2C2A2215040822 = [
                        '{"coef":' . $_obf_0D3C020D05193B1C40132714172E061D08263D36263522[0] . ',"bonus":false,"totalWin":' . ($_obf_0D3C020D05193B1C40132714172E061D08263D36263522[0] * $allbet * 100) . '}', 
                        '{"coef":' . $_obf_0D3C020D05193B1C40132714172E061D08263D36263522[1] . ',"bonus":false,"totalWin":' . ($_obf_0D3C020D05193B1C40132714172E061D08263D36263522[1] * $allbet * 100) . '}', 
                        '{"coef":' . $_obf_0D3C020D05193B1C40132714172E061D08263D36263522[2] . ',"bonus":false,"totalWin":' . ($_obf_0D3C020D05193B1C40132714172E061D08263D36263522[2] * $allbet * 100) . '}'
                    ];
                    if( $_obf_0D071B212611040A1736371C140F1C5B1A31143B3F1A32 >= 4 ) 
                    {
                        $_obf_0D06053C171007163C2B110C17381E1C2C2A2215040822[] = '{"coef":' . $_obf_0D3C020D05193B1C40132714172E061D08263D36263522[3] . ',"bonus":false,"totalWin":' . ($_obf_0D3C020D05193B1C40132714172E061D08263D36263522[3] * $allbet * 100) . '}';
                    }
                    if( $_obf_0D071B212611040A1736371C140F1C5B1A31143B3F1A32 >= 5 ) 
                    {
                        $_obf_0D06053C171007163C2B110C17381E1C2C2A2215040822[] = '{"coef":' . $_obf_0D3C020D05193B1C40132714172E061D08263D36263522[4] . ',"bonus":false,"totalWin":' . ($_obf_0D3C020D05193B1C40132714172E061D08263D36263522[4] * $allbet * 100) . '}';
                    }
                    $_obf_0D06053C171007163C2B110C17381E1C2C2A2215040822[$choice] = '{"coef":' . $_obf_0D2A011415400237290F232D0C0D3C1C0238370F231401[0] . ',"bonus":true,"totalWin":' . ($_obf_0D2A011415400237290F232D0C0D3C1C0238370F231401[0] * $allbet * 100) . '}';
                    $slotSettings->SetGameData('OceanRushEGTBonusStart', 2);
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"bonuschoiceObject":{"selectedIndex":' . $choice . ',"totalBet":' . ($allbet * 100) . ',"options":[' . implode(',', $_obf_0D06053C171007163C2B110C17381E1C2C2A2215040822) . ']},"freespins":0,"multiplier":1,"choices":0,"gambles":0,"gameCommand":"bonuschoice"},"state":"choice","winAmount":' . (($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') + $_obf_0D2A011415400237290F232D0C0D3C1C0238370F231401[1]) * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":1800675758589,"sessionKey":"f03017b9a27ddd27b5214d6a063b9ab3","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":1569874127218}';
                    break;
                case 'choice':
                    ...
                    $_obf_0D3E2A21032136092235272A2C3D1C0340223B163F0C11 = $slotSettings->GetGameData('OceanRushEGTChoiceArr');
                    $fs = $slotSettings->GetGameData('OceanRushEGTFreeGames');
                    $_obf_0D352C3B2F030A2414021C3C255C37211A3E31241E3922 = $slotSettings->GetGameData('OceanRushEGTMultiplier');
                    $choice = (int)$_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['bet']['choice'];
                    $opt = [];
                    if( !is_array($_obf_0D3E2A21032136092235272A2C3D1C0340223B163F0C11) ) 
                    {
                        $_obf_0D3E2A21032136092235272A2C3D1C0340223B163F0C11 = [];
                    }
                    $_obf_0D3E2A21032136092235272A2C3D1C0340223B163F0C11[] = $choice;
                    $_obf_0D262B143F2B3E140B0F050D371F08351338221C5B2922 = false;
                    $_obf_0D1405343F2E26210610051F181E173910185B2B043F32 = [
                        'mpl', 
                        'fs', 
                        'fs'
                    ];
                    shuffle($_obf_0D1405343F2E26210610051F181E173910185B2B043F32);
                    $_obf_0D5B30195C320C5B21191E1C0226261E052D3C29120422 = rand(1, 5);
                    $_obf_0D1F2E39342F0F2D371835031F0A3B2C350E251D3C1732 = rand(1, 2);
                    $_obf_0D105C2811322F073E163E1B1F390D1E3D1A03323D3F22 = 'false';
                    if( $_obf_0D1405343F2E26210610051F181E173910185B2B043F32[0] == 'fs' ) 
                    {
                        $_obf_0D1F2E39342F0F2D371835031F0A3B2C350E251D3C1732 = 0;
                    }
                    else
                    {
                        $_obf_0D5B30195C320C5B21191E1C0226261E052D3C29120422 = 0;
                    }
                    if( count($_obf_0D3E2A21032136092235272A2C3D1C0340223B163F0C11) >= 3 && $slotSettings->GetGameData('OceanRushEGTFreeGames') > 0 ) 
                    {
                        $_obf_0D262B143F2B3E140B0F050D371F08351338221C5B2922 = true;
                        $_obf_0D105C2811322F073E163E1B1F390D1E3D1A03323D3F22 = 'true';
                        $slotSettings->SetGameData('OceanRushEGTBonusStart', 0);
                    }
                    $state = 'choice';
                    $_obf_0D22363F0F3C1234262F032D2D1A3F2B0C1F1F2A3D3801 = '';
                    if( $_obf_0D262B143F2B3E140B0F050D371F08351338221C5B2922 ) 
                    {
                        $state = 'freespin';
                        for( $i = 0; $i < 12; $i++ ) 
                        {
                            $_obf_0D35163328030A1F0C0D0E072532190F1209130A1E1A22 = rand(5, 10);
                            $_obf_0D130E1E32260405103E2A0438172A3B3D1428092E1201 = rand(1, 3);
                            $_obf_0D22025B1B2E1E073C1127230D28322334173B30161F11 = [
                                'false', 
                                'true'
                            ];
                            if( !in_array($i, $_obf_0D3E2A21032136092235272A2C3D1C0340223B163F0C11) ) 
                            {
                                $opt[$i] = '{"pos":' . $i . ',"multiplier":' . $_obf_0D130E1E32260405103E2A0438172A3B3D1428092E1201 . ',"freespins":' . $_obf_0D35163328030A1F0C0D0E072532190F1209130A1E1A22 . ',"mult":' . $_obf_0D130E1E32260405103E2A0438172A3B3D1428092E1201 . ',"fs":' . $_obf_0D35163328030A1F0C0D0E072532190F1209130A1E1A22 . ',"play":' . $_obf_0D22025B1B2E1E073C1127230D28322334173B30161F11[rand(0, 1)] . '}';
                            }
                        }
                        $_obf_0D22363F0F3C1234262F032D2D1A3F2B0C1F1F2A3D3801 = implode(',', $opt);
                    }
                    $slotSettings->SetGameData('OceanRushEGTChoiceArr', $_obf_0D3E2A21032136092235272A2C3D1C0340223B163F0C11);
                    $slotSettings->SetGameData('OceanRushEGTFreeGames', $fs + $_obf_0D5B30195C320C5B21191E1C0226261E052D3C29120422);
                    $slotSettings->SetGameData('OceanRushEGTMultiplier', $_obf_0D352C3B2F030A2414021C3C255C37211A3E31241E3922 + $_obf_0D1F2E39342F0F2D371835031F0A3B2C350E251D3C1732);
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"choice":{"pos":' . $choice . ',"multiplier":' . $slotSettings->GetGameData('OceanRushEGTMultiplier') . ',"freespins":' . $slotSettings->GetGameData('OceanRushEGTFreeGames') . ',"mult":' . $_obf_0D1F2E39342F0F2D371835031F0A3B2C350E251D3C1732 . ',"fs":' . $_obf_0D5B30195C320C5B21191E1C0226261E052D3C29120422 . ',"play":' . $_obf_0D105C2811322F073E163E1B1F390D1E3D1A03323D3F22 . ',"closed":[' . $_obf_0D22363F0F3C1234262F032D2D1A3F2B0C1F1F2A3D3801 . ']},"freespins":' . $slotSettings->GetGameData('OceanRushEGTFreeGames') . ',"multiplier":1,"gameCommand":"choice"},"state":"' . $state . '","winAmount":' . ($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":1789706666325,"sessionKey":"46e640104224cef8245c4329c25ef561","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":1567196976582}';
                    break;
                case 'login':
                ...
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('OceanRushEGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'bet':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $wild = ['9'];
                        $scatter = '11';
                        $_obf_0D0F03101B163816052F05402233211D2611162D305B01 = '10';
                        ...
                        $_obf_0D093C052B092D2F012A0D15120912280F3D2B25242A11 = 0;
                        if( $totalWin <= $_obf_0D3030072F273706293C133F2F072B113B383322291201 && $_obf_0D4032063326312E14292A362E1B3E0B192115063F2322 >= 3 ) 
                        {
                            if( $_obf_0D4032063326312E14292A362E1B3E0B192115063F2322 == 3 ) 
                            {
                                $_obf_0D280633021D191036213E26370F5B0436291934030D22 = [
                                    2, 
                                    3, 
                                    4, 
                                    6, 
                            ...
                            if( $_obf_0D4032063326312E14292A362E1B3E0B192115063F2322 == 4 ) 
                            {
                                $_obf_0D280633021D191036213E26370F5B0436291934030D22 = [
                                    10, 
                                    15, 
                            ...
                            if( $_obf_0D4032063326312E14292A362E1B3E0B192115063F2322 == 5 ) 
                            {
                                $_obf_0D280633021D191036213E26370F5B0436291934030D22 = [
                                    50, 
                                    80, 
                            ...
                            shuffle($_obf_0D280633021D191036213E26370F5B0436291934030D22);
                            $_obf_0D093C052B092D2F012A0D15120912280F3D2B25242A11 = $allbet * $_obf_0D280633021D191036213E26370F5B0436291934030D22[0];
                            $slotSettings->SetGameData('OceanRushEGTChoiceWinAmount', [
                                $_obf_0D280633021D191036213E26370F5B0436291934030D22[0], 
                                $_obf_0D093C052B092D2F012A0D15120912280F3D2B25242A11, 
                                $_obf_0D280633021D191036213E26370F5B0436291934030D22
                            ]);
                            $slotSettings->SetGameData('OceanRushEGTChoiceCount', $_obf_0D4032063326312E14292A362E1B3E0B192115063F2322);
                        }
                        if( $i > 1000 ) 
                        {
                            $winType = 'none';
                        ...
                        else
                        {
                            ...
                            if( ($scattersCount >= 3 || $_obf_0D4032063326312E14292A362E1B3E0B192115063F2322 >= 3) && $winType != 'bonus' ) 
                            {
                            }
                            else if( $totalWin + $_obf_0D093C052B092D2F012A0D15120912280F3D2B25242A11 <= $_obf_0D3030072F273706293C133F2F072B113B383322291201 && $winType == 'bonus' ) 
                            {
                            ...
                            else if( $totalWin > 0 && $totalWin + $_obf_0D093C052B092D2F012A0D15120912280F3D2B25242A11 <= $_obf_0D3030072F273706293C133F2F072B113B383322291201 && $winType == 'win' ) 
                            {
                                $_obf_0D195C0F2915230B5C17342A08251204342D3C1F024001 = $slotSettings->GetBank((isset($_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent']) ? $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] : ''));
                                if( $_obf_0D195C0F2915230B5C17342A08251204342D3C1F024001 < $_obf_0D3030072F273706293C133F2F072B113B383322291201 ) 
                                {
                            ...
                            else if( $totalWin + $_obf_0D093C052B092D2F012A0D15120912280F3D2B25242A11 == 0 && $winType == 'none' ) 
                            {
                                break;
                            }
                        }
                    ...
                    if( $totalWin > 0 ) 
                    {
                        $slotSettings->SetBank((isset($_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent']) ? $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] : ''), -1 * $totalWin + $_obf_0D093C052B092D2F012A0D15120912280F3D2B25242A11);
                        $slotSettings->SetBalance($totalWin + $_obf_0D093C052B092D2F012A0D15120912280F3D2B25242A11);
                    }
                    $_obf_0D0C361D2E35362209025C2317232809271D34270D3232 = $totalWin + $_obf_0D093C052B092D2F012A0D15120912280F3D2B25242A11;
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = $slotSettings->GetGameData('OceanRushEGTFreeBalance');
                    }
                    else
                    {
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"Multiplier":' . $slotSettings->GetGameData('OceanRushEGTMultiplier') . ',"FreeWild":' . $slotSettings->GetGameData('OceanRushEGTFreeWild') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('OceanRushEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('OceanRushEGTCurrentFreeGame') . ',"Balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"afterBalance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"bonusWin":' . $slotSettings->GetGameData('OceanRushEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"Jackpots":' . $_obf_0D28393910101E062539311B3F371C121912162B061E32 . ',"reelsSymbols":' . $_obf_0D273522403840350F0A36072E150A0524143F382C3B32 . '}}';
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('OceanRushEGTCards');
                    ...
                    if( $_obf_0D4032063326312E14292A362E1B3E0B192115063F2322 >= 3 ) 
                    {
                        ...
                        $slotSettings->SetGameData('OceanRushEGTBonusCnt', $_obf_0D4032063326312E14292A362E1B3E0B192115063F2322);
                        $_obf_0D1224210F3F5B0819110834131432040D0E062B260211 = ',"bonuschoiceObject": {"bonusScatterIndex": 10}';
                    }
                    if( $scattersCount >= 3 ) 
                    {
                        $state = 'choice';
                        $slotSettings->SetGameData('OceanRushEGTBonusStart', 1);
                        $_obf_0D1224210F3F5B0819110834131432040D0E062B260211 = ',"choices": 1,"freespinScatters":[11]';
                    }
                    if( $scattersCount >= 3 && $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        $state = 'freespin';
                        $_obf_0D341E1906402E012D2302041A0B29343137123F023201 = $slotSettings->GetGameData('OceanRushEGTFreeGames');
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('OceanRushEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('OceanRushEGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('OceanRushEGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('OceanRushEGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('OceanRushEGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
