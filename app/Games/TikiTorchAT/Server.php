...
*/            $response = '';
            ...
            if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'gameInit' ) 
            {
                ...
                if( $lastEvent != 'NULL' ) 
                {
                    ...
                    $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54990161_20200215162832","current":' . $lastEvent->serverResponse->currentFreeGames . ',"add":0,"total":' . $lastEvent->serverResponse->totalFreeGames . ',"totalWin":' . ($lastEvent->serverResponse->totalWin * 100) . ',"multiplayer":' . $lastEvent->serverResponse->Mpl . '';
                ...
                $response = '{"status":"success","microtime":0.0077991485595703,"dateTime":"2020-02-13 13:16:03","error":"","content":{"cmd":"gameInit","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"session":"54594109_4133a64673d3883d42cd003ee905ba3e","betInfo":{"denomination":0.01,"bet":' . $_obf_0D131333153E3B3F113536290D1D1A025B0D3F16341932[0] . ',"lines":25},"betSettings":{"denomination":[0.01],"bets":[' . implode(',', $_obf_0D131333153E3B3F113536290D1D1A025B0D3F16341932) . '],"lines":[1,5,10,15,20,25]},"symbols":' . $_obf_0D26400E0A283529372A365B352A06032B3E1106081D32 . ',"reels":{},"exitUrl":"\/","pingInterval":60000,"restore":' . $restore . ',"freeSpin":{' . $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 . '},"hash":"da0a5044aebc413b6da3a8e42dea0246"}}';
                $response = '{"status":"success","microtime":0.2377917766571,"dateTime":"2020-02-18 15:50:46","error":"","content":{"cmd":"gameInit","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"session":"55520234_b64d5c8e3495d291120765ad7c95c322","betInfo":{"denomination":0.01,"bet":' . $_obf_0D131333153E3B3F113536290D1D1A025B0D3F16341932[0] . ',"lines":20},"betSettings":{"denomination":[0.01],"bets":[' . implode(',', $_obf_0D131333153E3B3F113536290D1D1A025B0D3F16341932) . '],"lines":[1,5,10,15,20]},"symbols":' . $_obf_0D26400E0A283529372A365B352A06032B3E1106081D32 . ',"reels":{"base":{"1":["' . implode('","', $slotSettings->reelStrip1) . '"],"2":["' . implode('","', $slotSettings->reelStrip2) . '"],"3":["' . implode('","', $slotSettings->reelStrip3) . '"],"4":["' . implode('","', $slotSettings->reelStrip4) . '"],"5":["' . implode('","', $slotSettings->reelStrip5) . '"]}},"exitUrl":"\/","freeSpin":{' . $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 . '},"pingInterval":60000,"restore":' . $restore . ',"hash":"159ede03c3e477340e5a1e305bf4f884"}}';
            }
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'bet' || $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                            ...
                            else
                            {
                                ...
                                if( $s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild) ) 
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D365B172533170712222423300A1B092C161521071B32 ) 
                                    {
                                        ...
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"line":' . ($k + 1) . ',"symbol":"' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . '","count":1,"side":"left","elements":[[1,' . $_obf_0D10312F2E0C401A0B2828350D16031F2B1A280C3D1A01[$k][0] . ']],"xWin":' . ($mpl + $bonusMpl) . ',"win":' . ($cWins[$k] * 100) . '}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"line":' . ($k + 1) . ',"symbol":"' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . '","count":2,"side":"left","elements":[[1,' . $_obf_0D10312F2E0C401A0B2828350D16031F2B1A280C3D1A01[$k][0] . '],[2,' . $_obf_0D10312F2E0C401A0B2828350D16031F2B1A280C3D1A01[$k][1] . ']],"xWin":' . ($mpl + $bonusMpl) . ',"win":' . ($cWins[$k] * 100) . '}';
                                    }
                                }
                                ...
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || in_array($s[3], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"line":' . ($k + 1) . ',"symbol":"' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . '","count":4,"side":"left","elements":[[1,' . $_obf_0D10312F2E0C401A0B2828350D16031F2B1A280C3D1A01[$k][0] . '],[2,' . $_obf_0D10312F2E0C401A0B2828350D16031F2B1A280C3D1A01[$k][1] . '],[3,' . $_obf_0D10312F2E0C401A0B2828350D16031F2B1A280C3D1A01[$k][2] . '],[4,' . $_obf_0D10312F2E0C401A0B2828350D16031F2B1A280C3D1A01[$k][3] . ']],"xWin":' . ($mpl + $bonusMpl) . ',"win":' . ($cWins[$k] * 100) . '}';
                                    }
                                }
                    ...
                    {
                        $scattersStr = '{"line":"scatter","symbol":"' . $scatter . '","count":' . $scattersCount . ',"elements":[' . implode(',', $_obf_0D2C161413333D05292D0304392523180D3F192D361122) . '],"xWin":' . $bonusMpl . ',"freeSpinAdd":-1,"win":' . ($scattersWin * 100) . '}';
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                {
                    ...
                    $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('TikiTorchATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('TikiTorchATMpl') . ',"add":0,"total":' . $slotSettings->GetGameData('TikiTorchATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('TikiTorchATBonusWin') * 100) . '';
                }
                else
                {
                    $slotSettings->SetGameData('TikiTorchATTotalWin', $totalWin);
                ...
                if( $scattersCount >= 3 ) 
                {
                    if( $slotSettings->GetGameData('TikiTorchATFreeGames') > 0 ) 
                    {
                        ...
                        $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('TikiTorchATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('TikiTorchATMpl') . ',"add":' . $slotSettings->slotFreeCount . ',"total":' . $slotSettings->GetGameData('TikiTorchATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('TikiTorchATBonusWin') * 100) . '';
                    }
                    else
                    {
                        ...
                        $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('TikiTorchATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('TikiTorchATMpl') . ',"add":-1,"total":-1,"totalWin":' . ($slotSettings->GetGameData('TikiTorchATBonusWin') * 100) . '';
                    }
                }
