...
*/            $response = '';
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'gamble5GetUserCards' ) 
            {
                ...
                $_obf_0D040B162710402D331E2209370C14231F2C252B172601 = $slotSettings->GetGameData('BookOfRaDX6GTDealerCard');
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'gamble5GetDealerCard' ) 
            {
                ...
                $slotSettings->SetGameData('BookOfRaDX6GTDealerCard', $_obf_0D5B5C0F232838114030190505402A241E131019332901);
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'bet' || $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        if( $slotSettings->Paytable[$slotSettings->GetGameData('BookOfRaDX6GTExpSymbol')][$_obf_0D3E38221E1F123B38332B10310F240F19031A33400432] * $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotBet'] > 0 ) 
                        {
                            ...
                            {
                                $_obf_0D23320C13372C013626031231161213371B1A012D2401 += ($slotSettings->Paytable[$slotSettings->GetGameData('BookOfRaDX6GTExpSymbol')][$_obf_0D3E38221E1F123B38332B10310F240F19031A33400432] * $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotBet']);
                                $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"lineWin":' . ($slotSettings->Paytable[$slotSettings->GetGameData('BookOfRaDX6GTExpSymbol')][$_obf_0D3E38221E1F123B38332B10310F240F19031A33400432] * $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotBet']) . ',"Count":' . $_obf_0D3E38221E1F123B38332B10310F240F19031A33400432 . ',"Line":' . $_obf_0D33393C2C1131301F35390606172D0B09211517061032 . ',"Win":' . $_obf_0D23320C13372C013626031231161213371B1A012D2401 . ',"stepWin":' . ($_obf_0D23320C13372C013626031231161213371B1A012D2401 + $totalWin);
                                for( $e = 1; $e <= 6; $e++ ) 
                                {
                                    if( $_obf_0D10102A1711251D1B2914193D1412043E210F14325C11[$e] ) 
                                    {
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 .= (',"winReel' . $e . '":[' . ($linesId[$_obf_0D33393C2C1131301F35390606172D0B09211517061032][$e - 1] - 1) . ',"' . $slotSettings->GetGameData('BookOfRaDX6GTExpSymbol') . '"]');
                                    }
                                    else
                                    {
