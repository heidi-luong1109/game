        ...
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType']) ) 
            {
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'bet' || $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' || $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'respin' ) 
                {
                    ...
                    if( $slotSettings->GetBalance() < $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['bet'] ) 
                    {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    $_obf_0D3018182E3F5B10403B03261A37180104052E0E1F0611 = '';
                    if( $winType == 'bonus' && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] != 'freespin' ) 
                    {
                        $_obf_0D3018182E3F5B10403B03261A37180104052E0E1F0611 = rand(8, 19);
                        $_obf_0D3E0E122D08113C25070F0E333106403E2130302C2E22 = floor($_obf_0D3018182E3F5B10403B03261A37180104052E0E1F0611 / 4) + 1;
                        $_obf_0D232B02071440161C2E2A0B0A331D0E3D1F3D3B402801 = $_obf_0D3018182E3F5B10403B03261A37180104052E0E1F0611 - (($_obf_0D3E0E122D08113C25070F0E333106403E2130302C2E22 - 1) * 4);
                        $reels['reel' . $_obf_0D3E0E122D08113C25070F0E333106403E2130302C2E22][$_obf_0D232B02071440161C2E2A0B0A331D0E3D1F3D3B402801] = '11';
                    }
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                    {
                        $snake = json_decode($slotSettings->GetGameData('AnacondaWildPTSnake'));
                        $_obf_0D5C3227401A2C040207335B02233B1B01400218400122 = $slotSettings->GetGameData('AnacondaWildPTSnakeDirection');
                        $_obf_0D020230312F02081B30272D02372706400E3407093332 = count($snake->positions) - 1;
                        if( $_obf_0D5C3227401A2C040207335B02233B1B01400218400122 == 'right' ) 
                        {
                            $snake->positions[] = $snake->positions[$_obf_0D020230312F02081B30272D02372706400E3407093332] + 4;
                            $_obf_0D3F3C1831370D0118161739350324021C2D4006093E11 = $snake->positions[$_obf_0D020230312F02081B30272D02372706400E3407093332] + 4;
                            $_obf_0D192B295C351829111A1E252309281425361435092701 = rand(1, 3);
                            if( $_obf_0D192B295C351829111A1E252309281425361435092701 == 1 || $_obf_0D3F3C1831370D0118161739350324021C2D4006093E11 >= 20 ) 
                            {
                                $_obf_0D04343C360B143D11180710143F33370C1D1C1F361332 = rand(1, 2);
                                if( $_obf_0D04343C360B143D11180710143F33370C1D1C1F361332 == 1 && $_obf_0D3F3C1831370D0118161739350324021C2D4006093E11 != 0 && $_obf_0D3F3C1831370D0118161739350324021C2D4006093E11 != 4 && $_obf_0D3F3C1831370D0118161739350324021C2D4006093E11 != 8 && $_obf_0D3F3C1831370D0118161739350324021C2D4006093E11 != 12 && $_obf_0D3F3C1831370D0118161739350324021C2D4006093E11 != 16 && $_obf_0D3F3C1831370D0118161739350324021C2D4006093E11 != 20 ) 
                                {
                                    $_obf_0D5C3227401A2C040207335B02233B1B01400218400122 = 'up';
                                }
                                else if( $_obf_0D04343C360B143D11180710143F33370C1D1C1F361332 == 1 ) 
                                {
                                    $_obf_0D5C3227401A2C040207335B02233B1B01400218400122 = 'down';
                                }
                                if( $_obf_0D04343C360B143D11180710143F33370C1D1C1F361332 == 2 && $_obf_0D3F3C1831370D0118161739350324021C2D4006093E11 != 3 && $_obf_0D3F3C1831370D0118161739350324021C2D4006093E11 != 7 && $_obf_0D3F3C1831370D0118161739350324021C2D4006093E11 != 11 && $_obf_0D3F3C1831370D0118161739350324021C2D4006093E11 != 15 && $_obf_0D3F3C1831370D0118161739350324021C2D4006093E11 != 19 && $_obf_0D3F3C1831370D0118161739350324021C2D4006093E11 != 23 ) 
                                {
                                    $_obf_0D5C3227401A2C040207335B02233B1B01400218400122 = 'down';
                                }
                                else if( $_obf_0D04343C360B143D11180710143F33370C1D1C1F361332 == 2 ) 
                                {
                                    $_obf_0D5C3227401A2C040207335B02233B1B01400218400122 = 'up';
                                }
                            }
                        }
                        else if( $_obf_0D5C3227401A2C040207335B02233B1B01400218400122 == 'left' ) 
                        {
                            $snake->positions[] = $snake->positions[$_obf_0D020230312F02081B30272D02372706400E3407093332] - 4;
                            $_obf_0D3F3C1831370D0118161739350324021C2D4006093E11 = $snake->positions[$_obf_0D020230312F02081B30272D02372706400E3407093332] - 4;
                            $_obf_0D2F0F5C402812010219125C25390C03342C231D222222 = $snake->positions[0];
                            if( $_obf_0D3F3C1831370D0118161739350324021C2D4006093E11 - 1 == $_obf_0D2F0F5C402812010219125C25390C03342C231D222222 ) 
                            {
                                $_obf_0D5C3227401A2C040207335B02233B1B01400218400122 = 'up';
                            }
                            if( $_obf_0D3F3C1831370D0118161739350324021C2D4006093E11 + 1 == $_obf_0D2F0F5C402812010219125C25390C03342C231D222222 ) 
                        ...
                        else if( $_obf_0D5C3227401A2C040207335B02233B1B01400218400122 == 'up' ) 
                        {
                            $snake->positions[] = $snake->positions[$_obf_0D020230312F02081B30272D02372706400E3407093332] - 1;
                            $_obf_0D5C3227401A2C040207335B02233B1B01400218400122 = 'left';
                        }
                        else if( $_obf_0D5C3227401A2C040207335B02233B1B01400218400122 == 'down' ) 
                        {
                            $snake->positions[] = $snake->positions[$_obf_0D020230312F02081B30272D02372706400E3407093332] + 1;
                            $_obf_0D5C3227401A2C040207335B02233B1B01400218400122 = 'left';
                        }
                        for( $_obf_0D31022B0515130F1E19212F3B240E3D080B1812102E32 = 0; $_obf_0D31022B0515130F1E19212F3B240E3D080B1812102E32 < count($snake->positions); $_obf_0D31022B0515130F1E19212F3B240E3D080B1812102E32++ ) 
                        {
                            $_obf_0D172C3E1E0F0703223B313E2C2419243F222224173B11 = $snake->positions[$_obf_0D31022B0515130F1E19212F3B240E3D080B1812102E32];
                            $_obf_0D3E0E122D08113C25070F0E333106403E2130302C2E22 = floor($_obf_0D172C3E1E0F0703223B313E2C2419243F222224173B11 / 4) + 1;
                            $_obf_0D232B02071440161C2E2A0B0A331D0E3D1F3D3B402801 = $_obf_0D172C3E1E0F0703223B313E2C2419243F222224173B11 - (($_obf_0D3E0E122D08113C25070F0E333106403E2130302C2E22 - 1) * 4);
                            $reels['reel' . $_obf_0D3E0E122D08113C25070F0E333106403E2130302C2E22][$_obf_0D232B02071440161C2E2A0B0A331D0E3D1F3D3B402801] = '11';
                        }
                    }
                    for( $k = 0; $k < $lines; $k++ ) 
                            ...
                            else
                            {
                                ...
                                if( $s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild) ) 
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                    {
                                        ...
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AnacondaWildPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AnacondaWildPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AnacondaWildPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AnacondaWildPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $wild)) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AnacondaWildPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $wild)) && ($s[5] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[5], $wild)) ) 
                                {
                                    ...
                                    $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 = $slotSettings->Paytable['SYM_' . $_obf_0D011C142C3C37263F351C4012170A074027083F321132][6] * $betLine * $mpl * $bonusMpl;
                                    if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":6,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AnacondaWildPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                    }
                                }
                            }
                        }
                ...
                $_obf_0D2D362B1A390D095B40330C220C3D3F09131F36323E22 = '';
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                {
                    ...
                    $slotSettings->SetGameData('AnacondaWildPTSnakeDirection', $_obf_0D5C3227401A2C040207335B02233B1B01400218400122);
                    $_obf_0D2D362B1A390D095B40330C220C3D3F09131F36323E22 = ',"adv":" ' . $snake->positions[count($snake->positions) - 1] . '|' . $snake->positions[0] . ' "';
                    if( $snake->positions[count($snake->positions) - 1] == $snake->positions[0] ) 
                    {
                        $slotSettings->SetGameData('AnacondaWildPTFreeGames', 0);
                        $slotSettings->SetGameData('AnacondaWildPTCurrentFreeGame', 0);
                    }
                    $_obf_0D270903270C0718293E300931132E3110141913282A32 = 'true';
                    $spinType = 'RE';
                }
                else
                {
                    $spinType = 'REGULAR';
                    $_obf_0D270903270C0718293E300931132E3110141913282A32 = 'false';
                    $slotSettings->SetGameData('AnacondaWildPTTotalWin', $totalWin);
                }
                if( $winType == 'bonus' ) 
                {
                    ...
                    $_obf_0D270903270C0718293E300931132E3110141913282A32 = 'true';
                    $slotSettings->SetGameData('AnacondaWildPTSnake', '{"positions":[' . $_obf_0D3018182E3F5B10403B03261A37180104052E0E1F0611 . ']}');
                }
                $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"spinType":"' . $spinType . '"' . $_obf_0D2D362B1A390D095B40330C220C3D3F09131F36323E22 . ',"reelset":0,"siv":[8,8,4,4,6,2,2,5,7,11,3,3,3,6,6,6,6,6,6,0,8,8,8,7],"respinFollows":' . $_obf_0D270903270C0718293E300931132E3110141913282A32 . ',"snakePositions":[' . $slotSettings->GetGameData('AnacondaWildPTSnake') . '],"credit":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"results":[' . implode(',', $reels['rp']) . '],"windowId":"2yV1fd"},"ID":49340,"umid":37}';
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"deltaBalanceInCents":1},"ID":40085}';
                $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 = '' . json_encode($reels) . '';
                $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 = '' . json_encode($slotSettings->Jackpots) . '';
                $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 = implode(',', $lineWins);
                $_obf_0D211A2130313C5C3C291124011B3B12062E400D122111 = $slotSettings->GetGameData('AnacondaWildPTSnake');
                if( $_obf_0D211A2130313C5C3C291124011B3B12062E400D122111 == '' ) 
                {
                    $_obf_0D211A2130313C5C3C291124011B3B12062E400D122111 = '""';
                }
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"Snake":' . $_obf_0D211A2130313C5C3C291124011B3B12062E400D122111 . ',"SnakeDirection":"' . $slotSettings->GetGameData('AnacondaWildPTSnakeDirection') . '","linesArr":[' . implode(',', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('AnacondaWildPTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AnacondaWildPTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('AnacondaWildPTBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('AnacondaWildPTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
            ...
            switch( $umid ) 
            {
                ...
                case '40066':
                    ...
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"funNoticeGames":0,"funNoticePayouts":0,"gameGroup":"anwild","minBet":0,"maxBet":0,"minPosBet":0,"maxPosBet":50000,"coinSizes":[' . implode(',', $_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11) . ']},"ID":40025,"umid":21}';
                    break;
                case '40036':
