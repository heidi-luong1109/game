...
*/            $response = '';
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'gamble5GetUserCards' ) 
            {
                ...
                $_obf_0D040B162710402D331E2209370C14231F2C252B172601 = $slotSettings->GetGameData('BookOfRaDXGTMDealerCard');
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'gamble5GetDealerCard' ) 
            {
                ...
                $slotSettings->SetGameData('BookOfRaDXGTMDealerCard', $_obf_0D5B5C0F232838114030190505402A241E131019332901);
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'bet' || $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                            ...
                            else
                            {
                                ...
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[0] == $wild) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[1] == $wild) ) 
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D365B172533170712222423300A1B092C161521071B32 ) 
                                    {
                                        ...
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[0] == $wild) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[1] == $wild) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[2] == $wild) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[0] == $wild) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[1] == $wild) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[2] == $wild) && ($s[3] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[3] == $wild) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( ($s[0] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[0] == $wild) && ($s[1] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[1] == $wild) && ($s[2] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[2] == $wild) && ($s[3] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[3] == $wild) && ($s[4] == $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 || $s[4] == $wild) ) 
                                {
                                    ...
                                    {
                                        $cWins[$k] = $_obf_0D365B172533170712222423300A1B092C161521071B32;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                    }
                                }
                            }
                        }
                    ...
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        {
                            $_obf_0D23320C13372C013626031231161213371B1A012D2401 += ($slotSettings->Paytable[$slotSettings->GetGameData('BookOfRaDXGTMExpSymbol')][$_obf_0D3E38221E1F123B38332B10310F240F19031A33400432] * $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotBet']);
                            $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"lineWin":' . ($slotSettings->Paytable[$slotSettings->GetGameData('BookOfRaDXGTMExpSymbol')][$_obf_0D3E38221E1F123B38332B10310F240F19031A33400432] * $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotBet']) . ',"Count":' . $_obf_0D3E38221E1F123B38332B10310F240F19031A33400432 . ',"Line":' . $_obf_0D33393C2C1131301F35390606172D0B09211517061032 . ',"Win":' . $_obf_0D23320C13372C013626031231161213371B1A012D2401 . ',"stepWin":' . ($_obf_0D23320C13372C013626031231161213371B1A012D2401 + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTMBonusWin'));
                            for( $e = 1; $e <= 5; $e++ ) 
                            {
                                if( $_obf_0D10102A1711251D1B2914193D1412043E210F14325C11[$e] ) 
                                {
                                    $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 .= (',"winReel' . $e . '":[' . ($linesId[$_obf_0D33393C2C1131301F35390606172D0B09211517061032][$e - 1] - 1) . ',"' . $slotSettings->GetGameData('BookOfRaDXGTMExpSymbol') . '"]');
                                }
                                else
                                {
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' && $slotSettings->GetGameData('BookOfRaDXGTMFreeGames') <= $slotSettings->GetGameData('BookOfRaDXGTMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('BookOfRaDXGTMTotalWin') + $totalWin > 0 ) 
                {
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"slotLines":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotLines'] . ',"slotBet":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotBet'] . ',' . $_obf_0D3917092A2A3817290F0217372B08310F2B2C1B081E22 . ',"expPay":' . $_obf_0D23320C13372C013626031231161213371B1A012D2401 . ',' . $_obf_0D2D282C3311140231253214191919022F17192E141601 . ',' . $expSymbol . '"totalFreeGames":' . $slotSettings->GetGameData('BookOfRaDXGTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BookOfRaDXGTMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D28393910101E062539311B3F371C121912162B061E32 . ',"reelsSymbols":' . $_obf_0D273522403840350F0A36072E150A0524143F382C3B32 . '}}';
