            ...
            switch( $gameData['slotEvent'] ) 
            {
                ...
                case 'A/u25':
                    ...
                    if( $lastEvent != 'NULL' ) 
                    {
                        ...
                        $slotSettings->SetGameData('FruitExpressAMLines', $_obf_0D0D3D19173E372D15391D0C1E1F01030F1E163B5B3222);
                        ...
                        $_obf_0D2F1816033E36143D160A39333D122840370C160B1D32 = dechex($slotSettings->GetGameData('FruitExpressAMFreeGames'));
                        $_obf_0D243812041C191E1B1A3F113E330236293F3D3D105C11 = dechex($slotSettings->GetGameData('FruitExpressAMFreeGames') - $slotSettings->GetGameData('FruitExpressAMCurrentFreeGame'));
                        ...
                        $_obf_0D1F02220D0F2D281D26051502182F0E0C1C3D18350732 = $slotSettings->HexFormat($slotSettings->GetGameData('FruitExpressAMBonusWin') * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01);
                    ...
                    {
                        $slotSettings->SetGameData('FruitExpressAMLines', $_obf_0D01361D0A3E2D311F08242223290C1B173C3E1D332432);
                        $slotState = '4';
                    ...
                    $response = '05' . $slotSettings->FormatReelStrips('', []) . '00' . $slotState . '0' . $reelSate . '10' . $balanceFormated . $_obf_0D1F02220D0F2D281D26051502182F0E0C1C3D18350732 . $_obf_0D0231242F16365B3C1D071E3B263319262A16261D2F01 . $_obf_0D353903345C2903220A0F1D1410163F37251D5B020711 . $_obf_0D1F210640113215055B051B35301630023C18403E2B22 . $_obf_0D01361D0A3E2D311F08242223290C1B173C3E1D332432 . $_obf_0D143D1E1E380F351E1138192B253404170B06113D2922 . '10101010100a0a0a1100' . $reelSate . '0000000000000000' . $_obf_0D2B230C15322D020F0D262A1538072D011C092D310732 . $_obf_0D130827385C083E1E300D2E3F3233061923211C050522 . '0b10101010101010101010100b10101010101010101010100b1010101010101010101010100001010101011500000150000015000001500000' . $slotSettings->FormatReelStrips('', [
                        1, 
                        2, 
                        3
                    ]) . $slotSettings->FormatReelStrips('', [
                    ...
                    break;
                case 'A/u250':
                    $_obf_0D01361D0A3E2D311F08242223290C1B173C3E1D332432 = $slotSettings->GetGameData('FruitExpressAMLines');
                    $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01));
                    $lastEvent = $slotSettings->GetHistory();
                    if( $lastEvent != 'NULL' ) 
                    {
                ...
                case 'A/u251':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $wild = ['7'];
                        $scatter = '7';
                        $_obf_0D37303C061D1F332429082E3133122A2D0F29285B0622 = -1;
                        if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                        {
                            $_obf_0D37303C061D1F332429082E3133122A2D0F29285B0622 = $slotSettings->GetGameData('FruitExpressAMRespinState');
                        }
                        $reels = $slotSettings->GetReelStrips($winType, $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'], $_obf_0D37303C061D1F332429082E3133122A2D0F29285B0622);
                        if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                        {
                            $_obf_0D37303C061D1F332429082E3133122A2D0F29285B0622 = $slotSettings->GetGameData('FruitExpressAMRespinState');
                            for( $r = 1; $r <= 5; $r++ ) 
                            {
                                if( $_obf_0D37303C061D1F332429082E3133122A2D0F29285B0622 == $r ) 
                                {
                                    $reels['reel' . $r][0] = '7';
                                    $reels['reel' . $r][1] = '7';
                                    $reels['reel' . $r][2] = '7';
                        ...
                        for( $k = 0; $k < $lines; $k++ ) 
                        {
                                ...
                                else
                                {
                                    ...
                                    if( $s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild) ) 
                                    {
                                        ...
                                        if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                        {
                                            ...
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FruitExpressAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FruitExpressAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FruitExpressAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                        }
                                    }
                                    if( ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) ) 
                                    {
                                        ...
                                        if( $_obf_0D1F3921401608132D25080B0D0B32143213093B3E3011[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                        {
                                            ...
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":3,"Line":' . $k . ',"Win":' . $_obf_0D1F3921401608132D25080B0D0B32143213093B3E3011[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FruitExpressAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FruitExpressAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                        }
                                    }
                                    ...
                                    if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FruitExpressAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                        }
                                    }
                                }
                            }
                            ...
                            if( $_obf_0D1F3921401608132D25080B0D0B32143213093B3E3011[$k] > 0 && $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 != '' ) 
                            {
                                array_push($lineWins, $_obf_0D0207283039073919263232090A382F3D26101F0D1E11);
                        ...
                        $scattersStr = '{';
                        $scattersCount = 0;
                        $_obf_0D181E052A0A07042C281E2B081A113818362525171A11 = 0;
                        $_obf_0D37303C061D1F332429082E3133122A2D0F29285B0622 = 0;
                        $rss = $slotSettings->GetGameData('FruitExpressAMRespinState');
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            $_obf_0D1D0A1A25263902273638223816123502133D37383C01 = 0;
                            if( $reels['reel' . $r][0] == $scatter || $reels['reel' . $r][1] == $scatter || $reels['reel' . $r][2] == $scatter ) 
                            {
                                $scattersCount++;
                                $_obf_0D1D0A1A25263902273638223816123502133D37383C01++;
                            }
                            if( $_obf_0D1D0A1A25263902273638223816123502133D37383C01 > 0 ) 
                            {
                                $_obf_0D37303C061D1F332429082E3133122A2D0F29285B0622 = $r;
                                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] != 'freespin' ) 
                                {
                        ...
                        else if( $scattersCount >= 1 && $winType != 'bonus' && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] != 'freespin' ) 
                        {
                        }
                        else
                        {
                            if( $totalWin <= $slotSettings->GetBank((isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent']) ? $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] : '')) && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                            {
                                break;
                            }
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                    {
                        $_obf_0D1B2E301E050611380115341C2B29101B112F071A3F22 = $slotSettings->GetGameData('FruitExpressAMRespinRow');
                        $reels['rp'][$_obf_0D1B2E301E050611380115341C2B29101B112F071A3F22[0]] = $_obf_0D1B2E301E050611380115341C2B29101B112F071A3F22[1];
                    }
                    $reelSate = $slotSettings->HexFormat($reels['rp'][0]) . $slotSettings->HexFormat($reels['rp'][1]) . $slotSettings->HexFormat($reels['rp'][2]) . $slotSettings->HexFormat($reels['rp'][3]) . $slotSettings->HexFormat($reels['rp'][4]);
                    $winLinesFormated = '';
                    ...
                    $_obf_0D0D312B5B2A362F140C2C3F2A34101D0B222E3E180311 = '';
                    for( $i = 0; $i < $_obf_0D261C3E293911272E102E06115B1E29282A3D11101D22; $i++ ) 
                    {
                        $_obf_0D1F3921401608132D25080B0D0B32143213093B3E3011[$i] = $_obf_0D1F3921401608132D25080B0D0B32143213093B3E3011[$i] / $betLine / $bonusMpl;
                        $_obf_0D0D312B5B2A362F140C2C3F2A34101D0B222E3E180311 .= $slotSettings->HexFormat($_obf_0D1F3921401608132D25080B0D0B32143213093B3E3011[$i]);
                    }
                    $_obf_0D1A2D0D2D3B25101C1F2F0107075C191D261C015B0211 = '';
                    for( $i = 0; $i < $_obf_0D261C3E293911272E102E06115B1E29282A3D11101D22; $i++ ) 
                    {
                        if( $_obf_0D1F3921401608132D25080B0D0B32143213093B3E3011[$i] > 0 ) 
                        {
                            $_obf_0D1F3921401608132D25080B0D0B32143213093B3E3011[$i] = $_obf_0D1F3921401608132D25080B0D0B32143213093B3E3011[$i] / $betLine / $bonusMpl;
                            $_obf_0D1A2D0D2D3B25101C1F2F0107075C191D261C015B0211 .= $slotSettings->HexFormat($_obf_0D1F3921401608132D25080B0D0B32143213093B3E3011[$i]);
                        }
                        else
                        {
                            $cWins[$i] = $cWins[$i] / $betLine / $bonusMpl;
                            $_obf_0D1A2D0D2D3B25101C1F2F0107075C191D261C015B0211 .= $slotSettings->HexFormat($cWins[$i]);
                        }
                    }
                    $winLinesFormated .= $slotSettings->HexFormat(round(round($scattersWin / $betLine / $lines / $bonusMpl, 2)));
                    $_obf_0D0D312B5B2A362F140C2C3F2A34101D0B222E3E180311 .= $slotSettings->HexFormat($scattersWin / $betLine / $lines / $bonusMpl);
                    $_obf_0D1A2D0D2D3B25101C1F2F0107075C191D261C015B0211 .= $slotSettings->HexFormat($scattersWin / $betLine / $lines / $bonusMpl);
                    ...
                    $_obf_0D142B2D28403935142D18260E2E2F122A120D2F1B0A22 = '0101';
                    $_obf_0D2C280226393D1D16260439281D29230735370E5C3432 = '1500000';
                    $_obf_0D012E2A185B0A1E330223145B191310133E160E113432 = '101010';
                    if( $_obf_0D37303C061D1F332429082E3133122A2D0F29285B0622 == 2 ) 
                    {
                        $_obf_0D012E2A185B0A1E330223145B191310133E160E113432 = '001010';
                    }
                    if( $_obf_0D37303C061D1F332429082E3133122A2D0F29285B0622 == 3 ) 
                    {
                        $_obf_0D012E2A185B0A1E330223145B191310133E160E113432 = '100010';
                    }
                    if( $_obf_0D37303C061D1F332429082E3133122A2D0F29285B0622 == 4 ) 
                    {
                        $_obf_0D012E2A185B0A1E330223145B191310133E160E113432 = '101000';
                    }
                    $_obf_0D2527252E241B2C0637125B3E13063419322109241511 = '000';
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                    {
                        $_obf_0D2527252E241B2C0637125B3E13063419322109241511 = '010';
                        if( $_obf_0D37303C061D1F332429082E3133122A2D0F29285B0622 == 2 ) 
                        {
                            $_obf_0D2C280226393D1D16260439281D29230735370E5C3432 = '1510111';
                        }
                        if( $_obf_0D37303C061D1F332429082E3133122A2D0F29285B0622 == 3 ) 
                        {
                            $_obf_0D2C280226393D1D16260439281D29230735370E5C3432 = '1522022';
                        }
                        if( $_obf_0D37303C061D1F332429082E3133122A2D0F29285B0622 == 4 ) 
                        {
                            $_obf_0D2C280226393D1D16260439281D29230735370E5C3432 = '1533303';
                        }
                        $_obf_0D2F1816033E36143D160A39333D122840370C160B1D32 = dechex($slotSettings->GetGameData('FruitExpressAMFreeGames'));
                        $_obf_0D243812041C191E1B1A3F113E330236293F3D3D105C11 = dechex($slotSettings->GetGameData('FruitExpressAMFreeGames') - $slotSettings->GetGameData('FruitExpressAMCurrentFreeGame'));
                        $_obf_0D2E3437162622183F300B5C220C15055C2D38031B3511 = '21';
                        $_obf_0D142B2D28403935142D18260E2E2F122A120D2F1B0A22 = '0001';
                    ...
                    {
                        $_obf_0D2E3437162622183F300B5C220C15055C2D38031B3511 = '1e';
                        $_obf_0D142B2D28403935142D18260E2E2F122A120D2F1B0A22 = '0100';
                        $slotSettings->SetGameData('FruitExpressAMRespinState', $_obf_0D37303C061D1F332429082E3133122A2D0F29285B0622);
                    ...
                    $response = '1' . $_obf_0D2E3437162622183F300B5C220C15055C2D38031B3511 . '010' . $balanceFormated . $slotSettings->HexFormat($slotSettings->GetGameData('FruitExpressAMTotalWin') * 100) . $reelSate . $_obf_0D3F05382A29123605040E3D10291E2F12391926360401 . $_obf_0D2E320D352628142310141D2F010A085C321810131022 . '10101010101010101010100b' . $_obf_0D1A2D0D2D3B25101C1F2F0107075C191D261C015B0211 . '2930020b20171e140b' . $winLinesFormated . '0b' . $_obf_0D0D312B5B2A362F140C2C3F2A34101D0B222E3E180311 . '' . $slotSettings->HexFormat(round($totalWin * 100)) . '' . $_obf_0D2527252E241B2C0637125B3E13063419322109241511 . '10' . $_obf_0D012E2A185B0A1E330223145B191310133E160E113432 . '11500000' . $_obf_0D2C280226393D1D16260439281D29230735370E5C3432 . '15000001500000#101010-' . $scattersCount;
                    $response .= ('_' . json_encode($reels));
                    $slotSettings->SetGameData('FruitExpressAMDoubleAnswer', $reelSate . $_obf_0D3F05382A29123605040E3D10291E2F12391926360401 . $_obf_0D2E320D352628142310141D2F010A085C321810131022 . '1010101010101010101010' . $_obf_0D0F172D1118050C402A0F213C1D233038275B3E103101 . $winLinesFormated);
                    ...
                    $slotSettings->SetGameData('FruitExpressAMCollectP0', $_obf_0D121F0821192F3304332C1D225C362A0F2C5C23312322);
                    ...
                    $slotSettings->SetGameData('FruitExpressAMCollect', $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22);
                    break;
                case 'A/u254':
                    $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                    $slotSettings->SetGameData('FruitExpressAMTotalWin', 0);
                ...
                case 'A/u257':
                    $doubleWin = rand(1, 2);
                    $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032 = $slotSettings->GetGameData('FruitExpressAMDoubleWin');
                    ...
                    $response = '107010' . $slotSettings->GetGameData('FruitExpressAMDoubleBalance') . strlen($_obf_0D143B0B042F091727280D3E182D1D0115352113380F01) . $_obf_0D143B0B042F091727280D3E182D1D0115352113380F01 . $slotSettings->GetGameData('FruitExpressAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                    $slotSettings->SetGameData('FruitExpressAMDoubleWin', $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032);
                    $slotSettings->SetGameData('FruitExpressAMTotalWin', $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032);
                    $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01));
                    $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22 = '104010' . $balanceFormated . strlen($_obf_0D143B0B042F091727280D3E182D1D0115352113380F01) . $_obf_0D143B0B042F091727280D3E182D1D0115352113380F01 . $slotSettings->GetGameData('FruitExpressAMCollectP0');
                    $slotSettings->SetGameData('FruitExpressAMCollect', $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22);
                ...
                case 'A/u258':
                    ...
                    $slotSettings->SetGameData('FruitExpressAMDoubleBalance', $_obf_0D373B302A1614233D3F2D03055B0B142A33240F1D0511);
                    $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032 = sprintf('%01.2f', $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032) * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01;
                    $_obf_0D055B13312136223405401F250A14140A220F080A0211 = str_replace('.', '', $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032 . '');
                    $_obf_0D143B0B042F091727280D3E182D1D0115352113380F01 = dechex($_obf_0D055B13312136223405401F250A14140A220F080A0211);
                    $_obf_0D0B231C5C1F3C2202340D2D242505232E371E352F2532 = '26280b2714161d0c';
                    $response = '108010' . $slotSettings->GetGameData('FruitExpressAMDoubleBalance') . strlen($_obf_0D143B0B042F091727280D3E182D1D0115352113380F01) . $_obf_0D143B0B042F091727280D3E182D1D0115352113380F01 . $slotSettings->GetGameData('FruitExpressAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                    break;
            }
