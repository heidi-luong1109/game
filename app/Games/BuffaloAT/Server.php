...
*/            $response = '';
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'bet' || $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
            {
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                {
                    ...
                    $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('BuffaloATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('BuffaloATMpl') . ',"xWin":[' . implode(',', $_obf_0D322E3B232F25403F0406272B0513332A2E082B113B11) . '],"add":0,"total":' . $slotSettings->GetGameData('BuffaloATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('BuffaloATBonusWin') * 100) . '';
                }
                else
                {
                    $slotSettings->SetGameData('BuffaloATTotalWin', $totalWin);
                ...
                if( $scattersCount >= 3 ) 
                {
                    if( $slotSettings->GetGameData('BuffaloATFreeGames') > 0 ) 
                    {
                        ...
                        $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('BuffaloATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('BuffaloATMpl') . ',"add":' . $slotSettings->slotFreeCount[$scattersCount] . ',"total":' . $slotSettings->GetGameData('BuffaloATFreeGames') . ',"xWin":[' . implode(',', $_obf_0D322E3B232F25403F0406272B0513332A2E082B113B11) . '],"totalWin":' . ($slotSettings->GetGameData('BuffaloATBonusWin') * 100) . '';
                    }
                    else
                    {
