            ...
            switch( $gameData['slotEvent'] ) 
            {
                ...
                case 'A/u25':
                    ...
                    if( $lastEvent != 'NULL' ) 
                    {
                        ...
                        $slotSettings->SetGameData('MultiWinTripleAMbalanceFormated', $_obf_0D05051A3B323B0F035B305B2D01061B120226380C3401);
                ...
                case 'A/u253':
                    ...
                    if( $lastEvent != 'NULL' ) 
                    {
                        ...
                        $_obf_0D061C162B391B0A23183D303C3C3F251F341D021D1022 = $slotSettings->GetGameData('MultiWinTripleAMCurrentCards');
                    }
                    else
                    {
                        $_obf_0D403B31280D2A01051A033840271D0236293E2E091601 = $slotSettings->GetGameData('MultiWinTripleAMCurrentCards');
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $totalWin = $_obf_0D3E291C370537291F350C5C0E070E3403290801034001[0] * $slotSettings->GetGameData('MultiWinTripleAMBet');
                        if( $totalWin <= $bank ) 
                        {
                            break;
                        }
                    ...
                    $response = '104010' . $_obf_0D05051A3B323B0F035B305B2D01061B120226380C3401 . $slotSettings->HexFormat(round($totalWin * 100)) . '10011f4138810' . implode('', $slotSettings->GetGameData('MultiWinTripleAMHistoryCards')) . $_obf_0D0F40311C121D1C3213161C1E21311E1C3116403B1001 . implode('', $holds) . '030' . $_obf_0D113C0B01390D1431072D263B3B0C27370D0D363D4032 . '03000000001010151a26431f4';
                    ...
                    $slotSettings->SetGameData('MultiWinTripleAMCollect', $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22);
                ...
                case 'A/u2512':
                    ...
                    $response = '10b010' . $_obf_0D05051A3B323B0F035B305B2D01061B120226380C3401 . $slotSettings->HexFormat(round($totalWin * 100)) . '10001a33e8100000000000000000' . $_obf_0D0F40311C121D1C3213161C1E21311E1C3116403B1001 . implode('', $holds) . '020' . $_obf_0D113C0B01390D1431072D263B3B0C27370D0D363D4032 . '000000000' . $_obf_0D342D5C29171D3B0A3934110F0F240F23342528193111 . '1010151a26431f4#';
                    $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22 = $slotSettings->HexFormat(round($totalWin * 100)) . '10001a33e8100000000000000000' . $_obf_0D0F40311C121D1C3213161C1E21311E1C3116403B1001 . $_obf_0D29393440375B18354019311334290C32102B27260511 . '020' . $_obf_0D113C0B01390D1431072D263B3B0C27370D0D363D4032 . '00000000';
                    $slotSettings->SetGameData('MultiWinTripleAMCollect', $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22);
                    $_obf_0D313216211E285C27221305312C19242C223C11353901 = (object)[
                        'Bet' => $slotSettings->GetGameData('MultiWinTripleAMBet'), 
                    ...
                    $_obf_0D2D350C1338352E3F0236115C1407341C0926053F2211 = '{"responseEvent":"spin","responseType":"bet","serverResponse":' . json_encode($_obf_0D313216211E285C27221305312C19242C223C11353901) . '}';
                    $slotSettings->SaveLogReport($_obf_0D2D350C1338352E3F0236115C1407341C0926053F2211, 0, 1, 0, 'bet');
                    $slotSettings->SetGameData('MultiWinTripleAMCurrentCards', $_obf_0D3933282D2F3207131E01322E3D2A243306341C300F01);
                    $slotSettings->SetGameData('MultiWinTripleAMCards', $cards);
                    break;
                case 'A/u257':
                    $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                    $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22 = $slotSettings->GetGameData('MultiWinTripleAMCollect');
                    $_obf_0D05051A3B323B0F035B305B2D01061B120226380C3401 = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01));
                ...
                case 'A/u251':
                    ...
                    $_obf_0D05051A3B323B0F035B305B2D01061B120226380C3401 = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01));
                    $slotSettings->SetGameData($slotSettings->slotId . 'BankReserved', 0);
                    $slotSettings->SetGameData('MultiWinTripleAMDoubleBalance', $_obf_0D05051A3B323B0F035B305B2D01061B120226380C3401);
                    $cardsArr = [];
                    for( $i = 0; $i <= 3; $i++ ) 
                    {
                        for( $j = 2; $j <= 15; $j++ ) 
                    ...
                    $response = '102010' . $_obf_0D05051A3B323B0F035B305B2D01061B120226380C3401 . '1010001a33e810' . implode('', $slotSettings->GetGameData('MultiWinTripleAMHistoryCards')) . $_obf_0D0F40311C121D1C3213161C1E21311E1C3116403B1001 . implode('', $holds) . '010' . $_obf_0D113C0B01390D1431072D263B3B0C27370D0D363D4032 . '000000000' . $_obf_0D342D5C29171D3B0A3934110F0F240F23342528193111 . '1010151a26431f4#';
                    $_obf_0D313216211E285C27221305312C19242C223C11353901 = (object)[
                        'Bet' => $allbet, 
                        'CurrentCards' => $_obf_0D3933282D2F3207131E01322E3D2A243306341C300F01, 
                        'Cards' => $cardsArr, 
                ...
                case 'A/u258':
                    $doubleWin = rand(1, 2);
                    $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032 = $slotSettings->GetGameData('MultiWinTripleAMTotalWin');
                    $_obf_0D1135362B02051A22113F1E5B2E2B062E123E2A2F2311 = $slotSettings->GetGameData('MultiWinTripleAMHistoryCards');
                    $_obf_0D16370E06283D2C01032D38041C0D1C171D273F260F01 = $slotSettings->GetGameData('MultiWinTripleAMGambleStep');
                    $bank = $slotSettings->GetBank((isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent']) ? $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] : ''));
                    ...
                    $response = '108010' . $slotSettings->GetGameData('MultiWinTripleAMDoubleBalance') . $slotSettings->HexFormat($_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032 * 100) . '10011f4138810' . implode('', $_obf_0D1135362B02051A22113F1E5B2E2B062E123E2A2F2311) . '10101010101010101010020103000' . dechex($_obf_0D16370E06283D2C01032D38041C0D1C171D273F260F01) . '00001010151a26431f4';
                    $_obf_0D05051A3B323B0F035B305B2D01061B120226380C3401 = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01));
                    $slotSettings->SetGameData('MultiWinTripleAMTotalWin', $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032);
                    $slotSettings->SetGameData('MultiWinTripleAMHistoryCards', $_obf_0D1135362B02051A22113F1E5B2E2B062E123E2A2F2311);
                    $slotSettings->SetGameData('MultiWinTripleAMGambleStep', $_obf_0D16370E06283D2C01032D38041C0D1C171D273F260F01);
                ...
                case 'A/u259':
                    ...
                    $slotSettings->SetGameData('MultiWinTripleAMDoubleBalance', $_obf_0D373B302A1614233D3F2D03055B0B142A33240F1D0511);
                    ...
                    $response = '109010' . $slotSettings->GetGameData('MultiWinTripleAMDoubleBalance') . strlen($_obf_0D143B0B042F091727280D3E182D1D0115352113380F01) . $_obf_0D143B0B042F091727280D3E182D1D0115352113380F01 . '10001a33e810060d15210f07131e21324f21b22e2291024f1022e1002010300000004101012152322fa';
                    break;
            }
