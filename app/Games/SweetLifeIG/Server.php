...
/*            if( config('LicenseDK.APL_INCLUDE_KEY_CONFIG') != 'wi9qydosuimsnls5zoe5q298evkhim0ughx1w16qybs2fhlcpn' ) 
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['action'] == 'risk' && $slotSettings->GetGameData('SweetLifeIGWin') <= 0 ) 
            {
            ...
            switch( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['action'] ) 
            {
                ...
                case 'start':
                    ...
                    $slotSettings->SetGameData('SweetLifeIGReels', $_obf_0D282A3E130518100418230D042B0A2B400930193F3232);
                    ...
                    $slotSettings->SetGameData('SweetLifeIGDealerCard', $_obf_0D152F2B13101C1F2D320B1C302214192A26071A401E32);
                ...
                case 'risk':
                    ...
                    $_obf_0D25035C31183316381216122811401A1F2A17243E2B22 = $slotSettings->GetGameData('SweetLifeIGDealerCard');
                    ...
                    $_obf_0D142C241F1B181D2723252601234035375B141A063811 = $slotSettings->GetGameData('SweetLifeIGWin');
                    $_obf_0D26162103330B0A341E0A1B3B1A0F271B140614180722 = $slotSettings->GetGameData('SweetLifeIGWin');
                    ...
                    $_obf_0D1003222E11232A3C021F081E07131D1D233E2B0F5B11 = $slotSettings->GetGameData('SweetLifeIGRisk');
                    ...
                    $balance = $slotSettings->GetBalance();
                    $slotSettings->SetGameData('SweetLifeIGWin', $_obf_0D14021B140C243D5C1C2E3E23212C17102934341D0E11);
                    $slotSettings->SetGameData('SweetLifeIGDealerCard', $_obf_0D37275B24252821042D1A1E0C281C260429221D220932);
                    $response = '{"cc":"' . $_obf_0D022D1F301438111B371D2C3C24173F1C5C21250D1632 . '|' . $_obf_0D0E2239233F403F07083639251E13090F2334173D3C01 . '","Lines":' . $slotSettings->GetGameData('SweetLifeIGLines') . ',"Bet":' . $slotSettings->GetGameData('SweetLifeIGBet') . ',"Amount":"' . sprintf('%01.2f', $balance * $slotSettings->CurrentDenom) . '","Reels":[' . $slotSettings->GetGameData('SweetLifeIGReels') . '],"Credit":' . floor($balance) . ',"Dealer":' . $slotSettings->cardsID[$_obf_0D25035C31183316381216122811401A1F2A17243E2B22] . ',"Other":[' . implode(',', $_obf_0D2E2D352519300D1C161E05101B3D341B0C3B1C1B0E22) . '],"Player":' . $slotSettings->cardsID[$_obf_0D283E1232290B032F3C29391E381D39322B320B170A11] . ',"PrevWin":' . $_obf_0D142C241F1B181D2723252601234035375B141A063811 . ',"RawCredit":' . floor($balance) . ',"Step":' . $_obf_0D1003222E11232A3C021F081E07131D1D233E2B0F5B11 . ',"Win":' . $_obf_0D14021B140C243D5C1C2E3E23212C17102934341D0E11 . ',"args":{},"cmd":"risk","time":"20181111T172027"}';
