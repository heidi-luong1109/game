...
*/            $response = '';
            ...
            if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'gameSpin' ) 
            {
                if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') ) 
                {
                    ...
                    $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotLines'] = 25;
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'bet' || $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                    {
                        ...
                        else
                        {
                            ...
                            $_obf_0D0F393B153C2A2F1B3619282622292F170124133D0D22[25] = [
                                [
                                    0, 
                                    1, 
                                    2, 
                            ...
                            for( $_obf_0D1A1D28155B19290D040C2E390F27100D1121120C1732 = 1; $_obf_0D1A1D28155B19290D040C2E390F27100D1121120C1732 <= 5; $_obf_0D1A1D28155B19290D040C2E390F27100D1121120C1732++ ) 
                            {
                                ...
                                foreach( $_obf_0D07260F39242B1E362C01033B081C151F1117223C2801 as $_obf_0D07240617342A2C272F1B38132A3D2E061D3917124011 ) 
                                {
                                    ...
                                    {
                                        if( $_obf_0D1A1D28155B19290D040C2E390F27100D1121120C1732 == 4 && $_obf_0D222B0F04393208295C2E123C405B180A2F251F2A0D32 == 3 ) 
                                        {
                                            $_obf_0D222B0F04393208295C2E123C405B180A2F251F2A0D32 = 5;
                                        }
                                        else
                                        {
                                            if( $_obf_0D1A1D28155B19290D040C2E390F27100D1121120C1732 == 2 ) 
                                            {
                                                $_obf_0D222B0F04393208295C2E123C405B180A2F251F2A0D32 = 3;
                                            }
                                            if( $_obf_0D1A1D28155B19290D040C2E390F27100D1121120C1732 == 4 ) 
                                            {
                                                $_obf_0D222B0F04393208295C2E123C405B180A2F251F2A0D32 = 5;
                                            }
                                        }
                    ...
                    $scattersWin = $slotSettings->Paytable[$scatter][$scattersCount] * $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotBet'];
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                {
                    ...
                    $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('PompeiiATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('PompeiiATMpl') . ',"xWin":[' . implode(',', $_obf_0D322E3B232F25403F0406272B0513332A2E082B113B11) . '],"add":0,"total":' . $slotSettings->GetGameData('PompeiiATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('PompeiiATBonusWin') * 100) . '';
                }
                else
                {
                    $slotSettings->SetGameData('PompeiiATTotalWin', $totalWin);
                ...
                if( $scattersCount >= 3 ) 
                {
                    if( $slotSettings->GetGameData('PompeiiATFreeGames') > 0 ) 
                    {
                        ...
                        $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('PompeiiATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('PompeiiATMpl') . ',"add":' . $slotSettings->slotFreeCount[$scattersCount] . ',"total":' . $slotSettings->GetGameData('PompeiiATFreeGames') . ',"xWin":[' . implode(',', $_obf_0D322E3B232F25403F0406272B0513332A2E082B113B11) . '],"totalWin":' . ($slotSettings->GetGameData('PompeiiATBonusWin') * 100) . '';
                    }
                    else
                    {
