...
namespace VanguardLTE\Games\SinbadsGoldenVoyagePT
{
    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            {
                $_obf_0D2813390912262B102326025B34051621182F31041832 = $slotSettings->GetGameData('SinbadsGoldenVoyagePTCurrentFreeGame');
                $_obf_0D131D5C261C392D093F121D1F2E13191812150D231232 = $slotSettings->GetGameData('SinbadsGoldenVoyagePTFreeSpins');
                $_obf_0D222C3C342D2C31305B091C0A1C10250A19140B2B2811 = $slotSettings->GetGameData('SinbadsGoldenVoyagePTFreeLogs');
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['ID']) && ($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['ID'] == '46583' || $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['ID'] == '46302') ) 
            {
                ...
                {
                    $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['bet'] = $slotSettings->GetGameData('SinbadsGoldenVoyagePTBet');
                ...
                else
                {
                    ...
                    $slotSettings->SetGameData('SinbadsGoldenVoyagePTBet', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['bet']);
                ...
                if( $scattersCount >= 3 ) 
                {
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        for( $fp = 0; $fp < 7; $fp++ ) 
                        {
                            ...
                            $_obf_0D1116233529011F0C293C2D011C113C061E381B341411[] = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"bonusMpl":1,"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":7,"currentFreeGames":' . ($fp + 1) . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('SinbadsGoldenVoyagePTBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('SinbadsGoldenVoyagePTFreeStartWin') . ',"totalWin":' . $currentWin . ',"winLines":[],"bonusInfo":"","Jackpots":"","reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                        }
                        if( $i > 1000 ) 
                        {
                            $winType = 'none';
                    ...
                    $slotSettings->SetGameData('SinbadsGoldenVoyagePTFreeSpins', $_obf_0D0135015B3B08180B21253F0A191F1E1040182A0E3E32);
                    $slotSettings->SetGameData('SinbadsGoldenVoyagePTFreeLogs', $_obf_0D1116233529011F0C293C2D011C113C061E381B341411);
                }
                $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"deltaBalanceInCents":1},"ID":40085}';
                if( $scattersCount >= 3 ) 
            ...
            switch( $umid ) 
            {
                ...
                case '46090':
                    ...
                    {
                        $_obf_0D2410310726250E1A3F025B0F2101383038135B043C01 = $slotSettings->GetGameData('SinbadsGoldenVoyagePTFreeSpins');
