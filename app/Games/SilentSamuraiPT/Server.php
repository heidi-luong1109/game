        ...
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['index']) ) 
            {
                ...
                if( $slotSettings->GetGameData('SilentSamuraiPTBonusStep') == 0 ) 
                {
                    ...
                    $slotSettings->SetGameData('SilentSamuraiPTBonusOpt', $_obf_0D1D03322B341A3E1C5B123F3E3F320821050D251C1611);
                    ...
                    {
                        $slotSettings->SetGameData('SilentSamuraiPTFreeGames', $slotSettings->GetGameData('SilentSamuraiPTFreeGames') + ($_obf_0D142C241F1B181D2723252601234035375B141A063811 / 100));
                    }
                    else
                    {
                        $slotSettings->SetGameData('SilentSamuraiPTFreeMpl', $slotSettings->GetGameData('SilentSamuraiPTFreeMpl') + $_obf_0D142C241F1B181D2723252601234035375B141A063811);
                    }
                ...
                {
                    $_obf_0D1D03322B341A3E1C5B123F3E3F320821050D251C1611 = $slotSettings->GetGameData('SilentSamuraiPTBonusOpt');
                    $_obf_0D142C241F1B181D2723252601234035375B141A063811 = $_obf_0D1D03322B341A3E1C5B123F3E3F320821050D251C1611[$_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['index']];
                    if( $_obf_0D142C241F1B181D2723252601234035375B141A063811 > 10 ) 
                    {
                        $slotSettings->SetGameData('SilentSamuraiPTFreeGames', $slotSettings->GetGameData('SilentSamuraiPTFreeGames') + ($_obf_0D142C241F1B181D2723252601234035375B141A063811 / 100));
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType']) ) 
            {
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"linesArr":[' . implode(',', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('SilentSamuraiPTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('SilentSamuraiPTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('SilentSamuraiPTBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('SilentSamuraiPTFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('SilentSamuraiPTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
            ...
            switch( $umid ) 
            {
                case '40743':
                    ...
                    if( $_obf_0D142C241F1B181D2723252601234035375B141A063811 == 0 && $slotSettings->GetGameData('SilentSamuraiPTFreeGames') == 0 ) 
                    {
                    ...
                    if( $_obf_0D142C241F1B181D2723252601234035375B141A063811 == 0 || $slotSettings->GetGameData('SilentSamuraiPTFreeGames') >= 28 || $slotSettings->GetGameData('SilentSamuraiPTFreeMpl') >= 8 ) 
                    {
                        $slotSettings->SetGameData('SilentSamuraiPTBonusStep', 2);
                        for( $i = 0; $i < 21; $i++ ) 
                        {
