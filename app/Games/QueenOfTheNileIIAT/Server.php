...
*/            $response = '';
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'bet' || $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
            {
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                {
                    ...
                    $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('QueenOfTheNileIIATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('QueenOfTheNileIIATMpl') . ',"add":0,"total":' . $slotSettings->GetGameData('QueenOfTheNileIIATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('QueenOfTheNileIIATBonusWin') * 100) . '';
                }
                else
                {
                    $slotSettings->SetGameData('QueenOfTheNileIIATTotalWin', $totalWin);
                ...
                if( $scattersCount >= 3 ) 
                {
                    ...
                    else
                    {
                        ...
                        $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('QueenOfTheNileIIATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('QueenOfTheNileIIATMpl') . ',"add":-1,"total":-1,"totalWin":' . ($slotSettings->GetGameData('QueenOfTheNileIIATBonusWin') * 100) . '';
                    }
                }
