            ...
            switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 ) 
            {
                case 'init':
                    ...
                    else
                    {
                        ...
                        $_obf_0D0D3D19173E372D15391D0C1E1F01030F1E163B5B3222 = 5;
                        $_obf_0D303824321032022116072C3F3F1A2225350B2B261611 = 0;
                ...
                case 'spin':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            for( $p = 0; $p <= 2; $p++ ) 
                            {
                                ...
                                {
                                    $_obf_0D1E0C132C292F3E260318130A122C015C3025041E1522 = 'smallWin' . $reels['reel' . $r][$p];
                                    $_obf_0D0410092A1F39153D171B22300F190E22312603020C01[] = 'i:' . $_obf_0D37325B0B3F020C26403910323E16341F311E110F1232 . ';a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:' . $p . ';s:9:"animation";s:4:"SWx' . $reels['reel' . $r][$p] . '";}';
                                    $_obf_0D37325B0B3F020C26403910323E16341F311E110F1232++;
                                }
                            }
                        }
                    ...
                    $rsym = $slotSettings->SymbolGame[rand(0, count($slotSettings->SymbolGame) - 1)];
                    $_obf_0D282A3E130518100418230D042B0A2B400930193F3232[0] .= ('i:2;i:' . $reels['reel1'][2] . ';i:3;i:' . $reels['reel1'][1] . ';i:4;i:' . $reels['reel1'][0] . ';i:5;i:' . $rsym . ';}');
                    $rsym = $slotSettings->SymbolGame[rand(0, count($slotSettings->SymbolGame) - 1)];
                    $_obf_0D282A3E130518100418230D042B0A2B400930193F3232[1] .= ('i:5;i:' . $reels['reel2'][2] . ';i:6;i:' . $reels['reel2'][1] . ';i:7;i:' . $reels['reel2'][0] . ';i:8;i:' . $rsym . ';}');
                    $rsym = $slotSettings->SymbolGame[rand(0, count($slotSettings->SymbolGame) - 1)];
                    $_obf_0D282A3E130518100418230D042B0A2B400930193F3232[2] .= ('i:8;i:' . $reels['reel3'][2] . ';i:9;i:' . $reels['reel3'][1] . ';i:10;i:' . $reels['reel3'][0] . ';i:11;i:' . $rsym . ';}');
                    $rsym = $slotSettings->SymbolGame[rand(0, count($slotSettings->SymbolGame) - 1)];
                    $_obf_0D282A3E130518100418230D042B0A2B400930193F3232[3] .= ('i:11;i:' . $reels['reel4'][2] . ';i:12;i:' . $reels['reel4'][1] . ';i:13;i:' . $reels['reel4'][0] . ';i:14;i:' . $rsym . ';}');
                    $rsym = $slotSettings->SymbolGame[rand(0, count($slotSettings->SymbolGame) - 1)];
                    $_obf_0D282A3E130518100418230D042B0A2B400930193F3232[4] .= ('i:14;i:' . $reels['reel5'][2] . ';i:15;i:' . $reels['reel5'][1] . ';i:16;i:' . $reels['reel5'][0] . ';i:17;i:' . $rsym . ';}');
                    $_obf_0D15135C211C1F15172A3D0D31233F2B1A3F1231270411 = 0;
                    $_obf_0D033E37340111220F282D2C192C0A5B1C0D2E14140711 = '';
                    $_obf_0D061B2C2334151F1D303E071B2A391C293D5C361A3C32 = '';
                    for( $_obf_0D31151A0E335C2508332E0524283F012C1927132D5B01 = 0; $_obf_0D31151A0E335C2508332E0524283F012C1927132D5B01 < $lines; $_obf_0D31151A0E335C2508332E0524283F012C1927132D5B01++ ) 
                    {
                        if( $cWins[$_obf_0D31151A0E335C2508332E0524283F012C1927132D5B01] > 0 ) 
                        {
                            ...
                            $_obf_0D061B2C2334151F1D303E071B2A391C293D5C361A3C32 .= ('i:' . ($_obf_0D31151A0E335C2508332E0524283F012C1927132D5B01 + 1) . ';i:' . ($cWins[$_obf_0D31151A0E335C2508332E0524283F012C1927132D5B01] / $betline) . ';');
                        }
                    }
                    if( $scattersCount >= 3 ) 
                    {
                    ...
                    $_obf_0D391B011D1126152F2D1A3D1C3916072B35151D2D3522 = 'a:' . $_obf_0D15135C211C1F15172A3D0D31233F2B1A3F1231270411 . ':{' . $_obf_0D061B2C2334151F1D303E071B2A391C293D5C361A3C32 . '}';
                    $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
