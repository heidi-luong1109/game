    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'gamble5GetUserCards' ) 
            {
                ...
                $_obf_0D25035C31183316381216122811401A1F2A17243E2B22 = $slotSettings->GetGameData('AncientEgyptPMDealerCard');
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'gamble5GetDealerCard' ) 
            {
                ...
                $slotSettings->SetGameData('AncientEgyptPMDealerCard', $_obf_0D1A28330223330201021115084008123B0F213C102922);
            ...
            {
                $_obf_0D1A10042F1C191310185C131108173E21101B37171911 = $slotSettings->GetGameData('AncientEgyptPMBonusState');
                $Balance = $slotSettings->GetBalance();
                if( $_obf_0D1A10042F1C191310185C131108173E21101B37171911 == 0 ) 
                {
                    ...
                    $_obf_0D142C241F1B181D2723252601234035375B141A063811 = $slotSettings->GetGameData('AncientEgyptPMBonusWin');
                    $_obf_0D0231242F16365B3C1D071E3B263319262A16261D2F01 = $slotSettings->GetGameData('AncientEgyptPMAllBet');
                ...
                $slotSettings->SetGameData('AncientEgyptPMBonusState', $_obf_0D1A10042F1C191310185C131108173E21101B37171911);
            }
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'doSpin' ) 
            {
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] != 'freespin' ) 
                {
                    ...
                    $slotSettings->SetGameData('AncientEgyptPMAllBet', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet'] * $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines']);
                }
                else
                {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    for( $r = 1; $r <= 5; $r++ ) 
                    {
                        for( $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 = 0; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 <= 2; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32++ ) 
                        {
                            ...
                            if( $reels['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] == $slotSettings->GetGameData('AncientEgyptPMSym') ) 
                            {
                    ...
                    for( $r = 1; $r <= 5; $r++ ) 
                    {
                        for( $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 = 0; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 <= 2; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32++ ) 
                        {
                            if( $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] == $slotSettings->GetGameData('AncientEgyptPMSym') ) 
                            {
                                $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel' . $r][0] = $slotSettings->GetGameData('AncientEgyptPMSym');
                                $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel' . $r][1] = $slotSettings->GetGameData('AncientEgyptPMSym');
                                $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel' . $r][2] = $slotSettings->GetGameData('AncientEgyptPMSym');
                                break;
                            }
                        }
                    }
                    ...
                    if( isset($slotSettings->Paytable[$slotSettings->GetGameData('AncientEgyptPMSym')]) && $slotSettings->Paytable[$slotSettings->GetGameData('AncientEgyptPMSym')][$_obf_0D28301D333F2827165C2511011438180336175B1E2A01] > 0 ) 
                    {
                        $_obf_0D2C1A321706030F3F1225352E343107190E393C131522 = $slotSettings->Paytable['' . $slotSettings->GetGameData('AncientEgyptPMSym')][$_obf_0D28301D333F2827165C2511011438180336175B1E2A01] * $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet'] * $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines'] * $bonusMpl;
                    }
                    else
                    {
                    ...
                    {
                        $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 .= ('&psym=' . $slotSettings->GetGameData('AncientEgyptPMSym') . '~' . $scattersWin . '~' . implode(',', $scattersStr));
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                {
                    ...
                    {
                        $spinType = 'c';
                        $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 .= ('&ms=' . $slotSettings->GetGameData('AncientEgyptPMSym') . '&fs_total=' . $slotSettings->GetGameData('AncientEgyptPMFreeGames') . '&fsmul_total=' . $slotSettings->GetGameData('AncientEgyptPMBonusMpl') . '&fswin_total=' . $slotSettings->GetGameData('AncientEgyptPMBonusWin') . '&fsres_total=' . $slotSettings->GetGameData('AncientEgyptPMBonusWin') . '');
                    }
                    else
                    {
                        $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 .= ('&ms=' . $slotSettings->GetGameData('AncientEgyptPMSym') . '&fsmul=' . $slotSettings->GetGameData('AncientEgyptPMBonusMpl') . '&fsmax=' . $slotSettings->GetGameData('AncientEgyptPMFreeGames') . '&fswin=' . $slotSettings->GetGameData('AncientEgyptPMTotalWin') . '&fs=' . $slotSettings->GetGameData('AncientEgyptPMCurrentFreeGame') . '&fsres=' . $slotSettings->GetGameData('AncientEgyptPMBonusWin'));
                    }
                ...
                $_obf_0D2D350C1338352E3F0236115C1407341C0926053F2211 = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"Sym":' . $slotSettings->GetGameData('AncientEgyptPMSym') . ',"BonusMpl":' . $slotSettings->GetGameData('AncientEgyptPMBonusMpl') . ',"lines":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines'] . ',"bet":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('AncientEgyptPMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AncientEgyptPMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"bonusWin":' . $slotSettings->GetGameData('AncientEgyptPMBonusWin') . ',"winLines":[],"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
