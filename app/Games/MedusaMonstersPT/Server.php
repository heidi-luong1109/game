        ...
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType']) ) 
            {
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType'] == 'regular' ) 
                {
                    ...
                    $_obf_0D2B21073B383F352F4033273225302208161E23042322 = [
                        -1, 
                        -1, 
                        -1, 
                        -1, 
                    ...
                    $slotSettings->SetGameData('MedusaMonstersPTstickySymbolArr', $_obf_0D2B21073B383F352F4033273225302208161E23042322);
                ...
                else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType'] == 'free' ) 
                {
                    ...
                    $_obf_0D2B21073B383F352F4033273225302208161E23042322 = $slotSettings->GetGameData('MedusaMonstersPTstickySymbolArr');
                    $bonusMpl = 1;
                }
                $linesId = [];
                $linesId[0] = [
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    if( $winType == 'bonus' ) 
                    {
                        ...
                        $reels = $slotSettings->GetReelStrips('bonus', $_obf_0D361A3F5C2730270A194003251E380340273105110711, $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent']);
                    }
                    else
                    {
                        if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                        {
                            $_obf_0D361A3F5C2730270A194003251E380340273105110711 = rand(0, 11);
                        }
                        else
                        {
                            $_obf_0D361A3F5C2730270A194003251E380340273105110711 = rand(0, 16);
                        }
                    ...
                    for( $r = 1; $r <= 6; $r++ ) 
                    {
                        for( $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 = 0; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 <= 6; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32++ ) 
                        {
                            ...
                            if( $reels['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] == '14' ) 
                            {
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && $slotSettings->GetGameData('MedusaMonstersPTwildRow') >= 1 ) 
                    {
                        ...
                        $reels['reel' . $wr][5] = '0';
                        $reels['reel' . $wr][6] = '0';
                        $_obf_0D291824340F2914103F042D2C5B1A1E1D31013C133032 = [];
                        $sr = 0;
                        for( $r = 1; $r <= 6; $r++ ) 
                        {
                            for( $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 = 0; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32 <= 6; $_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32++ ) 
                            {
                                if( $reels['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] == 0 ) 
                                {
                                    $_obf_0D2B21073B383F352F4033273225302208161E23042322[$sr] = -1;
                                }
                                else if( $reels['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] == $stickySymbol ) 
                                {
                                    $_obf_0D2B21073B383F352F4033273225302208161E23042322[$sr] = $stickySymbol;
                                }
                                else if( $_obf_0D2B21073B383F352F4033273225302208161E23042322[$sr] != -1 ) 
                                {
                                    $reels['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] = $stickySymbol;
                                }
                                if( $_obf_0D2B21073B383F352F4033273225302208161E23042322[$sr] != -1 ) 
                                {
                                    $_obf_0D291824340F2914103F042D2C5B1A1E1D31013C133032[] = $sr;
                                }
                                $sr++;
                            }
                        }
                    ...
                    else
                    {
                        ...
                        if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && $totalWin <= $slotSettings->GetBank((isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent']) ? $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] : '')) ) 
                        {
                            break;
                        }
                ...
                if( $scattersCount >= 3 ) 
                {
                    ...
                    $slotSettings->SetGameData('MedusaMonstersPTwildReels', $_obf_0D373B33361D1F2D401F0B2234112E362E0B2238062C01);
                    $slotSettings->SetGameData('MedusaMonstersPTIncreaseMpl', 0);
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"stickySymbolArr":[' . implode(',', $_obf_0D2B21073B383F352F4033273225302208161E23042322) . '],"wildRow":' . $slotSettings->GetGameData('MedusaMonstersPTwildRow') . ',"stickySymbol":' . $stickySymbol . ',"IncreaseMpl":1,"linesArr":[' . implode(',', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('MedusaMonstersPTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('MedusaMonstersPTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('MedusaMonstersPTBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('MedusaMonstersPTFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('MedusaMonstersPTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                ...
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"spinType":"' . $_obf_0D2C3832163F282A5C100B120D1405400B1F0A131C1201 . '","ww":' . $totalWin . ',"wt":"' . $winType . '","reelset":' . $_obf_0D361A3F5C2730270A194003251E380340273105110711 . ',"ewp":[0],"ssp":[],"credit":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"results":[' . implode(',', $reels['rp']) . '],"windowId":"iwBwxw"},"ID":49242,"umid":48}';
            ...
            switch( $umid ) 
            {
                case '49244':
                    $stickySymbol = $slotSettings->GetGameData('MedusaMonstersPTstickySymbol');
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"stickySymbolName":"THEME_' . $stickySymbol . '","windowId":"gEpIWw"},"ID":49245,"umid":80}';
                    break;
                case '31031':
                ...
                case '40066':
                    ...
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"funNoticeGames":0,"funNoticePayouts":0,"gameGroup":"aogmm","minBet":0,"maxBet":0,"minPosBet":0,"maxPosBet":50000,"coinSizes":[' . implode(',', $_obf_0D34145C302B1D0101103437210F3D3C2D1C3836051D11) . ']},"ID":40025,"umid":21}';
                    break;
                case '40036':
