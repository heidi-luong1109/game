        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 ) 
            {
                ...
                case 'poll':
                    ...
                    {
                        $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('Treasure40CTTotalWin')) * 100;
                    }
                ...
                case 'game_finished':
                    $slotSettings->SetGameData('Treasure40CTBonusWin', 0);
                    $slotSettings->SetGameData('Treasure40CTTotalWin', 0);
                    $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('Treasure40CTCurrentFreeGame0');
                ...
                case 'subgame_finished':
                    if( $slotSettings->GetGameData('Treasure40CTCurrentFreeGame0') < $slotSettings->GetGameData('Treasure40CTFreeGames') && $slotSettings->GetGameData('Treasure40CTFreeGames') > 0 ) 
                    {
                        ...
                        $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = $slotSettings->GetGameData('Treasure40CTFreeBalance');
                        ...
                        $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('Treasure40CTCurrentFreeGame0');
                        $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('Treasure40CTCurrentFreeGame0');
                ...
                case 'play':
                    ...
                    for( $_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32 = 0; $_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32 < $_obf_0D3B2A04131D2F18191C37340F3E1F161B362122233C01; $_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32++ ) 
                    {
                        ...
                        $_obf_0D21152412095C03222D3808130C3C012907290C181E22 = $slotSettings->GetGameData('Treasure40CTCards');
                        if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                        {
                            $state = 'freespin';
                        ...
                        $_obf_0D34321010172C292A1A09211E38143C3D083803231B01['play'][0]['result'][$_obf_0D5C3C3D341527110E0C130A171B275B1636053C3E3C32]['total_win'] = $slotSettings->GetGameData('Treasure40CTTotalWin') / $denom;
                ...
                case 'gamble':
                    ...
                    $slotSettings->SetGameData('Treasure40CTCards', $_obf_0D21152412095C03222D3808130C3C012907290C181E22);
