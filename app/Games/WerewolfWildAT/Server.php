...
*/            $response = '';
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'bet' || $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
            {
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                {
                    ...
                    $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('WerewolfWildATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('WerewolfWildATMpl') . ',"add":0,"total":' . $slotSettings->GetGameData('WerewolfWildATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('WerewolfWildATBonusWin') * 100) . '';
                }
                else
                {
                    $slotSettings->SetGameData('WerewolfWildATTotalWin', $totalWin);
                ...
                if( $scattersCount >= 3 ) 
                {
                    ...
                    else
                    {
                        ...
                        $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('WerewolfWildATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('WerewolfWildATMpl') . ',"add":-1,"total":-1,"totalWin":' . ($slotSettings->GetGameData('WerewolfWildATBonusWin') * 100) . '';
                    }
                }
