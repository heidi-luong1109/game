...
/*            if( config('LicenseDK.APL_INCLUDE_KEY_CONFIG') != 'wi9qydosuimsnls5zoe5q298evkhim0ughx1w16qybs2fhlcpn' ) 
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['action'] == 'risk' && $slotSettings->GetGameData('Pirate2IGWin') <= 0 ) 
            {
                ...
                case 'start':
                    ...
                    for( $i = 0; $i <= 1500; $i++ ) 
                    {
                        ...
                        if( $_obf_0D5C39151E192A0D0C273E041A211E31150B2201231D01 ) 
                        {
                            ...
                            {
                                $_obf_0D5B0D190F07273911051D090F2C1C12103018242A5C32 = $slotSettings->Bonus($bet * $lines, $fuseBet, $tmpBsCnt);
                            }
                        ...
                        $reels = $slotSettings->GetReelStrips($_obf_0D5C39151E192A0D0C273E041A211E31150B2201231D01, $tmpBsCnt);
                        $lineWins = [
                            0, 
                            0, 
                            0, 
                    ...
                    $slotSettings->SetGameData('Pirate2IGReels', $_obf_0D282A3E130518100418230D042B0A2B400930193F3232);
                    ...
                    $slotSettings->SetGameData('Pirate2IGDealerCard', $_obf_0D152F2B13101C1F2D320B1C302214192A26071A401E32);
