            ...
            switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 ) 
            {
                ...
                case 'spin':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                        {
                            $_obf_0D2312112F3011160814182121380A1A2F16273B173B01 = [
                                3, 
                                6, 
                                8
                            ];
                            shuffle($_obf_0D2312112F3011160814182121380A1A2F16273B173B01);
                            $bonusMpl = $_obf_0D2312112F3011160814182121380A1A2F16273B173B01[0];
                        }
                        $k = 0;
