        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('GreatAdventureEGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'choice':
                    ...
                    $_obf_0D3B221F2A0B312537393D083C05381D3B0F18171A0232 = [];
                    $_obf_0D3B221F2A0B312537393D083C05381D3B0F18171A0232[0] = '{"freespins":' . rand(3, 10) . ',"numberOfWilds":1,"wildIndexes":[' . rand(0, 7) . ']}';
                    $_obf_0D3B221F2A0B312537393D083C05381D3B0F18171A0232[1] = '{"freespins":' . rand(3, 10) . ',"numberOfWilds":1,"wildIndexes":[' . rand(0, 7) . ']}';
                    $_obf_0D3B221F2A0B312537393D083C05381D3B0F18171A0232[2] = '{"freespins":' . rand(3, 10) . ',"numberOfWilds":1,"wildIndexes":[' . rand(0, 7) . ']}';
                    $_obf_0D3B221F2A0B312537393D083C05381D3B0F18171A0232[3] = '{"freespins":' . rand(3, 10) . ',"numberOfWilds":1,"wildIndexes":[' . rand(0, 7) . ']}';
                    $_obf_0D3B221F2A0B312537393D083C05381D3B0F18171A0232[4] = '{"freespins":' . rand(3, 10) . ',"numberOfWilds":1,"wildIndexes":[' . rand(0, 7) . ']}';
                    $_obf_0D3B221F2A0B312537393D083C05381D3B0F18171A0232[$choice] = '{"freespins":' . $slotSettings->slotFreeCount . ',"numberOfWilds":1,"wildIndexes":[' . $holds . ']}';
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"selectedChoice":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['bet']['choice'] . ',"figures":[' . implode(',', $_obf_0D3B221F2A0B312537393D083C05381D3B0F18171A0232) . '],"freespins":' . $slotSettings->slotFreeCount . ',"gameCommand":"choice"},"state":"freespin","winAmount":' . ($slotSettings->GetGameData('GreatAdventureEGTBonusWin') * 100) . ',"gameIdentificationNumber":837,"gameNumber":1788419735632,"sessionKey":"65c80f0ddb696dd15c57d302947c4f35","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":1566881918263}';
                    break;
                case 'bet':
                    $linesId = [];
                    $linesId[0] = [
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $wild = [''];
                        $scatter = '8';
                        $reels = $slotSettings->GetReelStrips($winType, $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'], $slotSettings->GetGameData('GreatAdventureEGTFreespinCard'));
                        $_obf_0D1D190732303117182A032A083236110B03405B101A01 = $reels;
                        if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                        {
                            $_obf_0D352C3B2F030A2414021C3C255C37211A3E31241E3922 = $slotSettings->GetGameData('GreatAdventureEGTWildIndexes');
                            $wild = [$_obf_0D352C3B2F030A2414021C3C255C37211A3E31241E3922[0] . ''];
                        }
                        for( $k = 0; $k < $lines; $k++ ) 
                        {
                    ...
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = $slotSettings->GetGameData('GreatAdventureEGTFreeBalance');
                    }
                    else
                    {
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('GreatAdventureEGTCards');
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('GreatAdventureEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('GreatAdventureEGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('GreatAdventureEGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('GreatAdventureEGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('GreatAdventureEGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
