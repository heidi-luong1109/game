        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                case 'bonuschoice':
                    ...
                    $_obf_0D2A011415400237290F232D0C0D3C1C0238370F231401 = $slotSettings->GetGameData('ForestTaleEGTChoiceWinAmount');
                    $_obf_0D071B212611040A1736371C140F1C5B1A31143B3F1A32 = $slotSettings->GetGameData('ForestTaleEGTChoiceCount');
                ...
                case 'choice':
                    ...
                    $_obf_0D3E2A21032136092235272A2C3D1C0340223B163F0C11 = $slotSettings->GetGameData('ForestTaleEGTChoiceArr');
                    $fs = $slotSettings->GetGameData('ForestTaleEGTFreeGames');
                    $_obf_0D352C3B2F030A2414021C3C255C37211A3E31241E3922 = $slotSettings->GetGameData('ForestTaleEGTMultiplier');
                    $choice = (int)$_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['bet']['choice'];
                    $opt = [];
                    ...
                    if( count($_obf_0D3E2A21032136092235272A2C3D1C0340223B163F0C11) >= 3 && $slotSettings->GetGameData('ForestTaleEGTFreeGames') > 0 ) 
                    {
                    ...
                    $slotSettings->SetGameData('ForestTaleEGTChoiceArr', $_obf_0D3E2A21032136092235272A2C3D1C0340223B163F0C11);
                    $slotSettings->SetGameData('ForestTaleEGTFreeGames', $fs + $_obf_0D5B30195C320C5B21191E1C0226261E052D3C29120422);
                    $slotSettings->SetGameData('ForestTaleEGTMultiplier', $_obf_0D352C3B2F030A2414021C3C255C37211A3E31241E3922 + $_obf_0D1F2E39342F0F2D371835031F0A3B2C350E251D3C1732);
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"choice":{"pos":' . $choice . ',"multiplier":' . $slotSettings->GetGameData('ForestTaleEGTMultiplier') . ',"freespins":' . $slotSettings->GetGameData('ForestTaleEGTFreeGames') . ',"mult":' . $_obf_0D1F2E39342F0F2D371835031F0A3B2C350E251D3C1732 . ',"fs":' . $_obf_0D5B30195C320C5B21191E1C0226261E052D3C29120422 . ',"play":' . $_obf_0D105C2811322F073E163E1B1F390D1E3D1A03323D3F22 . ',"closed":[' . $_obf_0D22363F0F3C1234262F032D2D1A3F2B0C1F1F2A3D3801 . ']},"freespins":' . $slotSettings->GetGameData('ForestTaleEGTFreeGames') . ',"multiplier":1,"gameCommand":"choice"},"state":"' . $state . '","winAmount":' . ($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":1789706666325,"sessionKey":"46e640104224cef8245c4329c25ef561","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":1567196976582}';
                    break;
                case 'login':
                ...
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('ForestTaleEGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'bet':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        if( $totalWin <= $_obf_0D3030072F273706293C133F2F072B113B383322291201 && $_obf_0D4032063326312E14292A362E1B3E0B192115063F2322 >= 3 ) 
                        {
                            ...
                            $slotSettings->SetGameData('ForestTaleEGTChoiceCount', $_obf_0D4032063326312E14292A362E1B3E0B192115063F2322);
                        }
                        if( $i > 1000 ) 
                        {
                            $winType = 'none';
                    ...
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = $slotSettings->GetGameData('ForestTaleEGTFreeBalance');
                    }
                    else
                    {
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('ForestTaleEGTCards');
                    ...
                    if( $_obf_0D4032063326312E14292A362E1B3E0B192115063F2322 >= 3 ) 
                    {
                        ...
                        $slotSettings->SetGameData('ForestTaleEGTBonusCnt', $_obf_0D4032063326312E14292A362E1B3E0B192115063F2322);
                    ...
                    {
                        $state = 'freespin';
                        $_obf_0D341E1906402E012D2302041A0B29343137123F023201 = $slotSettings->GetGameData('ForestTaleEGTFreeGames');
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('ForestTaleEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('ForestTaleEGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('ForestTaleEGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('ForestTaleEGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('ForestTaleEGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
