...
*/            $response = '';
            ...
            else if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'bet' || $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
            {
                ...
                if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                {
                    ...
                    $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('BigBenATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('BigBenATMpl') . ',"add":0,"total":' . $slotSettings->GetGameData('BigBenATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('BigBenATBonusWin') * 100) . '';
                }
                else
                {
                    $slotSettings->SetGameData('BigBenATTotalWin', $totalWin);
                ...
                if( $scattersCount >= 3 ) 
                {
                    if( $slotSettings->GetGameData('BigBenATFreeGames') > 0 ) 
                    {
                        ...
                        $_obf_0D1E5B120D2A071E012A32025C390D0F061109362A0111 = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('BigBenATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('BigBenATMpl') . ',"add":' . $slotSettings->slotFreeCount . ',"total":' . $slotSettings->GetGameData('BigBenATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('BigBenATBonusWin') * 100) . '';
                    }
                    else
                    {
