                            ...
                            else
                            {
                                ...
                                if( $s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 && $s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 && $s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 ) 
                                {
                                    ...
                                    if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                    {
                                        ...
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BermudaTrianglePTMMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                    }
                                }
                                if( in_array($s[0], [
                                    4, 
                                ...
                                {
                                    $_obf_0D0D3D192C381F295C2F3723362D0A4029092D091C3022 = [];
                                    $_obf_0D0D3D192C381F295C2F3723362D0A4029092D091C3022[1] = 400;
                                    $_obf_0D0D3D192C381F295C2F3723362D0A4029092D091C3022[2] = 500;
                                    $_obf_0D0D3D192C381F295C2F3723362D0A4029092D091C3022[3] = 600;
                                    $_obf_0D0D3D192C381F295C2F3723362D0A4029092D091C3022[4] = 700;
                                    $_obf_0D0D3D192C381F295C2F3723362D0A4029092D091C3022[5] = 1000;
                                    $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 = $_obf_0D0D3D192C381F295C2F3723362D0A4029092D091C3022[$lines] * $betLine;
                                    if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                    {
                                        $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                        $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BermudaTrianglePTMMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
