        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'settings':
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"denominations":[' . implode(',', $_obf_0D0C2105130819393F29112D311A15170F3C2913160B01) . '],"bets":[[' . implode(',', $_obf_0D131333153E3B3F113536290D1D1A025B0D3F16341932) . '],[[1,1,14000],[2,1,28000],[3,1,42000],[4,1,56000],[5,2,70000]]],"paytables":{"1":[1,1,2,3,5,7,18,50,100,200,500],"2":[1,1,2,3,5,7,18,50,100,200,950]},"jackpot":true,"jackpotMinBet":1,"jackpotMaxBet":100000},"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"f470855a38998b4c1678a0fd7d0ea815","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":1567091239811}';
                    break;
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('JokerPokerEGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'ping':
                    ...
                    break;
                case 'draw':
                    $_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01 = $slotSettings->GetGameData('JokerPokerEGTCurrentCards');
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $totalWin = $_obf_0D144030072C09300C13273D0B122A320C3B04012D0B32[0] * $slotSettings->GetGameData('JokerPokerEGTBet');
                        if( $totalWin <= $bank ) 
                        {
                            break;
                        }
                    ...
                    $_obf_0D121E382D1431172E31100521310724191E141C383D32 = $_obf_0D144030072C09300C13273D0B122A320C3B04012D0B32[1] - 1;
                    $response = '{"responseEvent":"spin","responseType":"bet","serverResponse":{"cardsArr":' . json_encode($cardsArr) . ',"state":"idle","slotLines":1,"slotBet":' . $slotSettings->GetGameData('JokerPokerEGTBet') . ',"totalFreeGames":' . $slotSettings->GetGameData('JokerPokerEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('JokerPokerEGTCurrentFreeGame') . ',"Balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"afterBalance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"bonusWin":' . $slotSettings->GetGameData('JokerPokerEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"cards":[' . implode(',', $_obf_0D22070A5B1A1C152C0E341D10372F3F1F21301C343C11) . ']}}';
                ...
                case 'bet':
                    ...
                    $slotSettings->SetGameData('JokerPokerEGTGambleStep', 5);
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('JokerPokerEGTCards');
                    $cardsArr = [];
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $totalWin = $_obf_0D144030072C09300C13273D0B122A320C3B04012D0B32[0] * $allbet;
                        if( $totalWin <= $bank ) 
                        {
                    ...
                    $slotSettings->SetGameData('JokerPokerEGTCurrentCards', $_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01);
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"cardsArr":' . json_encode($cardsArr) . ',"state":"' . $state . '","slotLines":1,"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('JokerPokerEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('JokerPokerEGTCurrentFreeGame') . ',"Balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"afterBalance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"bonusWin":' . $slotSettings->GetGameData('JokerPokerEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"cards":[' . implode(',', $_obf_0D1633111E0C1C2610253F2A390E1E262B293E0F273111) . ']}}';
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('JokerPokerEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('JokerPokerEGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('JokerPokerEGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('JokerPokerEGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('JokerPokerEGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
