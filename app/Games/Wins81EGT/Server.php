        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('Wins81EGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'bet':
                            ...
                            else
                            {
                                ...
                                if( $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[0] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[1] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[2] > 0 ) 
                                {
                                    ...
                                    if( $_obf_0D37111B3335140203262E17350902171D182F5B312522 < $_obf_0D1A08361C315C0F302C102A0D011D1F041B0637020C11 ) 
                                    {
                                        ...
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . ',"len":3,"winAmount":' . ($_obf_0D37111B3335140203262E17350902171D182F5B312522 * 100) . ',"freespins":0,"cells":[' . implode(',', $_obf_0D1F0B292F242B2516303F2D3C2C5C2205250F2C320F11) . '],"multipliersWinInfo":[{"count":' . $_obf_0D0D2B0330121904261537292A32120D2E372A24263032 . ',"winPerCount":' . ($_obf_0D2312103E1E3F2B0A2724252D2916031F2E18100A2222 * 100) . ',"multiplier":' . $_obf_0D0D2B0330121904261537292A32120D2E372A24263032 . '}]}';
                                    }
                                }
                                if( $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[0] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[1] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[2] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[3] > 0 ) 
                                {
                                    ...
                                    {
                                        $_obf_0D37111B3335140203262E17350902171D182F5B312522 = $_obf_0D1A08361C315C0F302C102A0D011D1F041B0637020C11;
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . ',"len":3,"winAmount":' . ($_obf_0D37111B3335140203262E17350902171D182F5B312522 * 100) . ',"freespins":0,"cells":[' . implode(',', $_obf_0D1F0B292F242B2516303F2D3C2C5C2205250F2C320F11) . '],"multipliersWinInfo":[{"count":' . $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 . ',"winPerCount":' . ($_obf_0D2312103E1E3F2B0A2724252D2916031F2E18100A2222 * 100) . ',"multiplier":' . $_obf_0D0D2B0330121904261537292A32120D2E372A24263032 . '}]}';
                                    }
                                }
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('Wins81EGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('Wins81EGTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('Wins81EGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"Jackpots":' . $_obf_0D28393910101E062539311B3F371C121912162B061E32 . ',"reelsSymbols":' . $_obf_0D273522403840350F0A36072E150A0524143F382C3B32 . '}}';
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('Wins81EGTCards');
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 = '' . rand(1, 8) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(1, 8);
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(1, 8) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(1, 8));
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(1, 8) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(1, 8));
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(1, 8) . ',' . $reels['reel4'][0] . ',' . $reels['reel4'][1] . ',' . $reels['reel4'][2] . ',' . rand(1, 8));
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"reels":[' . $_obf_0D3E331C040E390B031B03100422040311293E023E0322 . '],"combos":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"scatters":[],"expand":[],"gambles":0,"freespins":0,"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":549,"gameNumber":1878401413134,"balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"7933737168a180846486f021c39b0078","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('Wins81EGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('Wins81EGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('Wins81EGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('Wins81EGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('Wins81EGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
