        ...
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType']) ) 
            {
                ...
                if( $_obf_0D0B230B342E0C0727115B043F283E2137182D312A3D11 >= 2 ) 
                {
                    ...
                    {
                        $slotSettings->SetGameData('TigerClawPTFreeGames', $slotSettings->GetGameData('TigerClawPTFreeGames') + $slotSettings->slotFreeCountAdd[$_obf_0D0B230B342E0C0727115B043F283E2137182D312A3D11]);
                    }
                    else if( $_obf_0D0B230B342E0C0727115B043F283E2137182D312A3D11 >= 3 ) 
                    {
                        $slotSettings->SetGameData('TigerClawPTFreeStartWin', $totalWin);
                        $slotSettings->SetGameData('TigerClawPTBonusWin', 0);
                        $slotSettings->SetGameData('TigerClawPTFreeGames', $slotSettings->slotFreeCount[$_obf_0D0B230B342E0C0727115B043F283E2137182D312A3D11]);
                    }
                }
                $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"linesArr":[4096],"slotLines":' . $lines . ',"slotBet":' . $_obf_0D3B5B082B1F0F0235292F01260B303B0F2E32313B0832 . ',"totalFreeGames":' . $slotSettings->GetGameData('TigerClawPTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('TigerClawPTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('TigerClawPTBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('TigerClawPTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $_obf_0D033835123E051D331E010A3C300C332C34021F052801 . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
