                        ...
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            for( $p = 0; $p <= 2; $p++ ) 
                            {
                                if( $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel' . $r][$p] == -1 ) 
                                {
                                    ...
                                    {
                                        $_obf_0D0410092A1F39153D171B22300F190E22312603020C01[] = 'i:' . $_obf_0D37325B0B3F020C26403910323E16341F311E110F1232 . ';a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:' . $p . ';s:9:"animation";s:5:"wild1";}';
                                    }
