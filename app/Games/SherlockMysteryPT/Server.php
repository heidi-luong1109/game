    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType']) ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    else
                    {
                        ...
                        if( $_obf_0D28301D333F2827165C2511011438180336175B1E2A01 >= 3 ) 
                        {
                            ...
                            $slotSettings->SetGameData('SherlockMysteryPTBonusWinArr', $_obf_0D0A04361940345B1A0732041A3D3026313B103C153B22);
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"linesArr":[' . implode(',', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('SherlockMysteryPTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('SherlockMysteryPTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('SherlockMysteryPTBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('SherlockMysteryPTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
            ...
            {
                case '40591':
                    $_obf_0D05362C2B0E0B1A11092A1E281A222F5C071A0D263701 = $slotSettings->GetGameData('SherlockMysteryPTBonusWinArr');
                    ...
                    $slotSettings->SetGameData('SherlockMysteryPTBonusWinArr', $_obf_0D05362C2B0E0B1A11092A1E281A222F5C071A0D263701);
                    break;
                case '31031':
