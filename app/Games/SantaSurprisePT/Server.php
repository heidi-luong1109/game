        ...
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType']) ) 
            {
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType'] == 'regular' ) 
                {
                    ...
                    $slotSettings->SetGameData('SantaSurprisePTChosenTree', $_obf_0D332D0D1D1835283D2F2A3E350C0D3B3806132F092532);
                    $slotSettings->SetGameData('SantaSurprisePTstartStick', $_obf_0D5B04291F2E1B3312272C03162513041836345B260611);
                    $slotSettings->SetGameData('SantaSurprisePTtreeStep', $_obf_0D09345C0F041B195C25080E373113305C263C3D040B32);
                    $slotSettings->SetGameData('SantaSurprisePTlastWins', $_obf_0D02300F1F24102B1F3F253C5B3F132323180A01232F11);
                }
                ...
                $slotSettings->SetGameData('SantaSurprisePTAllBet', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['bet']);
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    else
                    {
                        ...
                        if( ($scattersCount >= 3 || $_obf_0D2F2D132713113D2310013B1A1E0D315C1A3B38213601) && $winType != 'bonus' ) 
                        {
                        }
                ...
                if( $_obf_0D2F2D132713113D2310013B1A1E0D315C1A3B38213601 ) 
                {
                    ...
                    $slotSettings->SetGameData('SantaSurprisePTWinValues', $_obf_0D1A0A3E13292D2D182C023B2B27315B190F1507391601['curValues']);
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{' . $_obf_0D34133B2D401823121A3E3C0C3B3440063B2832150332 . '"allbet":' . $slotSettings->GetGameData('SantaSurprisePTAllBet') . ',"betLine":' . $slotSettings->GetGameData('SantaSurprisePTBetLine') . ',"linesArr":[' . implode(',', $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('SantaSurprisePTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('SantaSurprisePTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('SantaSurprisePTBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('SantaSurprisePTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
            ...
            {
                case '40145':
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['pickIndex'] >= 0 && $slotSettings->GetGameData('SantaSurprisePTPickedCount') < $slotSettings->GetGameData('SantaSurprisePTprizeBonusNum') ) 
                    {
                        $_obf_0D262D0136400C3F0525143D36383F363C3514155B0711 = json_decode($slotSettings->GetGameData('SantaSurprisePTLastResponse'));
                        $values = $slotSettings->GetGameData('SantaSurprisePTWinValues');
                        $pick = $slotSettings->GetGameData('SantaSurprisePTPickedCount');
                        $_obf_0D5C210631273818332424032C281E0D38310B1F0A1201 = $slotSettings->GetGameData('SantaSurprisePTPickedCountArr');
                        $_obf_0D23292E1910310B2D0F382A090D063F2A132521111C32 = $values[$pick] * $slotSettings->GetGameData('SantaSurprisePTBetLine');
                        ...
                        $slotSettings->SetGameData('SantaSurprisePTPickedCountArr', $_obf_0D5C210631273818332424032C281E0D38310B1F0A1201);
                        ...
                        $slotSettings->SaveLogReport(json_encode($_obf_0D262D0136400C3F0525143D36383F363C3514155B0711), 0, 0, $_obf_0D23292E1910310B2D0F382A090D063F2A132521111C32, 'prize_bonus');
                        $slotSettings->SetGameData('SantaSurprisePTLastResponse', json_encode($_obf_0D262D0136400C3F0525143D36383F363C3514155B0711));
                    }
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"pickedIndex":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['pickIndex'] . ',"windowId":"ohzB06"},"ID":49298,"umid":204}';
                    break;
                case '31031':
