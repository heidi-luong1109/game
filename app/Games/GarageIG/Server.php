...
/*            if( config('LicenseDK.APL_INCLUDE_KEY_CONFIG') != 'wi9qydosuimsnls5zoe5q298evkhim0ughx1w16qybs2fhlcpn' ) 
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['action'] == 'risk' && $slotSettings->GetGameData('GarageIGWin') <= 0 ) 
            {
            ...
            switch( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['action'] ) 
            {
                case 'open':
                    ...
                    $_obf_0D102A03031034183D3B31211E3E12310B343E1C090901 = $slotSettings->GetGameData('GarageIGBankReserved');
                    $finished = 'false';
                    $bet = $slotSettings->GetGameData('GarageIGLines');
                    $lines = $slotSettings->GetGameData('GarageIGBet');
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['Super'] > 0 ) 
                    {
                    ...
                    if( $finished ) 
                    {
                        ...
                        $slotSettings->SetBank('bonus', $_obf_0D102A03031034183D3B31211E3E12310B343E1C090901);
                    }
                    $bank = $slotSettings->GetBank('bonus');
                    for( $i = 0; $i <= 1000; $i++ ) 
                    {
                        $_obf_0D5B0D190F07273911051D090F2C1C12103018242A5C32 = $slotSettings->Bonus2($bet * $lines, $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['Super'], $finished);
                    ...
                    else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['Super'] <= 0 ) 
                    {
                        $slotSettings->SetGameData('GarageIGBankReserved', 0);
                        $slotSettings->SetBank('bonus', $_obf_0D102A03031034183D3B31211E3E12310B343E1C090901);
                    }
                    ...
                    $response = '{"Amount":"' . sprintf('%01.2f', $balance * $slotSettings->CurrentDenom) . '",' . $_obf_0D300523062B1B32265B033B2F1D2C3B0D28045C3F1232 . '"Credit":' . floor($balance) . ',"Denomination":"' . sprintf('%01.2f', $slotSettings->CurrentDenom) . '","Finished":' . $finished . ',"RawCredit":954,"Win":' . $totalWin . ',"args":{"Super":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['Super'] . '},"cmd":"open","time":"20190328T124737"}';
                ...
                case 'init':
                    ...
                    $response = '{"Amount":"' . sprintf('%01.2f', $balance * $slotSettings->CurrentDenom) . '","slotViewState":"' . $slotSettings->slotViewState . '","slotKeyConfig":' . $slotSettings->slotKeyConfig . ',"BetArray":[' . implode(',', $slotSettings->Bet) . '],"Credit":' . floor($balance) . ',"Currency":"' . $slotSettings->slotCurrency . '","Denomination":"' . sprintf('%01.2f', $slotSettings->CurrentDenom) . '","Denominations":{"100":"1.00"},"HelpCoef":[[0,0,0],[200,1000,5000],[100,500,2000],[30,100,500],[20,50,200],[10,30,100],[5,10,50],[3,5,20],[2,3,10]],"LastBet":' . $bet . ',"LastLines":' . $lines . ',"MaxWin":675000,"RawCredit":1000,"Reels":[' . $_obf_0D282A3E130518100418230D042B0A2B400930193F3232 . '],"Win":0,"args":{},"cmd":"init","time":"20190327T143954"}';
                    break;
                case 'status':
                ...
                case 'start':
                    ...
                    for( $i = 0; $i <= 1500; $i++ ) 
                    {
                        if( $_obf_0D5C39151E192A0D0C273E041A211E31150B2201231D01 ) 
                        {
                            ...
                            {
                                $_obf_0D5B0D190F07273911051D090F2C1C12103018242A5C32 = $slotSettings->Bonus1($bet * $lines, $fuseBet);
                            }
                            else
                            {
                                $_obf_0D102A03031034183D3B31211E3E12310B343E1C090901 = $bet * $lines * 10;
                                if( $bank < $_obf_0D102A03031034183D3B31211E3E12310B343E1C090901 ) 
                                {
                                    $_obf_0D5C39151E192A0D0C273E041A211E31150B2201231D01 = false;
                                }
                                else
                                {
                                    ...
                                    {
                                        $_obf_0D5B0D190F07273911051D090F2C1C12103018242A5C32 = [];
                                        $_obf_0D5B0D190F07273911051D090F2C1C12103018242A5C32['win'] = 0;
                                        $_obf_0D5B0D190F07273911051D090F2C1C12103018242A5C32['info'] = '"NeedBonus2": 4,';
                                        $slotSettings->SetGameData('GarageIGSuperKeySteps', 5);
                                        $slotSettings->SetGameData('GarageIGBankReserved', $_obf_0D102A03031034183D3B31211E3E12310B343E1C090901);
                                        $slotSettings->SetBank((isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent']) ? $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] : ''), -1 * $_obf_0D102A03031034183D3B31211E3E12310B343E1C090901);
                                    }
                                    else
                                    {
                                        $_obf_0D5B0D190F07273911051D090F2C1C12103018242A5C32 = $slotSettings->Bonus2Static($bet * $lines, $fuseBet);
                                    }
                                }
                            }
                            $totalWin = $_obf_0D5B0D190F07273911051D090F2C1C12103018242A5C32['win'];
                        ...
                        for( $_obf_0D182E3D04083B031231152D232B1935261A062D0A0F01 = 0; $_obf_0D182E3D04083B031231152D232B1935261A062D0A0F01 <= 4; $_obf_0D182E3D04083B031231152D232B1935261A062D0A0F01++ ) 
                        {
                            ...
                            if( $reels['reel' . ($_obf_0D182E3D04083B031231152D232B1935261A062D0A0F01 + 1)][0] == 1 ) 
                            {
                                $_obf_0D3D31320F040A1F042F3539050106042B0B0C061F1701++;
                            }
                            if( $reels['reel' . ($_obf_0D182E3D04083B031231152D232B1935261A062D0A0F01 + 1)][1] == 1 ) 
                            {
                                $_obf_0D3D31320F040A1F042F3539050106042B0B0C061F1701++;
                            }
                            if( $reels['reel' . ($_obf_0D182E3D04083B031231152D232B1935261A062D0A0F01 + 1)][2] == 1 ) 
                            {
                                $_obf_0D3D31320F040A1F042F3539050106042B0B0C061F1701++;
                            }
                        }
                        ...
                        else if( ($bonusSym >= 3 || $_obf_0D3D31320F040A1F042F3539050106042B0B0C061F1701 >= 3) && !$_obf_0D5C39151E192A0D0C273E041A211E31150B2201231D01 ) 
                        {
                        }
                    ...
                    $_obf_0D1A2F3507301A371F10192C355C12401B2B315B1E1211 = 'false';
                    if( $slotSettings->GetGameData('GarageIGSuperKey') >= 9 ) 
                    {
                        $_obf_0D1A2F3507301A371F10192C355C12401B2B315B1E1211 = 'true';
                    }
                    ...
                    $slotSettings->SetGameData('GarageIGDealerCard', $_obf_0D152F2B13101C1F2D320B1C302214192A26071A401E32);
                    $_obf_0D40110C403C2D2D0B3B020B223932223F0B3F380D3711 = 'bet';
                    if( $_obf_0D5C39151E192A0D0C273E041A211E31150B2201231D01 ) 
                    {
                        if( $slotSettings->bonusType == 1 ) 
                        {
                            $slotSettings->SaveAccumBonus($_obf_0D5B0D190F07273911051D090F2C1C12103018242A5C32['accCount'], $_obf_0D5B0D190F07273911051D090F2C1C12103018242A5C32['accWin']);
                        }
