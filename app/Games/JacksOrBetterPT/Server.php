    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            if( $umid == '40186' ) 
            {
                ...
                $_obf_0D0E141F34210C271834013D060623402816092A400E11 = $slotSettings->GetGameData('JacksOrBetterPTTotalWin');
                ...
                {
                    $_obf_0D373202210A393C1A2E39210B383D283D05051C3E1001 = rand($slotSettings->GetGameData('JacksOrBetterPTDCard'), 12);
                }
                else
                {
                    $_obf_0D373202210A393C1A2E39210B383D283D05051C3E1001 = rand(0, $slotSettings->GetGameData('JacksOrBetterPTDCard'));
                }
                $_obf_0D3933282D2F3207131E01322E3D2A243306341C300F01 = [
                    $cardsArr[0], 
                    $cardsArr[1], 
                ...
                if( $slotSettings->GetGameData('JacksOrBetterPTDCard') == $_obf_0D373202210A393C1A2E39210B383D283D05051C3E1001 ) 
                {
                    $totalWin = $_obf_0D0E141F34210C271834013D060623402816092A400E11;
                }
                else if( $slotSettings->GetGameData('JacksOrBetterPTDCard') < $_obf_0D373202210A393C1A2E39210B383D283D05051C3E1001 ) 
                {
                ...
                $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"amount":' . $slotSettings->GetGameData('JacksOrBetterPTDAmount') . ',"cWin":' . $_obf_0D0E141F34210C271834013D060623402816092A400E11 . ',"pcard":' . $slotSettings->GetGameData('JacksOrBetterPTDCard') . ',"totalWin":' . $totalWin . ',"data":{"cards":' . json_encode($_obf_0D3933282D2F3207131E01322E3D2A243306341C300F01) . ',"windowId":"VRqbhm"},"ID":40187,"umid":46}';
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"deltaBalanceInCents":1},"ID":40085}';
            ...
            if( $umid == '40182' ) 
            {
                ...
                $slotSettings->SetGameData('JacksOrBetterPTDAmount', (double)$_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['amount']);
                $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"am":' . $slotSettings->GetGameData('JacksOrBetterPTDAmount') . ',"card":{"suit":"' . $cardsArr[0]->suit . '","value":"' . $cardsArr[0]->value . '"},"windowId":"VRqbhm"},"ID":40183,"umid":46}';
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"deltaBalanceInCents":1},"ID":40085}';
            }
            if( $umid == '40179' ) 
            {
                $_obf_0D3933282D2F3207131E01322E3D2A243306341C300F01 = $slotSettings->GetGameData('JacksOrBetterPTCurrentCards');
                $cardsArr = $slotSettings->GetGameData('JacksOrBetterPTCards');
                $_obf_0D08362E123C0705361C1E135B2D30290C1F3D37321432 = 0;
                $_obf_0D250C12110C045B341A300E173F143F2A281425015C11 = $slotSettings->GetGameData('JacksOrBetterPTBankReserved');
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    $totalWin = $_obf_0D3930021E065C30212C110F1D2D150E03113925171401 * $slotSettings->GetGameData('JacksOrBetterPTBet');
                    if( $totalWin <= $bank ) 
                    {
                        break;
                    }
                ...
                $response = '{"responseEvent":"spin","responseType":"bet","serverResponse":{"cardsArr":' . json_encode($cardsArr) . ',"state":"idle","slotLines":1,"slotBet":' . $slotSettings->GetGameData('JacksOrBetterPTBet') . ',"totalFreeGames":0,"currentFreeGames":0,"Balance":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"afterBalance":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"bonusWin":0,"totalWin":' . $totalWin . ',"winLines":[],"cards":' . json_encode($_obf_0D3933282D2F3207131E01322E3D2A243306341C300F01) . '}}';
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"deltaBalanceInCents":1},"ID":40085}';
            ...
            if( $umid == '40175' ) 
            {
                ...
                $slotSettings->SetGameData('JacksOrBetterPTCurrentCards', $_obf_0D3933282D2F3207131E01322E3D2A243306341C300F01);
