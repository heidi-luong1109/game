            ...
            switch( $gameData['slotEvent'] ) 
            {
                ...
                case 'A/u25':
                    ...
                    if( $lastEvent != 'NULL' ) 
                    {
                        ...
                        for( $i = 0; $i < 5; $i++ ) 
                        {
                            $_obf_0D3933282D2F3207131E01322E3D2A243306341C300F01[$i] = (array)$_obf_0D3933282D2F3207131E01322E3D2A243306341C300F01[$i];
                ...
                case 'A/u253':
                    ...
                    $_obf_0D3933282D2F3207131E01322E3D2A243306341C300F01 = $slotSettings->GetGameData('JokerCardAMCurrentCards');
                    ...
                    $response = '104010' . $balanceFormated . $slotSettings->HexFormat(round($totalWin * 100)) . '10001a33e810' . implode('', $slotSettings->GetGameData('JokerCardAMHistoryCards')) . $_obf_0D0F40311C121D1C3213161C1E21311E1C3116403B1001 . implode('', $holds) . '020' . $_obf_0D113C0B01390D1431072D263B3B0C27370D0D363D4032 . '00000000061010151a26431f4';
                    $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22 = $slotSettings->HexFormat(round($totalWin * 100)) . '10001a33e8100000000000000000' . $_obf_0D0F40311C121D1C3213161C1E21311E1C3116403B1001 . implode('', $holds) . '020' . $_obf_0D113C0B01390D1431072D263B3B0C27370D0D363D4032 . '00000000';
                    $slotSettings->SetGameData('JokerCardAMCollect', $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22);
                ...
                case 'A/u257':
                    $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                    $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22 = $slotSettings->GetGameData('JokerCardAMCollect');
                    $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01));
                ...
                case 'A/u251':
                    ...
                    $slotSettings->SetGameData('JokerCardAMCurrentCards', $_obf_0D3933282D2F3207131E01322E3D2A243306341C300F01);
                ...
                case 'A/u258':
                    $doubleWin = rand(1, 2);
                    $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032 = $slotSettings->GetGameData('JokerCardAMTotalWin');
                    $_obf_0D1135362B02051A22113F1E5B2E2B062E123E2A2F2311 = $slotSettings->GetGameData('JokerCardAMHistoryCards');
                    $_obf_0D16370E06283D2C01032D38041C0D1C171D273F260F01 = $slotSettings->GetGameData('JokerCardAMGambleStep');
                    $bank = $slotSettings->GetBank((isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent']) ? $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] : ''));
                    ...
                    if( $doubleWin == 1 ) 
                    {
                        if( $_obf_0D402727035C182F2E13251F291908030C400B2C222B01 == 6 ) 
                        {
                            $_obf_0D283E1232290B032F3C29391E381D39322B320B170A11 = rand(2, 14);
                            $_obf_0D34013C37172D1239362C15351C16011E0D3C11141901 = rand(0, 1);
                        }
                        else
                        {
                            $_obf_0D283E1232290B032F3C29391E381D39322B320B170A11 = rand(2, 14);
                            $_obf_0D34013C37172D1239362C15351C16011E0D3C11141901 = rand(2, 3);
                        }
                    }
                    else
                    {
                        if( $_obf_0D402727035C182F2E13251F291908030C400B2C222B01 == 4 ) 
                        {
                            $_obf_0D283E1232290B032F3C29391E381D39322B320B170A11 = rand(2, 14);
                            $_obf_0D34013C37172D1239362C15351C16011E0D3C11141901 = rand(0, 1);
                        }
                    ...
                    if( $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032 > 0 ) 
                    {
                        ...
                        $_obf_0D23292E1910310B2D0F382A090D063F2A132521111C32 = $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032 * 2;
                    }
                    else
                    {
                    ...
                    array_unshift($_obf_0D1135362B02051A22113F1E5B2E2B062E123E2A2F2311, $cardsID['c_' . $_obf_0D283E1232290B032F3C29391E381D39322B320B170A11][$_obf_0D34013C37172D1239362C15351C16011E0D3C11141901]);
                    $response = '108010' . $slotSettings->GetGameData('JokerCardAMDoubleBalance') . $slotSettings->HexFormat($_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032 * 100) . '10001a33e810' . implode('', $_obf_0D1135362B02051A22113F1E5B2E2B062E123E2A2F2311) . '1c23622b23821c1c10101021c020103000' . $_obf_0D16370E06283D2C01032D38041C0D1C171D273F260F01 . '00041010151a26431f4';
                    $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01));
                    $slotSettings->SetGameData('JokerCardAMTotalWin', $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032);
                    $slotSettings->SetGameData('JokerCardAMHistoryCards', $_obf_0D1135362B02051A22113F1E5B2E2B062E123E2A2F2311);
                    $slotSettings->SetGameData('JokerCardAMGambleStep', $_obf_0D16370E06283D2C01032D38041C0D1C171D273F260F01);
                ...
                case 'A/u259':
                    ...
                    $slotSettings->SetGameData('JokerCardAMDoubleBalance', $_obf_0D373B302A1614233D3F2D03055B0B142A33240F1D0511);
                    ...
                    $response = '109010' . $slotSettings->GetGameData('JokerCardAMDoubleBalance') . strlen($_obf_0D143B0B042F091727280D3E182D1D0115352113380F01) . $_obf_0D143B0B042F091727280D3E182D1D0115352113380F01 . '10001a33e810060d15210f07131e21324f21b22e2291024f1022e1002010300000004101012152322fa';
                    break;
            }
