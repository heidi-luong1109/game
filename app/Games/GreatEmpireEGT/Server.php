        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('GreatEmpireEGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                    ...
                    if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') ) 
                    {
                        ...
                        {
                            $_obf_0D35310F2F170C1C2A045C0E401E332D1C09231B272B01 = 'choice';
                        }
                    }
                    else
                    {
                ...
                case 'choice':
                    ...
                    {
                        if( $_obf_0D3105083F300417011E24321D131C14325C260C400511[$_obf_0D3D11063F0B3C1E1D365C1E122104310B3219022B3D11] * $betline <= $slotSettings->GetBank('bonus') ) 
                        {
                    ...
                    {
                        $_obf_0D2D3F3D0A2F0E1A2C3C265C261C312107270D2D061C22 = json_decode(trim(file_get_contents(dirname(__FILE__) . '/presets/select_' . ($_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['bet']['choice'] + 1) . '/p_' . $_obf_0D0D142D29330A012D0B2E232729130B1F2B14222F1522 . '/preset_' . $lines . '.json')), true);
                        for( $_obf_0D2722163E1D3E27212A163007151812040B35073D2911 = 0; $_obf_0D2722163E1D3E27212A163007151812040B35073D2911 < 50; $_obf_0D2722163E1D3E27212A163007151812040B35073D2911++ ) 
                        {
                        ...
                        $_obf_0D131B0E321F362C05230E0927342A090F2C0B34290322 = $curSeq['allWin'] * $betline;
                        $slotSettings->SetGameData('GreatEmpireEGTCurrentSeq', $curSeq);
                    }
                    if( $_obf_0D131B0E321F362C05230E0927342A090F2C0B34290322 > 0 ) 
                    {
                        $slotSettings->SetBank('bonus', -1 * $_obf_0D131B0E321F362C05230E0927342A090F2C0B34290322);
                    }
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"freespins":' . $slotSettings->slotFreeCount . ',"holdReels":[' . implode(',', $holds) . '],"gameCommand":"choice"},"state":"freespin","winAmount":' . ($slotSettings->GetGameData('GreatEmpireEGTBonusWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":1786410455191,"sessionKey":"f5774618bc882d98fdf578c1ade432b4","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    break;
                case 'bet':
                    $linesId = [];
                    $linesId[0] = [
                    ...
                    if( $winType == 'bonus' && $_obf_0D3030072F273706293C133F2F072B113B383322291201 < ($allbet * 5 + ($betline * 500)) ) 
                    {
                        $winType = 'none';
                    }
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                        {
                            for( $r = 0; $r < 5; $r++ ) 
                            {
                                if( in_array($r, $holds) ) 
                                {
                                    ...
                                    {
                                        $reels['reel' . ($r + 1)][$_obf_0D31403C0837332A1A1711312A3415151610280F122122] = '9';
                                    }
                                }
                            }
                        }
                        $_obf_0D1D190732303117182A032A083236110B03405B101A01 = $reels;
                        $_obf_0D320D2B0C3606293B2C343D120C2B1F25385C27150F32 = [];
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            for( $_obf_0D31403C0837332A1A1711312A3415151610280F122122 = 0; $_obf_0D31403C0837332A1A1711312A3415151610280F122122 <= 2; $_obf_0D31403C0837332A1A1711312A3415151610280F122122++ ) 
                            {
                                if( $reels['reel' . $r][$_obf_0D31403C0837332A1A1711312A3415151610280F122122] == '9' && !in_array($r - 1, $holds) ) 
                                {
                                    $_obf_0D320D2B0C3606293B2C343D120C2B1F25385C27150F32[] = '' . ($r - 1) . ',' . $_obf_0D31403C0837332A1A1711312A3415151610280F122122 . '';
                                    break;
                                }
                            }
                        }
                        ...
                        $_obf_0D2E2104170A1F301F1040361E0D0434333B2D28043C11 = [];
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            for( $_obf_0D31403C0837332A1A1711312A3415151610280F122122 = 0; $_obf_0D31403C0837332A1A1711312A3415151610280F122122 <= 2; $_obf_0D31403C0837332A1A1711312A3415151610280F122122++ ) 
                            {
                                if( $reels['reel' . $r][$_obf_0D31403C0837332A1A1711312A3415151610280F122122] == '9' && !in_array($r - 1, $holds) ) 
                                {
                                    $_obf_0D2E2104170A1F301F1040361E0D0434333B2D28043C11[] = '' . ($r - 1) . ',' . $_obf_0D31403C0837332A1A1711312A3415151610280F122122 . '';
                                }
                            }
                        }
                        for( $k = 0; $k < $lines; $k++ ) 
                        ...
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            for( $_obf_0D31403C0837332A1A1711312A3415151610280F122122 = 0; $_obf_0D31403C0837332A1A1711312A3415151610280F122122 <= 2; $_obf_0D31403C0837332A1A1711312A3415151610280F122122++ ) 
                            {
                                if( $_obf_0D1D190732303117182A032A083236110B03405B101A01['reel' . $r][$_obf_0D31403C0837332A1A1711312A3415151610280F122122] == $scatter ) 
                                {
                                    $scattersCount++;
                        ...
                        else
                        {
                            ...
                            if( $scattersCount >= 3 && $winType == 'bonus' && $slotSettings->GetBank((isset($_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent']) ? $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] : '')) < ($betline * 500 + $totalWin) ) 
                            {
                                $winType = 'none';
                            }
                    ...
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = $slotSettings->GetGameData('GreatEmpireEGTFreeBalance');
                    }
                    else
                    {
                    ...
                    if( $scattersCount >= 3 ) 
                    {
                        ...
                        {
                            $slotSettings->SetBank((isset($_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent']) ? $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] : ''), -1 * ($betline * 500));
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"BankReserved":' . $slotSettings->GetGameData('GreatEmpireEGTBankReserved') . ',"curSeq":' . json_encode($curSeq) . ',"FreeHolds":[' . implode(',', $slotSettings->GetGameData('GreatEmpireEGTFreeHolds')) . '],"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('GreatEmpireEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('GreatEmpireEGTCurrentFreeGame') . ',"Balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"afterBalance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"bonusWin":' . $slotSettings->GetGameData('GreatEmpireEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"Jackpots":' . $_obf_0D28393910101E062539311B3F371C121912162B061E32 . ',"reelsSymbols":' . $_obf_0D273522403840350F0A36072E150A0524143F382C3B32 . '}}';
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('GreatEmpireEGTCards');
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(0, 6));
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(0, 6));
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(0, 6) . ',' . $reels['reel4'][0] . ',' . $reels['reel4'][1] . ',' . $reels['reel4'][2] . ',' . rand(0, 6));
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gambles":5,"reels":[' . $_obf_0D3E331C040E390B031B03100422040311293E023E0322 . '],"holdReels":[' . implode(',', $holds) . '],"lines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"expand":[' . implode(',', $_obf_0D2E2104170A1F301F1040361E0D0434333B2D28043C11) . '],"specialExpand":[],"gambles":5,"freespins":' . $fs . ',"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('GreatEmpireEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('GreatEmpireEGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('GreatEmpireEGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('GreatEmpireEGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('GreatEmpireEGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
