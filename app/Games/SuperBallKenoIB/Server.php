            ...
            switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 ) 
            {
                ...
                case 'get':
                    ...
                    for( $i = 0; $i <= 5000; $i++ ) 
                    {
                        ...
                        $_obf_0D5C2D5B3904171D060434330831162E3B0D110E381C32 = [1];
                    ...
                    $_obf_0D21152412095C03222D3808130C3C012907290C181E22 = $slotSettings->GetGameData('SuperBallKenoIBCards');
                    ...
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[0] = '{"result":{"spin":{"win_scatters":[],"win_other":[],"win_lines":[],"win":' . $totalWin . ',"total_win":' . ($totalWin + $_obf_0D240B07121E19081B1A2430230F103535063D212E3B11) . ',"respin":null,"reels_add":null,"reels":[' . count($_obf_0D023B1001185C212335253B1E163B372B1D1D1B1D1F32) . ',1],"hotswap":null,"freegames":null,"extra":{},"e":"","bonus3":null,"bonus2":null,"bonus1":null},"message":[],"free_spin":null,"extra":{"total_win":0,"subgame":0,"spin_id":51288850063,"line":' . $line . ',"game":"k_dpk","double_step":0,"dkf":100,"dealer_card":null,"bet":1},"currency":"' . $slotSettings->slotCurrency . '","credits":' . ceil($_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 / 100) . ',"bets":null,"balance":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . '},"error":null,"code":200}';
                    break;
                case 'take':
                    $gameData = json_decode(trim(file_get_contents('php://input')), true);
                    $lines = 10;
                    ...
                    $slotSettings->SetGameData('SuperBallKenoIBCurrentDenom', $slotSettings->CurrentDenom);
                    $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = round(sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[0] = '{"result":{"spin":null,"message":[],"free_spin":null,"extra":{"total_win":0,"subgame":0,"spin_id":null,"line":' . $line . ',"game":"k_dpk","double_step":0,"dkf":100,"dealer_card":null,"bet":1},"currency":"' . $slotSettings->slotCurrency . '","credits":' . ceil($_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 / 100) . ',"bets":null,"balance":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . '},"error":null,"code":200}';
                    break;
            }
