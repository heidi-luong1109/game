        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 ) 
            {
                ...
                case 'Act41':
                    ...
                    break;
                case 'Act18':
                    if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['reqDat']) && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['reqDat']['subaction'] == 'gamble' ) 
                    {
                        $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 = 'Act21';
                        ...
                        $_obf_0D300C2F21350336261622142A322E0C270C0A1F2F0422 = '{"dealerCard":"' . $_obf_0D25035C31183316381216122811401A1F2A17243E2B22 . '","gambleState":"' . $_obf_0D0E2C2E373C171C3B0B2905400E372723283E18043511 . '","totalWin":' . ($totalWin / 2) . ',"afterBalance":' . $_obf_0D14303C231C032D241D0B0B3536181C110C0D0A2B1932 . ',"Balance":' . $Balance . '}';
                    ...
                    else if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['reqDat']) ) 
                    {
                        ...
                        for( $i = 0; $i <= 2000; $i++ ) 
                        {
                            ...
                            $scattersStr = '';
                            $scattersCount = 0;
                            $_obf_0D023F252225140C223413272B2B0F1D270115303B1201 = 0;
                            ...
                            for( $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622 = 1; $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622 <= 5; $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622++ ) 
                            {
                                for( $rs = 0; $rs <= 2; $rs++ ) 
                                {
                                    ...
                                    if( $reels['reel' . $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622][$rs] == '7' ) 
                                    {
                                        $_obf_0D023F252225140C223413272B2B0F1D270115303B1201++;
                                    }
                                    if( $reels['reel' . $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622][$rs] == '8' ) 
                                    {
                                        $_obf_0D28301D333F2827165C2511011438180336175B1E2A01++;
                                    }
                                }
                            }
                            if( $_obf_0D023F252225140C223413272B2B0F1D270115303B1201 >= 3 ) 
                            {
                                $_obf_0D0A0235122E5C24131816231530282A10152D123C1732 = [
                                    100, 
                                    150, 
                                    200, 
                                    250, 
                                ...
                                shuffle($_obf_0D0A0235122E5C24131816231530282A10152D123C1732);
                                $scattersWin = $_obf_0D0A0235122E5C24131816231530282A10152D123C1732[0] * $betline;
                            }
                            else if( $_obf_0D28301D333F2827165C2511011438180336175B1E2A01 >= 3 ) 
                            {
                                $_obf_0D0A0235122E5C24131816231530282A10152D123C1732 = [
                                    100, 
                                    150, 
                            ...
                            else
                            {
                                ...
                                if( ($scattersCount >= 3 || $_obf_0D023F252225140C223413272B2B0F1D270115303B1201 >= 3 || $_obf_0D28301D333F2827165C2511011438180336175B1E2A01 >= 3) && $winType != 'bonus' ) 
                                {
                                }
                    ...
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[0] = '{"action":"' . $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 . '","gameid":69,"serverResponse":' . json_encode($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822) . ',"nickName":"' . $slotSettings->username . '","currency":"' . $slotSettings->slotCurrency . '","Credit":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"Denom":' . ($slotSettings->CurrentDenom * 100) . '}';
                    break;
            }
