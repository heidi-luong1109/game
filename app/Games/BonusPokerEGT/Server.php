        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'settings':
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"denominations":[' . implode(',', $_obf_0D0C2105130819393F29112D311A15170F3C2913160B01) . '],"bets":[[' . implode(',', $_obf_0D131333153E3B3F113536290D1D1A025B0D3F16341932) . '],[[1,1,14000],[2,1,28000],[3,1,42000],[4,1,56000],[5,2,70000]]],"paytables":{"1":[1,2,3,4,5,8,25,40,80,50,250],"2":[1,2,3,4,5,8,25,40,80,50,800]},"jackpot":true,"jackpotMinBet":1,"jackpotMaxBet":100000},"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"f470855a38998b4c1678a0fd7d0ea815","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":1567091239811}';
                    break;
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('BonusPokerEGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'ping':
                    ...
                    break;
                case 'draw':
                    $_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01 = $slotSettings->GetGameData('BonusPokerEGTCurrentCards');
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $totalWin = $_obf_0D144030072C09300C13273D0B122A320C3B04012D0B32 * $slotSettings->GetGameData('BonusPokerEGTBet');
                        if( $totalWin <= $bank ) 
                        {
                            break;
                        }
                    ...
                    $_obf_0D1A2106361923133B253C0D2A3F052C18230D362F5C11['pay_8'] = 5;
                    $_obf_0D1A2106361923133B253C0D2A3F052C18230D362F5C11['pay_25'] = 6;
                    $_obf_0D1A2106361923133B253C0D2A3F052C18230D362F5C11['pay_40'] = 7;
                    $_obf_0D1A2106361923133B253C0D2A3F052C18230D362F5C11['pay_80'] = 8;
                    $_obf_0D1A2106361923133B253C0D2A3F052C18230D362F5C11['pay_100'] = 9;
                    $_obf_0D1A2106361923133B253C0D2A3F052C18230D362F5C11['pay_200'] = 10;
                    $_obf_0D1A2106361923133B253C0D2A3F052C18230D362F5C11['pay_500'] = 11;
                    ...
                    $response = '{"responseEvent":"spin","responseType":"bet","serverResponse":{"cardsArr":' . json_encode($cardsArr) . ',"state":"idle","slotLines":1,"slotBet":' . $slotSettings->GetGameData('BonusPokerEGTBet') . ',"totalFreeGames":' . $slotSettings->GetGameData('BonusPokerEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BonusPokerEGTCurrentFreeGame') . ',"Balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"afterBalance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"bonusWin":' . $slotSettings->GetGameData('BonusPokerEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"cards":[' . implode(',', $_obf_0D22070A5B1A1C152C0E341D10372F3F1F21301C343C11) . ']}}';
                ...
                case 'bet':
                    ...
                    $slotSettings->SetGameData('BonusPokerEGTGambleStep', 5);
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('BonusPokerEGTCards');
                    $cardsArr = [];
                    ...
                    $slotSettings->SetGameData('BonusPokerEGTCurrentCards', $_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01);
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"CurrentCards":' . json_encode($slotSettings->GetGameData('BonusPokerEGTCurrentCards')) . ',"cardsArr":' . json_encode($cardsArr) . ',"state":"' . $state . '","slotLines":1,"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('BonusPokerEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BonusPokerEGTCurrentFreeGame') . ',"Balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"afterBalance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"bonusWin":' . $slotSettings->GetGameData('BonusPokerEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"cards":[' . implode(',', $_obf_0D1633111E0C1C2610253F2A390E1E262B293E0F273111) . ']}}';
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('BonusPokerEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('BonusPokerEGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('BonusPokerEGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('BonusPokerEGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('BonusPokerEGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
