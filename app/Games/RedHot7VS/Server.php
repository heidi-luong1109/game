...
namespace VanguardLTE\Games\RedHot7VS
{
    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            {
                case 'QRY_CHECK':
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '{"status":"OK","for":"QRY_CHECK","device":"S4617","login":"user","username":"","firstname":"","lastname":"CARD_4116078299570565","usejp":1,"forward":"e1","game":"000540d0","credit":{"tot":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . '},"account":{"tot":0}}';
                    break;
                case 'LOGIN':
                ...
                case 'GA_SPIN':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $_obf_0D2B2F2802280E223138132C0B310F3C0A2D3328275C22 = '0';
