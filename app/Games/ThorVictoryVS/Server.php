        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 ) 
            {
                ...
                case 'SELGAME':
                    ...
                    $slotSettings->SetGameData('ThorVictoryVSCards', $_obf_0D21152412095C03222D3808130C3C012907290C181E22);
                ...
                case 'GA_SPIN':
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $_obf_0D1F292430132C1009140F17162121100D240917270211 . ',"totalFreeGames":' . $slotSettings->GetGameData('ThorVictoryVSFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('ThorVictoryVSCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('ThorVictoryVSBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                    ...
                    $_obf_0D21152412095C03222D3808130C3C012907290C181E22 = $slotSettings->GetGameData('ThorVictoryVSCards');
                ...
                case 'GA_TAKE':
                    ...
                    $slotSettings->SetGameData('ThorVictoryVSTotalWin', 0);
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '{"status":"OK","authtoken":"1/90317550919705477001","for":"GA_TAKE","totsg":' . $slotSettings->GetGameData('ThorVictoryVSFreeGames') . ',"plsg":' . $slotSettings->GetGameData('ThorVictoryVSCurrentFreeGame') . ',"inscatwin":' . ($slotSettings->GetGameData('ThorVictoryVSBonusWin') * 100) . ',"gtype":' . $_obf_0D3B3428360D152B3D312F043B1F083E2317380A020511 . ',"credit":{"tot":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . '}}';
                    break;
                case 'QUITGAME':
                    $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                ...
                case 'GA_GAMBLE':
                    ...
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '{"status":"OK","gtypeaft":' . $_obf_0D3B3428360D152B3D312F043B1F083E2317380A020511 . ',"gtype":' . $_obf_0D3B3428360D152B3D312F043B1F083E2317380A020511 . ',"totsg":' . $slotSettings->GetGameData('ThorVictoryVSFreeGames') . ',"plsg":' . $slotSettings->GetGameData('ThorVictoryVSCurrentFreeGame') . ',"inscatwin":' . ($slotSettings->GetGameData('ThorVictoryVSBonusWin') * 100) . ',"authtoken":"1/90317550923628407358","for":"GA_GAMBLE","rno":29444,"state":3,"gmblwinf":2,"card":' . $_obf_0D25035C31183316381216122811401A1F2A17243E2B22 . ',"halfs":0,"snd":"' . $_obf_0D1623401B401E2D0E5C36303905161D112D0E12271F01 . '","gmblamount":' . ($totalWin * 100) . ',"gmblmayhalf":2,"gmblhalfmin":100,"takesnd":"slidein","gmblhist":[' . implode(',', $_obf_0D21152412095C03222D3808130C3C012907290C181E22) . '],"win":' . ($totalWin * 100) . ',"sgwin":0,"credit":{"tot":40885}}';
                    break;
            }
