        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('GraceOfCleopatraEGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'bet':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                        {
                            for( $r = 1; $r <= 5; $r++ ) 
                            {
                                ...
                                {
                                    if( $_obf_0D3D05062631163936351A352E0A073E0401223F110832['reel' . $r][$_obf_0D31403C0837332A1A1711312A3415151610280F122122] == $slotSettings->GetGameData('GraceOfCleopatraEGTExpandSymbol') ) 
                                    {
                                        $_obf_0D3D05062631163936351A352E0A073E0401223F110832['reel' . $r][0] = $slotSettings->GetGameData('GraceOfCleopatraEGTExpandSymbol');
                                        $_obf_0D3D05062631163936351A352E0A073E0401223F110832['reel' . $r][1] = $slotSettings->GetGameData('GraceOfCleopatraEGTExpandSymbol');
                                        $_obf_0D3D05062631163936351A352E0A073E0401223F110832['reel' . $r][2] = $slotSettings->GetGameData('GraceOfCleopatraEGTExpandSymbol');
                                        break;
                                    }
                                }
                            }
                        ...
                        for( $k = 0; $k < $lines; $k++ ) 
                        {
                            ...
                            for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                            {
                                ...
                                else
                                {
                                    ...
                                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' && $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 == $slotSettings->GetGameData('GraceOfCleopatraEGTExpandSymbol') ) 
                                    {
                        ...
                        else
                        {
                            ...
                            {
                                if( $totalWin <= $_obf_0D3030072F273706293C133F2F072B113B383322291201 && $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                                {
                                    break;
                                }
                    ...
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = $slotSettings->GetGameData('GraceOfCleopatraEGTFreeBalance');
                    }
                    else
                    {
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('GraceOfCleopatraEGTFreeGames') . ',"freeSpinsExpandLines": [' . $_obf_0D2E15282C2E16291216341D1F1C38092C2427380F1C22 . '],"freeSpinsExpandSymbol":' . $slotSettings->GetGameData('GraceOfCleopatraEGTExpandSymbol') . ',"freeSpinsExpandWinAmount": ' . $_obf_0D110919322F1A121D1902170A3325192D3F0E391C0922 . ',"currentFreeGames":' . $slotSettings->GetGameData('GraceOfCleopatraEGTCurrentFreeGame') . ',"Balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"afterBalance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"bonusWin":' . $slotSettings->GetGameData('GraceOfCleopatraEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"Jackpots":' . $_obf_0D28393910101E062539311B3F371C121912162B061E32 . ',"reelsSymbols":' . $_obf_0D273522403840350F0A36072E150A0524143F382C3B32 . '}}';
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('GraceOfCleopatraEGTCards');
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('GraceOfCleopatraEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('GraceOfCleopatraEGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('GraceOfCleopatraEGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('GraceOfCleopatraEGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('GraceOfCleopatraEGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
