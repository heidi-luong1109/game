        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 ) 
            {
                ...
                case 'Act18':
                        ...
                        for( $i = 0; $i <= 2000; $i++ ) 
                        {
                            ...
                            for( $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622 = 1; $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622 <= 5; $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622++ ) 
                            {
                                for( $rs = 0; $rs <= 2; $rs++ ) 
                                {
                                    ...
                                    if( $reels['reel' . $_obf_0D0D401E2C11131E3013272F11160B3E0E0D2B1D310622][$rs] == '9' ) 
                                    {
                                        $_obf_0D023F252225140C223413272B2B0F1D270115303B1201++;
                                    }
                                }
                            }
                            $_obf_0D36283C2B172B382F142E1816170D290C05270E2F3F01 = 0;
                            if( $_obf_0D023F252225140C223413272B2B0F1D270115303B1201 >= 3 ) 
                            {
                                ...
                                $_obf_0D36283C2B172B382F142E1816170D290C05270E2F3F01 = rand(10, 100) * $allbet;
                            }
                            $totalWin += $_obf_0D36283C2B172B382F142E1816170D290C05270E2F3F01;
                            if( $i > 1000 ) 
                            {
                                $winType = 'none';
                            }
                    ...
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[0] = '{"action":"' . $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 . '","gameid":28,"serverResponse":' . json_encode($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822) . ',"nickName":"' . $slotSettings->username . '","currency":"' . $slotSettings->slotCurrency . '","Credit":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . ',"Denom":' . ($slotSettings->CurrentDenom * 100) . '}';
                    break;
            }
