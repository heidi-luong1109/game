...
namespace VanguardLTE\Games\BurningReelsVS
{
    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            {
                case 'QRY_CHECK':
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '{"status":"OK","for":"QRY_CHECK","device":"S4617","login":"user","username":"","firstname":"","lastname":"CARD_4116078299570565","usejp":1,"forward":"e1","game":"000502e0","credit":{"tot":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . '},"account":{"tot":0}}';
                    break;
                case 'LOGIN':
                ...
                case 'SELGAME':
                    ...
                    $slotSettings->SetGameData('BurningHotVSCards', $_obf_0D21152412095C03222D3808130C3C012907290C181E22);
                ...
                case 'GA_SPIN':
                    ...
                    $_obf_0D1F292430132C1009140F17162121100D240917270211 = $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['bet'] / 100;
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        {
                            $_obf_0D033835123E051D331E010A3C300C332C34021F052801 = ',"scatwin":[{"win":' . ($_obf_0D10342528350D243D16293C2835061F263C1C39042811 * 100) . ',"sgwin":15,"hw":0,"spos":[' . implode(',', $_obf_0D312B19262C083426241E0D392E22282324060B380811) . '],"frame":[174,0,0],"snd":"win_big1","ms":1500,"musictime":1}]';
                        }
                    ...
                    for( $i = 1; $i <= 5; $i++ ) 
                    {
                        ...
                        for( $j = 0; $j <= $_obf_0D3D1E350E290B165B5B3E2E311A251A332C0D1D073B32[$i - 1]; $j++ ) 
                        {
                            ...
                            $_obf_0D32282F3003310639351F1C3D1D01035C021B011A4032[$i - 1][] = $slotSettings->{'reelStrip' . $i}[$rc];
                        }
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $_obf_0D1F292430132C1009140F17162121100D240917270211 . ',"totalFreeGames":' . $slotSettings->GetGameData('BurningHotVSFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BurningHotVSCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('BurningHotVSBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $_obf_0D033835123E051D331E010A3C300C332C34021F052801 . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                ...
                case 'GA_TAKE':
                    $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                    $slotSettings->SetGameData('BurningHotVSTotalWin', 0);
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '{"status":"OK","authtoken":"1/90317550919705477001","for":"GA_TAKE","gtype":1,"credit":{"tot":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . '}}';
                    break;
                case 'QUITGAME':
                    $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                ...
                case 'GA_GAMBLE':
                    ...
                    $slotSettings->SetGameData('BurningHotVSCards', $_obf_0D21152412095C03222D3808130C3C012907290C181E22);
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '{"status":"OK","authtoken":"1/90317550923628407358","for":"GA_GAMBLE","rno":29444,"state":3,"gmblwinf":2,"card":' . $_obf_0D25035C31183316381216122811401A1F2A17243E2B22 . ',"halfs":0,"snd":"' . $_obf_0D1623401B401E2D0E5C36303905161D112D0E12271F01 . '","gmblamount":' . ($totalWin * 100) . ',"gmblmayhalf":2,"gmblhalfmin":100,"takesnd":"slidein","gmblhist":[' . implode(',', $_obf_0D21152412095C03222D3808130C3C012907290C181E22) . '],"gtype":1,"win":' . ($totalWin * 100) . ",\"sgwin\":0,\"gtypeaft\":1,\"credit\":{\"tot\":40885}}\n";
                    break;
            }
