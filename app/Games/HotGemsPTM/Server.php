...
namespace VanguardLTE\Games\HotGemsPTM
{
    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            {
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['ID'] == '46302' && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['drawId'] > 0 ) 
                {
                ...
                if( $slotSettings->GetGameData('HotGemsPTMCurrentFreeGame') <= $slotSettings->GetGameData('HotGemsPTMFreeGames') && $slotSettings->GetGameData('HotGemsPTMFreeGames') > 0 && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['savedStates'][0]['attr21'] > 0 ) 
                {
                    $_obf_0D2813390912262B102326025B34051621182F31041832 = $slotSettings->GetGameData('HotGemsPTMCurrentFreeGame');
                    $_obf_0D131D5C261C392D093F121D1F2E13191812150D231232 = $slotSettings->GetGameData('HotGemsPTMFreeSpins');
                    $_obf_0D222C3C342D2C31305B091C0A1C10250A19140B2B2811 = $slotSettings->GetGameData('HotGemsPTMFreeLogs');
                    ...
                    {
                        $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::' . $_obf_0D131D5C261C392D093F121D1F2E13191812150D231232[$slotSettings->GetGameData('HotGemsPTMCurrentFreeGame')];
                    }
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['ID']) && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['ID'] == '40029' ) 
            {
                ...
                for( $s = 1; $s <= $_obf_0D220B060A21130E0C011A09151D32403F5B025C070411; $s++ ) 
                {
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        {
                            $_obf_0D1F3C315C2D083C1E0237362212360301171F11010811 = $slotSettings->GetReelsWin($reels, $lines, $betLine, $linesId, $_obf_0D1F171A1F35063716213837072F111B1E0D042E1B1A11, $_obf_0D1016073B15193E060D2D0C262328020129171D232A32);
                            ...
                            $_obf_0D1016073B15193E060D2D0C262328020129171D232A32++;
                        }
                        $scattersWin = 0;
                        $scattersStr = '{';
                    ...
                    $_obf_0D390225301D2E21373038281039131A192C011A3F0632[] = '{"data":{"betLine":' . $betLine . ',"currentWin":' . $totalWin . ',"drawState":{"event":[{"seq":0,"id":' . $reels['rp'][0] . ',"type":"24:A"},{"seq":1,"id":' . $reels['rp'][1] . ',"type":"4:Q"},{"seq":2,"id":' . $reels['rp'][2] . ',"type":"23:T"},{"seq":3,"id":' . $reels['rp'][3] . ',"type":"32:Q"},{"seq":4,"id":' . $reels['rp'][4] . ',"type":"4:A"}],"gameStages":[{"stage":[{"display":"J,A,J,W,J;A,Q,T,Q,A;N,L,K,K,D","multiplier":1,"stage":1}],"spins":0,"stages":1,"wCapMaxWin":1000000.0}],"bet":[{"toPayout":0.25,"pick":"L25","seq":0,"stake":0.25,"type":"line","won":"false"}],"drawId":0,"seed":389802986,"state":"settling"},"gameId":2501019450},"ID":46303,"umid":49}';
                    $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 = '' . json_encode($reels) . '';
                    $_obf_0D1116233529011F0C293C2D011C113C061E381B341411[] = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"bonusMpl":' . $bonusMpl . ',"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $_obf_0D220B060A21130E0C011A09151D32403F5B025C070411 . ',"currentFreeGames":' . $s . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('HotGemsPTMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('HotGemsPTMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"bonusInfo":"","Jackpots":"","reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                }
                $slotSettings->SetGameData('HotGemsPTMFreeSpins', $_obf_0D390225301D2E21373038281039131A192C011A3F0632);
                $slotSettings->SetGameData('HotGemsPTMFreeLogs', $_obf_0D1116233529011F0C293C2D011C113C061E381B341411);
                $slotSettings->SetGameData('HotGemsPTMFreeGames', $_obf_0D220B060A21130E0C011A09151D32403F5B025C070411);
                ...
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '3:::{"data":{"gameId":2543168908,"drawStates":[{"drawId":1,"feature":{"name":"bonus","details":{"bonusPayout":' . $slotSettings->GetGameData('HotGemsPTMFreeStartWin') . ',"initialSpins":' . $_obf_0D220B060A21130E0C011A09151D32403F5B025C070411 . ',"multiplier":' . $bonusMpl . ',"spins":' . $_obf_0D220B060A21130E0C011A09151D32403F5B025C070411 . ',"totalPayout":' . $_obf_0D5B0B29062722350A081C02112A2808251D120E2E0C01 . '}}},' . $_obf_0D262203355C053823371B100325295B12151B3F095C22 . ']},"ID":47342,"umid":1951}';
            }
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['ID']) && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['ID'] == '46299' ) 
            {
                $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01 = [];
                ...
                $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"rStr":"' . $_obf_0D1C301838081913090C0C1A2E0F010F3C3D2E33310D01 . '","sc":' . $scattersCount . ',"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('HotGemsPTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('HotGemsPTMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('HotGemsPTMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('HotGemsPTMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
