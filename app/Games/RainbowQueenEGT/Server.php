        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('RainbowQueenEGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'bet':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $_obf_0D0627143B293F052B1B090C3431082F395B021E2F2132 = '';
                        if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                        {
                            $_obf_0D1D15032631143F3301082901140E0C27252C23281A11 = $slotSettings->GetGameData($slotSettings->slotId . 'allWilds');
                            $wild = array_merge($wild, $_obf_0D1D15032631143F3301082901140E0C27252C23281A11);
                        }
                        for( $k = 0; $k < $lines; $k++ ) 
                        {
                    ...
                    $_obf_0D1802262D3D14212B1D1506300D325C173F311B372F22 = false;
                    if( $reels['reel5'][0] == '11' ) 
                    {
                        $_obf_0D0627143B293F052B1B090C3431082F395B021E2F2132 = '4,0';
                        $_obf_0D1802262D3D14212B1D1506300D325C173F311B372F22 = true;
                    }
                    if( $reels['reel5'][1] == '11' ) 
                    {
                        $_obf_0D0627143B293F052B1B090C3431082F395B021E2F2132 = '4,1';
                        $_obf_0D1802262D3D14212B1D1506300D325C173F311B372F22 = true;
                    }
                    if( $reels['reel5'][2] == '11' ) 
                    {
                        $_obf_0D0627143B293F052B1B090C3431082F395B021E2F2132 = '4,2';
                        $_obf_0D1802262D3D14212B1D1506300D325C173F311B372F22 = true;
                    }
                    $_obf_0D3F24170C131539213D06280A36163E1603340F320201 = 0;
                    if( $_obf_0D1802262D3D14212B1D1506300D325C173F311B372F22 ) 
                    {
                        ...
                        if( $slotSettings->GetGameData($slotSettings->slotId . 'passedClovers') == 3 ) 
                        {
                            ...
                            $allwilds[] = 8;
                            $_obf_0D3F24170C131539213D06280A36163E1603340F320201 = 8;
                        ...
                        if( $slotSettings->GetGameData($slotSettings->slotId . 'passedClovers') == 6 ) 
                        {
                            $allwilds = $slotSettings->GetGameData($slotSettings->slotId . 'allWilds');
                            $allwilds[] = 7;
                            $_obf_0D3F24170C131539213D06280A36163E1603340F320201 = 7;
                            $slotSettings->SetGameData($slotSettings->slotId . 'allWilds', $allwilds);
                        }
                        if( $slotSettings->GetGameData($slotSettings->slotId . 'passedClovers') == 9 ) 
                        {
                            $allwilds = $slotSettings->GetGameData($slotSettings->slotId . 'allWilds');
                            $allwilds[] = 6;
                            $_obf_0D3F24170C131539213D06280A36163E1603340F320201 = 6;
                            $slotSettings->SetGameData($slotSettings->slotId . 'allWilds', $allwilds);
                        }
                        if( $slotSettings->GetGameData($slotSettings->slotId . 'passedClovers') == 12 ) 
                        {
                            $allwilds = $slotSettings->GetGameData($slotSettings->slotId . 'allWilds');
                            $allwilds[] = 5;
                            $_obf_0D3F24170C131539213D06280A36163E1603340F320201 = 5;
                            $slotSettings->SetGameData($slotSettings->slotId . 'allWilds', $allwilds);
                        }
                    }
                    if( $totalWin > 0 ) 
                    ...
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = $slotSettings->GetGameData('RainbowQueenEGTFreeBalance');
                    }
                    else
                    {
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('RainbowQueenEGTCards');
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gambles":5,"reels":[' . $_obf_0D3E331C040E390B031B03100422040311293E023E0322 . '],"lines":[' . $_obf_0D5B5C2E0D1C3D1F232F3E051D3225380127293C2A2432 . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"clover":[' . $_obf_0D0627143B293F052B1B090C3431082F395B021E2F2132 . '],"newWild":' . $_obf_0D3F24170C131539213D06280A36163E1603340F320201 . ',"allWilds":[' . implode(',', $slotSettings->GetGameData($slotSettings->slotId . 'allWilds')) . '],"passedClovers":' . $slotSettings->GetGameData($slotSettings->slotId . 'passedClovers') . ',"expand":[],"specialExpand":[],"gambles":5,"freespins":' . $fs . ',"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('RainbowQueenEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('RainbowQueenEGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('RainbowQueenEGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('RainbowQueenEGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('RainbowQueenEGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
