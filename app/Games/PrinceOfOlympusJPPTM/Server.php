        ...
        public function get($request, $game)
        {
            ...
            if( isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['spinType']) ) 
            {
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    if( $slotSettings->GetGameData('PrinceOfOlympusJPPTMBonusStep') == 1 && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                    {
                        $reels['reel3'][0] = 0;
                        $reels['reel3'][1] = 0;
                        $reels['reel3'][2] = 0;
                    ...
                    else
                    {
                        ...
                        if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && $totalWin <= $_obf_0D3B3C113639391705311B0F12323C3B3B250C1A142401 && $slotSettings->GetGameData('PrinceOfOlympusJPPTMBonusStep') == 1 ) 
                        {
                            break;
                        }
                        if( ($scattersCount >= 3 || $_obf_0D28301D333F2827165C2511011438180336175B1E2A01 >= 2 || $_obf_0D211C0A37341A0A1B3F04052C3B1B3339110626302911 >= 3 || $_obf_0D2738213028083F381130262C363F2433322C040A2E01 >= 1 && $slotSettings->GetGameData('PrinceOfOlympusJPPTMBonusStep') != 1) && $winType != 'bonus' && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] != 'freespin' ) 
                        {
                        }
                        else
                        {
                            if( $_obf_0D28301D333F2827165C2511011438180336175B1E2A01 >= 2 ) 
                            {
                                ...
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMHydraBonusArr', $_obf_0D14052A37113132220D301518051A373C301C061B0311);
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMHydraBonusMpl', $_obf_0D052E36281E390A03353012300623092E1F28091A3B01);
            ...
            switch( $umid ) 
            {
                case '47850':
                    ...
                    {
                        $_obf_0D05362C2B0E0B1A11092A1E281A222F5C071A0D263701 = $slotSettings->GetGameData('PrinceOfOlympusJPPTMHydraBonusArr');
                        ...
                        $slotSettings->SetGameData('PrinceOfOlympusJPPTMHydraBonusArr', $_obf_0D05362C2B0E0B1A11092A1E281A222F5C071A0D263701);
                    }
                    else
                    {
                        ...
                        $_obf_0D27332F352B311B190D045B333538180E3C1B3F333B32[$_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['pickIndex']] = $slotSettings->GetGameData('PrinceOfOlympusJPPTMHydraBonusMpl');
