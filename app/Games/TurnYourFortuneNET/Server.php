            ...
            switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 ) 
            {
                case 'init':
                    ...
                    if( $lastEvent != 'NULL' ) 
                    {
                        ...
                        $_obf_0D0C2D02303D05261238144030211A030D5C28401C0F32 .= ('&rs.i1.r.i0.syms=SYM' . $reels->reel1[0] . '%2CSYM' . $reels->reel1[1] . '%2CSYM' . $reels->reel1[2] . '%2CSYM' . $reels->reel1[3] . '');
                        ...
                        $_obf_0D0C2D02303D05261238144030211A030D5C28401C0F32 .= ('&rs.i1.r.i4.syms=SYM' . $reels->reel5[0] . '%2CSYM' . $reels->reel5[1] . '%2CSYM' . $reels->reel5[2] . '%2CSYM' . $reels->reel5[3] . '');
                ...
                case 'spin':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                        {
                            $_obf_0D1F3D2E290C02011D250C241835320527142A33070511 = 0;
                            for( $r = 1; $r <= 5; $r++ ) 
                            {
                                ...
                                {
                                    if( $reels['reel' . $r][$_obf_0D13090C3F3C3624123E1A2C091F31232304270B023B32] == $FreeSym ) 
                                    {
                                        $LadderMeter++;
                                    }
                                }
                        ...
                        if( $scattersCount >= 3 ) 
                        {
                            $scattersStr = '&ws.i0.types.i0.freespins=' . $slotSettings->slotFreeCount[$scattersCount] . '&rs.i0.nearwin=2%2C4&ws.i0.reelset=basic&ws.i0.betline=null&ws.i0.types.i0.wintype=freespins&ws.i0.direction=none&ws.i0.types.i0.wintype=bonusgame&ws.i0.types.i0.bonusid=ladder_symbol_wheel&gamestate.current=bonus&nextaction=bonusaction&nextactiontype=pickbonus' . implode('', $_obf_0D312B19262C083426241E0D392E22282324060B380811);
                        }
                        ...
                        else
                        {
                            ...
                            if( $LadderMeter >= 20 && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                            {
                                $_obf_0D5C133E3924040711370E250C2804160D1F2528393F32 = $slotSettings->PayTower[$LadderLevel][$LadderStep + 1] * $allbet;
                                if( $_obf_0D3B3C113639391705311B0F12323C3B3B250C1A142401 < ($_obf_0D5C133E3924040711370E250C2804160D1F2528393F32 + $LadderWin + $totalWin) ) 
                                {
                                }
                            }
                            if( $scattersCount >= 3 && $winType == 'bonus' ) 
                            {
                                ...
                                $slotSettings->SetGameData($slotSettings->slotId . 'LadderMeter', 0);
                                $slotSettings->SetGameData($slotSettings->slotId . 'LadderWin', 0);
                                $_obf_0D5C133E3924040711370E250C2804160D1F2528393F32 = $slotSettings->PayTower[$slotSettings->GetGameData($slotSettings->slotId . 'LadderLevel')][0] * $allbet;
                                $slotSettings->SetGameData($slotSettings->slotId . 'LadderWin', $_obf_0D5C133E3924040711370E250C2804160D1F2528393F32);
                                if( $_obf_0D3B3C113639391705311B0F12323C3B3B250C1A142401 < ($_obf_0D5C133E3924040711370E250C2804160D1F2528393F32 + $totalWin) ) 
                                {
                                }
                            }
                            if( $scattersCount >= 3 && $winType != 'bonus' ) 
                    ...
                    if( $scattersCount >= 3 ) 
                    {
                        ...
                        $_obf_0D1B2E0C36332C300E220E172F340909213938031E1211 = $slotSettings->GetGameData($slotSettings->slotId . 'LadderWin');
                        $slotSettings->SetBank((isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent']) ? $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] : ''), -1 * $_obf_0D1B2E0C36332C300E220E172F340909213938031E1211, '');
                        $slotSettings->SetBalance($_obf_0D1B2E0C36332C300E220E172F340909213938031E1211, '');
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        if( $LadderMeter >= 20 ) 
                        {
                            $slotSettings->SetBank((isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent']) ? $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] : ''), $LadderWin);
                            $slotSettings->SetBalance(-1 * $LadderWin);
                            $LadderStep++;
                            $LadderWin = $slotSettings->PayTower[$LadderLevel][$LadderStep] * $allbet;
                            $slotSettings->SetBank((isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent']) ? $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] : ''), -1 * $LadderWin);
