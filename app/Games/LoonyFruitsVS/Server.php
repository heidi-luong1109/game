        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 ) 
            {
                ...
                case 'SELGAME':
                    ...
                    $slotSettings->SetGameData('LoonyFruitsVSCards', $_obf_0D21152412095C03222D3808130C3C012907290C181E22);
                ...
                case 'GA_SPIN':
                    ...
                    $_obf_0D21152412095C03222D3808130C3C012907290C181E22 = $slotSettings->GetGameData('LoonyFruitsVSCards');
                ...
                case 'GA_TAKE':
                    ...
                    $slotSettings->SetGameData('LoonyFruitsVSTotalWin', 0);
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '{"status":"OK","authtoken":"1/90317550919705477001","for":"GA_TAKE","totsg":' . $slotSettings->GetGameData('LoonyFruitsVSFreeGames') . ',"plsg":' . $slotSettings->GetGameData('LoonyFruitsVSCurrentFreeGame') . ',"inscatwin":' . ($slotSettings->GetGameData('LoonyFruitsVSBonusWin') * 100) . ',"gtype":' . $_obf_0D3B3428360D152B3D312F043B1F083E2317380A020511 . ',"credit":{"tot":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . '}}';
                    break;
                case 'QUITGAME':
                    $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
