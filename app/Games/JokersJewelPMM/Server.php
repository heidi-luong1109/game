    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'gamble5GetUserCards' ) 
            {
                ...
                $_obf_0D25035C31183316381216122811401A1F2A17243E2B22 = $slotSettings->GetGameData('JokersJewelPMMDealerCard');
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'gamble5GetDealerCard' ) 
            {
                ...
                $slotSettings->SetGameData('JokersJewelPMMDealerCard', $_obf_0D1A28330223330201021115084008123B0F213C102922);
            ...
            else if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'doSpin' ) 
            {
                ...
                if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                {
                    ...
                    {
                        $spinType = 'c';
                        $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 .= ('&fs_total=' . $slotSettings->GetGameData('JokersJewelPMMFreeGames') . '&fsmul_total=' . $slotSettings->GetGameData('JokersJewelPMMBonusMpl') . '&fswin_total=' . $slotSettings->GetGameData('JokersJewelPMMBonusWin') . '&fsres_total=' . $slotSettings->GetGameData('JokersJewelPMMBonusWin') . '');
                    }
                    else
                    {
                        $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 .= ('&fsmul=' . $slotSettings->GetGameData('JokersJewelPMMBonusMpl') . '&fsmax=' . $slotSettings->GetGameData('JokersJewelPMMFreeGames') . '&fswin=' . $slotSettings->GetGameData('JokersJewelPMMTotalWin') . '&fs=' . $slotSettings->GetGameData('JokersJewelPMMCurrentFreeGame') . '&fsres=' . $slotSettings->GetGameData('JokersJewelPMMBonusWin'));
                    }
                ...
                $response = 'tw=' . $slotSettings->GetGameData('JokersJewelPMMBonusWin') . '&bstate=' . $slotSettings->GetGameData('JokersJewelPMMBonusState') . '&balance=' . $Balance . '&index=' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['index'] . '&balance_cash=' . $Balance . '&balance_bonus=0.00' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '&na=' . $spinType . '&stime=' . floor(microtime(true) * 1000) . '&sa=' . $reels['reel1'][3] . ',' . $reels['reel2'][3] . ',' . $reels['reel3'][3] . ',' . $reels['reel4'][3] . ',' . $reels['reel5'][3] . '&sb=' . $reels['reel1'][-1] . ',' . $reels['reel2'][-1] . ',' . $reels['reel3'][-1] . ',' . $reels['reel4'][-1] . ',' . $reels['reel5'][-1] . '&sh=3&c=0.01&sver=5&counter=' . ((int)$_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['counter'] + 1) . '&l=25&s=' . $s . '&w=' . $_obf_0D5C3B1F210914123C222630290E271410213E320B0A11 . '';
                if( $slotSettings->GetGameData('JokersJewelPMMFreeGames') <= $slotSettings->GetGameData('JokersJewelPMMCurrentFreeGame') && $slotSettings->GetGameData('JokersJewelPMMFreeGames') > 0 ) 
                {
                    $slotSettings->SetGameData('JokersJewelPMMTotalWin', 0);
                    $slotSettings->SetGameData('JokersJewelPMMBonusWin', 0);
                }
                $_obf_0D2D350C1338352E3F0236115C1407341C0926053F2211 = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"BonusMpl":' . $slotSettings->GetGameData('JokersJewelPMMBonusMpl') . ',"lines":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotLines'] . ',"bet":' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('JokersJewelPMMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('JokersJewelPMMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"bonusWin":' . $slotSettings->GetGameData('JokersJewelPMMBonusWin') . ',"winLines":[],"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
