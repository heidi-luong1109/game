            ...
            switch( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['act'] ) 
            {
                ...
                case 'WXMNPP7H8F':
                    ...
                    else
                    {
                        ...
                        $_obf_0D3E1E10392C18192A17311514325C2E132A29390E2E22 = $slotSettings->GetGameData($slotSettings->slotId . 'FreeMultiplier');
                    }
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $_obf_0D09150B2722395B0A39250839035C2C1C053B311C2B22 = ['9'];
                        ...
                        {
                            $_obf_0D3E1E10392C18192A17311514325C2E132A29390E2E22 = $slotSettings->GetGameData($slotSettings->slotId . 'FreeMultiplier');
                            if( $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel3'][0] == '10' || $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel3'][1] == '10' || $_obf_0D3C090E192F3D26100429351F02123B310C3504040132['reel3'][2] == '10' ) 
                            {
                        ...
                        else
                        {
                            ...
                            else if( $_obf_0D0137091E13053E273C250F3E3E251D162D2A0C0B2F32 <= $_obf_0D3B3C113639391705311B0F12323C3B3B250C1A142401 && $winType == 'bonus' ) 
                            {
                    ...
                    if( $_obf_0D0B230B342E0C0727115B043F283E2137182D312A3D11 >= 3 ) 
                    {
                        ...
                        {
                            $slotSettings->SetGameData($slotSettings->slotId . 'FreeGames', $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') + $slotSettings->slotFreeCount[$_obf_0D0B230B342E0C0727115B043F283E2137182D312A3D11]);
                        }
                        else
                        {
                            $slotSettings->SetGameData($slotSettings->slotId . 'FreeMultiplier', 2);
                            $_obf_0D3E1E10392C18192A17311514325C2E132A29390E2E22 = 2;
                            $slotSettings->SetGameData($slotSettings->slotId . 'BonusSymbol', rand(1, 9));
                            $slotSettings->SetGameData($slotSettings->slotId . 'FreeStartWin', $_obf_0D0137091E13053E273C250F3E3E251D162D2A0C0B2F32);
                            $slotSettings->SetGameData($slotSettings->slotId . 'BonusWin', $_obf_0D0137091E13053E273C250F3E3E251D162D2A0C0B2F32);
                            $slotSettings->SetGameData($slotSettings->slotId . 'FreeGames', $slotSettings->slotFreeCount[$_obf_0D0B230B342E0C0727115B043F283E2137182D312A3D11]);
                        }
                    }
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeMultiplier', $_obf_0D3E1E10392C18192A17311514325C2E132A29390E2E22);
                        $flag = 0;
