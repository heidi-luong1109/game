        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'settings':
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"paytableCoef":{"0":{"coef":[20],"multiplier":1},"1":{"coef":[20],"multiplier":1},"2":{"coef":[20],"multiplier":1},"3":{"coef":[40],"multiplier":1},"4":{"coef":[40],"multiplier":1},"5":{"coef":[100],"multiplier":1},"6":{"coef":[100],"multiplier":1},"7":{"coef":[300],"multiplier":1},"8":{"coef":[300],"multiplier":1},"9":{"coef":[500],"multiplier":1},"10":{"coef":[0],"mysteryCoefs":[[250,400,550,700,850,1000]],"multiplier":1}},"bets":[' . implode(',', $_obf_0D131333153E3B3F113536290D1D1A025B0D3F16341932) . '],"jackpotMinBet":1,"lines":[5],"jackpot":true,"mainFakeReels":[[6,1,1,1,4,0,0,0,9,5,8,2,2,2,3,3,3,5,2,2,2,5,10,2,2,2,7,1,1,1],[10,0,0,0,8,2,2,2,3,3,3,7,5,1,1,1,0,0,0,2,2,2,4,8,6,9,2,2,2,5],[9,0,0,2,2,2,1,1,1,6,4,0,0,0,6,10,3,3,3,5,1,1,1,5,7,2,2,2,5,8]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $_obf_0D0C2105130819393F29112D311A15170F3C2913160B01) . ']},"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                    break;
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('Wins27EGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'bet':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                            ...
                            else
                            {
                                ...
                                for( $r = 1; $r <= 3; $r++ ) 
                                {
                                    for( $s = 0; $s <= 2; $s++ ) 
                                    {
                                        ...
                                        {
                                            $_obf_0D16182D2B31120E1C1B29351805140216313036102C01[$r - 1] = 1;
                                        }
                                    }
                                }
                                if( $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[0] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[1] > 0 && $_obf_0D1721010A251E2B223C190C28145B0A041029390E3222[2] > 0 ) 
                                {
                                    ...
                                    $_obf_0D1A08361C315C0F302C102A0D011D1F041B0637020C11 = $slotSettings->Paytable['SYM_' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][3] * $betline * $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711;
                                    if( $_obf_0D37111B3335140203262E17350902171D182F5B312522 < $_obf_0D1A08361C315C0F302C102A0D011D1F041B0637020C11 ) 
                                    {
                                        ...
                                        $_obf_0D02100911023C3C260E0C262F5B2C1D2839310E112A32 = '{"card":' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11 . ',"len":3,"count":' . $_obf_0D1D26331C2D5B3C3609010C082C30030E3E1C03310711 . ',"winPerCount":' . ($slotSettings->Paytable['SYM_' . $_obf_0D350901162A195B273D0F282B290A2A0B1811330C0E11][3] * $betline * 100) . ',"multiplier":1,"winAmount":' . ($_obf_0D37111B3335140203262E17350902171D182F5B312522 * 100) . ',"cells":[' . implode(',', $_obf_0D1F0B292F242B2516303F2D3C2C5C2205250F2C320F11) . ']}';
                                    }
                                }
                        ...
                        if( $scattersCount >= 3 ) 
                        {
                            $_obf_0D24192D0C223E12010E13192624050E2F1B5C2B0C1301 = [
                                250, 
                                400, 
                                550, 
                                700, 
                            ...
                            shuffle($_obf_0D24192D0C223E12010E13192624050E2F1B5C2B0C1301);
                            $scattersWin = $_obf_0D24192D0C223E12010E13192624050E2F1B5C2B0C1301[0] * $betline;
                            $scattersStr = '{"scatterName":10,"cells":[' . implode(',', $_obf_0D2A350433382703193E3D095B5C3B160A253E01191622) . '],"winAmount":' . ($scattersWin * 100) . ',"freespins":0}';
                        }
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('Wins27EGTCards');
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 = '' . rand(1, 8) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(1, 8);
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(1, 8) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(1, 8));
                    $_obf_0D3E331C040E390B031B03100422040311293E023E0322 .= (',' . rand(1, 8) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(1, 8));
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('Wins27EGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('Wins27EGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('Wins27EGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('Wins27EGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('Wins27EGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
