            ...
            switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 ) 
            {
                ...
                case 'spin':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            if( $Holds[$r] == 1 && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                            {
                                $reels['reel' . $r][0] = 9;
                                $reels['reel' . $r][1] = 9;
                                $reels['reel' . $r][2] = 9;
                        ...
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            ...
                            if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && ($reels['reel' . $r][0] == 9 || $reels['reel' . $r][1] == 9 || $reels['reel' . $r][2] == 9) ) 
                            {
                                $Holds[$r] = 1;
                            }
                        }
                        ...
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            for( $p = 0; $p <= 2; $p++ ) 
                            {
                                if( $_obf_0D1103183E22072D2511390A1B145C25235C2407082111['reel' . $r][$p] == -1 || $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && $Holds[$r] != 1 ) 
                                {
                                    $_obf_0D1A31365C2828323432011C290C0C32091F3709230511 = [
                                        'T', 
                                        'M', 
                                        'B'
                                    ];
                                    if( $reels['reel' . $r][$p] == 9 ) 
                                    {
                                        $_obf_0D0410092A1F39153D171B22300F190E22312603020C01[] = 'i:' . $_obf_0D37325B0B3F020C26403910323E16341F311E110F1232 . ';a:3:{s:4:"reel";i:' . ($r - 1) . ';s:3:"pos";i:' . $p . ';s:9:"animation";s:5:"wild' . $_obf_0D1A31365C2828323432011C290C0C32091F3709230511[$p] . '";}';
                                    }
                    ...
                    if( count($_obf_0D0410092A1F39153D171B22300F190E22312603020C01) <= 0 ) 
                    {
                        $_obf_0D4024053D1B0C30062D1523193E0210230C385B3D2911 = 'b:0;';
                    }
                    else
                    {
