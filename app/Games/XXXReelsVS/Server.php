        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D1725391C1C0A3529182B263529401F0E1322380B1A32 ) 
            {
                ...
                case 'SELGAME':
                    ...
                    $slotSettings->SetGameData('XXXReelsVSCards', $_obf_0D21152412095C03222D3808130C3C012907290C181E22);
                ...
                case 'GA_SPIN':
                    ...
                    $response = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $_obf_0D1F292430132C1009140F17162121100D240917270211 . ',"totalFreeGames":' . $slotSettings->GetGameData('XXXReelsVSFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('XXXReelsVSCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('XXXReelsVSBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                    ...
                    $_obf_0D21152412095C03222D3808130C3C012907290C181E22 = $slotSettings->GetGameData('XXXReelsVSCards');
                ...
                case 'GA_TAKE':
                    ...
                    $slotSettings->SetGameData('XXXReelsVSTotalWin', 0);
                    $_obf_0D0C042906245B03073E5C11081A210E351540320D2B01[] = '{"status":"OK","authtoken":"1/90317550919705477001","for":"GA_TAKE","totsg":' . $slotSettings->GetGameData('XXXReelsVSFreeGames') . ',"plsg":' . $slotSettings->GetGameData('XXXReelsVSCurrentFreeGame') . ',"inscatwin":' . ($slotSettings->GetGameData('XXXReelsVSBonusWin') * 100) . ',"gtype":' . $_obf_0D3B3428360D152B3D312F043B1F083E2317380A020511 . ',"credit":{"tot":' . $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 . '}}';
                    break;
                case 'QUITGAME':
                    $_obf_0D1A3E15343531081F13061E15332D2C3B403D0F100901 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
