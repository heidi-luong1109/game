...
namespace VanguardLTE\Games\LaGranAventuraAM
{
    ...
    class Server
    {
        public function get($request, $game)
        {
            ...
            $response = '';
            $lines = 20;
            $_obf_0D261C3E293911272E102E06115B1E29282A3D11101D22 = 20;
            ...
            switch( $gameData['slotEvent'] ) 
            {
                ...
                case 'A/u25':
                    ...
                    $slotState = '4';
                    $_obf_0D0A02273C2E3938231F391D0E1C2D06341F2504283022 = '0';
                    ...
                    if( $lastEvent != 'NULL' ) 
                    {
                        ...
                        $slotSettings->SetGameData('LaGranAventuraAMLines', $_obf_0D0D3D19173E372D15391D0C1E1F01030F1E163B5B3222);
                        ...
                        $_obf_0D2F1816033E36143D160A39333D122840370C160B1D32 = dechex($slotSettings->GetGameData('LaGranAventuraAMFreeGames'));
                        $_obf_0D243812041C191E1B1A3F113E330236293F3D3D105C11 = dechex($slotSettings->GetGameData('LaGranAventuraAMFreeGames') - $slotSettings->GetGameData('LaGranAventuraAMCurrentFreeGame'));
                        ...
                        $_obf_0D1F02220D0F2D281D26051502182F0E0C1C3D18350732 = $slotSettings->HexFormat($slotSettings->GetGameData('LaGranAventuraAMBonusWin') * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01);
                        if( $slotSettings->GetGameData('LaGranAventuraAMCurrentFreeGame') < $slotSettings->GetGameData('LaGranAventuraAMFreeGames') && $slotSettings->GetGameData('LaGranAventuraAMFreeGames') > 0 ) 
                        {
                            ...
                            $_obf_0D0A02273C2E3938231F391D0E1C2D06341F2504283022 = '' . $lastEvent->serverResponse->FreeSym;
                    ...
                    {
                        $slotSettings->SetGameData('LaGranAventuraAMLines', $_obf_0D01361D0A3E2D311F08242223290C1B173C3E1D332432);
                        $slotState = '4';
                    ...
                    $_obf_0D11151A1D085C32271F03141323161C1C140D30403D11 = $slotSettings->GetGameData('LaGranAventuraAMStackedWilds');
                    $response = '05' . $slotSettings->FormatReelStrips('') . '5' . $slotSettings->FormatReelStrips('Bonus') . '0' . $slotState . '0' . $reelSate . '10' . $balanceFormated . $_obf_0D1F02220D0F2D281D26051502182F0E0C1C3D18350732 . $_obf_0D0231242F16365B3C1D071E3B263319262A16261D2F01 . $_obf_0D353903345C2903220A0F1D1410163F37251D5B020711 . $_obf_0D1F210640113215055B051B35301630023C18403E2B22 . $_obf_0D01361D0A3E2D311F08242223290C1B173C3E1D332432 . $_obf_0D143D1E1E380F351E1138192B253404170B06113D2922 . '1010101011' . $_obf_0D01361D0A3E2D311F08242223290C1B173C3E1D332432 . $_obf_0D01361D0A3E2D311F08242223290C1B173C3E1D332432 . '0a1000' . $reelSate . '0000000000000000' . $_obf_0D2B230C15322D020F0D262A1538072D011C092D310732 . $_obf_0D130827385C083E1E300D2E3F3233061923211C050522 . '151010101010101010101010101010101010101010100' . $_obf_0D0A02273C2E3938231F391D0E1C2D06341F2504283022 . implode('', $_obf_0D11151A1D085C32271F03141323161C1C140D30403D11[0]) . implode('', $_obf_0D11151A1D085C32271F03141323161C1C140D30403D11[0]) . implode('', $_obf_0D11151A1D085C32271F03141323161C1C140D30403D11[0]) . implode('', $_obf_0D11151A1D085C32271F03141323161C1C140D30403D11[0]) . '#00101010|0';
                    break;
                case 'A/u250':
                    $_obf_0D01361D0A3E2D311F08242223290C1B173C3E1D332432 = $slotSettings->GetGameData('LaGranAventuraAMLines');
                    $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01));
                    $lastEvent = $slotSettings->GetHistory();
                    if( $lastEvent != 'NULL' ) 
                    {
                ...
                case 'A/u2517':
                    ...
                    {
                        if( $_obf_0D352C382D18370F060731361A34213C22051017303211[$_obf_0D36152A142D3640231A1D361D113D0D310B0121323711] * $betline <= $slotSettings->GetBank('bonus') ) 
                        {
                    ...
                    {
                        $_obf_0D333E3226362123015B0D2A04063804030F3E05312322 = json_decode(trim(file_get_contents(dirname(__FILE__) . '/presets/select_' . $_obf_0D1F343E172A2D1D232C0E035C01131F1E1E0F3E332F11[1] . '/p_' . $_obf_0D33011D06062C0A3B1A36280F123F3C365C1D3D252211 . '/preset_' . $lines . '.json')), true);
                        for( $_obf_0D310C36352B131E0D2B172E14091F1A242B2519130611 = 0; $_obf_0D310C36352B131E0D2B172E14091F1A242B2519130611 < 50; $_obf_0D310C36352B131E0D2B172E14091F1A242B2519130611++ ) 
                        {
                        ...
                        $_obf_0D0E290F260D400B403013221104265C0A372236133011 = $curSeq['allWin'] * $betline;
                        $slotSettings->SetGameData('LaGranAventuraAMCurrentSeq', $curSeq);
                    }
                    if( $_obf_0D0E290F260D400B403013221104265C0A372236133011 > 0 ) 
                    {
                        $slotSettings->SetBank('bonus', -1 * $_obf_0D0E290F260D400B403013221104265C0A372236133011);
                    }
                    $slotSettings->SetGameData('LaGranAventuraAMFreeSym', $_obf_0D1F343E172A2D1D232C0E035C01131F1E1E0F3E332F11[1]);
                    $response = $slotSettings->GetGameData('LaGranAventuraAMFreeStart') . '1' . dechex($_obf_0D1F343E172A2D1D232C0E035C01131F1E1E0F3E332F11[1]) . '1010';
                    break;
                case 'A/u251':
                    ...
                    if( $winType == 'bonus' && $slotSettings->GetBank((isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent']) ? $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] : '')) < ($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['bet'] * 5 + (500 * $betLine)) ) 
                    {
                        $winType == 'none';
                    }
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                        {
                            for( $wr = 1; $wr <= 5; $wr++ ) 
                            {
                                for( $_obf_0D1E312A051725301D4036132C351D1A033138261F2701 = 0; $_obf_0D1E312A051725301D4036132C351D1A033138261F2701 <= 2; $_obf_0D1E312A051725301D4036132C351D1A033138261F2701++ ) 
                                {
                                    if( $_obf_0D11151A1D085C32271F03141323161C1C140D30403D11[$_obf_0D1E312A051725301D4036132C351D1A033138261F2701][$wr] == $slotSettings->GetGameData('LaGranAventuraAMFreeSym') ) 
                                    {
                                        $reels['reel' . $wr][$_obf_0D1E312A051725301D4036132C351D1A033138261F2701] = $slotSettings->GetGameData('LaGranAventuraAMFreeSym');
                                    }
                                }
                            }
                        }
                                ...
                                else
                                {
                                    ...
                                    if( $s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild) ) 
                                    {
                                        ...
                                        if( $cWins[$k] < $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01 ) 
                                        {
                                            ...
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('LaGranAventuraAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('LaGranAventuraAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('LaGranAventuraAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('LaGranAventuraAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                        }
                                    }
                                    if( ($s[0] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[0], $wild)) && ($s[1] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[1], $wild)) && ($s[2] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[2], $wild)) && ($s[3] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[3], $wild)) && ($s[4] == $_obf_0D011C142C3C37263F351C4012170A074027083F321132 || in_array($s[4], $wild)) ) 
                                    {
                                        ...
                                        {
                                            $cWins[$k] = $_obf_0D0D163F1706133D0A110219022A07303D371E1C0A0F01;
                                            $_obf_0D0207283039073919263232090A382F3D26101F0D1E11 = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('LaGranAventuraAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                        }
                                    }
                                }
                            }
                        ...
                        {
                            if( $scattersCount >= 3 && $winType == 'bonus' && $slotSettings->GetBank((isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent']) ? $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] : '')) < ($betLine * 500 + $totalWin) ) 
                            {
                                $winType = 'none';
                            }
                    ...
                    if( $totalWin > 0 && $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] != 'freespin' ) 
                    {
                        $slotSettings->SetBank((isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent']) ? $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] : ''), -1 * $totalWin);
                    }
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' && $slotSettings->GetGameData('LaGranAventuraAMFreeGames') <= $slotSettings->GetGameData('LaGranAventuraAMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('LaGranAventuraAMBonusWin') + $totalWin > 0 ) 
                    {
                    ...
                    if( $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        for( $wr = 1; $wr <= 5; $wr++ ) 
                        {
                            for( $_obf_0D1E312A051725301D4036132C351D1A033138261F2701 = 0; $_obf_0D1E312A051725301D4036132C351D1A033138261F2701 <= 2; $_obf_0D1E312A051725301D4036132C351D1A033138261F2701++ ) 
                            {
                                if( $reels['reel' . $wr][$_obf_0D1E312A051725301D4036132C351D1A033138261F2701] == $slotSettings->GetGameData('LaGranAventuraAMFreeSym') ) 
                                {
                                    $_obf_0D11151A1D085C32271F03141323161C1C140D30403D11[$_obf_0D1E312A051725301D4036132C351D1A033138261F2701][$wr] = $slotSettings->GetGameData('LaGranAventuraAMFreeSym');
                                }
                            }
                        }
                        $slotSettings->SetGameData('LaGranAventuraAMStackedWilds', $_obf_0D11151A1D085C32271F03141323161C1C140D30403D11);
                    }
                    else
                    {
                        $slotSettings->SetGameData('LaGranAventuraAMTotalWin', $totalWin);
                    ...
                    if( $scattersCount >= 3 ) 
                    {
                        $_obf_0D2E3437162622183F300B5C220C15055C2D38031B3511 = '10';
                        $bonusMpl = $slotSettings->slotFreeMpl;
                        ...
                        {
                            $slotSettings->SetBank((isset($_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent']) ? $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] : ''), -1 * ($betLine * 500));
                    ...
                    $_obf_0D2D350C1338352E3F0236115C1407341C0926053F2211 = '{"responseEvent":"spin","responseType":"' . $_obf_0D221D1040101E0C18152D38350A220B2431190A3E1822['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"FreeSym":' . $slotSettings->GetGameData('LaGranAventuraAMFreeSym') . ',"StackedWilds":' . json_encode($slotSettings->GetGameData('LaGranAventuraAMStackedWilds')) . ',"slotLines":' . $lines . ',"slotBet":' . $_obf_0D5C0D3128242C1E2D2A0A0C38391632153F3C3B171F11 . ',"totalFreeGames":' . $slotSettings->GetGameData('LaGranAventuraAMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('LaGranAventuraAMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('LaGranAventuraAMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('LaGranAventuraAMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $_obf_0D33120B1B18292D30293B191C3D383E3D2D0C195B2101 . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $_obf_0D1B370B073F123C3210300C0336351F3E072217172A22 . ',"reelsSymbols":' . $_obf_0D140A1C122D065B2A1629031B280E272815082A0D2122 . '}}';
                    ...
                    $_obf_0D253E081A3F131A15301F3208364004053E2B1E0E0F32 = '0' . $slotSettings->GetGameData('LaGranAventuraAMFreeSym') . implode('', $_obf_0D11151A1D085C32271F03141323161C1C140D30403D11[0]) . implode('', $_obf_0D11151A1D085C32271F03141323161C1C140D30403D11[1]) . implode('', $_obf_0D11151A1D085C32271F03141323161C1C140D30403D11[2]);
                    $response = '1' . $_obf_0D2E3437162622183F300B5C220C15055C2D38031B3511 . '010' . $balanceFormated . $slotSettings->HexFormat(round($totalWin * 100)) . $reelSate . $_obf_0D3F05382A29123605040E3D10291E2F12391926360401 . $_obf_0D2E320D352628142310141D2F010A085C321810131022 . $_obf_0D143D1E1E380F351E1138192B253404170B06113D2922 . $_obf_0D2A110E32023D090C020D1E24321C2F19081A26092D32 . $slotSettings->HexFormat($bonusMpl) . '1010' . $reelSate . $_obf_0D0F172D1118050C402A0F213C1D233038275B3E103101 . $winLinesFormated . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards')) . '' . $_obf_0D253E081A3F131A15301F3208364004053E2B1E0E0F32 . '#' . $scattersCount;
                    $response .= ('_' . json_encode($reels));
                    $slotSettings->SetGameData('LaGranAventuraAMFreeStart', '105010' . $balanceFormated . $slotSettings->HexFormat(round($totalWin * 100)) . $reelSate . '' . $_obf_0D3F05382A29123605040E3D10291E2F12391926360401 . $_obf_0D2E320D352628142310141D2F010A085C321810131022 . '1a1a101110101010101010' . $_obf_0D0F172D1118050C402A0F213C1D233038275B3E103101 . $winLinesFormated . '0000000000000000');
                    $slotSettings->SetGameData('LaGranAventuraAMDoubleAnswer', $reelSate . $_obf_0D3F05382A29123605040E3D10291E2F12391926360401 . $_obf_0D2E320D352628142310141D2F010A085C321810131022 . '1010101010101010101010' . $_obf_0D0F172D1118050C402A0F213C1D233038275B3E103101 . $winLinesFormated);
                    ...
                    $slotSettings->SetGameData('LaGranAventuraAMCollectP0', $_obf_0D121F0821192F3304332C1D225C362A0F2C5C23312322);
                    ...
                    $slotSettings->SetGameData('LaGranAventuraAMCollect', $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22);
                    break;
                case 'A/u254':
                    $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                ...
                case 'A/u257':
                    $doubleWin = rand(1, 2);
                    $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032 = $slotSettings->GetGameData('LaGranAventuraAMDoubleWin');
                    ...
                    $response = '107010' . $slotSettings->GetGameData('LaGranAventuraAMDoubleBalance') . strlen($_obf_0D143B0B042F091727280D3E182D1D0115352113380F01) . $_obf_0D143B0B042F091727280D3E182D1D0115352113380F01 . $slotSettings->GetGameData('LaGranAventuraAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                    $slotSettings->SetGameData('LaGranAventuraAMDoubleWin', $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032);
                    $slotSettings->SetGameData('LaGranAventuraAMTotalWin', $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032);
                    $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01));
                    $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22 = '104010' . $balanceFormated . strlen($_obf_0D143B0B042F091727280D3E182D1D0115352113380F01) . $_obf_0D143B0B042F091727280D3E182D1D0115352113380F01 . $slotSettings->GetGameData('LaGranAventuraAMCollectP0');
                    $slotSettings->SetGameData('LaGranAventuraAMCollect', $_obf_0D3C151610112B1F3C1426091814400B382A0E1D112B22);
                ...
                case 'A/u258':
                    ...
                    $slotSettings->SetGameData('LaGranAventuraAMDoubleBalance', $_obf_0D373B302A1614233D3F2D03055B0B142A33240F1D0511);
                    $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032 = sprintf('%01.2f', $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032) * $_obf_0D2C053C101716192D2F13310A1308232F0F393F253D01;
                    $_obf_0D055B13312136223405401F250A14140A220F080A0211 = str_replace('.', '', $_obf_0D2131292F1B0124035C2B071E143E103D3F17131F4032 . '');
                    $_obf_0D143B0B042F091727280D3E182D1D0115352113380F01 = dechex($_obf_0D055B13312136223405401F250A14140A220F080A0211);
                    $_obf_0D0B231C5C1F3C2202340D2D242505232E371E352F2532 = '26280b2714161d0c';
                    $response = '108010' . $slotSettings->GetGameData('LaGranAventuraAMDoubleBalance') . strlen($_obf_0D143B0B042F091727280D3E182D1D0115352113380F01) . $_obf_0D143B0B042F091727280D3E182D1D0115352113380F01 . $slotSettings->GetGameData('LaGranAventuraAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                    break;
            }
