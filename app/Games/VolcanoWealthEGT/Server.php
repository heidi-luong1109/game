        ...
        public function get($request, $game)
        {
            ...
            switch( $_obf_0D36302910132C2C39290C27155B093F1526105B2A2C22 ) 
            {
                ...
                case 'subscribe':
                    ...
                    $slotSettings->SetGameData('VolcanoWealthEGTCards', $_obf_0D0B38261D090527042502043006023133212F0F040922);
                ...
                case 'bet':
                    ...
                    for( $i = 0; $i <= 2000; $i++ ) 
                    {
                        ...
                        $_obf_0D2E1E2C1B04120D115C142A2A11031F10053616375C01 = [];
                        for( $r = 1; $r <= 5; $r++ ) 
                        {
                            for( $_obf_0D5C0907022524223D08023D0D1E1A163D3D152E3C1222 = 0; $_obf_0D5C0907022524223D08023D0D1E1A163D3D152E3C1222 <= 3; $_obf_0D5C0907022524223D08023D0D1E1A163D3D152E3C1222++ ) 
                            {
                                if( $reels['reel' . $r][$_obf_0D5C0907022524223D08023D0D1E1A163D3D152E3C1222] == '10' ) 
                                {
                                    for( $_obf_0D5B0202371E2A2E3024322D0836181A1C1B2B18133401 = $_obf_0D5C0907022524223D08023D0D1E1A163D3D152E3C1222 + 1; $_obf_0D5B0202371E2A2E3024322D0836181A1C1B2B18133401 <= 3; $_obf_0D5B0202371E2A2E3024322D0836181A1C1B2B18133401++ ) 
                                    {
                                        $reels['reel' . $r][$_obf_0D5B0202371E2A2E3024322D0836181A1C1B2B18133401] = '10';
                                        $_obf_0D2E1E2C1B04120D115C142A2A11031F10053616375C01[] = ($r - 1) . ',' . $_obf_0D5B0202371E2A2E3024322D0836181A1C1B2B18133401;
                                    }
                                }
                            }
                        }
                    ...
                    if( $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = $slotSettings->GetGameData('VolcanoWealthEGTFreeBalance');
                    }
                    else
                    {
                    ...
                    $_obf_0D0B38261D090527042502043006023133212F0F040922 = $slotSettings->GetGameData('VolcanoWealthEGTCards');
                    ...
                    break;
                case 'collect':
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('VolcanoWealthEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                    $slotSettings->SetGameData('VolcanoWealthEGTTotalWin', 0);
                    break;
                case 'jackpot':
                    $_obf_0D331603075C262F240C055B033811280F370B2C071D01 = $slotSettings->GetGameData('VolcanoWealthEGTJackSteps');
                    $_obf_0D1209110D1C02405B0D2E233115272A2E091F04213C01 = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                    if( $_obf_0D331603075C262F240C055B033811280F370B2C071D01[0] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[1] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[2] >= 3 || $_obf_0D331603075C262F240C055B033811280F370B2C071D01[3] >= 3 || !$slotSettings->HasGameData('VolcanoWealthEGTJackSteps') ) 
                    {
                        exit();
                    }
                    ...
                    $slotSettings->SetGameData('VolcanoWealthEGTJackSteps', $_obf_0D331603075C262F240C055B033811280F370B2C071D01);
                    break;
                case 'gamble':
