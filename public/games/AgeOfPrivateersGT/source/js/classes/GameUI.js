...
objArr['menuTab'].x=474;
objArr['menuTab'].y=482;
...
objArr[objId]._view.y=cObj.y;
objArr[objId].Enable();
}else if(cObj.type=="button_circle"){

objArr[objId]=new CircleButton(this._view,objId,cObj.res,cObj.colors,cObj.width,cObj.height,cObj.minText);
...
objArr[objId]._view.y=cObj.y;
objArr[objId].Enable();
objArr[objId]._view.visible=false;
}
...
objArr['uiButtonBetPlus']._view.visible=false;
objArr['uiButtonBetMinus']._view.visible=false;
