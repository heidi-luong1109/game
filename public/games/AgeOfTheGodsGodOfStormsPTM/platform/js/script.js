...
(function (g) {
    var j = ["hlk", "hlk2", "hulk", "ba", "baws", "bj_mh5", "cheaa", "evj", "ges", "glrj", "gos", "hf", "ir", "ir2", "irmn3", "pgv", "pnp", "ro_g", "ssp", "spidc", "avng"];
    var a = {};
    var f = "";
    ...
    g.isCore1Game = function (k) {
        return j.indexOf(k) !== -1
    };
    g.getParam = function (l, k) {
        var m = k ? l : l.toLowerCase();
        return a[m]
    };
    g.inJsViewport = function () {
        try {
...
(function (a) {
    ...
    a.isForceEnabled = function () {
        return c
    };

    function d(e) {
        dispatchEvent(new CustomEvent("cpLogStateEvent", {
            detail: e
        }))
    }
}(CP.Log));
(function (t) {
    ...
    var z = false,
        ...
        p = true;
    var v = function () {};
    t.activateJsScaling = function () {
        c = false;
        d()
    };
    t.activateCSSScaling = function () {
        b = g();
        p = window.CSS && window.CSS.supports && window.CSS.supports("(height:var(--value))");
        k();
        d()
    };
    ...
    function B() {
        ...
        return (D.indexOf("ipad") !== -1 || D.indexOf("iphone") !== -1 || D.indexOf("ipod") !== -1) && D.indexOf("safari") !== -1 && D.indexOf("crios") === -1
    }

    function o() {
        var D = navigator.userAgent.toLowerCase();
        return (D.indexOf("iphone") !== -1 || D.indexOf("ipad") !== -1 || D.indexOf("ipod") !== -1)
    }

    function g() {
        var D = window.devicePixelRatio ? window.devicePixelRatio : 1;
        if (D > 2) {
            return 2
        }
        return D
    ...
    function u() {
        if (c) {
            if (p) {
                v = function (D) {
                    document.documentElement.style.setProperty("--platform-inner-height", D.height + "px");
                    document.documentElement.style.setProperty("--platform-inner-width", D.width + "px");
                    document.documentElement.style.setProperty("--platform-scaled-height", C * D.height + "px");
                    document.documentElement.style.setProperty("--platform-scaled-width", C * D.width + "px");
                    0
                }
            } else {
                v = function (G) {
                    var F = document.getElementById("css-viewport");
                    var D = true;
                    if (!F) {
                        D = false;
    ...
    function y(D) {
        if (D.height === a.height && D.width === a.width) {
            return false
        }
        return true
    }
    ...
    function m() {
        var D = Math.max(screen.height, screen.width);
        if (o() && (D === 812 || D === 896)) {
            return true
        }
        return false
    ...
    function k() {
        ...
        document.documentElement.style.setProperty("--platform-css-scale", x(1 / C))
    }
    ...
    var f = function (G) {
        ...
        var F = Math.min(G.width, G.height);
...
(function (c) {
    try {
        ...
        function a(e, g) {
            ...
            var f = c.document.createEvent("Event");
            f.initEvent(e, g.bubbles, g.cancelable);
            return f
        }
        a.prototype = c.Event.prototype;
        ...
        function d(e, g) {
            ...
            var f = c.document.createEvent("CustomEvent");
            f.initEvent(e, g.bubbles, g.cancelable);
            f.detail = g.detail;
            f.initCustomEvent = function (k, l, h, j) {
                f.initEvent(k, l, h);
                f.detail = j
            };
            return f
        }
        d.prototype = c.Event.prototype;
        c.Event = a;
        c.CustomEvent = d
    }
})(window);
    ...
    Detect = (function () {
        ...
        function a() {
            ...
            !Detect.F ? Detect.F = {
                Unidentified: {
                    name: "Unidentified",
                    type: Detect.T.Unidentified
                },
                Iphone: {
                    name: "Apple - iPhone Family",
                    type: Detect.T.SmartPhone
                },
                Ipad: {
                    name: "Apple - iPad Family",
                    type: Detect.T.Tablet
                },
                Ipod: {
                    name: "Apple - iPod Family",
                    type: Detect.T.SmartPhone
                },
                NexusSmartPhones: {
                    name: "Google - Nexus Family",
                    type: Detect.T.SmartPhone
                },
                NexusTablets: {
                    name: "Google - Nexus Family",
                ...
                GalaxyA: {
                    name: "Samsung - Galaxy A Family",
                    type: Detect.T.SmartPhone
                },
                GalaxyS: {
                    name: "Samsung - Galaxy S Family",
                    type: Detect.T.SmartPhone
                },
                GalaxyNote: {
                    name: "Samsung - Galaxy Note Family",
                    type: Detect.T.SmartPhone
                },
                GalaxyTab: {
                    name: "Samsung - Galaxy Tab Family",
                    type: Detect.T.Tablet
                },
                GalaxyTabS: {
                    name: "Samsung - Galaxy Tab S Family",
                    type: Detect.T.Tablet
                },
                HtcOne: {
                    name: "HTC - One Family",
                ...
                XperiaZ: {
                    name: "Sony - Xperia Z Family",
                    type: Detect.T.SmartPhone
                },
                MotorolaMotoG: {
                    name: "Motorola - Moto G Family",
                    type: Detect.T.SmartPhone
                },
                LGG: {
                    name: "LG - G Family",
                ...
                MeizuMX: {
                    name: "Meizu - MX Family",
                    type: Detect.T.SmartPhone
                },
                XiaomiMi: {
                    name: "Xiaomi - Mi Family",
                    type: Detect.T.SmartPhone
                },
                LenovoTab: {
                    name: "Lenovo - Tab Family",
                    type: Detect.T.Tablet
                },
                LenovoA: {
                    name: "Lenovo - A Family",
                    type: Detect.T.SmartPhone
                },
                Lumia: {
                    name: "Nokia - Lumia Family",
                    type: Detect.T.SmartPhone
                },
                UnidentifiedDesktop: {
                    name: "Unidentified - Desktop",
                    type: Detect.T.Desktop
                }
            } : null;
            !Detect.D ? Detect.D = {
                Unidentified: {
                    name: "Unidentified",
                    family: Detect.F.Unidentified
                },
                Iphone: {
                    name: "Apple - iPhone",
                    family: Detect.F.Iphone
                },
                Iphone6Plus: {
                ...
                Nexus6P: {
                    ...
                    family: Detect.F.NexusSmartPhones
                },
                Nexus5X: {
                ...
                GalaxyTabA9_7: {
                    name: "Samsung - Galaxy Tab A 9.7",
                    family: Detect.F.GalaxyTab
                },
                GalaxyTabA8_0: {
                ...
                GalaxyTabPro12_2: {
                    name: "Samsung - Galaxy Tab Pro 12.2",
                    family: Detect.F.GalaxyTab
                },
                GalaxyTabPro10_1: {
                    name: "Samsung - Galaxy Tab Pro 10.1",
                    family: Detect.F.GalaxyTab
                },
                GalaxyTabPro8_4: {
                ...
                GalaxyTab4_10_1_2015: {
                    name: "Samsung - Galaxy Tab 4 10.1 (2015)",
                    family: Detect.F.GalaxyTab
                },
                GalaxyTab4_10_1_LTE: {
                    name: "Samsung - Galaxy Tab 4 10.1 LTE",
                    family: Detect.F.GalaxyTab
                },
                GalaxyTab4_10_1_3G: {
                    name: "Samsung - Galaxy Tab 4 10.1 3G",
                    family: Detect.F.GalaxyTab
                },
                GalaxyTab4_10_1: {
                    name: "Samsung - Galaxy Tab 4 10.1",
                    family: Detect.F.GalaxyTab
                },
                GalaxyTab4_8_0: {
                ...
                GalaxyA7: {
                    ...
                    family: Detect.F.GalaxyA
                },
                GalaxyNotePro12_2: {
                    name: "Samsung - Galaxy Note Pro 12.2",
                    family: Detect.F.GalaxyNote
                },
                GalaxyNote10_1_2014: {
                    name: "Samsung - Galaxy Note 10.1 2014 Edition",
                    family: Detect.F.GalaxyNote
                },
                GalaxyNote10_1: {
                ...
                HtcOne: {
                    name: "HTC - One",
                    family: Detect.F.HtcOne
                },
                XperiaZ: {
                    name: "Sony - Xperia Z",
                    family: Detect.F.XperiaZ
                },
                MotorolaMotoG2: {
                    name: "Motorola - Moto G (2nd gen)",
                    family: Detect.F.MotorolaMotoG
                },
                MotorolaMotoG: {
                ...
                LenovoTab2A730HC: {
                    name: "Lenovo - Tab 2 A7-30",
                    family: Detect.F.LenovoTab
                },
                LenovoA889: {
                    name: "Lenovo - A889",
                    family: Detect.F.LenovoA
                },
                LenovoA850: {
                    name: "Lenovo - A850",
                    family: Detect.F.LenovoA
                ...
                UnidentifiedDesktop: {
                    name: "Unidentified - Desktop",
                    family: Detect.F.UnidentifiedDesktop
                }
            } : null;
            !Detect.O ? Detect.O = {
                Unidentified: {
            ...
            !Detect.B ? Detect.B = {
                ...
                AndroidWebkitChrome: {
                    name: "Android Browser Chromium"
                },
                SamsungBrowser: {
                    name: "Samsung - Samsung Browser"
                },
                Ie: {
                ...
                UcBrowser: {
                    name: "UCWeb - UC Browser"
                },
                Firefox: {
                    name: "Mozilla - Firefox"
                },
                BaiduBrowser: {
                    name: "Baidu - Baidu Browser"
                },
                DUBrowser: {
                    name: "Baidu - DU Browser"
                },
                QQBrowser: {
                    name: "Tencent Technology - QQ Browser"
                },
                _360Browser: {
                    name: "360.cn - 360 Security Browser"
                },
                Opera: {
                    name: "Opera Software - Opera"
                },
                YandexBrowser: {
                    name: "Yandex - Yandex Browser"
                },
                Maxthon: {
                    name: "Maxthon  - Maxthon Browser"
                },
                Silk: {
                    name: "Amazon - Silk"
                }
            ...
            !Detect.Consts ? Detect.Consts = {
                ...
                DeviceUAMarks: {
                    ...
                    iPhone: function () {
                        return b.widerSide == 480 ? Detect.D.Iphone4 : b.widerSide == 568 ? Detect.D.Iphone5 : b.widerSide == 667 ? Detect.D.Iphone6 : b.widerSide == 736 ? Detect.D.Iphone6Plus : b.widerSide == 812 ? Detect.D.IphoneX : b.widerSide == 896 ? Detect.D.IphoneXsMax : Detect.D.Iphone
                    },
                    iPad: function () {
                        if (b.widerSide == 1366) {
                            return Detect.D.IpadPro129
                        } else {
                            return b.devicePixelRatio == 1 ? Detect.D.Ipad : Detect.D.IpadRetina
                        }
                    }
                },
                OsUAMarks: {
        ...
        function d() {
            for (var g = 0; g < e.length; g++) {
                if (e[g].init && e[g].init instanceof Function) {
                    e[g].init(b);
                    console.log("[Detect] Initialized " + (g == 0 ? "logic" : "extension " + g))
                } else {
                    console.error("Can't initialize extension " + g + " due to missing init() method!")
                }
            }
        }
        ...
        function c() {
            if (b.screenWidth && b.screenHeight) {
                b.widerSide = Math.max(b.screenWidth, b.screenHeight)
            }
        }
        return {
            init: function (g) {
                b = g;
                if (b && b.userAgent && typeof b.userAgent == "string") {
                    c();
                    a();
                    d();
                    console.info("[Detect] Initialization finished")
                } else {
                    console.error("Can't initialize Detect.js due to malformed input user agent info: " + b + ". Expected '{userAgent : string}'");
                    console.dir(b)
                }
            },
            extend: function (j, g) {
                ...
                for (var h in j) {
                    Object.assign(j[h], g[h])
                }
            },
            registerExtension: function (g) {
                e.push(g)
            }
        }
    })()
...
Detect.registerExtension((function () {
    ...
    var c = (function () {
        function k(n, o) {
            var m = o ? o : Detect.Consts.unidentified;
            return {
                itemID: m,
                item: n[Detect.Consts.unidentified],
        ...
        return {
            detectDevice: function (p, o) {
                var m = p.exec(e.userAgent);
                if (!m) {
                    return k(o)
                }
            ...
            detectOSorBrowser: function (s, u, t) {
                var o = {
                    Android: 5,
                    IEMobile: 10,
                    Version: 15,
                ...
                var w;
                var n = [];
                while ((w = s.exec(e.userAgent)) != null) {
                    n.push(w[1] + "|" + w[2])
                }
                w = u.exec(e.userAgent);
                if (w) {
                    var p, r;
                    for (var q = 1; q < w.length; q++) {
                        if (w[q]) {
                            if (Detect.Consts.isEntityVersion.test(w[q])) {
                                r = w[q]
                            } else {
                                p = w[q]
                            }
            ...
            versionCompare: function (r, q) {
                if (r === q) {
                    return 0
                }
                if (typeof r + typeof q != "stringstring" || isNaN(parseInt(r)) || isNaN(parseInt(q))) {
                    return false
                }
                var o = r.split(".");
                var n = q.split(".");
                var p = 0;
                var m = Math.max(o.length, n.length);
                for (; p < m; p++) {
                    if ((o[p] && !n[p] && parseInt(o[p]) > 0) || (parseInt(o[p]) > parseInt(n[p]))) {
                        return 1
                    } else {
                        if ((n[p] && !o[p] && parseInt(n[p]) > 0) || (parseInt(o[p]) < parseInt(n[p]))) {
                            return -1
                        }
                    }
                }
    ...
    function g() {
        ...
        Detect.Device = (function () {
            ...
            function l() {
                var p = Detect.Consts.deviceModelCutOff.exec(n);
                if (p) {
                    p = p[0];
                    var o = Detect.Consts.DeviceUAMarks[p];
                    o ? k.item = m = o : null
                }
            }
            return {
                init: function () {
                    k = c.detectDevice(Detect.Consts.deviceRegex, Detect.Consts.DeviceUAMarks);
                    n = k.itemID;
                    m = k.item;
                    if (k.item == Detect.D.Unidentified) {
                        l()
                    }
                    return k
                },
                ...
                isAnyOf: function () {
                    return c.checkAnyOf(arguments, m)
                }
            }
        })()
    }
    ...
    function h() {
        ...
        Detect.Family = (function () {
            ...
            return {
                ...
                isAnyOf: function () {
                    return c.checkAnyOf(arguments, l)
                }
            }
        })()
    }
    ...
    function a() {
        ...
        Detect.Type = (function () {
            ...
            function k(n) {
                ...
                function p() {
                    return /Android.+UCBrowser/i.test(o) ? undefined : Detect.Consts.deviceIsSmartPhoneRegex.test(o) && n != Detect.F.Ipad && n != Detect.F.Lumia
                }

                function m() {
                    return Detect.Consts.deviceIsTabletRegex.test(o)
                }
                if (p()) {
    ...
    function d() {
        ...
        Detect.OS = (function () {
            ...
            return {
                init: function () {
                    var n = c.detectOSorBrowser(Detect.Consts.osRegexSimple, Detect.Consts.osRegexComplex, Detect.Consts.OsUAMarks);
                    m = n.itemID;
                    l = n.item;
                    k = n.itemVersion
                },
                ...
                versionIs: function (n) {
                    return c.versionCompare(k.substring(0, n.length), n) == 0
                },
                versionIsExactly: function (n) {
                    return c.versionCompare(k, n) === 0
                },
                versionIsLaterThan: function (n) {
                    return c.versionCompare(k, n) === 1
                },
                versionIsEarlierThan: function (n) {
                    return c.versionCompare(k, n) === -1
                }
            }
        })()
    ...
    function j() {
        ...
        Detect.Browser = (function () {
            ...
            return {
                init: function () {
                    var n = c.detectOSorBrowser(Detect.Consts.browserRegexSimple, Detect.Consts.browserRegexComplex, Detect.Consts.BrowserUAMarks);
                    m = n.itemID;
                    k = n.item;
                    l = n.itemVersion
                },
                ...
                isAnyOf: function () {
                    return c.checkAnyOf(arguments, k)
                },
                version: function () {
                    return l
                },
                versionIs: function (n) {
                    return c.versionCompare(l.substring(0, n.length), n) == 0
                },
                versionIsExactly: function (n) {
                    return c.versionCompare(l, n) === 0
                },
                versionIsLaterThan: function (n) {
                    return c.versionCompare(l, n) === 1
                },
                versionIsEarlierThan: function (n) {
                    return c.versionCompare(l, n) === -1
                }
    ...
    return {
        init: function (k) {
            ...
            d();
            j();
            var m = Detect.Device.init();
            var l = Detect.Family.init(m);
            Detect.Type.init(l);
            Detect.OS.init();
            Detect.Browser.init()
        }
...
Detect.registerExtension(function () {
    ...
    b.prototype.addBrowser = function (d) {
        this.browsers[d.getId()] = d
    };
    b.prototype.getBrowser = function (d) {
        return this.browsers[d]
    };
    ...
    a.prototype.getLandscape = function () {
        return this.landscape
    };
    a.prototype.getPortrait = function () {
    ...
    c.prototype.getCore1 = function () {
        return this.core1
    };
    c.prototype.getCore2 = function () {
        return this.core2
    };
    return {
        init: function () {
            Detect.D.Iphone5.deviceResolution = new b();
...
(function () {
    ...
    (function (exports, io, global) {
        ...
        WS.prototype.open = function () {
            ...
            this.websocket = new Socket(serverString);
...
(function (f) {
    ...
    function c(j, h) {
        ...
        return h < 0 ? j + d.substring(0, k) : d.substring(0, k) + j
    }
    f.format = function () {
        ...
        var j = /\{(\d+)(?:,([-+]?\d+))?(?:\:([^(^}]+)(?:\(((?:\\\)|[^)])+)\)){0,1}){0,1}\}/g;
        var h = arguments;
        return this.replace(j, function (n, m, p, l, k) {
            n = h[Number(m)];
            l = g[l];
            return c(l == null ? n : l(n, b((k || "").replace(/\\\)/g, ")").replace(/\\,/g, "\0").split(","), h)), p)
        })
    };
    String.Format = function (e) {
        return arguments.length <= 1 ? e : f.format.apply(e, Array.prototype.slice.call(arguments, 1))
    };
    f.format.add = function (k, h, j) {
        if (g[k] != null && j != true) {
            throw "Format " + k + " exist, use replace=true for replace"
        }
        g[k] = h
    };
    String.Format.init = f.format.init = function (k) {
        var h;
        for (var j in k) {
            h = g[j];
    ...
    f.format.get = function (h) {
        return g[h]
    };
    var a = /^\{(\d+)\}$/;
    var g = {};
    var d = "    ";
    f.format.add("arr", function (j, l) {
        if (j == null) {
            return "null"
        }
        var h = [];
...
(function (g) {
    function l(a) {
        b.dseparator = a.dseparator || ".";
        b.nan = a.nan || "NaN"
    }

    function c(m, a, o) {
        if (isNaN(o = Number(o == "" ? undefined : o))) {
            return a == null || a == "" ? "" : (m || "") + a
        }
        if ((a = a || "").length >= o) {
            return m == null ? a : m + a.substr(0, o)
        }
        return m == null ? j(o - a.length) + a : m + a + j(o - a.length)
    }
    ...
    function h(u, p, v, o, q, m) {
        ...
        if (o > 0) {
            ...
            if (o < 0) {
                ...
                p = r > 0 ? p.substring(0, -o - 1) : "0"
            }
        }
        return "".concat(u, c(null, p, q), c(b.dseparator, v, m))
    }
    g.add("n", function (m, a) {
        if ((m = k.exec(m)) == null) {
            return b.nan
        }
        var e = Number(m[4]);
        return isNaN(e) ? "".concat(m[1], c(null, m[2], a[0]), c(b.dseparator, m[3], a[1])) : h(m[1], m[2], m[3], e, a[0], a[1])
    });
    g.add("nb", function (e, m) {
        e = Number(e);
        if (isNaN(e)) {
            return b.nan
        }
        var a = Number(m[0]);
        return c(null, e.toString(isNaN(a) ? 16 : a), Number(m[1]))
    });
    g.add("nf", function (m, a) {
        m = Number(m);
        if (isNaN(m)) {
            return b.nan
        }
        var o = f[a[0].toLowerCase()];
        return o == null ? a[0] + "?" : o(m, a)
    });
    g.get("nf").add = function (m, a) {
        f[m.toLowerCase()] = a
    };
    g.get("n").init = l;
    var k = /^([+-]?)(\d+)(?:\.(\d+))?(?:\s*e([+-]\d+))?$/i;
    ...
    var f = {
        ...
        ru: function (o, a) {
            var p = o % 10;
            var m = o % 100;
            return a[p == 1 && m != 11 ? 1 : p >= 2 && p <= 4 && (m < 10 || m >= 20) ? 2 : 3]
        }
    }
...
var pta = (function () {
    (function (q, r) {
        var p = function (u) {
                ...
                t.get = function (v) {
                    ...
                    return t._cache[t._cacheKeyPrefix + v]
                };
                t.set = function (v, w, x) {
                    x = t._getExtendedOptions(x);
                    x.expires = t._getExpiresDate(w === r ? -1 : x.expires);
                    t._document.cookie = t._generateCookieString(v, w, x);
                    return t
                };
                t.expire = function (v, w) {
                    return t.set(v, r, w)
                };
                t._getExtendedOptions = function (v) {
                    return {
                        path: v && v.path || t.defaults.path,
                        domain: v && v.domain || t.defaults.domain,
                        expires: v && v.expires || t.defaults.expires,
                        secure: v && v.secure !== r ? v.secure : t.defaults.secure
                    }
                };
                t._isValidDate = function (v) {
                    return "[object Date]" === Object.prototype.toString.call(v) && !isNaN(v.getTime())
                };
                t._getExpiresDate = function (v, w) {
                    w = w || new Date;
                    "number" === typeof v ? v = Infinity === v ? t._maxExpireDate : new Date(w.getTime() + 1000 * v) : "string" === typeof v && (v = new Date(v));
                    if (v && !t._isValidDate(v)) {
                        throw Error("`expires` parameter cannot be converted to a valid Date instance")
                    }
                    return v
                };
                t._generateCookieString = function (w, v, x) {
                    w = w.replace(/[^#$&+\^`|]/g, encodeURIComponent);
                    w = w.replace(/\(/g, "%28").replace(/\)/g, "%29");
                    v = (v + "").replace(/[^!#$&-+\--:<-\[\]-~]/g, encodeURIComponent);
                    x = x || {};
                    w = w + "=" + v + (x.path ? ";path=" + x.path : "");
                    w += x.domain ? ";domain=" + x.domain : "";
                    w += x.expires ? ";expires=" + x.expires.toUTCString() : "";
                    return w += x.secure ? ";secure" : ""
                };
                t._getCacheFromString = function (v) {
                    var x = {};
                    v = v ? v.split("; ") : [];
                    for (var y = 0; y < v.length; y++) {
                        var w = t._getKeyValuePairFromCookieString(v[y]);
                        x[t._cacheKeyPrefix + w.key] === r && (x[t._cacheKeyPrefix + w.key] = w.value)
                    }
                    return x
                };
                t._getKeyValuePairFromCookieString = function (w) {
                    var v = w.indexOf("="),
                        v = 0 > v ? w.length : v;
                    return {
                        key: decodeURIComponent(w.substr(0, v)),
                        value: decodeURIComponent(w.substr(v + 1))
                    }
                };
                ...
                t._areEnabled = function () {
                    var v = "1" === t.set("cookies.js", 1).get("cookies.js");
                    t.expire("cookies.js");
                    return v
                };
            ...
            s = "object" === typeof q.document ? p(q) : p;
        "function" === typeof define && define.amd ? define(function () {
            return s
        }) : "object" === typeof exports ? ("object" === typeof module && "object" === typeof module.exports && (exports = module.exports = s), exports.Cookies = s) : q.Cookies = s
    })("undefined" === typeof window ? this : window);
    var g = {};
    var a = "";
    var j = "";
    var k = ["user", "brand", "ctype", "cplat", "skin", "mode", "lang"];
    var m = 60 * 60 * 24;
    var l = function (p) {
        if (pta.debug === true) {
            alert("pta runtime error: " + p)
        }
    };
    var d = function (p, r) {
        try {
    ...
    var c = function (r, q, t) {
        try {
            if ((parseInt(r) < 1) || (parseInt(r) > 5)) {
                l("set custom field error : <index>=" + r + " is not a valid parameter");
                return false
            }
            if (typeof q !== "string") {
                l("set custom field error: <name>=" + q + " is not a valid parameter");
                return false
            }
            if (typeof t !== "string") {
                l("set custom field error: <value>=" + t + " is not a valid parameter");
                return false
            }
            var p = g["custname" + r];
            var s = g["custval" + r];
    ...
    var b = function (s, q) {
        try {
            s = s.toLowerCase();
            if (!e(k, s)) {
                l("set field error: <field>=" + s + " is not a valid parameter");
                return false
            }
            if (typeof q !== "string") {
                l("set field error: <value>=" + q + " is not a valid parameter");
                return false
            }
            var p = g[s];
            g[s] = q;
    ...
    var f = function (q, u, p, s) {
        try {
            if (typeof g.user === "undefined") {
                l('send error: "user" field is mandatory. use "set" to add this field');
                return false
            }
            if (typeof g.brand === "undefined") {
                l('send error: "brand" field is mandatory. use "set" to add this field');
                return false
            }
            if (typeof g.ctype === "undefined") {
                l('send error: "ctype" field is mandatory. use "set" to add this field');
                return false
            }
            if (typeof g.cplat === "undefined") {
                l('send error: "cplat" field is mandatory. use "set" to add this field');
                return false
            }
            if (typeof g.mode === "undefined") {
                l('send error: "mode" field is mandatory. use "set" to add this field');
                return false
            }
            if (typeof q !== "string") {
                l("send error: <category>=" + q + " is not a valid parameter");
                return false
            }
            if (typeof u !== "string") {
                l("send error: <action>=" + u + " is not a valid parameter");
                return false
            }
            if (typeof p !== "string") {
                l("send error: <label>=" + p + " is not a valid parameter");
                return false
            }
            if ((s !== null) && (typeof s !== "undefined") && (typeof s !== "number")) {
                l("send error: <value>=" + s + " is not a valid parameter");
                return false
            }
            var r = j + "&category=" + q + "&event=" + u + "&label=" + p + "&r=" + (new Date()).getTime();
    ...
    var o = function () {
        try {
            for (var q = 0; q < arguments.length; q++) {
                ...
                if (p === "set") {
                    var t = r[1];
                    if (t.toLowerCase() === "cust") {
                        c(r[2], r[3], r[4])
                    } else {
                        if (t.toLowerCase() === "statsurl") {
                            a = r[2]
                        } else {
                            b(r[1], r[2])
                        }
                    ...
                    if (p === "send") {
                        ...
                        l("method <" + p + '> is not supported. use only "set" or "send"')
                    }
                }
            }
        } catch (s) {
    ...
    var n = function () {
        try {
            var q = ["custname1", "custval1", "custname2", "custval2", "custname3", "custval3", "custname4", "custval4", "custname5", "custval5", "user", "brand", "ctype", "cplat", "skin", "mode", "lang"];
...
(function (f, a, e) {
    var h = f.requestAnimationFrame || f.webkitRequestAnimationFrame || f.mozRequestAnimationFrame || f.oRequestAnimationFrame || f.msRequestAnimationFrame || function (j) {
        f.setTimeout(j, 1000 / 60)
    };
    var c = (function () {
        var n = {};
        var o = a.createElement("div").style;
        var l = (function () {
            var s = ["t", "webkitT", "MozT", "msT", "OT"],
                q, r = 0,
                p = s.length;
            for (; r < p; r++) {
                q = s[r] + "ransform";
                if (q in o) {
                    return s[r].substr(0, s[r].length - 1)
                }
            }
            return false
        })();
        ...
        function m(p) {
            ...
            return l + p.charAt(0).toUpperCase() + p.substr(1)
        }
        n.getTime = Date.now || function j() {
            return new Date().getTime()
        };
        n.extend = function (r, q) {
            for (var p in q) {
                r[p] = q[p]
            }
        };
        n.addEvent = function (s, r, q, p) {
            s.addEventListener(r, q, !!p)
        };
        n.removeEvent = function (s, r, q, p) {
            s.removeEventListener(r, q, !!p)
        };
        n.prefixPointerEvent = function (p) {
            return f.MSPointerEvent ? "MSPointer" + p.charAt(9).toUpperCase() + p.substr(10) : p
        };
        n.momentum = function (v, r, s, p, w, x) {
            var q = v - r,
                t = e.abs(q) / s,
                y, u;
        ...
        n.hasClass = function (q, r) {
            var p = new RegExp("(^|\\s)" + r + "(\\s|$)");
            return p.test(q.className)
        };
        n.addClass = function (q, r) {
            if (n.hasClass(q, r)) {
                return
            }
        ...
        n.removeClass = function (q, r) {
            if (!n.hasClass(q, r)) {
                return
            }
            var p = new RegExp("(^|\\s)" + r + "(\\s|$)", "g");
        ...
        n.preventDefaultException = function (r, q) {
            for (var p in q) {
                if (q[p].test(r[p])) {
                    return true
                }
        ...
        n.extend(n.ease = {}, {
            ...
            elastic: {
                ...
                fn: function (p) {
                    ...
                    return (r * e.pow(2, -10 * p) * e.sin((p - q / 4) * (2 * e.PI) / q) + 1)
                }
            }
        });
        n.tap = function (r, p) {
            var q = a.createEvent("Event");
    ...
    g.prototype = {
        ...
        _transitionEnd: function (j) {
            if (j.target != this.scroller || !this.isInTransition) {
                return
            }
        ...
        _move: function (o) {
            ...
            n = e.abs(this.distX);
            m = e.abs(this.distY);
            if (p - this.endTime > 300 && (n < 10 && m < 10)) {
                return
            }
            if (!this.directionLocked && !this.options.freeScroll) {
                if (n > m + this.options.directionLockThreshold) {
                    this.directionLocked = "h"
                } else {
                    if (m >= n + this.options.directionLockThreshold) {
            ...
            j = this.x + l;
            r = this.y + k;
            if (j > 0 || j < this.maxScrollX) {
                j = this.options.bounce ? this.x + l / 3 : j > 0 ? 0 : this.maxScrollX
            }
            if (r > 0 || r < this.maxScrollY) {
                r = this.options.bounce ? this.y + k / 3 : r > 0 ? 0 : this.maxScrollY
            }
            this.directionX = l > 0 ? -1 : l < 0 ? 1 : 0;
            this.directionY = k > 0 ? -1 : k < 0 ? 1 : 0;
            if (!this.moved) {
                this._execEvent("scrollStart")
            }
            this.moved = true;
            this._translate(j, r);
            if (p - this.startTime > 300) {
                this.startTime = p;
                this.startX = this.x;
                this.startY = this.y
            }
        ...
        _end: function (p) {
            ...
            if (this.options.preventDefault && !c.preventDefaultException(p.target, this.options.preventDefaultException)) {
                p.preventDefault()
            }
            var r = p.changedTouches ? p.changedTouches[0] : p,
            ...
            if (this._events.flick && o < 200 && t < 100 && s < 100) {
                this._execEvent("flick");
                return
            }
            if (this.options.momentum && o < 300) {
                l = this.hasHorizontalScroll ? c.momentum(this.x, this.startX, o, this.maxScrollX, this.options.bounce ? this.wrapperWidth : 0, this.options.deceleration) : {
                    destination: j,
                    duration: 0
                };
                k = this.hasVerticalScroll ? c.momentum(this.y, this.startY, o, this.maxScrollY, this.options.bounce ? this.wrapperHeight : 0, this.options.deceleration) : {
                    destination: u,
                    duration: 0
                };
                j = l.destination;
            ...
            if (this.options.snap) {
                ...
                this.directionX = 0;
                this.directionY = 0;
                q = this.options.bounceEasing
            }
            if (j != this.x || u != this.y) {
                if (j > 0 || j < this.maxScrollX || u > 0 || u < this.maxScrollY) {
                    q = c.ease.quadratic
                }
                this.scrollTo(j, u, m, q);
                return
            }
            this._execEvent("scrollEnd")
        },
        ...
        resetPosition: function (k) {
            ...
            if (j == this.x && l == this.y) {
                return false
            }
            this.scrollTo(j, l, k, this.options.bounceEasing);
            return true
        },
        disable: function () {
            this.enabled = false
        ...
        refresh: function () {
            var j = this.wrapper.offsetHeight;
        ...
        off: function (l, k) {
            ...
            var j = this._events[l].indexOf(k);
            if (j > -1) {
                this._events[l].splice(j, 1)
            }
        },
        ...
        scrollBy: function (j, m, k, l) {
            j = this.x + j;
            m = this.y + m;
            k = k || 0;
            this.scrollTo(j, m, k, l)
        },
        scrollTo: function (j, m, k, l) {
            l = l || c.ease.circular;
            this.isInTransition = this.options.useTransition && k > 0;
            if (!k || (this.options.useTransition && l.style)) {
                this._transitionTimingFunction(l.style);
                this._transitionTime(k);
                this._translate(j, m)
            } else {
                this._animate(j, m, k, l.fn)
            }
        },
        scrollToElement: function (k, l, j, o, n) {
            ...
            if (j === true) {
                j = e.round(k.offsetWidth / 2 - this.wrapper.offsetWidth / 2)
            }
            if (o === true) {
                o = e.round(k.offsetHeight / 2 - this.wrapper.offsetHeight / 2)
            }
            m.left -= j || 0;
            m.top -= o || 0;
        ...
        _initEvents: function (j) {
            var k = j ? c.removeEvent : c.addEvent,
                l = this.options.bindToWrapper ? this.wrapper : f;
            k(f, "orientationchange", this);
            k(f, "resize", this);
            if (this.options.click) {
                k(this.wrapper, "click", this, true)
            }
            if (!this.options.disableMouse) {
                k(this.wrapper, "mousedown", this);
                k(l, "mousemove", this);
                k(l, "mousecancel", this);
                k(l, "mouseup", this)
            }
            if (c.hasPointer && !this.options.disablePointer) {
                k(this.wrapper, c.prefixPointerEvent("pointerdown"), this);
                k(l, c.prefixPointerEvent("pointermove"), this);
                k(l, c.prefixPointerEvent("pointercancel"), this);
                k(l, c.prefixPointerEvent("pointerup"), this)
            }
            if (c.hasTouch && !this.options.disableTouch) {
                k(this.wrapper, "touchstart", this);
                k(l, "touchmove", this);
                k(l, "touchcancel", this);
                k(l, "touchend", this)
            }
            k(this.scroller, "transitionend", this);
            k(this.scroller, "webkitTransitionEnd", this);
            k(this.scroller, "oTransitionEnd", this);
            k(this.scroller, "MSTransitionEnd", this)
        },
        getComputedPosition: function () {
            var k = f.getComputedStyle(this.scroller, null),
                j, l;
            if (this.options.useTransform) {
                k = k[c.style.transform].split(")")[0].split(", ");
                j = +(k[12] || k[4]);
                l = +(k[13] || k[5])
            } else {
                j = +k.left.replace(/[^-\d.]/g, "");
                l = +k.top.replace(/[^-\d.]/g, "")
            }
            return {
                x: j,
        ...
        _wheel: function (n) {
            ...
            if (this.wheelTimeout === undefined) {
                j._execEvent("scrollStart")
            }
            clearTimeout(this.wheelTimeout);
            this.wheelTimeout = setTimeout(function () {
                j._execEvent("scrollEnd");
                j.wheelTimeout = undefined
            }, 400);
            if ("deltaX" in n) {
                if (n.deltaMode === 1) {
                    l = -n.deltaX * this.options.mouseWheelSpeed;
                    k = -n.deltaY * this.options.mouseWheelSpeed
                } else {
                    l = -n.deltaX;
                    k = -n.deltaY
                }
                ...
                if ("wheelDeltaX" in n) {
                    l = n.wheelDeltaX / 120 * this.options.mouseWheelSpeed;
                    k = n.wheelDeltaY / 120 * this.options.mouseWheelSpeed
                } else {
                    if ("wheelDelta" in n) {
                        l = k = n.wheelDelta / 120 * this.options.mouseWheelSpeed
                    } else {
                        if ("detail" in n) {
                            l = k = -n.detail / 3 * this.options.mouseWheelSpeed
                        } else {
                            return
                        }
                    }
            ...
            l *= this.options.invertWheelDirection;
            ...
            o = this.x + e.round(this.hasHorizontalScroll ? l : 0);
            m = this.y + e.round(this.hasVerticalScroll ? k : 0);
            if (o > 0) {
                o = 0
            } else {
        ...
        _initSnap: function () {
            ...
            this.on("flick", function () {
                var j = this.options.snapSpeed || e.max(e.max(e.min(e.abs(this.x - this.startX), 1000), e.min(e.abs(this.y - this.startY), 1000)), 300);
        ...
        goToPage: function (j, o, k, n) {
            ...
            if (o >= this.pages[j].length) {
                o = this.pages[j].length - 1
            } else {
                if (o < 0) {
                    o = 0
                }
            }
            var m = this.pages[j][o].x,
                l = this.pages[j][o].y;
            ...
            this.scrollTo(m, l, k, n)
        },
        next: function (k, m) {
            var j = this.currentPage.pageX,
                l = this.currentPage.pageY;
            j++;
            if (j >= this.pages.length && this.hasVerticalScroll) {
                j = 0;
                l++
            }
            this.goToPage(j, l, k, m)
        },
        prev: function (k, m) {
            var j = this.currentPage.pageX,
                l = this.currentPage.pageY;
            j--;
            if (j < 0 && this.hasVerticalScroll) {
                j = 0;
                l--
            }
            this.goToPage(j, l, k, m)
        ...
        _key: function (o) {
            ...
            var j = this.options.snap,
                ...
                q;
            if (this.options.useTransition && this.isInTransition) {
                q = this.getComputedPosition();
                this._translate(e.round(q.x), e.round(q.y));
                this.isInTransition = false
            }
            this.keyAcceleration = l - k < 200 ? e.min(this.keyAcceleration + m, 50) : 0;
            switch (o.keyCode) {
            case this.options.keyBindings.pageUp:
                if (this.hasHorizontalScroll && !this.hasVerticalScroll) {
                    p += j ? 1 : this.wrapperWidth
                } else {
                    n += j ? 1 : this.wrapperHeight
                }
                break;
            ...
            case this.options.keyBindings.end:
                ...
                n = j ? this.pages[0].length - 1 : this.maxScrollY;
                break;
            ...
            case this.options.keyBindings.left:
                p += j ? -1 : 5 + this.keyAcceleration >> 0;
                break;
            case this.options.keyBindings.up:
                n += j ? 1 : 5 + this.keyAcceleration >> 0;
                break;
        ...
        _animate: function (s, r, m, j) {
            ...
            function l() {
                ...
                if (t >= q) {
                    p.isAnimating = false;
                    p._translate(s, r);
                    if (!p.resetPosition(p.options.bounceTime)) {
                        p._execEvent("scrollEnd")
                    }
                    return
                }
                t = (t - k) / m;
    ...
    b.prototype = {
        ...
        transitionTime: function (j) {
            j = j || 0;
            this.indicatorStyle[c.style.transitionDuration] = j + "ms";
            if (!j && c.isBadAndroid) {
                this.indicatorStyle[c.style.transitionDuration] = "0.001s"
            }
        },
        transitionTimingFunction: function (j) {
            this.indicatorStyle[c.style.transitionTimingFunction] = j
        },
        refresh: function () {
            this.transitionTime();
        ...
        updatePosition: function () {
            var j = this.options.listenX && e.round(this.sizeRatioX * this.scroller.x) || 0,
                k = this.options.listenY && e.round(this.sizeRatioY * this.scroller.y) || 0;
            if (!this.options.ignoreBoundaries) {
                if (j < this.minBoundaryX) {
                    if (this.options.shrink == "scale") {
                        this.width = e.max(this.indicatorWidth + j, 8);
                        this.indicatorStyle.width = this.width + "px"
                    }
                    j = this.minBoundaryX
                } else {
                    if (j > this.maxBoundaryX) {
                        if (this.options.shrink == "scale") {
                            this.width = e.max(this.indicatorWidth - (j - this.maxPosX), 8);
                            this.indicatorStyle.width = this.width + "px";
                            j = this.maxPosX + this.indicatorWidth - this.width
                        } else {
                            j = this.maxBoundaryX
                        }
                    } else {
                ...
                if (k < this.minBoundaryY) {
                    if (this.options.shrink == "scale") {
                        this.height = e.max(this.indicatorHeight + k * 3, 8);
                        this.indicatorStyle.height = this.height + "px"
                    }
                    k = this.minBoundaryY
                } else {
                    if (k > this.maxBoundaryY) {
                        if (this.options.shrink == "scale") {
                            this.height = e.max(this.indicatorHeight - (k - this.maxPosY) * 3, 8);
                            this.indicatorStyle.height = this.height + "px";
                            k = this.maxPosY + this.indicatorHeight - this.height
                        } else {
                            k = this.maxBoundaryY
                        }
                    } else {
            ...
            if (this.scroller.options.useTransform) {
                this.indicatorStyle[c.style.transform] = "translate(" + j + "px," + k + "px)" + this.scroller.translateZ
            } else {
                this.indicatorStyle.left = j + "px";
                this.indicatorStyle.top = k + "px"
            }
        },
        _pos: function (j, k) {
            if (j < 0) {
            ...
            j = this.options.listenX ? e.round(j / this.sizeRatioX) : this.scroller.x;
            k = this.options.listenY ? e.round(k / this.sizeRatioY) : this.scroller.y;
            this.scroller.scrollTo(j, k)
        },
        fade: function (m, l) {
            if (l && !this.visible) {
                return
...
function CustomIScroll(b, a) {
    this.originUseTransition = a.useTransition;
...
CustomIScroll.prototype.stop = function () {
    this.isAnimating = false;
    var b = this.getComputedPosition();
    var a = b.x;
    this._translate(a, 0)
};
CustomIScroll.prototype.scrollToLeft = function (a) {
    this.scrollTo(0, 0, a * Math.abs(this.x) / 1000, linearEasing)
};
CustomIScroll.prototype.scrollToRight = function (a) {
    this.scrollTo(this.maxScrollX, 0, a * (Math.abs(this.maxScrollX) - Math.abs(this.x)) / 1000, linearEasing)
};

function shiftLobbyElementsAround(c) {
    var b = getLeftLobbyElements(c);
    var a = getRightLobbyElements(c);
    for (i = 0; i < b.length; i++) {
        b[i].className += " moveLeft"
    }
    for (i = 0; i < a.length; i++) {
        a[i].className += " moveRight"
    }
}

function getRightLobbyElements(a) {
    return getLobbyElementsByDirection(a, true)
}

function getLeftLobbyElements(a) {
    return getLobbyElementsByDirection(a, false)
}

function getLobbyElementsByDirection(d, c) {
    var a = [];
    var b = d;
    while (b) {
        var e = c ? b.nextSibling : b.previousSibling;
        if (e && e.className && e.className.indexOf("item") > -1) {
            a.push(e)
        }
        b = e
    }
    ...
    var w, C = {},
        ...
        a = function (k) {
            return f[k] || k.toUpperCase().charCodeAt(0)
        },
        y = [];
    for (w = 1; w < 20; w++) {
        f["f" + w] = 111 + w
    ...
    function D(K) {
        ...
        for (G = 0; G < C[H].length; G++) {
            J = C[H][G];
            if (J.scope == I || J.scope == "all") {
                L = J.mods.length > 0;
                for (F in B) {
                    if ((!B[F] && h(J.mods, +F) > -1) || (B[F] && h(J.mods, +F) == -1)) {
                        L = false
                    }
                }
                if ((J.mods.length == 0 && !B[16] && !B[18] && !B[17] && !B[91]) || L) {
                    if (J.method(K, J) === false) {
                        if (K.preventDefault) {
                            K.preventDefault()
                        } else {
                            K.returnValue = false
    ...
    function m(F) {
        var k = (F.target || F.srcElement).tagName;
