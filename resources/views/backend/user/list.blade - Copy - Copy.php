				...
				<form action="{{ route('backend.user.balance.update') }}" method="POST">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input type="button"  style="background: url(../img/num5.png);
    background-repeat: round;
	border: 1px solid; 
    border-radius: 5px;
    width: 19%;
    text-align: center;
    height: 40px;"id="OutSum" name="summ" placeholder="+5" data-dismiss="modal"	required>
							<option value="5" >Add 5 CHF</option><input type="button" style="background: url(../img/num10.png);
    background-repeat: round;
	border: 1px solid;
    border-radius: 5px;
    width: 19%;
    text-align: center;
    height: 40px;"id="OutSum" name="summ" placeholder="+10" required>
							<input type="button" style="background: url(../img/num20.png);
    background-repeat: round;
	border: 1px solid;
    border-radius: 5px;
    width: 19%;
    text-align: center;
    height: 40px;"id="OutSum" name="summ" placeholder="+20" required>
							<input type="button" style="background: url(../img/num50.png);
    background-repeat: round;
	border: 1px solid;
    border-radius: 5px;
    width: 19%;
    text-align: center;
    height: 40px;"id="OutSum" name="summ" placeholder="+50" required>
							<input type="button" style="background: url(../img/num100.png);
    background-repeat: round;
	border: 1px solid;
    border-radius: 5px;
    width: 19%;
    text-align: center;
    height: 40px;"id="OutSum" name="summ" placeholder="+100" required>
