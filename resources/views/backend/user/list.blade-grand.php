...
@section('content')
    ...
    width: 19%;
    text-align: center;
    height: 40px;"id="OutSum" name="summ" placeholder="+5" value="10"	required>
							<input type="button"value="10" style="background: url(../img/num10.png);
    background-repeat: round;
	border: 1px solid;
    border-radius: 5px;
    width: 19%;
    text-align: center;
    height: 40px;"id="OutSum" name="summ" placeholder="+10" data-dismiss="modal" required>
