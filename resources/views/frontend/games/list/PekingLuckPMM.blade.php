...
<head>
   ...
   <script src="/games/PekingLuckPMM/device.min.js"></script>
...
<iframe id='game' style="position:fixed;margin:0px;border:0px;width:100%; height:100vh;" src='/games/PekingLuckPMM/index.html?lang=en&cur=@if( auth()->user()->present()->shop ){{ auth()->user()->present()->shop->currency }}@endif&gameSymbol=vs1dragon8&websiteUrl=&lobbyURL=' allowfullscreen>
...
<img  id="swipeOverlayImg" style="display:none;z-index:200;width: 20vw;position: fixed; left: 50%; top: 25%;" src="/games/PekingLuckPMM/swipe.png">
</body>
<script>
