...
<span  style="color: #fff;
    ...
    font-weight: 700;
        ...
        <div class="form-group has-feedback">
          <input type="text" name="username" id="username" class="form-control" placeholder="@lang('')">
...
<span  style="color: #fff;
    ...
    font-weight: 700;
        ...
        <div class="form-group has-feedback">
          <input type="password" name="password" id="password" class="form-control" placeholder="@lang('')">
