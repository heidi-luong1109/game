@extends('frontend.Default1.layouts.app')
...
@section('content')
							...
							<div class="grid__content games">
								<div class="games__item">
									<div class="games__content">
										<img src="{{ $game->name ? '/frontend/Default1/ico/' . $game->name . '.jpg' : '' }}" alt="{{ $game->title }}">										
			...
			<div class="footer__block">
				<div class="footer__left">
					...
					<a href="#" data-name="modal-bonus" class="gift" id="returns">
						<img src="/frontend/Default1/img/_src/gift-active.png" alt="" class="gift-icon active">
					</a>
					@endif
					<!--
					<a href="#" class="wheel">
				...
				<div class="footer__right">
					<a href="/logout" class="footer__icon"><img src="/frontend/Default1/img/_src/close.svg" alt=""></a>
				</div>
			</div>
		</div>
	</footer>
	...
	<div class="modal modal-bonus" >
		...
		<span class="close-btn">
			<img src="/frontend/Default1/img/_src/close.svg" alt="">
		</span>
	</div>
