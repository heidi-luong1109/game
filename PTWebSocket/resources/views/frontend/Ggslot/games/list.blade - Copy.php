...
<div id="txt"class="time"></div>
    ...
    font-size: 2vw;
    font-family: fantasy;
    color: #f4c017;"><em></em> {{ Auth::user()->username }}</span>
				</div>
				<div class="">
					<div class="">
...
.button7:hover {
	...
	<a href="/frontend/Ggslot/wazdan.php"><img src="/frontend/Ggslot/images/wazdan0.png" class="button6"></a></div-->
			            ...
			            <a href="../logout"><img src="../frontend/Ggslot/images/logout.png" style="position: fixed;
    right: 44%;
    bottom: 0%;
    width: 13%;
    height: 9%;
    ...
    background-size: 7vw auto;
    z-index: 9999;"></a></div>
					          <a href=""><img src="../frontend/Ggslot/images/navbar.png" style="position: fixed;
    right: 0%;
    bottom: 0%;
    width: 104%;
    height: 15%;
